...
*/
	...
	*/ 
	$config['database']['user_acc']['table'] = 'users';
	$config['database']['user_acc']['join'] = 'users.id';
	 ...
	 * All columns are required.
	*/ 
	$config['database']['user_group']['table'] = 'groups';
	$config['database']['user_group']['join'] = 'groups.id';
	$config['database']['user_group']['columns']['id'] = 'id';
	$config['database']['user_group']['columns']['name'] = 'name';
	$config['database']['user_group']['columns']['description'] = 'desc';
	$config['database']['user_group']['columns']['admin'] = 'admin';
	...
	*/ 
	...
	$config['database']['user_privileges']['columns']['id'] = 'id';
	$config['database']['user_privileges']['columns']['name'] = 'name';
	$config['database']['user_privileges']['columns']['description'] = 'desc';
	...
	*/ 
	...
	$config['database']['user_privilege_users']['columns']['id'] = 'id';
	$config['database']['user_privilege_users']['columns']['user_id'] = 'user_id';
	$config['database']['user_privilege_users']['columns']['privilege_id'] = 'privilege_id';
	...
	*/ 
	...
	$config['database']['user_privilege_groups']['columns']['id'] = 'id';
	$config['database']['user_privilege_groups']['columns']['group_id'] = 'group_id';
	$config['database']['user_privilege_groups']['columns']['privilege_id'] = 'privilege_id';
	...
	*/ 
	...
	$config['database']['user_sess']['join'] = 'user_login_sessions.user_id';
	$config['database']['user_sess']['columns']['user_id'] = 'user_id';
	$config['database']['user_sess']['columns']['series'] = 'series';
	$config['database']['user_sess']['columns']['token'] = 'token';
	$config['database']['user_sess']['columns']['date'] = 'login_date';
	...
	*/ 
	...
	$config['database']['custom']['user_profile']['primary_key'] = 'profile_id';
	$config['database']['custom']['user_profile']['foreign_key'] = 'user_id';
	$config['database']['custom']['user_profile']['join'] = 'user_profiles.user_id';
	$config['database']['custom']['user_profile']['custom_columns'] = array(
		'company','first_name','last_name','phone','address','address2','city','state','zipcode'
	);
	...
	*/ 
	$config['database']['settings']['primary_identity_col'] = 'email';  
	...
	*/ 
	$config['database']['settings']['search_user_cols'] = array('email', 'first_name', 'last_name');
	...
	*/
	$config['security']['login_session_expire'] = 60*30;
	...
	*/
	...
	$config['email']['site_title'] = "Ctrl-O";
	
	// Reply email shown as 'from' header on emails.
	$config['email']['reply_email'] = "ctrl-o@randomwire.biz";
