...
class User extends CI_Controller {
	...
	*/
	...
	function dashboard()
	{
		...
		$this->load->view('public_dashboard_view', $this->data);
	}
	...
	function profile()
	{
		...
		$this->load->view('account_update_view', $this->data);
	}
 	/**
 	 * update_account
	...
	function change_password()
	{
		...
		$this->load->view('password_update_view', $this->data);
	}
	...
	function update_email($user_id = FALSE, $token = FALSE)
	{
		...
		if ($this->flexi_auth->is_logged_in())
		{
			...
			$this->load->view('email_update_view', $this->data);
		}
		else
		{
			redirect('auth/login');
