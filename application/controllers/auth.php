...
class Auth extends CI_Controller {
    ...
    function __construct() 
    {
		...
		// Note: This is only included to create base urls for purposes of this demo only and are not necessarily considered as 'Best practice'.
                ...
                //$this->load->vars('base_url', 'http://members.pataelmo.com/');
                //$this->load->vars('includes_dir', 'http://members.pataelmo.com/includes/');
	...
	*/
	...
	function activate_account($user_id, $token = FALSE)
	{
		...
		$email_data['username'] = $user[$this->flexi_auth->db_column('user_acc', 'username')];
		$this->load->model('flexi_auth_model');
		$this->flexi_auth_model->send_email($email, 'Welcome', 'registration_welcome.tpl.php', $email_data);
