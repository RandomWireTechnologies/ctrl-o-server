					...
					<table>
						...
						<tbody>
							...
							<tr>
								...
								<?php if ($this->flexi_auth->is_privileged('Manage Users')) { ?>
						...
						<tfoot>
							<tr>
								<td colspan="7">
									<?php $disable = (! $this->flexi_auth->is_privileged('Manage Users') && ! $this->flexi_auth->is_privileged('Manage Users')) ? 'disabled="disabled"' : NULL;?>
