...
<div id="body_wrap">
	...
	<div class="content_wrap main_content_bg">
		<div class="content clearfix">
			<div class="col100">
				<h2>Update User Group Privileges of Group '<?php echo $group['name']; ?>'</h2>
				<a href="<?php echo $base_url;?>auth_admin/manage_user_groups">Manage User Groups</a> | 
				<a href="<?php echo $base_url;?>auth_admin/update_user_group/<?php echo $group['id']; ?>">Update User Group</a>
