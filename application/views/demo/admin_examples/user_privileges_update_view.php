...
<div id="body_wrap">
	...
	<div class="content_wrap main_content_bg">
		<div class="content clearfix">
			<div class="col100">
				<h2>Update User Privileges of '<?php echo $user['first_name'].' '.$user['last_name']; ?>', Member of Group '<?php echo $user['name']; ?>'</h2>
				<a href="<?php echo $base_url;?>auth_admin/manage_user_accounts">Manage User Accounts</a> | 
				<a href="<?php echo $base_url;?>auth_admin/update_user_account/<?php echo $user['id']; ?>">Update Users Account</a>
