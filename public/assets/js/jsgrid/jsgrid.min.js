...
(function(window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        _createPagerContainer: function() {
            var pagerContainer = this.pagerContainer || $("<nav>").appendTo(this._container);
        ...
        _createPager: function() {
            ...
            if($.isFunction(this.pagerRenderer)) {
                ...
                $result = $("<ul>").append(this._createPagerByFormat());
            }
        ...
        deleteItem: function(item) {
            ...
            if (typeof swal == 'undefined') {
                ...
                swal({
                    ...
                    if (!isConfirm) {
                        swal("Cancelled", "All is well with the world :)", "error");
                    } else {
                        return $that._deleteRow($row);
                    }
                })
            }
        },
