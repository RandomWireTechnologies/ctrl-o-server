        ...
        <div class="modal-dialog open-modal-center">
            {!! Form::open([
                ...
                <div class="modal-body">
                    <div class="row">
                        @include('admin.cards.form', ['users' => $users])
                    </div>
                </div>
...
<script>
    ...
    Grid.setOptions({
        ...
        updateRoute: "{{ route('admin.cards.update', ['id' => ':id']) }}",
        insertRoute: "{{ route('admin.cards.store') }}",
        deleteRoute: "{{ route('admin.cards.destroy', ['id' => ':id']) }}",
        fields: {!! $fields !!},
        rules: {!! $rules !!},
        messages: {!! $messages !!}
    }).render();
