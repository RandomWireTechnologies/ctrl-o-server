...
<div class="main-content">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="panel">
                    ...
                    <header class="panel-heading">
                        <h3 class="panel-title">Membership Types</h3>
                    </header>
    ...
    <div class="modal fade modal-scalled" id="form-modal" aria-hidden="true" role="dialog">
        <div class="modal-dialog open-modal-center">
            {!! Form::open([
                'route' => 'admin.membership-types.store', 
                'id'    => 'add-form', 
...
<script>
    Grid.setOptions({
        deleteConfirm: 'Do you really want to delete this Membership Type?',
        loadRoute: "{{ route('api.membership-types.list') }}",
        updateRoute: "{{ route('admin.membership-types.update', ['id' => ':id']) }}",
        insertRoute: "{{ route('admin.membership-types.store') }}",
        deleteRoute: "{{ route('admin.membership-types.destroy', ['id' => ':id']) }}",
        fields: {!! $fields !!},
        rules: {!! $rules !!},
        messages: {!! $messages !!}
    }).render();
