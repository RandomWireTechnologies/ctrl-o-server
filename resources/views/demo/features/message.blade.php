...
<html lang="en">
	<head>
		...
		<title>Message | Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<!--  Page CSS -->
		<link rel="stylesheet" href="../assets/css/message/custom.css">
	</head>
	<body class="basic-table site-navbar-small message">
		...
		<div class="main-content app-message">
			...
			<div class="page-content">
				<div class="contaner-flueid">
					<div class="chat-message">
						<div class="page-left-side chat-padding-left">
							<div class="content panel-heading panel-title chat-title-box chat-title-padding">
							...
							<div class="sidebar-height collapse" id="collapseExample">
								<div class="panel margin-bottom-0">
									...
									<div class="message-list chat-message-box">
										<!-- Start Chat Message Box -->
										<ul class="list-group margin-top-15">
											<li class="list-group-item">
												<div class="media">
													<div class="media-left">
														<a class="profile-pic image-height pro-online" href="javascript:void(0)">
														<img data-image="../assets/images/global/img_240x265.png" class="img-responsive" src="../assets/images/global/img_240x265.png" alt="chat message image"><i></i></a>
													</div>
													<div class="media-body">
														<h3 class="media-heading">Domare Dos</h3>
														<span>At vero eos et acc...</span>
													</div>
													<div class="media-right">
														<span class="badge badge-danger">5</span>
														<p class="media-time-right">45 sec ago</p>
													</div>
												</div>
											</li>
											<li class="list-group-item">
												<div class="media">
													...
													<div class="media-body">
														<h3 class="media-heading">Melissa Dock</h3>
														<span>At vero eos et acc...</span>
													</div>
													<div class="media-right">
														<span class="badge badge-danger">2</span>
														<p class="media-time-right">50 sec ago</p>
													</div>
												</div>
											</li>
											<li class="list-group-item active">
												<div class="media">
													...
													<div class="media-body">
														<h3 class="media-heading">Verdell Rea</h3>
														<span>At vero eos et acc...</span>
													</div>
													<div class="media-right">
														<p class="media-time-right">13 minut ago</p>
													</div>
												</div>
											</li>
											<li class="list-group-item">
												<div class="media">
													<div class="media-left">
														<a class="profile-pic image-height pro-away" href="javascript:void(0)">
														<img data-image="../assets/images/global/img_240x265.png" class="img-responsive" src="../assets/images/global/img_240x265.png" alt="chat message image"><i></i></a>
													</div>
													<div class="media-body">
														<h3 class="media-heading">Clay Peskin</h3>
														<span>At vero eos et acc...</span>
													</div>
													<div class="media-right">
														<p class="media-time-right">11 minut ago</p>
													</div>
												</div>
											</li>
											<li class="list-group-item">
												<div class="media">
													...
													<div class="media-body">
														<h3 class="media-heading">Hinem Jome</h3>
														<span>At vero eos et acc...</span>
													</div>
													<div class="media-right">
														<p class="media-time-right">1 minut ago</p>
													</div>
												</div>
											</li>
											<li class="list-group-item">
												<div class="media">
													...
													<div class="media-body">
														<h3 class="media-heading">Brooks Lata</h3>
														<span>At vero eos et acc...</span>
													</div>
													<div class="media-right">
														<span class="badge badge-danger">1</span>
														<p class="media-time-right">20 sec ago</p>
													</div>
												</div>
											</li>
											<li class="list-group-item">
												<div class="media">
													...
													<div class="media-body">
														<h3 class="media-heading">Chempi Roke</h3>
														<span>At vero eos et acc...</span>
													</div>
													<div class="media-right">
														<p class="media-time-right">43 minut ago</p>
													</div>
												</div>
											</li>
											<li class="list-group-item">
												<div class="media">
													...
													<div class="media-body">
														<h3 class="media-heading">Aerace Boara</h3>
														<span>At vero eos et acc...</span>
													</div>
													<div class="media-right">
														<p class="media-time-right">54 minut ago</p>
													</div>
												</div>
											</li>
											<li class="list-group-item">
												<div class="media">
													...
													<div class="media-body">
														<h3 class="media-heading">Jonathan Smith</h3>
														<span>At vero eos et acc...</span>
													</div>
													<div class="media-right">
														<p class="media-time-right">2 hours ago</p>
													</div>
												</div>
											</li>
											<li class="list-group-item">
												<div class="media">
													...
													<div class="media-body">
														<h3 class="media-heading">Miles Morales</h3>
														<span>At vero eos et acc...</span>
													</div>
													<div class="media-right">
														<p class="media-time-right">3 hours ago</p>
													</div>
												</div>
											</li>
											<li class="list-group-item">
												<div class="media">
													...
													<div class="media-body">
														<h3 class="media-heading">Barlina Maze</h3>
														<span>At vero eos et acc...</span>
													</div>
													<div class="media-right">
														<p class="media-time-right">5 hours ago</p>
													</div>
												</div>
											</li>
											<li class="list-group-item">
												<div class="media">
													...
													<div class="media-body">
														<h3 class="media-heading">Herff Jones</h3>
														<span>At vero eos et acc...</span>
													</div>
													<div class="media-right">
														<p class="media-time-right">1 day ago</p>
													</div>
												</div>
											</li>
											<li class="list-group-item">
												<div class="media">
													...
													<div class="media-body">
														<h3 class="media-heading">Coop Norden</h3>
														<span>At vero eos et acc...</span>
													</div>
													<div class="media-right">
														<p class="media-time-right">3 days ago</p>
													</div>
												</div>
											</li>
											<li class="list-group-item">
												<div class="media">
													...
													<div class="media-body">
														<h3 class="media-heading">Mott Donald</h3>
														<span>At vero eos et acc...</span>
													</div>
													<div class="media-right">
														<p class="media-time-right">4 days ago</p>
													</div>
												</div>
											</li>
										</ul>
						...
						<div class="page-main-content chat-padding">
							<div class="panel margin-bottom-0">
								<div class="panel-heading panel-title chat-title-box chat-title-box-padding">
									<h4>Chat</h4>
									<div class="btn-group dropdown chat-btn-right">
										<!-- Setting Icon -->
										<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light padding-top-10" id="chat-dropdown" data-toggle="dropdown" aria-expanded="false">
										<i class="icon icon_cog"></i>
										<span class="caret"></span>
										</button>
										<!-- Setting Sub Menu -->
										<ul class="dropdown-menu bullet dropdown-menu-right" aria-labelledby="chat-dropdown" role="menu">
											<li><a href="#"><i class="icon icon_chat_alt"></i> Online</a></li>
											<li><a href="#"><i class="icon icon_error-oct_alt"></i> Busy</a></li>
											<li><a href="#"><i class="icon icon_menu-circle_alt2"></i> Away</a></li>
											<li class="divider"></li>
											<li><a href="#"><i class="icon icon_link"></i> Connect</a></li>
											<li><a href="#"><i class="icon icon_link_alt"></i> Disconect</a></li>
										</ul>
									</div>
								</div>
									...
									<div class="chat_box">
										<div class="row">
											...
											<div class="col-md-12 col-sm-12 col-xs-12">
												<div class="chat_message_wrapper">
													<div class="chat_user_avatar">
														<img class="user-image-left" src="../assets/images/global/img_240x265.png" alt="chat-img">
													</div>
													<ul class="chat_message_left">
														<li class="chat_margin">
															<h3 class="chat-name-left">Verdell Rea</h3>
															<p>Donec sodales sagittis magna. Sed consequat, leo eget bibendum sodales, augue velit cursus nunc, quis gravida magna mi a libero. Fusce vulputate eleifend sapien. <span class="chat_message_time_left"><i class="icon icon_clock_alt"></i> 19 JUN 1:30 PM</span> </p>
														</li>
													</ul>
												</div>
											</div>
											<div class="col-md-12 col-sm-12 col-xs-12">
												<div class="chat_message_wrapper">
													<div class="chat_user_avatar">
														<img class="user-image-right" src="../assets/images/global/img_240x265.png" alt="chat-img">
													</div>
													<ul class="chat_message_right">
														<li class="chat_margin">
															<h3 class="chat-name-right">Sevral Den</h3>
															<p>Maecenas nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus. Nullam quis.<span class="chat_message_time_right"><i class="icon icon_clock_alt"></i> 13:39</span>
															</p>
														</li>
													</ul>
												</div>
											...
											<div class="col-md-12 col-sm-12 col-xs-12">
												<div class="chat_message_wrapper">
													...
													<ul class="chat_message_right">
														<li class="chat_margin">
															<h3 class="chat-name-right">Sevral Den</h3>
															<p>Integer ante arcu, accumsan a, consectetuer eget, posuere ut, mauris.<span class="chat_message_time_right"><i class="icon icon_clock_alt"></i>  2:43 AM</span>
															</p>
														</li>
													</ul>
												</div>
											...
											<div class="col-md-12 col-sm-12 col-xs-12">
												<div class="chat_message_wrapper">
													...
													<ul class="chat_message_right">
														<li class="chat_margin">
															<h3 class="chat-name-right">Sevral Den</h3>
															<p>Cras ultricies mi eu turpis hendrerit fringilla.<span class="chat_message_time_right"><i class="icon icon_clock_alt"></i> 13:39</span></p>
														</li>
													</ul>
												</div>
											</div>
											<div class="col-md-12 col-sm-12 col-xs-12">
												<div class="chat_message_wrapper">
													...
													<ul class="chat_message_left">
														<li class="chat_margin">
															<h3 class="chat-name-left">Verdell Rea</h3>
															<p>Sed aliquam ultrices mauris Sed consequat.<span class="chat_message_time_left"><i class="icon icon_clock_alt"></i> 12:30 PM</span> </p>
														</li>
													</ul>
												</div>
											</div>
											<div class="col-md-12 col-sm-12 col-xs-12">
												<div class="chat_message_wrapper">
													...
													<ul class="chat_message_right">
														<li class="chat_margin">
															<h3 class="chat-name-right">Sevral Den</h3>
															<p>Integer ante arcu, accumsan a, consectetuer eget, posuere ut, mauris. Praesent adipiscing. Phasellus ullamcorper ipsum rutrum nunc. Nunc nonummy metus. Vestibulum volutpat pretium libero. Cras.<span class="chat_message_time_right"><i class="icon icon_clock_alt"></i>  2:43 AM</span>
															</p>
														</li>
													</ul>
												</div>
											...
											<div class="col-md-12 col-sm-12 col-xs-12">
												<div class="chat_message_wrapper">
													...
													<ul class="chat_message_left">
														<li class="chat_margin">
															<h3 class="chat-name-left">Verdell Rea</h3>
															<p> Maecenas malesuada.<span class="chat_message_time_left"><i class="icon icon_clock_alt"></i> 15:43</span> </p>
														</li>
													</ul>
												</div>
											</div>
											<div class="col-md-12 col-sm-12 col-xs-12">
												<div class="chat_message_wrapper">
													...
													<ul class="chat_message_right">
														<li class="chat_margin">
															<h3 class="chat-name-right">Sevral Den</h3>
															<p>imperdiet feugiat, pede Sed lectus.<span class="chat_message_time_right"><i class="icon icon_clock_alt"></i> 16:00</span>
															</p>
														</li>
													</ul>
												</div>
											...
											<div class="col-md-12 col-sm-12 col-xs-12">
												<div class="chat_message_wrapper">
													...
													<ul class="chat_message_left">
														<li class="chat_margin">
															<p><img src="../assets/images/chat/Smiley.png" alt="chat-smile" width="20"><span class="chat_message_time_left"><i class="icon icon_clock_alt"></i> 12:00</span> </p>
														</li>
													</ul>
												</div>
											</div>
								...
								<div class="panel-footer border-none chat_footer">
									<form>
										<div class="input-group form-material">
											<!-- Chat Input Box -->
											<span class="input-group-btn">
											<a href="#" class="btn icon md-camera"></a>
											</span>
											<input class="form-control" type="text" placeholder="Type message here ...">
											<span class="input-group-btn">
											<span class="btn icon md-mail-send"></span>
											</span>
										</div>
									</form>
								</div>
		...
		<!-- Page JavaScript -->
		<script src="../assets/js/message/custom-message.js" type="text/javascript"></script>
