...
<html lang="en">
	<head>
		...
		<title>User List | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="dashboard site-navbar-small">
			...
			<div class="page-content container-fluid">
				<div class="panel">
					<div class="panel-body">
						<form class="navbar-form search-input" role="search">
							<div class="form-group mobile-input">
								<div class="icon-addon">
									<!--  Search Box -->
									<input type="text" placeholder="Search Users" class="form-control" style="position: absolute;">
									<label class="icon icon_search" rel="tooltip"></label>
									<label class="icon  icon_close" rel="tooltip"></label>
								</div>
							</div>
						</form>
						<div class="panel box-mobile">
							<!--  Start Contacts Section -->
							<div class="panel-heading">
								<h3 class="panel-title mobile-title">My Contacts</h3>
							</div>
							<div class="panel-body">
								<div class="row">
									<div class="col-lg-4 col-sm-4 col-xs-6 box-userlist">
										<div class="row">
											<div class="col-lg-4 col-sm-12 col-xs-12">
												<img class="img-size" src="../assets/images/global/img_240x265.png" alt="user image">
											</div>
											<div class="col-lg-8 col-sm-12 col-xs-12">
												<div class="user-details">
													...
													<div class="user-icon">
														<a href="javascript:void(0)"><i class="social_facebook" aria-hidden="true"></i></a>
														<a href="javascript:void(0)"><i class="social_twitter" aria-hidden="true"></i></a>
														<a href="javascript:void(0)"><i class="social_googleplus" aria-hidden="true"></i></a>
														<a href="javascript:void(0)"><i class="social_linkedin" aria-hidden="true"></i></a>
														<a href="javascript:void(0)"><i class="social_instagram" aria-hidden="true"></i></a>
													</div>
													<div class="btn-userlist">
														<button type="button" class="btn btn-sm btn-flat waves-effect waves-light btn-view" data-target="#view-modal" data-toggle="modal">View Profile</button>
														<button type="button" class="btn btn-sm btn-info waves-effect waves-light btn-view btn-connect" data-target="#edit-modal" data-toggle="modal" >Edit Profile</button>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-lg-8 col-sm-12 col-xs-12">
												<div class="user-details">
													...
													<div class="btn-userlist">
														<button type="button" class="btn btn-sm btn-flat waves-effect waves-light btn-view" data-target="#view-modal" data-toggle="modal">View Profile</button>
														<button type="button" class="btn brn-sm btn-info waves-effect waves-light btn-view btn-connect" data-target="#edit-modal" data-toggle="modal" >Edit Profile</button>
													</div>
												</div>
											</div>
										</div>
									</div>
									<div class="clearfix visible-xs-block hidden-xlg"></div>
									<div class="col-lg-4 col-sm-4 col-xs-6 box-userlist">
										<div class="row">
											<div class="col-lg-4 col-sm-12 col-xs-12">
												<img class="img-size" src="../assets/images/global/img_240x265.png" alt="user image">
										...
										<div class="row">
											...
											<div class="col-lg-8 col-sm-12 col-xs-12">
												<div class="user-details">
													...
													<div class="btn-userlist">
														<button type="button" class="btn btn-flat waves-effect waves-light btn-view" data-target="#view-modal" data-toggle="modal">View Profile</button>
														<button type="button" class="btn btn-info waves-effect waves-light btn-view btn-connect" data-target="#edit-modal" data-toggle="modal" >Edit Profile</button>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="clearfix visible-xlg-block"></div>
									<div class="col-lg-4 col-sm-4 col-xs-6 box-userlist margin-md-0 margin-sm-0">
										<div class="row">
											<div class="col-lg-4 col-sm-12 col-xs-12">
												<img class="img-size" src="../assets/images/global/img_240x265.png" alt="user image">
											</div>
									...
									<div class="clearfix visible-xs-block hidden-xlg"></div>
									<div class="col-lg-4 col-sm-4 col-xs-6 box-userlist margin-bottom-0">
										<div class="row">
											<div class="col-lg-4 col-sm-12 col-xs-12">
												<img class="img-size" src="../assets/images/global/img_240x265.png" alt="user image">
											</div>
						...
						<div class="panel box-mobile">
							<!--  Start Google Contact Section -->
							<div class="panel-heading">
								<h3 class="panel-title mobile-title">Google Contacts</h3>
							</div>
							<div class="panel-body">
								<div class="row">
									<div class="col-lg-4 col-sm-4 col-xs-6 box-userlist">
							...
							<!--  End Google Contact Section -->
						</div>
					</div>
				</div>
			</div>
		</div>
		<div class="modal fade row" id="view-modal">
			<div class="modal-dialog">
				<div class="modal-content-modal modal-view-profile">
					...
					<div class="modal-body-user margin-md-0">
						<div class="row">
							<div class="top-profile padding-bottom-0">
								<div class="profile-bottom">
									<div class="name-profile">Munaro Jacob</div>
									<div class="post-profile">Project Manger</div>
								</div>
								...
								<div class="col-md-12">
									...
									<div class="col-md-4 col-sm-4 col-xs-12">
										<div class="twitter-box margin-bottom-20">
								...
								<div class="col-md-12">
									<div class="col-md-12">
										<h4 class="skill-title margin-bottom-15">Personal Information</h4>
									</div>
									<div class="col-md-12">
										<div class="first-name-profile">
											<span class="text-name-profile text-info">Name : </span>
											<span>Munaro Jacob</span>
										</div>
									</div>
									<div class="col-md-12">
										<div class="first-name-profile">
											<span class="text-name-profile text-info">Address : </span>
											<span>4109 HT Amsterdam, Saifi District, USA</span>
										</div>
									</div>
									<div class="col-md-12">
										<div class="first-name-profile">
		...
		<div class="modal fade" id="edit-modal" aria-hidden="true" role="dialog" tabindex="-1" style="display: none;">
			<div class="modal-dialog">
				<div class="modal-content modal-view-profile">
					...
					<div class="modal-body margin-top-15">
						<div class="layout-layout-example layout-wrap margin-md-0">
							<form class="form-horizontal">
								<div class="form-group form-material">
									<label class="col-sm-2 text-info control-label">Name: </label>
									<div class="col-sm-9">
										<input type="text" class="form-control" name="name" placeholder="Full Name" value="Munaro Jacob" autocomplete="off">
									</div>
								</div>
								<div class="form-group form-material">
									<label class="col-sm-2 text-info control-label">Gender: </label>
									<div class="col-sm-9">
								...
								<div class="form-group form-material">
									<label class="col-sm-2 text-info control-label">Email: </label>
									<div class="col-sm-9">
										<input type="email" class="form-control" name="email" value="munaro@example.com" placeholder="@email.com" autocomplete="off">
									</div>
								</div>
								<div class="form-group form-material">
									<label class="col-sm-2 text-info control-label">Address: </label>
									<div class="col-sm-9">
										<textarea class="form-control" placeholder="Enter address">4109 HT Amsterdam, Saifi District, USA</textarea>
									</div>
								</div>
								<div class="form-group form-material">
									<label class="col-sm-2 text-info control-label">Phone: </label>
									<div class="col-sm-9">
										<input type="number" class="form-control" name="phone" value="1234567890" placeholder="Enter Phone Number" autocomplete="off">
									</div>
								</div>
								<div class="form-group form-material">
									<label class="col-sm-2 text-info control-label">Post: </label>
									<div class="col-sm-9">
										<input type="text" class="form-control" name="post" value="Project Manager" placeholder="Briefly Describe Yourself" autocomplete="off">
									</div>
								</div>
							</form>
						</div>
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn waves-effect waves-light" data-dismiss="modal">Close</button>
					</div>
