...
<html lang="en">
	<head>
		...
		<title>Login3 | Porish Material Admin Template</title>
		<!-- Favicons -->
				...
				<div class="login-page login-second-page">
					...
					<form action="#" class="form-login" id="form1" method="post">
						<div class="input-box input-box-login2">
							...
							<div class="textbox-login"><input type="text" id='email' class="form-control" name='email' placeholder="Email"/></div>
						</div>
						<div class="input-box input-box-login2">
						...
						<div class="bottom-login">
							...
							<div class="remember-text-login forget-password-login remember-register-3"><a href="forgot_password_v2.html">Forgot password?</a></div>
						</div>
						<div class="form-group">
							<button class="btn btn-info btn-sign waves-effect waves-dark" type="submit">Sign In</button>
						</div>
					</form>
					<div class="sign-up-text sign-up-login2 remember-register-3">Create A New Account? Go to <a class="underline" href="register_v3.html">Sign up</a>.</div>
					<!-- End Login Form -->
				</div>
			</div>
		</div>
