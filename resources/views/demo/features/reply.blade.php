...
<html lang="en">
	<head>
		...
		<title>Reply | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="dashboard site-navbar-small">
								...
								<div class="page-left-side">
									...
									<div class="sidebar-height collapse" id="collapseExample">
										...
										<ul class="nav nav-pills nav-stacked padding-20">
											<li><a href="mailbox.html"><span class="badge pull-right">42</span> Inbox </a></li>
									...
									<div class="mailbox">
										<div class="row margin-bottom-15">
											<div class="col-md-12 mail-top">
												<!-- Back Button -->
												<button type="button" class="btn btn-info waves-effect waves-light" data-toggle="tooltip" title="Back" onClick="javascript: window.location = 'read-more.html'">Back</button>
												<!-- Refresh Button -->
										...
										<div>
											...
											<form action="read-more.html">
												<div class="padding-top-20">
													...
													<div class="form-group form-material material floatlabl margin-top-30">
														<input type="text" class="form-control empty" name="inputFloatingText">
														<label class="control-label">Subject:</label>
													</div>
													<div class="form-group form-material material floatlabl margin-top-20">
														<div class="">
															<textarea name="content" data-provide="markdown" rows="10">Curabitur. Inceptos elementum eleifend lobortis. Ornare dapibus dis Ultricies at placerat.
															Pellentesque. Cubilia, netus. Vel lacus cursus. Quam cursus non id.
															Platea. Mattis vivamus fermentum imperdiet aptent a. Turpis laoreet fringilla velit semper vel fusce per cras. Curae;. Magnis metus.</textarea>
														</div>
													</div>
												</div>
		...
		<div class="site-action">
			...
			<ul class="dropdown-menu dropdown-menu-right differentmenu" role="menu">
				<li><a href="#" data-toggle="tooltip" data-placement="left" title="Compose" class="compose animation-slide-bottom"><span data-target="#compose-mail" data-toggle="modal"><i class="fa-pencil"></i></span></a></li>
				<li><a href="#" data-toggle="tooltip" data-placement="left" title="Delete" class="delete animation-slide-bottom"><span data-target="#delete-mail" data-toggle="modal"><i class="fa-trash"></i></span></a></li>
				<li><a href="#" data-toggle="tooltip" data-placement="left" title="Reminders" class="reminder animation-slide-bottom"><span data-target="" data-toggle="modal"><i class="icon_mail"></i></span></a></li>
				<li><a href="#" data-toggle="tooltip" data-placement="left" title="Invites" class="invite animation-slide-bottom"><span data-target="#" data-toggle="modal"><i class="fa fa-ticket"></i></span></a></li>
			</ul>
		</div>
