...
<html lang="en">
	<head>
		...
		<title>Read-mail | Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<!--  Page CSS -->
		<link rel="stylesheet" href="../assets/css/mail/custom.css">
		<!--  Global Template CSS -->
		...
		<!-- Page plugin CSS -->
		<link rel="stylesheet" href="../assets/css/editor-markdown/bootstrap-markdown.min.css">
	</head>
	<body class="read-more site-navbar-small">
		...
		<div class="main-content">
			...
			<div class="page-content app-mailbox">
							...
							<div class="">
								<div class="page-left-side">
									<div class="content">
										...
										<!-- Mailbox Title -->
										<h4 class="panel-title padding-left-20">Mailbox</h4>
									</div>
									<div class="sidebar-height collapse" id="collapseExample">
										<!-- Compose Menu -->
										<div class="white padding-horizontal-20">
											<a href="" class="btn btn-info btn-block" role="button" data-target="#compose-mail" data-toggle="modal">COMPOSE</a>
										</div>
										<!-- Compose Submenu Menu -->
										<ul class="nav nav-pills nav-stacked padding-20">
											<li><a href="mailbox.html"><span class="badge pull-right">42</span> Inbox </a>
											</li>
											<li><a href="#">Draft</a></li>
											<li><a href="#"><span class="badge pull-right">20</span>Sent</a></li>
											<li><a href="#">Archive</a></li>
											<li><a href="#">Important</a></li>
											<li><a href="#">Trash</a></li>
											<li>
												<h5 class="padding-vertical-10 padding-horizontal-15 according margin-bottom-0">Label</h5>
												<ul class="nav">
													<li class=""><a href="#home" data-toggle="tab">Primary</a></li>
								...
								<div class="page-main-content">
									<div class="mailbox">
										<div class="row margin-bottom-15">
											<div class="col-md-12 mail-top">
												<!-- Back Button -->
												<button type="button" class="btn btn-info waves-effect waves-light" data-toggle="tooltip" title="Back" onClick="javascript: window.location = 'mailbox.html'">Back</button>
												<!-- Refresh Button -->
												<button type="button" class="btn btn-info waves-effect waves-light" data-toggle="tooltip" title="Refresh"><span class="glyphicon glyphicon-refresh"></span></button>
												<div class="mailbox-sidelink pull-right">
													<a href="#" class="btn btn-box-tool" data-toggle="tooltip" title="" data-original-title="Previous"><i class="fa fa-chevron-left"></i></a>
													<a href="#" class="btn btn-box-tool" data-toggle="tooltip" title="" data-original-title="Next"><i class="fa fa-chevron-right"></i></a>
												</div>
											</div>
										</div>
										<!-- Start Mail description -->
										<div class="pull-right">
											<small>Yesterday 09.15pm</small>
										</div>
										<h3>Auctor rutrum sociosqu pulvinar placerat faucibus. Cursus sed phasellus dis.</h3>
										<h5>From:jack@yahoo.com</h5>
										<hr>
										<div class="margin-top-20">
											<p>Hello..</p>
											<p>Potenti. Commodo iaculis vitae, turpis hymenaeos velit praesent, nisi blandit mauris malesuada dignissim. Iaculis semper lacinia pulvinar congue odio eros cum accumsan tempus aucw hymenaeos ante congue mus. Vulputate sociis Torquent sapien pharetra hymenaeos. Placerat Diam.</p>
											<p>Odio, hac pellentesque. Faucibus consequat dignissim vel nascetur cras sit felis urna, lacinia. Luctus arcu ac ultricies a. Luctus. Sed quisque cubilia sodales donec adipiscing egestas nam mi, tristique.</p>
											<p>Sagittis amet vehicula eu posuere primis malesuada porta. Suscipit felis nec. Nisi mattis platea imperdiet aenean egestas diam parturient netus.</p>
											<p>Conubia volutpat gravida aliquam convallis dictumst pharetra blandit arcu tincidunt interdum hymenaeos senectus, laoreet ridiculus facilisi tortor senectus facilisi venenatis.Neque etiam sollicitudin tincidunt fringilla viverra Varius accumsan rhoncus dictum adipiscing faucibus, dictum purus suspendisse feugiat montes malesuada faucibus ad.</p>
											<p>Gravida. Litora cubilia mauris dolor varius varius pellentesque et ac lacus, mollis volutpat, mattis metus.</p>
										</div>
										<div class="attachment-infor">
											<span><i class="fa fa-paperclip margin-right-10"></i><b>Attachments &nbsp;: </b><a href="javascript:void(0)" class="margin-left-10">View</a> | <a href="javascript:void(0)">Download all</a></span>
											<ul class="nav margin-left-8">
												<li>
													<a download="attachment-1.jpeg" href="../assets/images/blog/img_890x593.jpeg">
														<div class="padding-10 padding-left-0">
															<p class="margin-0">Attachment-1.jpeg</p>
														</div>
														<div class="overlay">
															<img src="../assets/images/blog/img_890x593.jpeg" alt="mail image" class="width-100per">
															<div class="top-description bottom-overlay padding-top-0"><i class="fa fa-download font-22 vertical-align-middle"></i></div>
														</div>
													</a>
												</li>
												<li>
													<a download="attachment-2.jpeg" href="../assets/images/blog/img_890x593.jpeg">
														<div class="padding-10 padding-left-0">
															<p class="margin-0">Attachment-2.jpeg</p>
														</div>
														<div class="overlay">
															<img src="../assets/images/blog/img_890x593.jpeg" alt="mail image" class="width-100per">
															<div class="top-description bottom-overlay padding-top-0"><i class="fa fa-download font-22 vertical-align-middle"></i></div>
										...
										<hr>
										<div class="margin-top-20 read-more-wrap">
											<!-- Reply Button -->
											<button class="btn btn-info waves-effect waves-light" onClick="javascript: window.location = 'reply.html'"><i class="fa-mail-reply margin-right-5"></i>Reply</button>
											<!-- Forward Button -->
											<button class="btn btn-info waves-effect waves-light" onClick="javascript: window.location = 'reply.html'"><i class="fa-mail-forward margin-right-5"></i>Forward</button>
											<!-- Remove Button -->
											<button class="btn btn-info waves-effect waves-light margin-0"><i class="fa-trash-o margin-right-5"></i>Remove</button>
										</div>
										<!-- End Mail description -->
									</div>
								</div>
							</div>
						</div>
		...
		<div class="site-action">
			<!-- Plus Icon -->
			<button type="button" class="fab btn btn-success dropdown-toggle btn-raised btn-floating" data-toggle="dropdown" >
			<span class="fa-stack">
			<i class="icon fa-plus fab-primary"></i>
			<i class="icon fa-pencil fab-secondary"></i>
			</span>
			</button>
			<!-- Plus Icon Sub Menu -->
			<ul class="dropdown-menu dropdown-menu-right differentmenu" role="menu">
				<li><a href="javascript:void(0)" data-toggle="tooltip" data-placement="left" title="Compose" class="compose animation-slide-bottom"><span data-target="#compose-mail" data-toggle="modal"><i class="fa-pencil"></i></span></a></li>
				<li><a href="javascript:void(0)" data-toggle="tooltip" data-placement="left" title="Delete" class="delete animation-slide-bottom"><span data-target="#delete-mail" data-toggle="modal"><i class="fa-trash"></i></span></a></li>
				<li><a href="javascript:void(0)" data-toggle="tooltip" data-placement="left" title="Reminders" class="reminder animation-slide-bottom"><span data-target="" data-toggle="modal"><i class="icon_mail"></i></span></a></li>
				<li><a href="javascript:void(0)" data-toggle="tooltip" data-placement="left" title="Invites" class="invite animation-slide-bottom"><span data-target="#" data-toggle="modal"><i class="fa fa-ticket"></i></span></a></li>
			</ul>
		</div>
		<div id="compose-mail" class="modal fade" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					<!-- Start Compose Form Box-->
					...
					<form action="mailbox.html">
						...
						<div class="modal-footer padding-20">
							<!-- Send Button -->
							<button type="submit" class="btn btn-success waves-effect waves-light" data-dismiss="modal">Send</button>
							<!-- Cancel Button -->
							<button type="submit" class="btn btn-danger waves-effect waves-light" data-dismiss="modal">Cancel</button>
						</div>
					</form>
					<!-- End Compose Form Box-->
				</div>
			</div>
		</div>
		<!-- End Contain Section -->
		...
		<script src="../assets/js/editor-markdown/bootstrap-markdown.js"></script>
		<script src="../assets/js/editor-markdown/markdown.js"></script>
		<script src="../assets/js/overlay/overlay.js"></script>
		...
		<!-- Page JavaScript -->
		<script src="../assets/js/material/material.min.js" type="text/javascript"></script>
		<script src="../assets/js/message/chat-sticky.js" type="text/javascript"></script>
	</body>
</html>
