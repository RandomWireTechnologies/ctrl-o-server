			...
			<div class="page-content">
				<div class="row">
					<div class="col-lg-4 col-sm-6 col-xs-12">
						<div class="data data-shadow-media">
							...
							<div class="media-desc">
								<div class="media-menu">
									<div class="dropup">
										<div class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" aria-expanded="false" role="menu">
											<i class="icon_menu"></i> 
										</div>
										<ul class="dropdown-menu bullet dropdown-menu-right" role="menu">
											<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Edit</a></li>
											<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Delete</a></li>
										</ul>
									</div>
								</div>
								<p>Les Schaub  </p>
					...
					<div class="col-lg-4 col-sm-6 col-xs-12">
						<div class="data data-shadow-media">
							...
							<div class="media-desc">
								...
								<p>Penelope Barfield  </p>
								<p>27 Sep 2016 , 24KB</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-sm-6 col-xs-12">
					...
					<div class="col-lg-4 col-sm-6 col-xs-12">
						<div class="data data-shadow-media">
							...
							<div class="media-desc">
								...
								<p>Elfriede Lemelle  </p>
								<p>28 July 2016 , 51KB</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-sm-6 col-xs-12">
					...
					<div class="col-lg-4 col-sm-6 col-xs-12">
						<div class="data data-shadow-media">
							...
							<div class="media-desc">
								...
								<p>Tamisha Fitzgibbon  </p>
								<p>19 Jun 2016 , 24KB</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-sm-6 col-xs-12">
