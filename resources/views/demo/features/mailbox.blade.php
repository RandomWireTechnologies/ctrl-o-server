...
<html lang="en">
	<head>
		...
		<title>Mail | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="mail-page site-navbar-small">
		...
		<div class="main-content">
			...
			<div class="page-content app-mailbox contain-mailbox">
				<div class="panel">
					<div class="panel-body padding-0">
						<div class="page-left-side">
							<div class="content">
								<button aria-controls="collapseExample" aria-expanded="false" data-target="#collapseExample" data-toggle="collapse" type="button" class="code-toggle-button collapsed">
								<span class="icon arrow_carrot-up"></span>
								</button>
								<h4 class="panel-title">Mailbox</h4>
							</div>
							<div id="collapseExample" class="sidebar-height collapse">
								<!-- Compose Button -->
								<div class="white padding-horizontal-20">
									<a data-toggle="modal" data-target="#compose-mail" role="button" class="btn btn-info btn-block mail-compose">COMPOSE</a>
								</div>
								<!-- Mailbox Menu -->
								<ul class="nav nav-pills nav-stacked padding-20">
									<li><a href="javascript:void(0)"><span class="badge pull-right">42</span> Inbox </a>
									</li>
									<li><a href="javascript:void(0)">Draft</a></li>
									<li><a href="javascript:void(0)"><span class="badge pull-right">20</span>Sent</a></li>
									...
									<li>
										...
										<ul class="nav">
											<li class=""><a data-toggle="tab" href="#home">Primary</a></li>
						...
						<div class="page-main-content">
							<div class="mailbox">
								<div class="row margin-bottom-15">
									<div class="col-md-12 mail-top">
										<div class="margin-right-5 inline-block">
											<div class="checkbox-custom mail-checkbox checkbox-primary margin-left-20 margin-vertical-5">
												<!-- Checkbox -->
										...
										<!-- Refresh Icon -->
										<button title="" data-toggle="tooltip" class="btn btn-info waves-effect waves-light inline-block" type="button" data-original-title="Refresh"><span class="glyphicon glyphicon-refresh"></span></button>
										<!-- More Menu -->
										<div class="inline-block relative">
											<button data-toggle="dropdown" class="btn btn-info dropdown-toggle waves-effect waves-light" type="button">
											More <span class="caret"></span>
											</button>
											<ul role="menu" class="dropdown-menu dropdown-menu-info">
												<li><a href="javascript:void(0)">See All</a></li>
												<li><a href="javascript:void(0)">See Unread Mail</a></li>
												<li><a href="javascript:void(0)">See Read Mail</a></li>
											</ul>
										</div>
										<div class="text-right btn-side pull-right">
											<div class="inline-block vertical-align-middle no-width">
												<!-- Next And Previous Icon -->
												<span class="margin-right-5 pull-xs-left">1-50/200</span>
												<div class="btn-group next-prev-btn pull-xs-right margin-xs-right-0">
													<button class="btn btn-info waves-effect waves-light" type="button"><i class="fa fa-chevron-left"></i></button>
													<button class="btn btn-info waves-effect waves-light" type="button"><i class="fa fa-chevron-right"></i></button>
												</div>
											</div>
											<div class="inline-block vertical-align-middle no-width">
												<!-- Search Box -->
								...
								<div>
									<!-- table-responsive Responsive class -->
									<!-- Start Mail Section -->
									<table id="basic-inbox" class="table dt-responsive nowrap margin-bottom-0">
										<tbody>
											<tr>
												<td>
													<div class="leftMessages">
														<div class="checkbox-custom mail-checkbox checkbox-primary margin-top-0">
															<input type="checkbox" name="foo" />
															<label></label>
														</div>
														<div class="user-message">
															<h1><a href="read-more.html">Lisa Sids</a></h1>
															<p><span>Bibendum pulvinar</span> - Bibendum pulvinar a aliquet eros convallis ipsum tempus aenean lacinia... </p>
														</div>
													</div>
													<div class="rightMessages">
														<div class="message-time"><i class="fa fa-paperclip"></i> 10 hour ago</div>
														<span class="checkbox-important checkbox-default">
														<input type="checkbox" checked="checked" class="mailbox-checkbox mailbox-important">
														<label class="margin-bottom-10" style="position: relative"></label>
														</span>
													</div>
												</td>
											</tr>
											<tr>
												<td>
													<div class="leftMessages">
														...
														<div class="user-message">
															<h1><a href="read-more.html">Alexander Pierce</a></h1>
															<p><span>AdminLTE 2.0 Issue </span>- Trying to find a solution to this problem... </p>
														</div>
													</div>
													<div class="rightMessages">
														<div class="message-time"><i class="fa fa-paperclip"></i> 10 hour ago</div>
											...
											<tr>
												<td>
													<div class="leftMessages">
														...
														<div class="user-message">
															<h1><a href="read-more.html">Jacky Haed</a></h1>
															<p><span>Pede accumsan pede </span>- Est congue posuere venenatis Diam dictum imperdiet. Laoreet conubia lectus... </p>
														</div>
													</div>
													<div class="rightMessages">
														<div class="message-time"><i class="fa fa-paperclip"></i> 10 hour ago</div>
											...
											<tr>
												<td>
													<div class="leftMessages">
														...
														<div class="user-message">
															<h1><a href="read-more.html">Alexander Pierce</a></h1>
															<p><span>Rutrum vestibulum primis </span>- Amet maecenas placerat Ipsum dictumst bibendum facilisis dictum at..</p>
														</div>
													</div>
													<div class="rightMessages">
														<div class="message-time"><i class="fa fa-paperclip"></i> 10 hour ago</div>
											...
											<tr>
												<td>
													<div class="leftMessages">
														...
														<div class="user-message">
															<h1><a href="read-more.html">Sid D'souza</a></h1>
															<p><span>Cum semper montes elit </span>- Dapibus natoque bibendum at cras velit, rutrum litora lacus fusce... </p>
														</div>
													</div>
													<div class="rightMessages">
														<div class="message-time"><i class="fa fa-paperclip"></i> 10 hour ago</div>
											...
											<tr>
												<td>
													<div class="leftMessages">
														...
														<div class="user-message">
															<h1><a href="read-more.html">Joseph Heine</a></h1>
															<p><span>Mauris aptent gravida </span>- Praesent sed facilisis porta pretium vehicula commodo convallis cubilia...</p>
														</div>
													</div>
													<div class="rightMessages">
														<div class="message-time"><i class="fa fa-paperclip"></i> 10 hour ago</div>
											...
											<tr>
												<td>
													<div class="leftMessages">
														...
														<div class="user-message">
															<h1><a href="read-more.html">Kyle Mark</a></h1>
															<p><span>Facilisis porta </span>- Et interdum viverra. Sem, libero sagittis eu. Quisque tellus elit...</p>
														</div>
													</div>
													<div class="rightMessages">
														<div class="message-time"><i class="fa fa-paperclip"></i> 10 hour ago</div>
							...
							<div class="paginations pull-right margin-bottom-15 padding-horizontal-20">
								<!-- Pagination Mailbox -->
								<ul class="pagination pagination-no-border">
									<li><a aria-label="Previous" href="javascript:void(0)">«</a></li>
									<li class="active"><a href="javascript:void(0)">1 <span class="sr-only">(current)</span></a></li>
									<li><a href="javascript:void(0)">2</a></li>
									<li><a href="javascript:void(0)">3</a></li>
									<li><a href="javascript:void(0)">4</a></li>
									<li><a href="javascript:void(0)">5</a></li>
									<li><a aria-label="Next" href="javascript:void(0)">»</a></li>
								</ul>
							</div>
						</div>
					</div>
		...
		<div class="site-action">
			...
			<!-- Plus Icon Sub Menu -->
			<ul class="dropdown-menu dropdown-menu-right differentmenu animation-slide-up" role="menu">
				<li class=""><a href="javascript:void(0)" data-toggle="tooltip" data-placement="left" title="Compose" class="compose"><span data-target="#compose-mail" data-toggle="modal"><i class="fa-pencil"></i> </span></a></li>
				<li class=""><a href="javascript:void(0)" data-toggle="tooltip" data-placement="left" title="Delete" class="delete"><span data-target="#delete-mail" data-toggle="modal"><i class="fa-trash"></i></span></a></li>
				<li class=""><a href="javascript:void(0)" data-toggle="tooltip" data-placement="left" title="Reminders" class="reminder"><span data-target="" data-toggle="modal"><i class="icon_mail"></i></span></a></li>
				<li class=""><a href="javascript:void(0)" data-toggle="tooltip" data-placement="left" title="Invites" class="invite"><span data-target="#" data-toggle="modal"><i class="fa fa-ticket"></i></span></a></li>
			</ul>
		</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer padding-20">
						<!-- Send Button -->
						<button type="button" class="btn btn-success waves-effect waves-light" data-dismiss="modal">Send</button>
						<!-- Cancel Button -->
		...
		<script src="../assets/js/mail/custom-mail.js"></script>
