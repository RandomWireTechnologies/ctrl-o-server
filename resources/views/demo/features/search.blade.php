...
<html lang="en">
	<head>
		...
		<title>Search | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="dashboard site-navbar-small">
		...
		<div class="main-content">
			...
			<div class="page-content container-fluid search">
				<div class="panel">
					<div class="panel-body margin-horizontal-xs-15">
				...
				<div class="panel">
					<div class="panel-body">
						<!-- Start Search List Box -->
						<h1 class="search-title">Search Results For "Web Development"</h1>
						<p class="search-count">About <span>4,370</span> result ( <span>0.43</span> seconds ) </p>
						<ul class="list-group search-group-item">
							<li class="list-group-item">
								<div class="row">
									<div class="col-md-3 col-sm-5">
										<img class="img-search" src="../assets/images/lightbox/img_1920x1080.jpg" alt="image">
									</div>
									<div class="col-md-9 col-sm-7">
										<h4><a href="#">Make the Web Work For Everyone Mozilla Hacks</a><span class="search-day"> - 19 hours ago</span></h4>
										<a class="search-link break-text" href="#">http://www.webwiztech.com/webdevelop.html</a>
										<p>The web developer community can fix this. The web has changed immensely in the past 20 ...</p>
									</div>
								</div>
							</li>
							<li class="list-group-item clearfix">
								<h4><a href="#">Web development - Wikipedia, the free encyclopedia</a><span class="search-day"> - 1 days ago</span></h4>
								<a class="search-link break-text" href="#">https://en.wikipedia.org/wiki/Web_development</a>
								...
								<a class="search-link" href="#">‎Web development as an industry</a> · ‎<a class="search-link" href="#">Practical web development</a>
							</li>
							<li class="list-group-item">
								<h4><a href="#">Web Development Technologies - TutorialsPoint</a><span class="search-day"> - 2 days ago</span></h4>
								<a class="search-link break-text" href="#">www.tutorialspoint.com/web_development.htm</a>
								<p>Web Development Technologies - Tutorials for DOM, AngularJS, SVG, XSD, XPath, XSLT, Web Development Technologies including Adobe Flex, GWT, JSF, ...</p>
								<p class="tag"><span class="search-label">Tags:</span> <a href="#" class="margin-right-10">Admin</a> <a href="#">App</a></p>
							</li>
							<li class="list-group-item">
								<h4><a href="#">Iflexion: Advanced Web Development</a><span class="search-day"> - 3 days ago</span></h4>
								<span class="search-ad">Ad</span>
								<a class="search-link break-text" href="#">https://teamtreehouse.com/tracks/front-end-web-development</a>
								<p>Iflexion web development company provides professional full-cycle services: web application development, custom software development, website design.</p>
							</li>
							<li class="list-group-item">
								<h4><a href="#">Website Design And Development</a><span class="search-day"> - 5 days ago</span></h4>
								<a class="search-link break-text" href="#">https://www.quaditworld.com/development/web-development/</a><br>
								<div class="search-star">
									...
									<i class="icon icon_star"></i>
									<i class="icon icon_star"></i>
									<a> Rating: 4.9 - ‎157 votes</a>
								</div>
								<p>Website Designing and Development services, Mobile Application, SEO Company in Surat, India with Developers training eCommerce, PHP, Wordpress, ...</p>
							</li>
							<li class="list-group-item">
								<h4><a href="#">Web Development | Udacity</a><span class="search-day"> - 1 month ago</span></h4>
								<a class="search-link break-text" href="#">https://www.udacity.com/course/web-development--cs253</a>
								<p class="tag">Try to picture yourself sitting down with your computer, ready to start developing a fully functional web application for the first time, available online for millions to ...</p>
							</li>
						</ul>
						<!-- End Search List Box -->
						<nav>
