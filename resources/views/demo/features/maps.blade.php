...
<html lang="en">
	<head>
		...
		<title>Google maps | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="dashboard site-navbar-small">
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="map-canvas1 map-canvas-height"></div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="map-canvas2 map-canvas-height"></div>
							</div>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="map-canvas3 map-canvas-height"></div>
							</div>
						</div>
						<!--  End Map -->
					</div>
		...
		<!-- Page JavaScript -->
		<script src="../assets/js/google-map/custom.js"></script>
	</body>
</html>