...
<html lang="en">
	<head>
		...
		<title>Project | Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<!-- Page plugin CSS -->
		<link rel="stylesheet" href="../assets/plugin/bootstrap-datepicker/css/bootstrap-datepicker.min.css">
		<!--  Page CSS -->
		<link rel="stylesheet" href="../assets/css/project/custom.css">
	</head>
	<body class="project site-navbar-small">
							...
							<div class="row">
									...
									<div class="project-box">
										<div class="project-header">
											<div class="post-media">
												<a href="javascript:void(0)">
													<!-- Image Porject -->
													<img src="../assets/images/media/img_720x480.jpg" alt="project">
													<!-- Image Hover Porject -->
													<span class="icon icon-i fa fa-info-circle"></span>
													<span class="btn btn-icon btn-pure icon icon-pencil waves-effect waves-classic margin-right-0 margin-bottom-0" data-target="#project-edit" data-toggle="modal"><i class="fa-pencil"></i></span>
													<span class="btn btn-icon btn-pure icon icon-trash waves-effect waves-classic margin-right-0 margin-bottom-0" data-target="#project-delete" data-toggle="modal"><i class="fa-trash-o"></i></span>
												</a>
											</div>
										</div>
										<div class="project-footer">
											<div class="post-content text-left margin-top-10">
												<h4 class="margin-top-10"><a href="javascript:void(0)">They're meat you creepeth.</a></h4>
												<div class="post-meta white">
													<!-- Date Porject -->
													<time datetime="2016-01-01">
													<span class="post-meta-day">22</span>
													<span class="post-meta-month">February</span>
													<span class="post-meta-time">18:00</span>
													</time>
												</div>
											</div>
										</div>
								...
								<div class="col-lg-4 col-sm-6 col-xs-12">
									<div class="project-box">
										...
										<div class="project-footer">
											<div class="post-content text-left margin-top-10">
												<h4 class="margin-top-10"><a href="javascript:void(0)">Cattle moving whales blessed.</a></h4>
												<div class="post-meta white">
													<!-- Date Porject -->
													<time datetime="2016-01-01">
													<span class="post-meta-day">12</span>
													<span class="post-meta-month">December</span>
													<span class="post-meta-time">05:00</span>
													</time>
												</div>
											</div>
										</div>
								...
								<div class="col-lg-4 col-sm-6 col-xs-12">
									<div class="project-box">
										...
										<div class="project-footer">
											<div class="post-content text-left margin-top-10">
												<h4 class="margin-top-10"><a href="javascript:void(0)">Beginning heaven tree green.</a></h4>
												<div class="post-meta white">
													<!-- Date Porject -->
													<time datetime="2016-01-01">
													<span class="post-meta-day">23</span>
													<span class="post-meta-month">December</span>
													<span class="post-meta-time">13:00</span>
													</time>
												</div>
											</div>
										</div>
								...
								<div class="col-lg-4 col-sm-6 col-xs-12">
									<div class="project-box">
										...
										<div class="project-footer">
											<div class="post-content text-left margin-top-10">
												<h4 class="margin-top-10"><a href="javascript:void(0)">In, two fish you'll brought.</a></h4>
												<div class="post-meta white">
													<!-- Date Porject -->
													<time datetime="2016-01-01">
													<span class="post-meta-day">02</span>
													<span class="post-meta-month">February</span>
													<span class="post-meta-time">15:00</span>
													</time>
												</div>
											</div>
										</div>
										...
										<div class="project-header">
											<div class="post-media">
												<a href="javascript:void(0)">
													...
													<span class="icon icon-i fa fa-info-circle"></span>
													<span class="btn btn-icon btn-pure icon icon-pencil waves-effect waves-classic margin-right-0 margin-bottom-0" data-target="#project-edit" data-toggle="modal"><i class="fa-pencil"></i></span>
													<span class="btn btn-icon btn-pure icon icon-trash waves-effect waves-classic margin-right-0 margin-bottom-0" title="Delete" data-target="#project-delete" data-toggle="modal"><i class="fa-trash-o"></i></span>
												</a>
											</div>
										</div>
										<div class="project-footer">
											<div class="post-content text-left margin-top-10">
												<h4 class="margin-top-10"><a href="javascript:void(0)">Were own likeness gathering.</a></h4>
												<div class="post-meta white">
													<!-- Date Porject -->
													<time datetime="2016-01-01">
								...
								<div class="col-lg-4 col-sm-6 col-xs-12">
									<div class="project-box">
										...
										<div class="project-footer">
											<div class="post-content text-left margin-top-10">
												<h4 class="margin-top-10"><a href="javascript:void(0)">Saying tree divide spirit.</a></h4>
												<div class="post-meta white">
													<!-- Date Porject -->
													<time datetime="2016-01-01">
													<span class="post-meta-day">25</span>
													<span class="post-meta-month">February</span>
													<span class="post-meta-time">18:00</span>
													</time>
												</div>
								...
								<div class="col-lg-4 col-sm-6 col-xs-12">
									<div class="project-box">
										...
										<div class="project-footer">
											<div class="post-content text-left margin-top-10">
												<h4 class="margin-top-10"><a href="javascript:void(0)">For stars wherein fly.</a></h4>
												<div class="post-meta white">
													<!-- Date Porject -->
													<time datetime="2016-01-01">
													<span class="post-meta-day">09</span>
													<span class="post-meta-month">December</span>
													<span class="post-meta-time">06:00</span>
													</time>
												</div>
											</div>
										</div>
								...
								<div class="col-lg-4 col-sm-6 col-xs-12">
									<div class="project-box">
										...
										<div class="project-footer">
											<div class="post-content text-left margin-top-10">
												<h4 class="margin-top-10"><a href="javascript:void(0)">After seas given a set fly.</a></h4>
												<div class="post-meta white">
													<!-- Date Porject -->
													<time datetime="2016-01-01">
													<span class="post-meta-day">22</span>
													<span class="post-meta-month">November</span>
													<span class="post-meta-time">18:00</span>
													</time>
												</div>
											</div>
								...
								<div class="clearfix visible-xlg-block"></div>
								<div class="col-lg-4 col-sm-6 col-xs-12">
									<div class="project-box margin-md-0 margin-sm-0">
										<div class="project-header">
											<div class="post-media">
												<a href="javascript:void(0)">
													<!-- Image Porject -->
										...
										<div class="project-footer">
											<div class="post-content text-left margin-top-10">
												...
												<div class="post-meta white">
													<!-- Date Porject -->
													<time datetime="2016-01-01">
													<span class="post-meta-day">15</span>
													<span class="post-meta-month">February</span>
													<span class="post-meta-time">18:00</span>
													</time>
												</div>
								...
								<div class="col-lg-4 col-sm-6 col-xs-12">
									<div class="project-box margin-bottom-0">
										<div class="project-header">
											<div class="post-media">
												<a href="javascript:void(0)">
													<!-- Image Porject -->
		...
		<!-- Plus Icon -->
		<button class="site-action btn-raised btn btn-success btn-floating" data-target="#new-project" data-toggle="modal" type="button">
		<i class="fa-plus" aria-hidden="true"></i>
		</button>
		<!-- Delete Overlay Porject -->
		<div id="project-delete" class="modal fade" role="dialog">
		...
		<div id="project-edit" class="modal fade" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<p>Do you want to edit the project?</p>
					</div>
					<div class="modal-footer">
				...
				<div class="modal-content">
					...
					<div class="modal-body padding-20">
						<form>
							...
							<div class="form-group form-material material floatlabl">
								<input type="text" class="form-control empty datepicker" name="inputFloatingText">
								<label class="control-label">Start Date:</label>
							</div>
							<div class="form-group form-material material floatlabl">
								<input type="text" class="form-control empty datepicker" name="inputFloatingText" data-multidate="true">
								<label class="control-label">End Date:</label>
							</div>
						</form>
					</div>
					<div class="padding-20 padding-top-0 project-btn">
		...
		<script src="../assets/plugin/bootstrap-datepicker/js/custom-datepicker.js"></script>
	</body>
</html>