...
<html lang="en">
	<head>
		...
		<title>Media | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="media-page site-navbar-small">
				...
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-6">
								<div class="page-wrap">
									...
									<h4 class="list-title">Default media</h4>
									...
									<div class="margin-vertical-20">
										<div class="media">
											<div class="media-left">
												<a href="#">
												<img class="media-object" src="../assets/images/profile/img_400x266.png" alt="media image">
												</a>
											</div>
											<div class="media-body">
												<h5 class="text-info">Media heading</h5>
												Lorem ipsum dolor sit amet, consectetur adipiscing elit. In at tempus elit, quis pretium urna. Pellentesque maximus malesuada nulla.
												<div class="media">
													<a class="media-left" href="#">
													<img class="media-object" src="../assets/images/profile/img_400x266.png" alt="media image">
													</a>
													<div class="media-body">
														<h5 class="text-info">Nested media heading</h5>
														Lorem ipsum dolor sit amet, consectetur adipiscing elit. In at tempus elit, quis pretium urna. Pellentesque maximus malesuada nulla.
													</div>
												</div>
											</div>
							...
							<div class="col-lg-6">
								<div class="page-wrap">
									<!-- Nested Media List Object -->
									<h4 class="list-title">Nested media list</h4>
									...
									<div class="margin-vertical-20">
										<div class="media">
											...
											<div class="media-body">
												<h5 class="media-heading text-info">Media heading</h5>
												<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In at tempus elit, quis pretium urna. Pellentesque maximus malesuada nulla. </p>
												<div class="media">
													<a class="media-left" href="#">
													<img class="media-object" src="../assets/images/profile/img_400x266.png" alt="media image">
													</a>
													<div class="media-body">
														<h5 class="media-heading text-info">Nested media heading</h5>
														Lorem ipsum dolor sit amet, consectetur adipiscing elit. In at tempus elit, quis pretium urna. Pellentesque maximus malesuada nulla. 
													</div>
												</div>
												<div class="media">
							...
							<div class="col-lg-6">
								<div class="page-wrap">
									<!-- Media Alignment Object -->
									<h4 class="list-title">Alignment media</h4>
									...
									<div class="margin-vertical-20">
										<div class="media">
											...
											<div class="media-body">
												<h5 class="text-info">Top Aligned Media</h5>
												Lorem ipsum dolor sit amet, consectetur adipiscing elit. In at tempus elit, quis pretium urna. Pellentesque maximus malesuada nulla. Phasellus efficitur libero id lorem consequat, eu efficitur nisi faucibus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. In at tempus elit, quis pretium urna. Pellentesque maximus malesuada nulla. Phasellus efficitur libero id lorem consequat, eu efficitur nisi faucibus.  Phasellus efficitur libero id lorem consequat, eu efficitur nisi faucibus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. In at tempus elit, quis pretium urna.
											</div>
										</div>
										<div class="media">
											...
											<div class="media-body">
												<h5 class="text-info">Middle Aligned Media</h5>
												Lorem ipsum dolor sit amet, consectetur adipiscing elit. In at tempus elit, quis pretium urna. Pellentesque maximus malesuada nulla. Phasellus efficitur libero id lorem consequat, eu efficitur nisi faucibus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. In at tempus elit, quis pretium urna. Pellentesque maximus malesuada nulla. Phasellus efficitur libero id lorem consequat, eu efficitur nisi faucibus.  Phasellus efficitur libero id lorem consequat, eu efficitur nisi faucibus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. In at tempus elit, quis pretium urna.
											</div>
										</div>
										<div class="media">
											...
											<div class="media-body">
												<h5 class="text-info">Bottom Aligned Media</h5>
												Lorem ipsum dolor sit amet, consectetur adipiscing elit. In at tempus elit, quis pretium urna. Pellentesque maximus malesuada nulla. Phasellus efficitur libero id lorem consequat, eu efficitur nisi faucibus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. In at tempus elit, quis pretium urna. Pellentesque maximus malesuada nulla. Phasellus efficitur libero id lorem consequat, eu efficitur nisi faucibus.  Phasellus efficitur libero id lorem consequat, eu efficitur nisi faucibus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. In at tempus elit, quis pretium urna.
											</div>
										</div>
									</div>
							...
							<div class="col-lg-6">
								<div class="page-wrap">
									<!-- Media Sizes Object -->
									<h4 class="list-title">Media Object Sizes</h4>
									<p>Add another optional classes to change a media object’s size.</p>
									<div class="row">
										<div class="col-md-3 col-sm-3">
											<div class="media-image"><img class="media-object" src="../assets/images/profile/img_400x266.png" alt="media image"></div>
											<h5 class="comment-title text-info">Generated Text</h5>
											<p>
												Lorem ipsum dolor sit amet, consectetur adipiscing elit. In at tempus elit, quis pretium urna. Pellentesque maximus malesuada nulla. Phasellus efficitur libero id lorem consequat, eu efficitur nisi faucibus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. In at tempus elit, quis pretium urna. Pellentesque maximus malesuada nulla. Phasellus efficitur libero id lorem consequat, eu efficitur nisi faucibus  
										</div>
										...
										<div class="col-md-5 col-sm-5">
											<div class="media-image text-info"><img class="media-object" src="../assets/images/profile/img_400x266.png" alt="media image"></div>
											<h5 class="comment-title  text-info">Generated Text</h5>
											<p>
												Lorem ipsum dolor sit amet, consectetur adipiscing elit. In at tempus elit, quis pretium urna. Pellentesque maximus malesuada nulla. Phasellus efficitur libero id lorem consequat, eu efficitur nisi faucibus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. In at tempus elit, quis pretium urna. Pellentesque maximus malesuada nulla. Phasellus efficitur libero id lorem consequat, eu efficitur nisi faucibus 
											</p>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="page-wrap">
									<!-- Media List Image With Button Object -->
									<h4 class="list-title">Media List Image With Button</h4>
									<p>A default media is used to float media object(images) to either to the left or right of the content block.</p>
									<div class="row">
										<div class="col-md-6">
											<div class="media media-sm">
												<div class="media-left">
													<a class="avatar avatar-lg" href="javascript:void(0)">
													<img src="../assets/images/global/img_240x265.png" alt="avatar-img">
													</a>
												</div>
												<div class="media-body">
													<h5 class="media-heading text-info">Generated Text</h5>
													Lorem ipsum dolor sit amet, consectetur adipiscing elit. In at tempus elit, quis pretium urna. Pellentesque maximus malesuada nulla. 
													<p class="margin-top-10">
														<a class="btn btn-media btn-dark waves-effect waves-light" href="javascript:void(0)" role="button">Edit</a>
														<a class="btn btn-media btn-default btn-pure waves-effect waves-light" href="javascript:void(0)" role="button">Cancel</a>
													</p>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="media media-sm">
												...
												<div class="media-body">
													...
													Lorem ipsum dolor sit amet, consectetur adipiscing elit. In at tempus elit, quis pretium urna. Pellentesque maximus malesuada nulla. 
													<p class="margin-top-10">
														<a class="btn btn-media btn-warning waves-effect waves-light" href="javascript:void(0)" role="button">Confirm</a>
														<a class="btn btn-media btn-default btn-pure waves-effect waves-light" href="javascript:void(0)" role="button">Cancel</a>
													</p>
												</div>
											</div>
										...
										<div class="col-md-6">
											<div class="media media-sm">
												...
												<div class="media-body">
													...
													Lorem ipsum dolor sit amet, consectetur adipiscing elit. In at tempus elit, quis pretium urna. Pellentesque maximus malesuada nulla. 
													<p class="margin-top-10">
														<a class="btn btn-media btn-danger waves-effect waves-light" href="javascript:void(0)" role="button">Delete</a>
														<a class="btn btn-media btn-default btn-pure waves-effect waves-light" href="javascript:void(0)" role="button">Cancel</a>
													</p>
												</div>
											</div>
											...
											<div class="media media-sm">
												...
												<div class="media-body">
													...
													<p class="margin-top-10 margin-bottom-0">
														<a class="btn btn-media btn-info waves-effect waves-light" href="javascript:void(0)" role="button">Save</a>
														<a class="btn btn-media btn-default btn-pure waves-effect waves-light" href="javascript:void(0)" role="button">Cancel</a>
													</p>
												</div>
											</div>
