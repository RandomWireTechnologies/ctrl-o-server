...
<html lang="en">
	<head>
		...
		<title>Icons | Porish Material Admin Template</title>
		...
		<link rel="stylesheet" href="../assets/fonts/7-stroke/7-stroke.min.css" />
				...
				<div class="panel">
					<div class="panel-body">
						<div class="icon-title-center ">
							<!--  Different Icon Title -->
							<h3>Browse 5 icons sets</h3>
							<p class="title-desc">Web icons / Font awesome / 7-Stroke / Glyphicons / Material Design</p>
						</div>
						<div class="row">
							<div class="col-lg-4 col-sm-6">
								<!--  Web Icons -->
								<h4 class="list-title">Web-Icons</h4>
								<div class="icons page page-bg overlay overlay-hover">
									...
									<div class="overlay-panel bottom-effects overlay-background overlay-fade text-center vertical-align">
										<a class="btn btn-info vertical-align-middle waves-effect waves-light" href="../components/web-icons.html">Read More</a>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6">
								<!--  Font Awesome Icons -->
								<h4 class="list-title">Font-Awesome</h4>
								<div class="icons page page-bg overlay overlay-hover">
									<ul class="blocks-xs-6 margin-0">
										<li>
											<div class="iconlist">
									...
									<div class="overlay-panel bottom-effects overlay-background overlay-fade text-center vertical-align">
										<a class="btn btn-info vertical-align-middle waves-effect waves-light" href="../components/font-awesome.html">Read More</a>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6">
								<!--  7-Stroke Icons -->
								<h4 class="list-title">7-stroke</h4>
								<div class="icons page page-bg overlay overlay-hover">
									<ul class="blocks-xs-6 margin-0">
										<li>
											<div class="iconlist">
									...
									<div class="overlay-panel bottom-effects overlay-background overlay-fade text-center vertical-align">
										<a class="btn btn-info vertical-align-middle waves-effect waves-light" href="../components/7-stroke.html">Read More</a>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6">
								<!--  Glyphicons Icons -->
								<h4 class="list-title">Glyphicons</h4>
								<div class="icons page page-bg overlay overlay-hover margin-md-0">
									<ul class="blocks-xs-6 margin-0">
										<li>
											<div class="iconlist">
									...
									<div class="overlay-panel bottom-effects overlay-background overlay-fade text-center vertical-align">
										<a class="btn btn-info vertical-align-middle waves-effect waves-light" href="../components/glyphicons.html">Read More</a>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-4 col-sm-6">
								...
								<h4 class="list-title">Material-Design</h4>
								<div class="icons page page-bg overlay overlay-hover margin-bottom-0">
									<ul class="blocks-xs-6 margin-0">
										<li>
											<div class="iconlist">
									...
									<div class="overlay-panel bottom-effects overlay-background overlay-fade text-center vertical-align">
										<a class="btn btn-info vertical-align-middle waves-effect waves-light" href="../components/material-design.html">Read More</a>
									</div>
								</div>
							</div>
						</div>
