...
<html lang="en">
	<head>
		...
		<title>List | Porish Material Admin Template</title>
		<!-- Favicons -->
			...
			<div class="page-content">
				<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">List Style</h3>
					</div>
					<div class="panel-body container-fluid list-page">
						<div class="row row-lg">
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<!--  Basic List -->
									<h4 class="list-title">Basic List</h4>
									<p>To create a basic list group, use an <code>&lt;ul&gt;</code> element with class <code>.list-group</code>, and <code>&lt;li&gt;</code> elements with class <code>.list-group-item</code>.</p>
									<ul class="list-group list-group-full">
										<li class="list-group-item active">1. Active</li>
										<li class="list-group-item">2.  Aenean leo ligula</li>
										<li class="list-group-item">3.  Phasellus viverra nulla</li>
										<li class="list-group-item">4. Aenean vulputate eled</li>
										<li class="list-group-item disabled">5. Disabled</li>
									</ul>
								</div>
							</div>
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<!--  Group Bordered List -->
									<h4 class="list-title">List Group Bordered</h4>
									<p>The current code you are trying is a descendant selector and will only work when <code>&lt;li&gt;</code> is the child of <code>.list-group-bordered</code> to the wrap.</p>
									<ul class="list-group list-group-bordered list-group-right-icon">
										<li class="list-group-item active">1. Active<span class="icon-right"><i class="icon icon_paperclip"></i></span></li>
										<li class="list-group-item">2.  Aenean leo ligula<span class="icon-right"><i class="icon icon_genius"></i></span></li>
										<li class="list-group-item">3.  Phasellus viverra nulla<span class="icon-right"><i class="icon icon_link"></i></span></li>
										<li class="list-group-item">4. Aenean vulputate eled<span class="icon-right"><i class="icon icon_like"></i></span></li>
										<li class="list-group-item disabled">5. Disabled<span class="icon-right"><i class="icon icon_heart_alt"></i></span></li>
									</ul>
								</div>
							</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<!--  List Group With Dividered List -->
									<h4 class="list-title">List Group With Dividered</h4>
									<p>The trick is to create an extra view for collapse group layout and last child layout with <code>.list-group-dividered</code> to the wrap.</p>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<!--  Badges List -->
									<h4 class="list-title">Badges List</h4>
									<p>To create a badge, create a <code>&lt;span&gt;</code> element with class <code>.badge</code> inside the list item.</p>
									<ul class="list-group list-group-full badges-list">
										<li class="list-group-item">
											<span class="badge badge-success">14</span><i class="icon arrow_right" aria-hidden="true"></i> Aenean leo ligula
										</li>
										<li class="list-group-item">
											<span class="badge badge-info">10</span><i class="icon arrow_right" aria-hidden="true"></i> Phasellus viverra nulla
										</li>
										<li class="list-group-item">
											<span class="badge badge-danger">3</span><i class="icon arrow_right" aria-hidden="true"></i> Aenean vulputate eled
										</li>
										<li class="list-group-item active">
											<span class="badge badge-info">2</span><i class="icon arrow_right" aria-hidden="true"></i> Maecenas tempus tellus
										</li>
										<li class="list-group-item">
											<span class="badge badge-success">1</span><i class="icon arrow_right" aria-hidden="true"></i> Quisque rutrum
										</li>
									</ul>
								</div>
							</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<!--  Linked Items List -->
									<h4 class="list-title">Linked Items</h4>
									<p>Just replace the <code>&lt;li&gt;</code> with <code>&lt;a&gt;</code> tag and use <code>&lt;div&gt;</code> element as a parent instead of <code>&lt;ul&gt;</code>.</p>
									<div class="list-group">
										<a class="list-group-item active" href="javascript:void(0)">Aenean leo ligula<i class="icon-right icon arrow_triangle-up_alt2 icon-dark"></i></a>
										<a class="list-group-item" href="javascript:void(0)">Phasellus viverra nulla<i class="icon-right icon arrow_triangle-up_alt2 icon-success"></i></a>
										<a class="list-group-item" href="javascript:void(0)">Aenean vulputate eled<i class="icon-right icon arrow_triangle-down_alt2 icon-denger"></i></a>
										<a class="list-group-item disabled" href="javascript:void(0)">Maecenas tempus tellus<i class="icon-right icon arrow_triangle-down_alt2 icon-denger"></i></a>
										<a class="list-group-item" href="javascript:void(0)">Quisque rutrum<i class="icon-right icon arrow_triangle-up_alt2 icon-success"></i></a>
									</div>
								</div>
							</div>
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<!--  Background List -->
									<h4 class="list-title">Background</h4>
									<p>Add the color by <code>.bg-*</code> in class and Also add the class with <code>.bg-inherit</code></p>
									<div class="list-group bg-gray bg-inherit">
										<a class="list-group-item gray" href="javascript:void(0)">
										<i class="icon icon_house_alt" aria-hidden="true"></i> Inbox
										</a>
										<a class="list-group-item gray" href="javascript:void(0)">
										<i class="icon icon_profile" aria-hidden="true"></i> Profile
										visits
										</a>
										<a class="list-group-item gray" href="javascript:void(0)">
										<i class="icon icon_phone" aria-hidden="true"></i> Call
										</a>
										<a class="list-group-item gray" href="javascript:void(0)">
										<i class="icon icon_mail_alt" aria-hidden="true"></i> Messages
										</a>
										<a class="list-group-item gray" href="javascript:void(0)">
										<i class="icon icon_tag_alt" aria-hidden="true"></i> Bookmarks
										</a>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									...
									<h4 class="list-title">Contextual Classes</h4>
									<p>The classes for coloring list-items are: <code>.list-group-item-success</code>, <code>list-group-item-info</code>, <code>list-group-item-warning</code>, <code>.list-group-item-danger</code>, and <code>.list-group-item-dark</code>.</p>
									<ul class="list-group list-group-gap list-group-right-icon">
										<li class="list-group-item list-group-item-warning">Aenean leo ligula<i class="icon-right icon  icon_info_alt"></i></li>
										<li class="list-group-item list-group-item-success">Phasellus viverra nulla<i class="icon-right icon  icon_error-oct_alt"></i></li>
										<li class="list-group-item list-group-item-info">Aenean vulputate eled<i class="icon-right icon  icon_error-circle_alt"></i></li>
										<li class="list-group-item list-group-item-danger">Maecenas tempus tellus<i class="icon-right icon  icon_error-triangle_alt"></i></li>
										<li class="list-group-item list-group-item-dark">Quisque rutrum<i class="icon-right icon  icon_question_alt2"></i></li>
									</ul>
								</div>
							</div>
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<!--  Custom Content List -->
									<h4 class="list-title">Custom Content</h4>
									<p>Bootstrap provides the classes <code>.list-group-item-heading</code> and <code>.list-group-item-text</code> which can be used as follows.</p>
									<div class="list-group ab">
										<a class="list-group-item active" href="javascript:void(0)">
											<h4 class="list-group-item-heading">List 1</h4>
											<p class="list-group-item-text">Maecenas nec odio et ante tincidunt tempus.</p>
										</a>
										<a class="list-group-item" href="javascript:void(0)">
											<h4 class="list-group-item-heading">List 2</h4>
											<p class="list-group-item-text">Maecenas nec odio et ante tincidunt tempus.</p>
										</a>
										<a class="list-group-item" href="javascript:void(0)">
											<h4 class="list-group-item-heading">List 3</h4>
											<p class="list-group-item-text">Maecenas nec odio et ante tincidunt tempus.</p>
										</a>
									</div>
								</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<!-- Gap List -->
									<h4 class="list-title">With Gap</h4>
									<p>Add <code>.list-group-gap</code> in class for gap the items.</p>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<!--  Notifications List -->
									<h4 class="list-title">List notifications</h4>
									<p>Create a list of notification with description and icon.</p>
									<div class="list-group list-notification">
										<a class="list-group-item" href="javascript:void(0)">
											<h4 class="list-group-item-heading"><i class="icon social_share" style="color: #4caf50;"></i>Dolanan Remi : Chris Denny Puk</h4>
											<p class="list-group-item-text">3 Minutes ago</p>
										</a>
										<a class="list-group-item" href="javascript:void(0)">
											<h4 class="list-group-item-heading"><i class="icon icon_cogs" style="color: #ff9800;"></i>Your System is update</h4>
											<p class="list-group-item-text">5 Minutes ago</p>
										</a>
										<a class="list-group-item" href="javascript:void(0)">
											<h4 class="list-group-item-heading"><i class="icon icon_blocked" style="color: #f44336;"></i>Three Members is BANNED</h4>
											<p class="list-group-item-text">8 Minutes ago</p>
										</a>
									</div>
								</div>
							</div>
							<div class="clearfix visible-md-block  hidden-xlg"></div>
							<div class="col-sm-6 col-lg-4 list-user">
								<div class="page-wrap margin-lg-0">
									<!--  User List -->
									<h4 class="list-title">User List</h4>
									<p>Create a new Structure list item with image with state.</p>
									<div class="col-sm-12 col-lg-12 list-borders">
										<div class="media">
											<div class="media-left">
												<a class="profile-pic" href="javascript:void(0)">
												<img class="img-responsive list-img-size" src="../assets/images/global/img_240x265.png" alt="list image">
												</a>
											</div>
											<div class="media-body">
												<h4 class="media-heading">Domare Dos</h4>
												<small>CEO</small>
												<p><a href="#"><i class="icon icon_mail_alt" aria-hidden="true"></i>
													domare@gmail.com</a>
												</p>
											</div>
											<div class="media-right">
									...
									<div class="col-sm-12 col-lg-12 list-borders">
										<div class="media">
											...
											<div class="media-body">
												<h4 class="media-heading">Sevral Den</h4>
												<small>CIO</small>
												<p><a href="#"><i class="icon icon_mail_alt" aria-hidden="true"></i>
													sevral@gmail.com</a>
												</p>
									...
									<div class="col-sm-12 col-lg-12 list-borders">
										<div class="media">
											...
											<div class="media-body">
												<h4 class="media-heading">Hinem Jome</h4>
												<small>CTO</small>
												<p><a href="#"><i class="icon icon_mail_alt" aria-hidden="true"></i>
													hinem@gmail.com</a>
												</p>
									...
									<div class="col-sm-12 col-lg-12 list-borders">
										<div class="media">
											...
											<div class="media-body">
												<h4 class="media-heading">Melissa Dock</h4>
												<small>CVO</small>
												<p><a href="#"><i class="icon icon_mail_alt" aria-hidden="true"></i>
													melissa@gmail.com</a>
												</p>
							...
							<div class="col-sm-6 col-lg-4">
								<!--  Media List -->
								<h4 class="list-title">Media List</h4>
								<p>Create a new Structure list item image with state and description.</p>
								<div class="list-media">
									<div class="col-sm-12 col-lg-12 list-borders">
										<div class="media">
											<div class="media-left">
												<a class="profile-pic pro-online" href="javascript:void(0)">
												<img class="img-responsive list-img-size" src="../assets/images/global/img_240x265.png" alt="list image"><i></i>
												</a>
											</div>
											<div class="media-body">
												<h4 class="media-heading">Domare Dos</h4>
												<p>Lorem ipsum dolor sit amet, Maecenas ligula tempus elit.</p>
											</div>
										</div>
									</div>
									<div class="col-sm-12 col-lg-12 list-borders">
										<div class="media">
											<div class="media-left">
												<a class="profile-pic pro-away" href="javascript:void(0)">
												<img class="img-responsive list-img-size" src="../assets/images/global/img_240x265.png" alt="list image"><i></i></a>
											</div>
											<div class="media-body">
												<h4 class="media-heading">Sevral Den</h4>
												<p>Aenean Maecenas tempus ligula dolor. Aenean.</p>
											</div>
										</div>
									</div>
									<div class="col-sm-12 col-lg-12 list-borders">
										<div class="media">
											<div class="media-left">
												<a class="profile-pic pro-busy" href="javascript:void(0)">
												<img class="img-responsive list-img-size" src="../assets/images/global/img_240x265.png" alt="list image"><i></i></a>
											</div>
											<div class="media-body">
												<h4 class="media-heading">Hinem Jome</h4>
												<p>Cum sociis penatibus et magnis Maecenas tempus dis.</p>
											</div>
										</div>
									</div>
									<div class="col-sm-12 col-lg-12 list-borders">
										<div class="media">
											<div class="media-left">
												<a class="profile-pic pro-off" href="javascript:void(0)">
												<img class="img-responsive list-img-size" src="../assets/images/global/img_240x265.png" alt="list image"><i></i></a>
											</div>
											<div class="media-body">
												<h4 class="media-heading">Melissa Dock</h4>
												<p>nascetur ridiculus mus. Donec quam felis, ultricies necen eu.</p>
											</div>
										</div>
									</div>
								</div>
