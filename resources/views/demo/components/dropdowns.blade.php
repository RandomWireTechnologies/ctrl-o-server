...
<html lang="en">
	<head>
		...
		<title>Dropdowns | Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<!-- Page CSS -->
		<link rel="stylesheet" href="../assets/css/dropdown/dropdown-js.min.css" />
	</head>
	<body class="site-navbar-small">
		...
		<div class="main-content dropdown-page">
			<div class="page-header">
				<div class="header-left-panel">
					...
					<ol class="breadcrumb">
						<!--  Breadcrumb Section -->
						<li><a href="#">Home</a></li>
						<li class="text-info">Basic UI</li>
						<li class="active">Dropdowns</li>
					</ol>
				</div>
			</div>
			<div class="page-content container-fluid dropdown-list">
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-sm-12 col-lg-6">
								<div class="page-wrap dropdown-color">
									<!--  Color Dropdown -->
									<h4 class="list-title">Dropdown Color</h4>
									<p>Will change background color of dropdown-menu - that is <code>&lt;ul&gt;</code> under dropdown link. All we have to understand the structure of navbar.</p>
									<div class="btn-group mar-button">
										<button type="button" class="btn btn-primary waves-effect waves-light">Primary</button>
										<button type="button" class="btn btn-primary dropdown-toggle waves-effect waves-light" id="ColorDropdown1" data-toggle="dropdown" aria-expanded="false">
										<span class="caret"></span>
										<span class="sr-only">Primary</span>
										</button>
										<ul class="dropdown-menu dropdown-menu-primary" aria-labelledby="ColorDropdown1" role="menu">
									...
									<div class="btn-group mar-button">
										...
										<button type="button" class="btn btn-success dropdown-toggle waves-effect waves-light" id="ColorDropdown2" data-toggle="dropdown" aria-expanded="false">
										<span class="caret"></span>
										<span class="sr-only">Success</span>
										</button>
										<ul class="dropdown-menu dropdown-menu-success" aria-labelledby="ColorDropdown2" role="menu">
											<li ><a href="javascript:void(0)"  class=" waves-effect waves-light">Action</a></li>
											<li ><a href="javascript:void(0)"  class=" waves-effect waves-light">Another action</a></li>
											<li ><a href="javascript:void(0)"  class=" waves-effect waves-light">Something else here</a></li>
											<li></li>
									...
									<div class="btn-group mar-button">
										...
										<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light" id="ColorDropdown3" data-toggle="dropdown" aria-expanded="false">
										<span class="caret"></span>
										<span class="sr-only">Info</span>
										</button>
										<ul class="dropdown-menu dropdown-menu-info" aria-labelledby="ColorDropdown3" role="menu">
											<li ><a href="javascript:void(0)"  class=" waves-effect waves-light">Action</a></li>
											<li ><a href="javascript:void(0)"  class=" waves-effect waves-light">Another action</a></li>
											<li ><a href="javascript:void(0)"  class=" waves-effect waves-light">Something else here</a></li>
											<li></li>
									...
									<div class="btn-group mar-button">
										...
										<button type="button" class="btn btn-warning dropdown-toggle waves-effect waves-light" id="ColorDropdown4" data-toggle="dropdown" aria-expanded="false">
										<span class="caret"></span>
										<span class="sr-only">Warning</span>
										</button>
										<ul class="dropdown-menu dropdown-menu-warning" aria-labelledby="ColorDropdown3" role="menu">
											<li ><a href="javascript:void(0)"  class=" waves-effect waves-light">Action</a></li>
											<li ><a href="javascript:void(0)"  class=" waves-effect waves-light">Another action</a></li>
											<li ><a href="javascript:void(0)"  class=" waves-effect waves-light">Something else here</a></li>
											<li></li>
									...
									<div class="btn-group mar-button">
										...
										<button type="button" class="btn btn-danger dropdown-toggle waves-effect waves-light" id="ColorDropdown5" data-toggle="dropdown" aria-expanded="false">
										<span class="caret"></span>
										<span class="sr-only">Danger</span>
										</button>
										<ul class="dropdown-menu dropdown-menu-danger" aria-labelledby="ColorDropdown3" role="menu">
											<li ><a href="javascript:void(0)"  class=" waves-effect waves-light">Action</a></li>
											<li ><a href="javascript:void(0)"  class=" waves-effect waves-light">Another action</a></li>
											<li ><a href="javascript:void(0)"  class=" waves-effect waves-light">Something else here</a></li>
											<li></li>
									...
									<div class="btn-group mar-button">
										...
										<button type="button" class="btn btn-dark dropdown-toggle waves-effect waves-light" id="ColorDropdown6" data-toggle="dropdown" aria-expanded="false">
										<span class="caret"></span>
										<span class="sr-only">Dark</span>
										</button>
										<ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="ColorDropdown3" role="menu">
											<li ><a href="javascript:void(0)"  class=" waves-effect waves-light">Action</a></li>
											<li ><a href="javascript:void(0)"  class=" waves-effect waves-light">Another action</a></li>
											<li ><a href="javascript:void(0)"  class=" waves-effect waves-light">Something else here</a></li>
											<li></li>
							...
							<div class="col-lg-6 col-sm-6">
								<div class="page-wrap">
									<!--  Boxes Dropdown -->
									<h4 class="list-title">Dropdown Boxs</h4>
									<p>Create a dropdown with Checkboxes & Search Form & Radio Buttons.</p>
									<div class="btn-group mar-button">
										<button type="button" class="btn btn-info waves-effect waves-light">Search Dropdown</button>
										<button class="btn btn-info dropdown-toggle waves-effect waves-light" type="button" data-toggle="dropdown" aria-expanded="false">
										<span class="caret"></span>
										...
										<div class="dropdown-menu dropdown-content input-large hold-on-click" role="menu">
											<form action="#">
												<div class="input-group">
													...
													<button class="btn btn-info dropdoewn-search-btn" type="submit">Go!</button>
													</span>
												</div>
											</form>
										</div>
									...
									<div class="btn-group mar-button">
										...
										<div class="dropdown-menu hold-on-click dropdown-checkboxes" role="menu">
											...
											<label class="control control-checkbox">Option 4
											<input type="checkbox"/>
											<span class="control_indicator"></span>
											</label>
										</div>
									...
									<div class="btn-group mar-button">
										<button type="button" class="btn btn-info waves-effect waves-light">Dropdown Radio</button>
										<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light" data-toggle="dropdown" aria-expanded="false">
										<span class="caret"></span>
										...
										<div class="dropdown-menu hold-on-click dropdown-radiobuttons" role="menu">
											...
											<label class="control control-radio">Option 4
											<input type="radio" name="radio"/>
											<span class="control_indicator"></span>
											</label>
										</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap display-hidden">
									<div class="basic-drop">
										<!--  Basic Dropdown -->
										<h4 class="list-title">Basic Dropdown</h4>
										<p>Create a dropdown box that appears when the user moves the mouse over an element.</p>
										<div class="dropdown">
											<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light" id="BasicDropdown" data-toggle="dropdown" aria-expanded="true">
											Dropdown
											<span class="caret"></span>
											</button>
											<ul class="dropdown-menu dropdown-menu1" aria-labelledby="BasicDropdown" role="menu">
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Another action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Something else here</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Separated link</a></li>
											</ul>
										</div>
									</div>
								</div>
							</div>
							<div class="col-sm-6 col-lg-4 clarclass">
								<div class="page-wrap display-hidden">
									<div class="alignment-drop">
										<!--  Alignment Dropdown -->
										<h4 class="list-title">Alignment Dropdown</h4>
										<p>we've deprecated <code>.pull-right</code> on <code>dropdown menus</code>. To right-align a menu, use <code>.dropdown-menu-right</code>. Right-aligned nav components in the navbar use a mixin version of this class to automatically align the menu. To override it, use  <code>.dropdown-menu-left</code>.</p>
										<div class="dropdown">
											<button type="button" class="btn btn-info dropdown-toggle pull-right waves-effect waves-light" id="AlignmentDropdown" data-toggle="dropdown" aria-expanded="true">
											Dropdown
											<span class="caret"></span>
											</button>
											<ul class="dropdown-menu dropdown-menu-right dropdown-menu1 pull-right" aria-labelledby="AlignmentDropdown" role="menu">
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Another action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Something else here</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Separated link</a></li>
							...
							<div class="col-sm-6 col-lg-4 clarclass">
								<div class="page-wrap display-hidden">
									<div class="headers-drop">
										<!--  Headers Dropdown -->
										<h4 class="list-title">Headers Dropdown</h4>
										<p>The <code>.dropdown-header</code> class is used to add headers inside the dropdown menu:</p>
										<div class="dropdown">
											<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light" id="HeadersDropdown" data-toggle="dropdown" aria-expanded="true">
											Dropdown
											<span class="caret"></span>
											</button>
											<ul class="dropdown-menu dropdown-header-menu dropdown-menu1" aria-labelledby="HeadersDropdown" role="menu">
							...
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<div class="sizing-drop">
										<!--  Sizing Dropdown -->
										<h4 class="list-title">Sizing Dropdown</h4>
										<p>The size attribute specifies the number of visible options in a drop-down list.</p>
										<div class="btn-group mar-button">
											<button type="button" class="btn btn-info dropdown-toggle btn-lg waves-effect waves-light" id="SizingDropdown1" data-toggle="dropdown" aria-expanded="false">
											Large button
											<span class="caret"></span>
											</button>
											<ul class="dropdown-menu" aria-labelledby="SizingDropdown1" role="menu">
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Another action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Something else here</a></li>
												<li class="divider" ></li>
										...
										<div class="btn-group mar-button">
											<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light" id="SizingDropdown2" data-toggle="dropdown" aria-expanded="false">
											Default button
											<span class="caret"></span>
											</button>
											<ul class="dropdown-menu" aria-labelledby="SizingDropdown2" role="menu">
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Another action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Something else here</a></li>
												<li class="divider" ></li>
										...
										<div class="btn-group mar-button">
											<button type="button" class="btn btn-info dropdown-toggle btn-sm waves-effect waves-light" id="SizingDropdown3" data-toggle="dropdown" aria-expanded="false">
											Small button
											<span class="caret"></span>
											</button>
											<ul class="dropdown-menu" aria-labelledby="SizingDropdown3" role="menu">
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Another action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Something else here</a></li>
												<li class="divider" ></li>
										...
										<div class="btn-group mar-button">
											<button type="button" class="btn btn-info dropdown-toggle btn-xs waves-effect waves-light" id="SizingDropdown4" data-toggle="dropdown" aria-expanded="false">
											Extra small button
											<span class="caret"></span>
											</button>
											<ul class="dropdown-menu" aria-labelledby="SizingDropdown4" role="menu">
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Another action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Something else here</a></li>
												<li class="divider" ></li>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<div class="icon-drop display-hidden">
										<!--  Icons Menu Dropdown -->
										<h4 class="list-title">Icons Menu Items</h4>
										<p>Icons are very important to the user-interface. The most effective way to make site navigation a truly user-friendly is to add icons to the menu.</p>
										<div class="dropdown">
											<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light" id="IconsDropdown" data-toggle="dropdown" aria-expanded="false">Icons Dropdown
											<span class="caret"></span>
											</button>
											<ul class="dropdown-menu dropdown-menu1" aria-labelledby="IconsDropdown" role="menu">
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic"><i class="icon arrow_back" aria-hidden="true"></i> Reply</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic"><i class="icon arrow_condense" aria-hidden="true"></i> Share</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic"><i class="icon icon_trash" aria-hidden="true"></i> Delete</a></li>
												<li class="divider" ></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic"><i class="icon icon_cog" aria-hidden="true"></i> Settings</a></li>
											</ul>
										</div>
									</div>
								</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap  display-hidden">
									<div class="number-drop">
										<!--  Badages In Menu Dropdown -->
										<h4 class="list-title">Badages In Menu Items</h4>
										<p>Badages in menu items content types you are able to use subtitles with the items.</p>
										<div class="dropdown">
											<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light" id="BadagesDropdown" data-toggle="dropdown" aria-expanded="false">Default
											<span class="caret"></span>
											</button>
											<ul class="dropdown-menu dropdown-menu1" aria-labelledby="BadagesDropdown" role="menu">
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Action<span class="badge badge-success num-margin">4</span></a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Another action<span class="badge badge-info num-margin">2</span></a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Something else here<span class="badge badge-warning num-margin">12</span></a></li>
												<li class="divider" ></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Separated link<span class="badge badge-danger num-margin">7</span></a></li>
											</ul>
										</div>
									</div>
								</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<div class="animation-drop">
										<!--  Animation Dropdown -->
										<h4 class="list-title">Animation</h4>
										<p>first post about improving your site navigation with some simple CSS animation.</p>
										<div class="btn-group mar-button">
											<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light" id="AnimationDropdown1" data-toggle="dropdown" aria-expanded="false">Animation
											<span class="caret"></span>
											</button>
											<ul class="dropdown-menu animate" aria-labelledby="AnimationDropdown1" role="menu">
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Another action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Something else here</a></li>
												<li class="divider" ></li>
										...
										<div class="btn-group dropup mar-button">
											<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light" id="AnimationDropdown2" data-toggle="dropdown" aria-expanded="false">
											Animation Reverse
											<span class="caret"></span>
											</button>
											<ul class="dropdown-menu animate animate-reverse" aria-labelledby="AnimationDropdown2" role="menu">
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Another action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Something else here</a></li>
												<li class="divider" ></li>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<div class="split-drop p-bottom">
										<!--  Animation Dropdown -->
										<h4 class="list-title">Split Button Dropdowns</h4>
										<p>We've simplified our split dropdown buttons by removing the dedicated ones associated with a style of button.</p>
										<div class="btn-group mar-button">
											<button type="button" class="btn btn-info waves-effect waves-light">Default</button>
											<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light" id="SplitDropdown1" data-toggle="dropdown" aria-expanded="false">
											<span class="caret"></span>
											<span class="sr-only">Toggle Dropdown</span>
											</button>
											<ul class="dropdown-menu" aria-labelledby="SplitDropdown1" role="menu">
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Another action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Something else here</a></li>
												<li class="divider" ></li>
										...
										<div class="btn-group mar-button">
											<button type="button" class="btn btn-primary waves-effect waves-light">Primary</button>
											<button type="button" class="btn btn-primary dropdown-toggle waves-effect waves-light" id="SplitDropdown2" data-toggle="dropdown" aria-expanded="false">
											<span class="caret"></span>
											<span class="sr-only">Toggle Dropdown</span>
											</button>
											<ul class="dropdown-menu dropdown-menu-primary" aria-labelledby="SplitDropdown2" role="menu">
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-light">Action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-light">Another action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-light">Something else here</a></li>
												<li></li>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<div class="up-drop">
										<!--  Dropup Variation Dropdown -->
										<h4 class="list-title">Dropup Variation</h4>
										<p>Menus can also be built to drop up rather than down. To achieve this, simply add <code>.dropup</code> to the parent container.</p>
										<div class="btn-group dropup mar-button">
											<button type="button" class="btn btn-info waves-effect waves-light">Dropup</button>
											<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light" data-toggle="dropdown" aria-expanded="false">
											<span class="caret"></span>
											<span class="sr-only">Toggle Dropdown</span>
											</button>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<div class="bullet-drop">
										<!--  Bullet Dropdown -->
										<h4 class="list-title">Bullet</h4>
										<p>I use Bootstrap Dropdown Menus Enhancement to center dropdown-menus and have <code>.bullet</code> between my button and the actual menu.</p>
										<div class="btn-group dropdown mar-button">
											<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light" id="BulletDropdown1" data-toggle="dropdown" aria-expanded="false">
											Default
											<span class="caret"></span>
											</button>
											<ul class="dropdown-menu bullet" aria-labelledby="BulletDropdown1" role="menu">
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Another action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Something else here</a></li>
												<li class="divider" ></li>
										...
										<div class="btn-group dropdown mar-button">
											<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light" id="BulletDropdown2" data-toggle="dropdown" aria-expanded="false">
											Right
											<span class="caret"></span>
											</button>
											<ul class="dropdown-menu bullet dropdown-menu-right" aria-labelledby="BulletDropdown2" role="menu">
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Another action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Something else here</a></li>
												<li class="divider" ></li>
										...
										<div class="btn-group dropup mar-button">
											<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light" id="BulletDropdown3" data-toggle="dropdown" aria-expanded="false">
											Bottom
											<span class="caret"></span>
											</button>
											<ul class="dropdown-menu bullet" aria-labelledby="BulletDropdown3" role="menu">
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Another action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Something else here</a></li>
												<li class="divider" ></li>
										...
										<div class="btn-group dropup mar-button">
											<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light" id="BulletDropdown4" data-toggle="dropdown" aria-expanded="false">
											Bottom right
											<span class="caret"></span>
											</button>
											<ul class="dropdown-menu bullet dropdown-menu-right" aria-labelledby="BulletDropdown4" role="menu">
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Another action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Something else here</a></li>
												<li class="divider" ></li>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<div class="hover-drop">
										<!--  Hover Plugin Dropdown -->
										<h4 class="list-title">Dropdown On Hover Plugin</h4>
										<p>A simple plugin to enable Bootstrap dropdowns to activate on hover and provide a nice user experience.</p>
										<div class="btn-group mar-button">
											<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light hover-dropdown" id="HoverDropdown1" data-hover="dropdown" data-delay="1000" data-toggle="dropdown" aria-expanded="false">
											1000ms Delay
											<span class="caret"></span>
											</button>
											<ul class="dropdown-menu dropdown-menu2" aria-labelledby="HoverDropdown1" role="menu">
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Another action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Something else here</a></li>
												<li class="divider" ></li>
										...
										<div class="btn-group mar-button">
											<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light" id="HoverDropdown2" data-hover="dropdown" data-close-others="false" data-toggle="dropdown" aria-expanded="false">
											Doesn't Close Others
											<span class="caret"></span>
											</button>
											<ul class="dropdown-menu dropdown-menu2" aria-labelledby="HoverDropdown2" role="menu">
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Another action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Something else here</a></li>
												<li class="divider" ></li>
										...
										<div class="btn-group mar-button">
											<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light" id="HoverDropdown3" data-hover="dropdown" data-toggle="dropdown" aria-expanded="false">
											Default
											<span class="caret"></span>
											</button>
											<ul class="dropdown-menu dropdown-menu2" aria-labelledby="HoverDropdown3" role="menu">
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Another action</a></li>
												<li ><a href="javascript:void(0)"  class=" waves-effect waves-classic">Something else here</a></li>
												<li class="divider" ></li>
							...
							<div class="col-lg-12 col-sm-12">
								<!--  Sub Menus Dropdown -->
								<h4 class="list-title">Sub Menus On Dropdowns</h4>
								<p>Drop down menus are among the coolest things on the web. Beside that they are also very good for creating navigations that contain many elements. The main problems of creating drop down menus lies in the Internet Explorer’s inappropriate way of displaying :hover pseudo class .</p>
								<div class="row">
									<div class="col-sm-4 col-lg-4 clarclasstablet padding-top-10">
										<div class="page-wrap margin-md-0 margin-sm-0">
											<div class="submenu-drop">
												<h5>Default</h5>
												<div class="dropdown">
													<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light" id="DefaultDropdownSubMenu" aria-expanded="false" data-toggle="dropdown">
													Dropdown
													<span class="caret"></span>
													</button>
													<ul class="dropdown-menu dropdown-menu1" aria-labelledby="DefaultDropdownSubMenu" role="menu">
														<li ><a href="javascript:void(0)"   class=" waves-effect waves-classic">Action</a></li>
														<li ><a href="javascript:void(0)"   class=" waves-effect waves-classic">Another action</a></li>
														<li ><a href="javascript:void(0)"   class=" waves-effect waves-classic">Something else here</a></li>
														<li class="divider" ></li>
														<li class="dropdown-submenu">
															<a href="javascript:void(0)" role="button"  class=" waves-effect waves-classic">More options</a>
															<ul class="dropdown-menu" role="menu">
																<li ><a href="javascript:void(0)"   class=" waves-effect waves-classic">Second level link</a></li>
																<li ><a href="javascript:void(0)"   class=" waves-effect waves-classic">Second level link</a></li>
																<li ><a href="javascript:void(0)"   class=" waves-effect waves-classic">Second level link</a></li>
															</ul>
														</li>
									...
									<div class="col-sm-4 col-lg-4 clarclasstablet padding-top-10">
										<div class="page-wrap margin-md-0 margin-sm-0">
											<div class="up-drop">
												...
												<h5>Dropup</h5>
												<div class="dropup">
													<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light" id="DropupSubMenu" aria-expanded="true" data-toggle="dropdown">
													Dropup
													<span class="caret"></span>
													</button>
													<ul class="dropdown-menu dropdown-menu1" aria-labelledby="DropupSubMenu" role="menu">
														<li ><a href="javascript:void(0)"   class=" waves-effect waves-classic">Action</a></li>
														<li ><a href="javascript:void(0)"   class=" waves-effect waves-classic">Another action</a></li>
														<li ><a href="javascript:void(0)"   class=" waves-effect waves-classic">Something else here</a></li>
														<li class="divider" ></li>
														<li class="dropdown-submenu">
															<a href="javascript:void(0)"  class=" waves-effect waves-classic">More options</a>
															<ul class="dropdown-menu" role="menu">
																<li ><a href="javascript:void(0)"   class=" waves-effect waves-classic">Second level link</a></li>
																<li ><a href="javascript:void(0)"   class=" waves-effect waves-classic">Second level link</a></li>
																<li ><a href="javascript:void(0)"   class=" waves-effect waves-classic">Second level link</a></li>
									...
									<div class="col-sm-4 col-lg-4 clarclasstablet padding-top-10">
										<div class="page-wrap margin-bottom-0">
											...
											<h5>Left Submenu</h5>
											<div class="dropdown">
												<button type="button" class="btn btn-info dropdown-toggle pull-right waves-effect waves-light" id="LeftDropdownSubMenu" aria-expanded="true" data-toggle="dropdown">
												Dropdown
												<span class="caret"></span>
												</button>
												<ul class="dropdown-menu dropdown-menu1 pull-right dropdown-menu-right" aria-labelledby="LeftDropdownSubMenu" role="menu">
													<li ><a href="javascript:void(0)"   class=" waves-effect waves-classic">Action</a></li>
													<li ><a href="javascript:void(0)"   class=" waves-effect waves-classic">Another action</a></li>
													<li ><a href="javascript:void(0)"   class=" waves-effect waves-classic">Something else here</a></li>
													<li class="divider" ></li>
													<li class="dropdown-submenu dropdown-menu-left">
														<a href="javascript:void(0)"  class=" waves-effect waves-classic">More options</a>
														<ul class="dropdown-menu open-left-submenu" role="menu">
															<li ><a href="javascript:void(0)"   class=" waves-effect waves-classic waves-effect waves-classic waves-effect waves-classic">Second level link</a></li>
															<li ><a href="javascript:void(0)"   class=" waves-effect waves-classic waves-effect waves-classic waves-effect waves-classic">Second level link</a></li>
															<li ><a href="javascript:void(0)"   class=" waves-effect waves-classic waves-effect waves-classic waves-effect waves-classic">Second level link</a></li>
														</ul>
													</li>
