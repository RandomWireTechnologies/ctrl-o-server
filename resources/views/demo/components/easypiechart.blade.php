...
<html data-ng-app="app" lang="en">
	<head>
		...
		<title>Easy Pie Chart | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="dashboard site-navbar-small">
		...
		<div class="main-content">
			<div class="page-header">
				<div class="header-left-panel">
					<!-- Title Page -->
					<h1 class="page-title">Easy pie chart</h1>
					<!-- Breadcrumb Section -->
					<ol class="breadcrumb">
						<li><a href="../dashboard_v1.html">Home</a></li>
						<li class="text-info">Chart</li>
						<li class="active">Easy pie chart</li>
					</ol>
				</div>
			</div>
				...
				<div class="panel">
					<div class="panel-body">
						<div class="page-wrap">
							<div class="row">
								<div class="col-sm-12">
									<!-- Easy Pie Charts Section -->
									<h4 class="list-title">Easy Pie Charts</h4>
									<p>Easy pie chart is uses the canvas element to render simple pie charts for single values.</p>
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12 box-chart">
									<div class="angular text-center" data-ng-controller="chartCtrl">
										<span class="chart chart-info" easypiechart percent="percent" options="options">
										<span class="percent" data-ng-bind="percent"></span>
										</span>
									</div>
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12 box-chart">
									<div class="angular text-center" data-ng-controller="chartCtrl">
										<span class="chart chart-warning" easypiechart percent="anotherPercent" options="anotherOptions">
										<span class="percent" data-ng-bind="anotherPercent"></span>
										</span>
									</div>
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12 box-chart">
									<div class="angular text-center" data-ng-controller="chartCtrl">
										<span class="chart chart-success" easypiechart percent="secondPercent" options="secondOptions">
										<span class="percent" data-ng-bind="secondPercent"></span>
										</span>
									</div>
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12 box-chart">
									<div class="angular text-center" data-ng-controller="chartCtrl">
										<span class="chart chart-green" easypiechart percent="threePercent" options="threeOptions">
										<span class="percent" data-ng-bind="threePercent"></span>
										</span>
									</div>
								</div>
							</div>
					...
					<div class="panel-body">
						<div class="page-wrap">
							<div class="row">
								<div class="col-sm-12">
									<!-- Knob Section -->
									<h4 class="list-title">Knob</h4>
									<p>Display different knob show disable display input, cursor mode, display previous value, angle offset and arc.</p>
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12 text-center margin-top-30">
									<input class="knob" data-width="200" data-displayInput=false data-fgColor="#36a9e1" value="35">
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12 text-center margin-top-30">
									<input class="knob" data-width="200" data-cursor=true data-fgColor="#5cb85c" data-thickness=.3 value="29">
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12 text-center margin-top-30">
									<input class="knob" data-width="200" data-min="-100" data-fgColor="#f0ad4e" data-displayPrevious=false value="44">
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12 text-center margin-top-30">
									<input class="knob" data-width="200" data-angleOffset=-125 data-angleArc=250 data-fgColor="#d9534f" data-rotation="anticlockwise" value="65">
								</div>
							</div>
						</div>
						<div class="page-wrap">
							<div class="row">
								<div class="col-sm-12">
									<!-- Sizes & Thickness Section -->
									<h4 class="list-title">Sizes & Thickness</h4>
									<p>Display different knob with size and thickness add <code>data-thickness</code>.</p>
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12 text-center margin-top-30">
									<input class="knob" data-width="200" data-thickness=".1" data-angleOffset=90 data-fgColor="#5cb85c" value="55">
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12 text-center margin-top-30">
									<input class="knob" data-width="200" data-thickness=".2" data-angleOffset=90 data-fgColor="#36a9e1" value="65">
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12 text-center margin-top-30">
						...
						<div class="page-wrap">
							<div class="row">
								<div class="col-sm-12">
									<!-- Previous Value Indicator Section -->
									<h4 class="list-title">Previous Value Indicator</h4>
									<p>Display different knob show Overloaded 'draw' method,  readonly, previous value.</p>
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12 text-center smallknob">
									<input class="knob" data-width="210" data-displayPrevious=true data-fgColor="#36a9e1" data-skin="tron" data-cursor=true value="75" data-thickness=".2">
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12 text-center smallknob">
									<input class="knob" data-width="210" data-displayPrevious=false data-fgColor="#5cb85c" data-skin="tron" data-thickness=".2" value="75">
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12 text-center margin-top-30">
									<input class="knob" data-width="200" data-fgColor="#f0ad4e" data-thickness=".4" readonly value="22">
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12 text-center margin-top-30">
									<input class="knob" data-width="200" data-angleOffset=-125 data-min="-1000" data-max="1000" data-angleArc=250 data-fgColor="#d9534f" data-rotation="anticlockwise" value="0">
								</div>
							</div>
						</div>
					</div>
		...
		<script src="../assets/js/easypiechart/angular.easypiechart.min.js"></script>
