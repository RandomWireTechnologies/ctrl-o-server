...
<html lang="en">
	<head>
		...
		<title>Alertify | Porish Material Admin Template</title>
		<!-- Favicons -->
					...
					<div class="panel-body container-fluid">
						<div class="row">
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<!--  Alert Dialog -->
									<h4 class="list-title">Alert dialog</h4>
									<p>Dialogs display a text and require user to acknowledge the message.</p>
									<button class="btn-curl btn-info generate-alertify" id="alert">Generate</button>
								</div>
							</div>
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<!--  Prompt Dialog -->
									<h4 class="list-title">Prompt dialog</h4>
									<p>To display value in input box.</p>
									<button class="btn-curl btn-info generate-alertify" id="prompt">Generate</button>
								</div>
							</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<!--  Confirm Dialog -->
									<h4 class="list-title">Confirm dialog</h4>
									<p>You're not limited to the "Ok" and "Cancel" button labels. You can easily set your own labels. </p>
									<button class="btn-curl btn-info generate-alertify" id="confirm">Generate</button>
								</div>
							</div>
							<div class="clearfix visible-xs-block visible-xlg-block"></div>
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<!--  Persistent Dialog -->
									<h4 class="list-title">Persistent log</h4>
									<p>The persistent log Will stay until clicked.</p>
									<button class="btn-curl btn-info generate-alertify" id="forever">Generate</button>
								</div>
							</div>
							<div class="clearfix visible-sm-block visible-md-block"></div>
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<!--  Maximum Number Dialog -->
									<h4 class="list-title">Maximum number of log messages</h4>
									<p>Maximum message display of log messages.</p>
									<button class="btn-curl btn-info generate-alertify" id="max-log-items">Generate</button>
								</div>
							</div>
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap">
									<!--  Delay Dialog -->
									<h4 class="list-title">Delay</h4>
									<p>The delay message user clicks “ok” button then hide in 10 seconds.</p>
									<button class="btn-curl btn-info generate-alertify" id="delay">Generate</button>
								</div>
							</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap margin-md-0 margin-sm-0">
									<!--  Multiple Dialog -->
									<h4 class="list-title">Multiple dialog</h4>
									<p>A multiple dialog is often used if you want the user to confirm a value And after clicks "ok" button.</p>
									<button class="btn-curl btn-info generate-alertify" id="ajax">Generate</button>
								</div>
							</div>
							<div class="col-sm-6 col-lg-4">
								<div class="page-wrap margin-bottom-0">
									<!--  Success Log With Callback Dialog -->
									<h4 class="list-title">Success log with callback</h4>
									<p>The success callback function will be open message and click after click notification.</p>
									<button class="btn-curl btn-info generate-alertify" id="success-callback">Generate</button>
								</div>
							</div>
						</div>
					</div>
