...
<html>
	<head>
		...
		<title>Editable Tables | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="basic-table site-navbar-small">
			...
			<div class="page-content container-fluid">
				<div class="panel">
					<div class="panel-body">
						...
						<table class="editable-table table table-striped margin-bottom-0" id="editableTable">
							<thead>
								<tr>
									<th>Product</th>
									<th>Price</th>
		...
		<script src="../assets/js/editable-table/editable.min.js"></script>
	</body>
</html>
