...
<html lang="en">
	<head>
		...
		<title>Highlight | Porish Material Admin Template</title>
		<!-- Favicons -->
			...
			<div class="page-header">
				<div class="header-left-panel">
					...
					<ol class="breadcrumb">
						...
						<li class="text-info">Advanced UI</li>
				...
				<div class="panel">
					...
					<div class="panel-body">
						<div class="html-section">
							<pre data-plugin="highlight"><code class="html hljs xml"><span class="marun-color">&lt;?xml version="1.0"?&gt;</span>
<span class="hljs-tag">&lt;<span class="green-color"><b>response</b></span> <span class="marun-color">value</span>=<span class="orange-color">"ok"</span> <span class="marun-color">xml:lang</span>=<span class="orange-color">"en"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="green-color"><b>text</b></span>&gt;</span>Highlight Ok<span class="hljs-tag">&lt;/<span class="green-color"><b>text</b></span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="green-color"><b>comment</b></span> <span class="marun-color">html_allowed</span>=<span class="orange-color">"true"</span>/&gt;</span>
  <span class="hljs-tag">&lt;<span class="green-color"><b>ns1:description</b></span>&gt;</span><span class="gray-color">&lt;![CDATA[
  CDATA is &lt;not&gt; magical.
  ]]&gt;</span><span class="hljs-tag">&lt;/<span class="green-color"><b>ns1:description</b></span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="green-color"><b>a</b></span>&gt;</span><span class="hljs-tag">&lt;/<span class="green-color"><b>a</b></span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="green-color"><b>response</b></span>&gt;</span>
</code>
                            </pre>
						</div>
					</div>
				...
				<div class="panel">
					...
					<div class="panel-body">
						<div class="html-section">
							<pre data-plugin="highlight"><code class="html hljs xml">
<span class="marun-color">&lt;!DOCTYPE html&gt;</span>
<span class="html-text">&lt;<span class="green-color"><b>html</b></span>&gt;</span>
<span class="html-text">&lt;<span class="green-color"><b>head</b></span>&gt;</span>
<span class="hljs-tag">&lt;<span class="green-color"><b>title</b></span>&gt;</span>Title<span class="hljs-tag">&lt;/<span class="green-color"><b>title</b></span>&gt;</span>

<span class="hljs-tag">&lt;<span class="green-color"><b>style</b></span>&gt;</span><span class="css"><span class="gray-color"><b>body</b></span> <span class="gray-color">{<span class="hljs-rule"><span class="gray-color">width</span>:<span class="hljs-value"> <span class="blue-color">500px</span></span></span>;}</span></span><span class="hljs-tag">&lt;/<span class="green-color"><b>style</b></span>&gt;</span>

<span class="hljs-tag">&lt;<span class="green-color"><b>script</b></span> <span class="hljs-attribute">type</span>=<span class="orange-color">"application/javascript"</span>&gt;</span><span class="javascript">
  <span class="hljs-function"><span class="red-color">function</span> <span class="gray-color"><b>$init</b></span>(<span class="g"></span>) </span>{<span class="red-color">return</span> <span class="hljs-literal">true</span>;}
</span><span class="hljs-tag">&lt;/<span class="green-color"><b>script</b></span>&gt;</span>
<span class="html-text">&lt;/<span class="green-color"><b>head</b></span>&gt;</span>

<span class="hljs-tag">&lt;<span class="green-color"><b>body</b></span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="green-color"><b>p</b></span> <span class="marun-color">checked</span> <span class="marun-color">class</span>=<span class="orange-color">"title"</span> <span class="marun-color">id</span>=<span class="orange-color">'title'</span>&gt;</span>Highlight Text<span class="hljs-tag">&lt;/<span class="green-color"><b>p</b></span>&gt;</span>
...
<span class="html-text">&lt;/<span class="green-color"><b>html</b></span>&gt;</span>
				...
				<div class="panel">
					...
					<div class="panel-body">
						<div class="html-section">
							<pre data-plugin="highlight"><code class="html hljs xml">
<span class="green-color"><b>body</b></span> {
    <span class="blue-color">background-color</span>: #d0e4fe;
}

<span class="green-color"><b>h1</b></span> {
    <span class="blue-color">color</span>: orange;
    <span class="blue-color">text-align</span>: center;
}

<span class="green-color"><b>p</b></span> {
    <span class="blue-color">font-family</span>: "Times New Roman";
    <span class="blue-color">font-size</span>: 20px;
}
</code></pre>
						</div>
					</div>
				...
				<div class="panel">
					...
					<div class="panel-body">
						<div class="html-section">
							<pre data-plugin="highlight"><code class="html hljs xml">
<span class="gray-color">// base.scss</span>

<span class="red-color"><b>@import</b></span> <span class="orange-color">'reset'</span>;

<span class="marun-color">html, body, ul, ol</span> {
  <span class="red-color"><b>margin</b></span>: <span class="blue-color">0</span>;
  <span class="red-color"><b>padding</b></span>: <span class="blue-color">0</span>;
}

<span class="marun-color">body</span> {
  <span class="red-color"><b>font</b></span>: <span class="blue-color">100%</span> <span class="marun-color">Helvetica</span>,<span class="blue-color">sans-serif</span>;
  <span class="red-color"><b>background-color</b></span>: <span class="blue-color">#efefef</span>;
}

<b>@mixin</b> <span class="red-color">border-radius</span><span class="red-color">($radius)</span> {
  <span class="blue-color">-webkit-border-radius</span>: <span class="blue-color">$radius</span>;
  <span class="blue-color">-moz-border-radius</span>: <span class="blue-color">$radius</span>;
  <span class="blue-color">-ms-border-radius</span>: <span class="blue-color">$radius</span>;
  <span class="red-color"><b>border-radius</b></span>: <span class="blue-color">$radius</span>;
}

<span class="marun-color"><b>.box</b></span> { @include border-radius(<span class="blue-color">10px</span>); }
</code>
                            </pre>
						</div>
					</div>
				...
				<div class="panel">
					<!--  Less CSS Section -->
					<div class="panel-heading">
						<h3 class="panel-title">LESS CSS</h3>
					</div>
					<div class="panel-body">
						<div class="html-section">
							<pre data-plugin="highlight"><code class="html hljs xml">
@color-base: <span class="green-color">#2d5e8b</span>;
<span class="green-color">.class<span class="green-color">1</span> {
    <span class="marun-color">background-color</span></span>: @color-base;
    <span class="marun-color">.class</span><span class="green-color">2</span> {
        <span class="blue-color">background-color</span>: <span class="green-color">#fff</span>;
        <span class="blue-color">color</span>: @color-base;
    }
}

<span class="green-color">@font-face</span> {
    <span class="blue-color">font-family:</span> <span class="gray-color">/* ? */</span> <span class="orange-color">'Omega'</span>;
    <span class="blue-color">src</span>: <span class="blue-color">url</span>(<span class="orange-color">'../fonts/omega-webfont.woff?v=2.0.2')</span>;
}

<span class="marun-color">nav</span> {
    <span class="blue-color">height</span>: 40px;
    <span class="blue-color">width</span>: 100%;
    <span class="blue-color">background</span>: #455868;
    <span class="blue-color">border-bottom</span>: 2px solid #283744;
    <span class="blue-color">@font-family</span>: Georgia, sans-serif;
}
<span class="marun-color">nav li</span> {
    <span class="blue-color">width</span>: 600px;
    <span class="blue-color">height</span>: 40px;
}
<span class="marun-color">nav li a</span> {
    <span class="blue-color">color</span>: #fff;
    <span class="blue-color">line-height</span>: 40px;
    <span class="blue-color">text-shadow</span>: 1px 1px 0px #283744;
    <span class="blue-color">content</span>:<span class="orange-color">"\f085"</span>;
}
</code>
                            </pre>
						</div>
				...
				<div class="panel">
					...
					<div class="panel-body">
						<div class="html-section">
							<pre data-plugin="highlight"><code class="html hljs xml">
<span class="blue-color">var</span> i = <span class="red-color">0</span>;
<span class="blue-color">var</span> len = cars.length;
<span class="blue-color">for</span> (; i &lt; len; ) {
    text += cars[i] + <span class="red-color">"&lt;br&gt;</span>";
    i++;
}
<span class="blue-color">var</span> cars = [<span class="orange-color">"BMW", "Volvo", "Saab", "Ford"</span>];
<span class="blue-color">var</span> i = <span class="red-color">0</span>;
<span class="blue-color">var</span> text = <span class="red-color">""</span>;

<span class="blue-color">for</span> (;cars[i];) {
    text += cars[i] + "<span class="red-color">&lt;br&gt;</span>";
    i++;
} 
</code>
				...
				<div class="panel">
					...
					<div class="panel-body">
						<div class="html-section">
							<pre data-plugin="highlight"><code class="html hljs xml">
<span class="light-red-color">&lt;?php</span>
$favcolor = <span class="red-color">"red"</span>;

<span class="blue-color">switch</span> ($favcolor) {
    <span class="blue-color">case</span> <span class="red-color">"red"</span>:
        <span class="blue-color">echo</span> <span class="red-color">"Your favorite color is red!"</span>;
        <span class="blue-color">break;</span>
   <span class="blue-color"> case</span> <span class="red-color">"blue"</span>:
        <span class="blue-color">echo</span> <span class="red-color">"Your favorite color is blue!"</span>;
        <span class="blue-color">break;</span>
    <span class="blue-color">case</span> <span class="red-color">"green"</span>:
        <span class="blue-color">echo</span> <span class="red-color">"Your favorite color is green!"</span>;
       <span class="blue-color"> break;</span>
    <span class="blue-color">default:</span>
        <span class="blue-color">echo</span> <span class="red-color">"Your favorite color is neither red, blue, nor green!"</span>;
}
<span class="light-red-color">?&gt; </span>
</code>
                            </pre>
						</div>
					</div>
				...
				<div class="panel">
					...
					<div class="panel-body">
						<div class="html-section">
							<pre data-plugin="highlight"><code class="html hljs xml">
{
    "<span class="orange-color">glossary</span>": {
        "<span class="orange-color">title</span>": "<span class="orange-color">Page glossary</span>",
		"<span class="orange-color">GlossDiv</span>": {
            "<span class="orange-color">title</span>": "<span class="orange-color">S</span>",
			"<span class="orange-color">GlossList</span>": {
                "<span class="orange-color">GlossEntry</span>": {
                    "<span class="orange-color">ID</span>": "<span class="orange-color">SGML</span>",
                         "<span class="orange-color">SortAs</span>": "<span class="orange-color">SGML</span>",
                         "<span class="orange-color">GlossTerm</span>": "<span class="orange-color">Standard Generalized Markup Language</span>",
                         "<span class="orange-color">Acronym</span>": "<span class="orange-color">SGML</span>",
                         "<span class="orange-color">Abbrev</span>": "<span class="orange-color">ISO</span> <span class="blue-color">8879:1986</span>",
                         "<span class="orange-color">GlossDef</span>": {
                         "<span class="orange-color">para</span>": "<span class="orange-color">A meta-markup language, used to create markup languages such as DocBook.</span>",
                              "<span class="orange-color">GlossSeeAlso</span>": ["<span class="blue-color">GML</span>", "<span class="blue-color">XML</span>"]
                    },
                        "<span class="orange-color">GlossSee</span>": "<span class="orange-color">markup</span>"
                }
            }
        }
    }
				...
				<div class="panel">
					...
					<div class="panel-body">
						<div class="html-section">
							<pre data-plugin="highlight"><code class="html hljs xml">
<span class="blue-color"><b>LoadModule</b></span> rewrite_module  modules/mod_rewrite.so
<span class="blue-color"><b>RewriteCond</b></span> <span class="blue-color">%{REQUEST_FILENAME}</span> !-f
<span class="blue-color"><b>RewriteCond</b></span> <span class="blue-color">%{REQUEST_FILENAME}</span> !-d
<span class="blue-color"><b>RewriteRule</b></span> . dashboard_v1.html <span class="orange-color">[NC,L]</span>

<span class="blue-color"><b>&lt;dependency&gt;</b></span>
     <span class="blue-color"><b>&lt;groupId&gt;</b></span>org.apache.camel<span class="blue-color"><b>&lt;/groupId&gt;</b></span>
     <span class="blue-color"><b>&lt;artifactId&gt;</b></span>camel-core<span class="blue-color"><b>&lt;/artifactId&gt;</b></span>
     <span class="blue-color"><b>&lt;version&gt;</b></span>2.15.1<span class="blue-color"><b>&lt;/version&gt;</b></span>
<span class="blue-color"><b>&lt;/dependency&gt;</b></span>

<span class="blue-color"><b>ExpiresActive</b></span> <span class="green-color">On<span class="blue-color">
<span class="blue-color"><b>ExpiresByType</b></span> application/x-javascript  <span class="orange-color">"access plus 1 days"</span>

<span class="blue-color"><b>Order</b></span> Deny,Allow
<span class="blue-color"><b>Allow</b></span> from <span class="green-color">All</span></span></span>
		...
		<script class="nor-js" src="../assets/js/global/bootstrap.min.js"></script>
