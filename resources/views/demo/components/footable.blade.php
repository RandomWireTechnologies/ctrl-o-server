...
<html lang="en">
	<head>
		...
		<title>FooTable | Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<div class="main-content">
			<div class="page-header">
				<div class="header-left-panel">
					<!-- Title Page -->
					<h1 class="page-title">FooTable</h1>
					<!-- Breadcrumb Section -->
					<ol class="breadcrumb">
			...
			<div class="page-content container-fluid">
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="panel">
							<!-- Start Add Remove Rows FooTable Section -->
							<header class="panel-heading">
								<h3 class="panel-title">Footable Normal</h3>
							</header>
							<div class="panel-body">
								<table id="pageFooable" class="table table-bordered table-hover toggle-circle" data-page-size="5">
									<thead>
										<tr>
											<th>Name</th>
											<th>Lastname</th>
							...
							<!-- End Add Remove Rows FooTable Section -->
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="panel">
							<!-- Start Expand And Collapse All Rows FooTable Section -->
							<header class="panel-heading">
								<h3 class="panel-title">Expand / Collapse All Rows</h3>
							</header>
							<div class="panel-body">
								<div class="padding-bottom-15">
									<button id="pageCollapseBtn" type="button" class="btn btn-round btn-info waves-effect waves-light">Collapse All</button>
									<button id="pageExpandBtn" type="button" class="btn btn-round btn-info waves-effect waves-light">Expand All</button>
								</div>
								<table class="table toggle-circle" id="pageAccordion">
									<thead>
										<tr>
									...
									<tbody>
										...
										<tr>
											<td>Vsedf</td>
											<td>Tdfsdfa</td>
											<td>Erara Yesra Uevar Offibe</td>
											<td>05 Mar 2012</td>
											<td>
										...
										<tr>
											<td>Sebja</td>
											<td>Kamewa</td>
											<td>Kemdfa Jemara Lemda Lejajre</td>
											<td>14 jun 2013</td>
											<td>
												<span class="label label-table label-success">Active</span>
											</td>
										...
										<tr>
											<td>Cenfaea</td>
											<td>Gendara</td>
											<td>Kamenre Sefeeba Janda Tennfara</td>
											<td>2 May 2010</td>
											<td>
												<span class="label label-table label-dark">Disabled</span>
											</td>
							...
							<!-- End Expand And Collapse All Rows FooTable Section -->
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="panel">
							<!-- Start Change Page Size FooTable Section -->
							<header class="panel-heading">
								<h3 class="panel-title">Change page size</h3>
							</header>
							<div class="panel-body">
								<label class="form-inline">
									Show
									<select id="pageShow" class="form-control input-md">
								...
								<table class="table toggle-arrow-tiny" id="pagePagination" data-page-size="10">
									<thead>
										<tr>
											<th data-toggle="true">First Name</th>
											<th>Last Name</th>
							...
							<!-- End Change Page Size FooTable Section -->
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="panel">
							<!-- Start Custom Filter FooTable Section -->
							<header class="panel-heading">
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												...
												<select id="pagefilteringStatus" class="form-control">
										...
										<div class="col-sm-6 text-right">
											<div class="form-group">
												<input id="pagefilteringSearch" type="text" placeholder="Search" class="form-control" autocomplete="off">
											</div>
										</div>
									</div>
								</div>
								<table class="table table-bordered table-hover toggle-circle" id="pageFootableFiltering">
									<thead>
										<tr>
											<th data-toggle="true">First Name</th>
											<th>Last Name</th>
							...
							<!-- End Custom Filter FooTable Section -->
						</div>
					</div>
				</div>
			</div>
