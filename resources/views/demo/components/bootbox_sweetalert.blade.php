...
<html lang="en">
	<head>
		...
		<title>Bootbox & Sweetalert | Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<link rel="stylesheet" href="../assets/css/bootbox/sweet-alert.min.css" />
		<link rel="stylesheet" href="../assets/css/bootbox/modal-effect.css" />
		<link rel="stylesheet" href="../assets/css/bootbox/custom.css" />
	</head>
	<body class="dashboard site-navbar-small list">
			...
			<div class="page-content">
				<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">Bootbox</h3>
					</div>
					<div class="panel-body container-fluid">
						<div class="page-wrap">
							<p class="margin-bottom-30">Bootbox.js is a small javaScript library which allows you to create programmatic dialog boxes using bootstrap modals, without having to worry about creating, managing or removing any of the required DOM elements or JS event handlers.</p>
							<div class="row">
								<div class="col-md-5">
									<div class="page-wrap margin-md-0">
										<!--  Examples Bootbox -->
										<h4 class="list-title">Examples</h4>
										<div class="button-wrap modal-btn">
											<button class="btn btn-info waves-effect waves-light" data-type="alert" data-message="Hello world!" data-plugin="bootbox" data-callback="pageBootboxAlertCallback" type="button">Alert</button>
											<button class="btn btn-info waves-effect waves-light" data-type="confirm" data-message="Are you sure?" data-plugin="bootbox" data-callback="pageBootboxConfirmCallback" type="button">Confirm</button>
											<button class="btn btn-info waves-effect waves-light" data-type="prompt" data-title="What is your name?" data-plugin="bootbox" data-callback="pageBootboxPromptCallback" type="button">Prompt</button>
											<button class="btn btn-info waves-effect waves-light" id="pageBootboxPromptDefaultValue" type="button">Prompt with default value</button>
											<button class="btn btn-info waves-effect waves-light" id="pageBootboxCustomDialog" type="button">Custom Dialog</button>
											<button class="btn btn-info waves-effect waves-light" id="pageBootboxCustomHtmlContents" type="button">Custom HTML Contents</button>
											<button class="btn btn-info waves-effect waves-light" id="pageBootboxCustomHtmlForms" type="button">Custom HTML Forms</button>
										</div>
									</div>
								</div>
								<div class="col-md-7">
									<div class="page-wrap margin-bottom-0">
										<!--  Nifty Effects Bootbox -->
										<h4 class="list-title">Work with nifty effects</h4>
										<div class="button-wrap modal-btn">
											<button class="btn btn-info waves-effect waves-light" data-plugin="bootbox" data-title="Triggered by Bootbox" data-message="I am a custom dialog with effects" data-classname="modal-fade-in-scale-up" type="button">Fade in &amp; Scale</button>
											<button class="btn btn-info waves-effect waves-light" data-plugin="bootbox" data-title="Triggered by Bootbox" data-message="I am a custom dialog with effects" data-classname="modal-slide-right" type="button">Slide in from right</button>
											<button class="btn btn-info waves-effect waves-light" data-plugin="bootbox" data-title="Triggered by Bootbox" data-message="I am a custom dialog with effects" data-classname="modal-slide-bottom" type="button">Slide in from bottom</button>
											<button class="btn btn-info waves-effect waves-light" data-plugin="bootbox" data-title="Triggered by Bootbox" data-message="I am a custom dialog with effects" data-classname="modal-news" type="button">Newspaper</button>
											<button class="btn btn-info waves-effect waves-light" data-plugin="bootbox" data-title="Triggered by Bootbox" data-message="I am a custom dialog with effects" data-classname="modal-sign" type="button">3D Sign</button>
											<button class="btn btn-info waves-effect waves-light" data-plugin="bootbox" data-title="Triggered by Bootbox" data-message="I am a custom dialog with effects" data-classname="modal-fall-slide" type="button">Side Fall</button>
											<button class="btn btn-info waves-effect waves-light" data-plugin="bootbox" data-title="Triggered by Bootbox" data-message="I am a custom dialog with effects" data-classname="modal-just" type="button">Just Me</button>
											<button class="btn btn-info waves-effect waves-light" data-plugin="bootbox" data-title="Triggered by Bootbox" data-message="I am a custom dialog with effects" data-classname="modal-3dslit" type="button">3D Slit</button>
											<button class="btn btn-info waves-effect waves-light" data-plugin="bootbox" data-title="Triggered by Bootbox" data-message="I am a custom dialog with effects" data-classname="modal-fall" type="button">Fall</button>
											<button class="btn btn-info waves-effect waves-light" data-plugin="bootbox" data-title="Triggered by Bootbox" data-message="I am a custom dialog with effects" data-classname="modal-flip-vertical" type="button">3D Flip vertical</button>
											<button class="btn btn-info waves-effect waves-light" data-plugin="bootbox" data-title="Triggered by Bootbox" data-message="I am a custom dialog with effects" data-classname="modal-flip" type="button">3D Flip horizontal</button>
											<button class="btn btn-info waves-effect waves-light" data-plugin="bootbox" data-title="Triggered by Bootbox" data-message="I am a custom dialog with effects" data-classname="modal-scalled" type="button">Super Scaled</button>
											<button class="btn btn-info waves-effect waves-light" data-plugin="bootbox" data-title="Triggered by Bootbox" data-message="I am a custom dialog with effects" data-classname="modal-rotate" type="button">3D Rotate Bottom</button>
											<button class="btn btn-info waves-effect waves-light" data-plugin="bootbox" data-title="Triggered by Bootbox" data-message="I am a custom dialog with effects" data-classname="modal-rotate-left" type="button">3D Rotate In Left</button>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">Sweet Alert</h3>
					</div>
					<div class="panel-body container-fluid">
						<div class="row">
							<div class="col-lg-6 col-md-12">
								<div class="sweet-well sweet-height margin-lg-0">
									<!--  Sweet Alert Image -->
									<img class="center" src="../assets/images/sweet-alert.png" alt="...">
								</div>
							</div>
							<div class="col-lg-6 col-md-12">
								<div class="page-wrap margin-bottom-0">
									<!--  Sweet Alert -->
									<h4 class="list-title">Sweet alert styles</h4>
									<p>Here’s a comparison of a standard error message. The first one uses the built-in alert-function, while the second is using sweetalert. sweetalert automatically centers itself on the page and looks great no matter if you're using a desktop computer, mobile or tablet. It's even highly customizable, as you can see below!</p>
									<div class="button-wrap modal-btn">
										<button type="button" class="btn btn-info waves-effect waves-light" id="Basicdata">Basic</button>
										<button type="button" class="btn btn-info waves-effect waves-light" id="CloseTimerdata">Close timer</button>
										<button type="button" class="btn btn-info waves-effect waves-light" id="TitleTextdata">Title text</button>
										<button type="button" class="btn btn-info waves-effect waves-light" id="SuccessMessagedata">Success message</button>
										<button type="button" class="btn btn-info waves-effect waves-light" id="CustomIcondata" data-plugin="sweetalert" data-title="Sweet!" data-text="Here's a custom image." data-image-url="http://i.imgur.com/4NZ6uLY.jpg">Custom icon</button>
									</div>
									<p>A warning message, with a function attached to the "Confirm" button :</p>
									<div class="sweetalert">
										<button type="button" class="btn btn-info waves-effect waves-light" id="pageWarningConfirm">Warning Confirm</button>
									</div>
									<p>Passing a parameter, you can execute something else for "Cancel".</p>
									<div class="sweetalert">
										<button type="button" class="btn btn-info waves-effect waves-light" id="pageWarningCancel">Warning Cancel</button>
									</div>
								</div>
							</div>
						</div>
		...
		<script src="../assets/js/bootbox-page/bootbox.js"></script>
		<script src="../assets/js/bootbox-page/bootbox-sweetalert.min.js"></script>
		<script src="../assets/js/bootbox-page/sweet-alert.min.js"></script>
	</body>
</html>
