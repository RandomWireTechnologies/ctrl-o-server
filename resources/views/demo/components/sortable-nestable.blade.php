...
<html lang="en">
	<head>
		...
		<title>Sortable Nestable | Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<link rel="stylesheet" href="../assets/css/sort-nestable/nestable.min.css" />
	</head>
	<body class="dashboard site-navbar-small">
		...
		<div class="main-content">
			...
			<div class="page-content container-fluid">
					...
					<div class="panel-body">
						<div class="row row-lg">
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!--  Basic Sortable -->
									<h4 class="list-title">Sortable basic</h4>
									<p>Drag and drop an element to a new location within the sortable grid. </p>
									<ul class="list-group sortable list-group-gap js-sortable">
										<li class="list-group-item">
											<span class="badge badge-danger margin-top-5">9</span>
											<span>
											<i class="icon arrow_expand_alt2 btn-info btn-panel" aria-hidden="true"></i>
											</span>  Best smile
										</li>
										<li class="list-group-item">
											<span>
										...
										<li class="list-group-item">
											<span class="badge badge-success margin-top-5">9</span>
											<span>
											<i class="icon arrow_expand_alt2 btn-info btn-panel" aria-hidden="true"></i>
											</span> Lazy bee
										</li>
										<li class="list-group-item">
											<span class="badge btn-dark margin-top-5">7</span>
											<span>
											<i class="icon arrow_expand_alt2 btn-info btn-panel" aria-hidden="true"></i>
											</span> Helping hand
										</li>
										<li class="list-group-item">
											<span>
											<i class="icon arrow_expand_alt2 btn-info btn-panel" aria-hidden="true"></i>
											</span> May the dollars keep rolling round you
										</li>
										<li class="list-group-item">
											<span>
											<i class="icon arrow_expand_alt2 btn-info btn-panel" aria-hidden="true"></i>
											</span> Study your way to glory
										</li>
										<li class="list-group-item">
											<span class="badge btn-info margin-top-5">23</span>
											<span>
											<i class="icon arrow_expand_alt2 btn-info btn-panel" aria-hidden="true"></i>
											</span> Fire on the mountain, run, run, run
										</li>
									</ul>
								</div>
							</div>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!--  Handle Sortable -->
									<h4 class="list-title">Sortable in handle</h4>
									<p>By default, the entire sortable element can be used for drag and drop sorting.  </p>
									<ul class="list-group list-group-gap sortable-with-handle">
										<li class="list-group-item">
											<i class="icon icon_paperclip sortable-handle" aria-hidden="true"></i>
											Best smile
										</li>
										<li class="list-group-item">
											<i class="icon icon_paperclip sortable-handle" aria-hidden="true"></i>                    
										...
										<li class="list-group-item">
											<i class="icon icon_paperclip sortable-handle" aria-hidden="true"></i>                    
											May the dollars keep rolling round you
										</li>
										<li class="list-group-item">
											<i class="icon icon_paperclip sortable-handle" aria-hidden="true"></i>                    
											Study your way to glory
										</li>
										<li class="list-group-item">
											<i class="icon icon_paperclip sortable-handle" aria-hidden="true"></i>                    
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="page-wrap margin-bottom-0">
									...
									<h4 class="list-title">Sortable with task list</h4>
									<p>Sort Tasks by dragging one of them and placed to what part of the list with checkbox when you want to choice it.</p>
									<ul class="list-task list-group sortable margin-bottom-0" data-role="tasklist">
										<li class="list-group-item task-complated" data-role="task">
				...
				<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">Nestable </h3>
					</div>
					<div class="panel-body">
						<div class="row row-lg">
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!--  Basic Nestables -->
									<h4 class="list-title">Basic nestables</h4>
									<p>The nestable allows you to sort items through drag and drop.</p>
									<div class="dd" id="nestable">
										<ol class="dd-list">
											<li class="dd-item" data-id="1">
												<div class="dd-handle">Section 1
													<span class="pull-right text-info">Active</span>
												</div>
												<ol class="dd-list">
													<li class="dd-item" data-id="4">
														<div class="dd-handle">Section 2</div>
													</li>
													<li class="dd-item" data-id="5" data-foo="bar">
														<div class="dd-handle">Section 3</div>
													</li>
												</ol>
											</li>
											<li class="dd-item" data-id="2">
												<div class="dd-handle">Section 4
													<span class="pull-right text-success">Approved</span>
												</div>
											</li>
											<li class="dd-item" data-id="3">
												<div class="dd-handle">Section 5
													<span class="pull-right text-warning">Pending</span>
												</div>
											</li>
											<li class="dd-item" data-id="6">
												<div class="dd-handle">Section 6</div>
												<ol class="dd-list">
													<li class="dd-item" data-id="7">
														<div class="dd-handle">Section 7</div>
														<ol class="dd-list">
															<li class="dd-item" data-id="8">
																<div class="dd-handle">Section 8</div>
															</li>
														</ol>
													</li>
												</ol>
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!--  Deag With Nestables -->
									<h4 class="list-title">Drag with handler</h4>
									<p>By default, the entire nestable element can be used for drag and drop sorting. </p>
									<div class="dd" id="nestabledrag">
										<ol class="dd-list">
											<li class="dd-item dd-item-alt" data-id="1">
												<div class="dd-handle border-sort"><span class="arrow_up-down_alt" aria-hidden="true"></span></div>
												<div class="dd-content">Section 1</div>
												<ol class="dd-list">
													<li class="dd-item dd-item-alt" data-id="4">
														<div class="dd-handle border-sort"><span class="arrow_up-down_alt" aria-hidden="true"></span></div>
														<div class="dd-content">Section 4
														</div>
													</li>
													<li class="dd-item dd-item-alt" data-id="5" data-foo="bar">
														<div class="dd-handle border-sort"><span class="arrow_up-down_alt" aria-hidden="true"></span></div>
														<div class="dd-content">Section 5
														</div>
													</li>
												</ol>
											</li>
											<li class="dd-item dd-item-alt" data-id="2">
												<div class="dd-handle border-sort"><span class="arrow_up-down_alt" aria-hidden="true"></span></div>
												<div class="dd-content">Section 2
												</div>
											</li>
											<li class="dd-item dd-item-alt" data-id="3">
												<div class="dd-handle border-sort"><span class="arrow_up-down_alt" aria-hidden="true"></span></div>
												<div class="dd-content">Section 3
													<span class="pull-right icon arrow_expand_alt2 btn-info btn-panel"></span>
												</div>
											</li>
											<li class="dd-item dd-item-alt" data-id="6">
												<div class="dd-handle border-sort"><span class="arrow_up-down_alt" aria-hidden="true"></span></div>
												<div class="dd-content">Section 6<span class="pull-right icon arrow_expand_alt2 btn-info btn-panel"></span></div>
												<ol class="dd-list">
													<li class="dd-item dd-item-alt" data-id="7">
														<div class="dd-handle border-sort"><span class="arrow_up-down_alt" aria-hidden="true"></span></div>
														<div class="dd-content">Section 7</div>
														<ol class="dd-list">
															<li class="dd-item dd-item-alt" data-id="8">
																<div class="dd-handle border-sort"><span class="arrow_up-down_alt" aria-hidden="true"></span></div>
																<div class="dd-content">Section 8</div>
															</li>
														</ol>
													</li>
												</ol>
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="page-wrap margin-md-0 margin-sm-0">
									...
									<h4 class="list-title">Connected sortable list</h4>
									<p>To be able to sort items from one list to another, multiple lists item drag and drop each list.</p>
									<div class="dd" id="nestablesortable">
										<h5>First List</h5>
										<ol class="dd-list">
											<li class="dd-item" data-id="1">
												<div class="dd-handle">Section 1</div>
											</li>
											<li class="dd-item" data-id="2">
												<div class="dd-handle">Section 2</div>
											</li>
										...
										<ol class="dd-list">
											...
											<li class="dd-item" data-id="7">
												...
												<ol class="dd-list">
													...
													<li class="dd-item" data-id="5" data-foo="bar">
														<div class="dd-handle">Section 9</div>
													</li>
												</ol>
											</li>
											<li class="dd-item" data-id="8">
												<div class="dd-handle">Section 10</div>
											</li>
										</ol>
									</div>
								</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="page-wrap margin-bottom-0">
									<!--  Media With Nestables -->
									<h4 class="list-title">With media content</h4>
									<div class="dd" id="nestablesortablemedia">
										<ol class="dd-list">
											<li class="dd-item dd-item-with-media" data-id="1">
												...
												<div class="dd-content">
													<div class="media">
														<div class="media-body">
															<h4 class="list-title media-heading">Jet misra</h4>
															<small>Web designer</small>
														</div>
														<div class="media-left pic-sort">
															<a class="avatar avatar-online" href="javascript:void(0)">
															<img class="img-responsive" src="../assets/images/global/img_240x265.png"
																alt="image"><i></i>
															</a>
														</div>
													</div>
											...
											<li class="dd-item dd-item-with-media" data-id="2">
												...
												<div class="dd-content">
													<div class="media">
														<div class="media-body">
															<h4 class="list-title media-heading">Garry keo</h4>
											...
											<li class="dd-item dd-item-with-media" data-id="4">
												<div class="dd-handle">Section 3</div>
												<div class="dd-content">
													<div class="media">
														<div class="media-body">
															<h4 class="list-title media-heading">Arafat jan</h4>
												...
												<ol class="dd-list">
													<li class="dd-item dd-item-with-media" data-id="3">
														...
														<div class="dd-content">
															<div class="media">
																<div class="media-body">
																	<h4 class="list-title media-heading">Ricky sen</h4>
																	<small>SEO</small>
																</div>
																<div class="media-left pic-sort">
													...
													<li class="dd-item dd-item-with-media" data-id="3">
														...
														<div class="dd-content">
															<div class="media">
																<div class="media-body">
																	<h4 class="list-title media-heading">Luke parth</h4>
																	<small>Graphics designer</small>
																</div>
																<div class="media-left pic-sort">
																	<a class="avatar avatar-away" href="javascript:void(0)">
																	<img class="img-responsive" src="../assets/images/global/img_240x265.png" alt="image"><i></i>
																	</a>
																</div>
															</div>
														</div>
		...
		<script src="../assets/js/sort-nesttable/html.sortable.min.js"></script>
		<script src="../assets/js/sort-nesttable/jquery.nestable.js"></script>
		<script src="../assets/js/sort-nesttable/tasklist.min.js"></script>
		<script src="../assets/js/sort-nesttable/custom.js"></script>
	</body>
</html>
