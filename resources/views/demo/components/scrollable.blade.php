...
<html lang="en">
	<head>
		...
		<title>Scrollable | Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<!-- Page CSS -->
		<link href="../assets/css/scrollable/scrollab.min.css" rel="stylesheet" type="text/css" />
	</head>
	<body class="dashboard site-navbar-small">
		...
		<div class="main-content">
			<div class="page-header">
				<div class="header-left-panel">
					<!--  Title Page -->
					<h1 class="page-title">Scrollable</h1>
					<!--  Breadcrumb Section -->
					<ol class="breadcrumb">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="page-wrap">
									...
									<div class="scrollab-page">
										<div class="is-enabled scrollable-vertical" data-plugin="scrollable">
											<div data-role="container" class="scroll-con" style="height: 300px;">
												<div data-role="content" class="scroll-con">
											...
											<div class="scrollable-bar scrollable-bar-hide" draggable="false">
												<div class="scrollable-bar-handle" style="height: 107.617px; transform: translate3d(0px, 0px, 0px);"></div>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-sm-6">
								<div class="page-wrap">
									<!--  Shadow Scroll -->
									<h4 class="list-title">Shadow</h4>
									<div class="scrollab-page">
										<div class="is-enabled scrollable-vertical is-hovering" data-skin="scrollable-shadow" data-plugin="scrollable">
											<div data-role="container" class="scrollable-container" style="height: 291px; width: 710px;">
												<div data-role="content" class="scrollable-content" style="width: 693px;">
													<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus.</p>
													<p> Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum.</p>
													<p> Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus. Nullam quis ante. Etiam sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh. Donec sodales sagittis magna. Sed consequat, leo eget bibendum sodales, augue velit cursus nunc, quis gravida magna mi a libero. Fusce vulputate eleifend sapien. Vestibulum purus quam, scelerisque ut, mollis sed, nonummy id, metus. Nullam accumsan lorem in dui. Cras ultricies mi eu turpis hendrerit fringilla.</p>
													<p> Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; In ac dui quis mi consectetuer lacinia. Nam pretium turpis et arcu. Duis arcu tortor, suscipit eget, imperdiet nec, imperdiet iaculis, ipsum. Sed aliquam ultrices mauris. Integer ante arcu, accumsan a, consectetuer eget, posuere ut, mauris. Praesent adipiscing. Phasellus ullamcorper ipsum rutrum nunc. Nunc nonummy metus. Vestibulum volutpat pretium libero. Cras id dui. Aenean ut eros et nisl sagittis vestibulum. Nullam nulla eros, ultricies sit amet, nonummy id, imperdiet feugiat, pede.</p>
							...
							<div class="col-sm-6">
								<div class="page-wrap">
									<!--  Direction Scroll -->
									<h4 class="list-title"> Both Direction</h4>
									<div class="scrollab-page image-scrollable">
										<div class="is-enabled scrollable-vertical scrollable-horizontal" data-plugin="scrollable" data-direction="both" style="height: 294px;">
											<div data-role="container" style="height: 282px;">
												<div data-role="content" style="height: 300px;">
													<img src="../assets/images/scrollab/img_1600x900.jpg" alt="image-scrollable">
												</div>
											</div>
										</div>
									</div>
							...
							<div class="col-sm-6">
								<div class="page-wrap">
									...
									<h4 class="list-title">Dynamic Content</h4>
									<p>Click "Append Content" button then add text them disply the content with a scrollbar.</p>
									<button type="button" class="btn btn-info waves-effect waves-light margin-bottom-15" id="btnPageDynamicAppend">APPEND CONTENT</button>
									<div class="scrollab-page">
										<div id="pageDynamic" data-plugin="scrollable" style="height: 253px;">
											<div data-role="container">
												<div id="PageDynamicContent" data-role="content">
							...
							<div class="col-sm-6">
								<div class="page-wrap">
									<!--  Inverse Skin Scroll -->
									<h4 class="list-title">Inverse Skin</h4>
									<p>Inverse skin used in a change background and color. </p>
									<div class="scrollab-page dark-scrollab">
										<div class="is-enabled scrollable-vertical" data-skin="scrollable-inverse" data-plugin="scrollable">
											<div data-role="container" style="height: 300px; width: 710px;">
												<div data-role="content" style="width: 693px;">
													<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus.</p>
													<p> Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum.</p>
													<p> Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus. Nullam quis ante. Etiam sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh. Donec sodales sagittis magna. Sed consequat, leo eget bibendum sodales, augue velit cursus nunc, quis gravida magna mi a libero. Fusce vulputate eleifend sapien. Vestibulum purus quam, scelerisque ut, mollis sed, nonummy id, metus. Nullam accumsan lorem in dui. Cras ultricies mi eu turpis hendrerit fringilla.</p>
													<p> Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; In ac dui quis mi consectetuer lacinia. Nam pretium turpis et arcu. Duis arcu tortor, suscipit eget, imperdiet nec, imperdiet iaculis, ipsum. Sed aliquam ultrices mauris. Integer ante arcu, accumsan a, consectetuer eget, posuere ut, mauris. Praesent adipiscing. Phasellus ullamcorper ipsum rutrum nunc. Nunc nonummy metus. Vestibulum volutpat pretium libero. Cras id dui. Aenean ut eros et nisl sagittis vestibulum. Nullam nulla eros, ultricies sit amet, nonummy id, imperdiet feugiat, pede.</p>
								...
								<div class="row">
									<div class="col-sm-6">
										<div class="page-wrap margin-bottom-0">
											<!--  API Direction Scroll -->
											<h4 class="list-title">Api Operation</h4>
											<div class="scrollab-page">
												<div class="" id="pageScollableApi" data-plugin="scrollable" style="position: relative;">
													<div data-role="container" class="scrollable-container" style="height: 300px; width: 710px;">
														<div data-role="content" class="scrollable-content" style="width: 693px;">
															<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus.</p>
															<p> Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum.</p>
															<p> Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus. Nullam quis ante. Etiam sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh. Donec sodales sagittis magna. Sed consequat, leo eget bibendum sodales, augue velit cursus nunc, quis gravida magna mi a libero. Fusce vulputate eleifend sapien. Vestibulum purus quam, scelerisque ut, mollis sed, nonummy id, metus. Nullam accumsan lorem in dui. Cras ultricies mi eu turpis hendrerit fringilla.</p>
									...
									<div class="col-sm-6">
										<div class="scrollable-button api-scroll-by padding-top-30">
											<button class="api-scroll-to btn btn-info waves-effect waves-light" data-to="0" type="button">Scroll to 0</button>
											<button class="api-scroll-to btn btn-info waves-effect waves-light" data-to="50" type="button">Scroll to 50</button>
											<button class="api-scroll-to btn btn-info waves-effect waves-light" data-to="0%" type="button">Scroll to 0%</button>
											<button class="api-scroll-to btn btn-info waves-effect waves-light" data-to="100%" type="button">Scroll to 100%</button>
											<button class="api-scroll-to btn btn-info waves-effect waves-light" data-to="50%" type="button">Scroll to 50%</button>
											<button class="api-scroll-by btn btn-info waves-effect waves-light" data-by="10" type="button">Scroll by 10</button>
											<button class="api-scroll-by btn btn-info waves-effect waves-light" data-by="+10" type="button">Scroll by +10</button>
											<button class="api-scroll-by btn btn-info waves-effect waves-light" data-by="-10" type="button">Scroll by -10</button>
											<button class="api-scroll-by btn btn-info waves-effect waves-light" data-by="10%" type="button">Scroll by 10%</button>
											<button class="api-scroll-by btn btn-info waves-effect waves-light" data-by="+10%" type="button">Scroll by +10%</button>
		...
		<!-- Page JavaScript -->
		<script src="../assets/js/scrollable/jquery-asHoverScroll.min.js" type="text/javascript"></script>
		<script src="../assets/js/global/jquery.asScrollable.all.min.js"></script>
		<script src="../assets/js/home-page/asscrollable.min.js" type="text/javascript"></script>
		<script src="../assets/js/global/jquery-asScroll.min.js" type="text/javascript"></script>
		<script src="../assets/js/home-page/scrollable.min.js" type="text/javascript"></script>
	</body>
</html>
