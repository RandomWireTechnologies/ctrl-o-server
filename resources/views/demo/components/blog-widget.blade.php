...
<html lang="en">
	<head>
		...
		<title>Blog Widgets| Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<!-- Page plugin CSS -->
		<link rel="stylesheet" href="../assets/css/timeline/plyr.min.css">
		<link rel="stylesheet" href="../assets/plugin/magnific-popup/css/magnific-popup.min.css">
	</head>
	<body class="blogwidget site-navbar-small">
		...
		<div class="main-content">
			<div class="page-header">
				<div class="header-left-panel">
					<!-- Title Page -->
					<h1 class="page-title">Blog widgets</h1>
					<!-- Breadcrumb Section -->
					<ol class="breadcrumb">
						<li><a href="../dashboard_v1.html">Home</a></li>
						<li class="text-info">Widgets</li>
						<li class="active">Blog widgets</li>
					</ol>
				</div>
			</div>
			<div class="page-content blog-widget">
				<div class="row">
					<div class="col-md-6 col-sm-12">
						<div class="row">
										...
										<div class="widgett-info v-align">
											<div class="align-middle padding-15">
												<div class="inner-middle">
													...
													<a class="btn btn-info widgett-readmore waves-effect waves-light" href="javascript:void(0)">View Post</a>
												</div>
											</div>
										</div>
									</div>
									<div class="widgett-body">
										<div class="widgett-body-footer margin-top-0">
											<div class="row">
												<div class="col-md-6 col-xs-6 col-lg-6 widgett-actions text-left margin-top-0" style="text-align: left;">
													<a href="javascript:void(0)" class=""><i class="icon_like" aria-hidden="true"></i><span> Like</span></a>
													<a href="javascript:void(0)" class="margin-right-0"><i class="icon_comment_alt" aria-hidden="true"></i><span> Comment </span></a>
												</div>
												<div class="col-md-6 col-xs-6 col-lg-6 widgett-actions text-right margin-top-0">
													<a href="javascript:void(0)" class="margin-right-0">
													<i class="icon_comment" aria-hidden="true"></i>
													<span>2500</span>
													</a>
													<a href="javascript:void(0)" class=" margin-left-10 margin-right-0">
							...
							<div class="col-md-12 col-sm-12">
								<div class="widgett widgett-article cover widgett-shadow">
									<!-- Blockquote With Blog Widget -->
									<div class="widgett-header cover padding-0">
										<div class="background-cover padding-15" style="background-image: url('../assets/images/timeline/img_960x640.jpg')">
											<blockquote class="quote-cover padding-left-35 padding-horizontal-10 white gray_templte-gray">Malesuada vulputate nunc. Facilisi maecenas ridiculus varius hymenaeos euismod. Vestibulum ligula suspendisse conubia at ipsum facilisis potenti Rutrum dignissim tellus pede.</blockquote>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-md-12 col-sm-12">
								<div class="widgett widgett-article widgett-shadow">
									<!-- Description With Blog Widget -->
									<div class="widgett-header cover padding-0">
										<img class="image-cover" src="../assets/images/blog/img_1500x600.jpg" alt="blog-image">
									</div>
									<div class="widgett-body">
										<h3 class="widgett-title">Lorem Ipsum</h3>
										<p class="widgett-metas">
											<span class="widgett-time">MAY 15, 2016</span>
										</p>
										<p>Fermentum diam fames massa ad consequat cum ornare gravida nascetur fames ullamcorper leo morbi metus non commodo augue neque torquent faucibus hac mus interdum viverra. Erat pede, lectus mattis ornare, nunc magnis auctor morbi mus platea aliquet Sodales vehicula euismod praesent ante fames vehicula lacinia phasellus turpis fringilla morbi integer ridiculus semper ultricies dis massa nisl pretium aenean Tristique dignissim. </p>
										<a class="btn btn-info widgett-readmore waves-effect waves-light" href="javascript:void(0)">Read More</a>
										<div class="widgett-body-footer">
											<div class="row">
												<div class="col-md-6 col-xs-6 col-lg-6 widgett-actions text-left margin-top-0" style="text-align: left;">
													<a href="javascript:void(0)" class=""><i class="icon_like" aria-hidden="true"></i><span> Like</span></a>
													<a href="javascript:void(0)" class="margin-right-0"><i class="icon_comment_alt" aria-hidden="true"></i><span> Comment </span></a>
							...
							<div class="col-md-12 col-sm-12">
								<div class="widgett widgett-article cover widgett-shadow">
									<!-- Blockquote With Description Blog Widget -->
									<div class="widgett-header cover padding-0">
										<div class="background-cover padding-15" style="background-image: url('../assets/images/timeline/img_960x640.jpg')">
											<blockquote class="quote-cover padding-left-35 padding-horizontal-10 white gray_templte-gray">Malesuada vulputate nunc. Facilisi maecenas ridiculus varius hymenaeos euismod. Vestibulum ligula suspendisse conubia at libero Sollicitudin ipsum facilisis potenti.</blockquote>
										</div>
									</div>
									<div class="widgett-body">
										<h3 class="widgett-title">Lorem Ipsum</h3>
							...
							<div class="col-md-12 col-sm-12">
								<div class="widgett widgett-article widgett-shadow">
									<div class="widgett-header cover padding-0 overlap">
										<!-- Image With Description Blog Widget -->
										<img class="image-cover" src="../assets/images/blog/img_890x500.jpg" alt="blog-image">
										<div class="widgett-info v-align">
											<div class="align-middle padding-15 padding-sm-0">
												<div class="inner-middle">
													<h3>Lorem ipsum dolor</h3>
					...
					<div class="col-md-6 sol-sm-12">
						<div class="row">
							<div class="col-md-12 col-sm-12">
								<div class="widgett widgett-article widgett-shadow">
									<!-- Image With Notification Blog Widget -->
									<div class="widgett-header cover padding-0">
										<img class="image-cover" src="../assets/images/blog/img_1500x600.jpg" alt="blog-image">
									</div>
									<div class="widgett-body">
										<p>Fames venenatis egestas. Posuere sodales nunc. Integer mauris facilisis eros diam cras Elementum nunc vulputate ante penatibus, enim id eget semper urna tristique magnis aliquam. Sodales mi nisi facilisi.</p>
										<div class="message-box margin-bottom-10">
											<a href="#" class="media">
												<div class="media-left user-img padding-right-0"> <img src="../assets/images/global/img_240x265.png" alt="blog-user" class="margin-top-5"> <span class="profile-status status-online pull-right profile-sm-status"></span> </div>
												<div class="media-body msg-detail">
													<small class="text-info pull-right">Just now</small>
													<p class="text-info">@ Jack Thomas</p>
													<p> Erat pede, lectus mattis ornare, nunc magnis auctor morbi mus platea aliquet Sodales vehicula euismod praesent ante pede. </p>
												</div>
											</a>
											<a href="#" class="media">
												...
												<div class="media-body msg-detail">
													<small class="text-info pull-right">2 hours ago</small>
													<p class="margin-bottom-5 text-info">@ Amati Sean</p>
													<p>Dapibus non, ipsum dui at nam. Nam bibendum fermentum gravida. Sociis proin phasellus id ullamcorper, velit ultrici.</p>
												</div>
											</a>
										</div>
										<a class="btn btn-info widgett-readmore waves-effect waves-light" href="javascript:void(0)">View Post</a>
							...
							<div class="col-md-12 col-sm-12">
								<div class="widgett widgett-article widgett-shadow">
									<!-- Multiple Image With Description Blog Widget -->
									<div class="widgett-header cover padding-0">
										<div class="row">
											<div class="img-blog-dash">
												<div class="col-md-4 col-sm-4 col-xs-4 padding-0">
													<div class="overlap-media">
														<a class="media_zoom_image" href="../assets/images/media/img_720x480.jpg">
														<img class="image-cover overlap-figure overlap-scale" src="../assets/images/media/img_720x480.jpg" alt="blog-image">
														</a>
													</div>
												</div>
												<div class="col-md-4 col-sm-4 col-xs-4  padding-0">
													<div class="overlap-media">
														<a class="media_zoom_image" href="../assets/images/media/img_720x480.jpg">
														<img class="image-cover" src="../assets/images/media/img_720x480.jpg" alt="blog-image">
														</a>
													</div>
												</div>
												<div class="col-md-4 col-sm-4 col-xs-4  padding-0">
									...
									<div class="widgett-body">
										...
										<a class="btn btn-info widgett-readmore waves-effect waves-light" href="javascript:void(0)">View More</a>
										<div class="widgett-body-footer">
											<div class="row">
												<div class="col-md-6 col-xs-6 col-lg-6 widgett-actions text-left margin-top-0" style="text-align: left;">
													<a href="javascript:void(0)" class=""><i class="icon_like" aria-hidden="true"></i><span> Like</span></a>
							...
							<div class="col-md-12 col-sm-12">
								<div class="widgett widgett-article cover widgett-shadow">
									<!-- Audio With Description Blog Widget -->
									<div class="widgett-header cover padding-0">
							...
							<div class="clearfix"></div>
							<div class="col-md-12 col-sm-12">
								<div class="widgett widgett-article widgett-shadow margin-bottom-0">
									<!-- Image With Notification Blog Widget -->
									<div class="widgett-left left-img-widgett">
										<img class="image-cover" src="../assets/images/blog/img_650x650.jpeg" alt="blog-image">
									</div>
									<div class="widgett-body">
										<h3 class="widgett-title">Lorem Ipsum</h3>
										<p class="widgett-metas">
										...
										<p>Fermentum diam fames massa ad consequat cum ornare gravida nascetur fames ullamcorper leo morbi metus non commodo augue neque torquent faucibus hac mus interdum viverra. Erat pede, lectus mattis ornare, nunc magnis auctor morbi mus platea aliquet Sodales vehicula euismod praesent ante integer ridiculus. </p>
									...
									<div class="widgett-body">
										<div class="message-box margin-bottom-10">
											<a href="#" class="media">
												<div class="media-left user-img padding-right-0"> <img src="../assets/images/global/img_240x265.png" alt="user" class="margin-top-5"> <span class="profile-status status-away pull-right profile-sm-status"></span> </div>
												<div class="media-body msg-detail">
													<small class="text-info pull-right">Yesterday</small>
													<p class="margin-bottom-5 text-info">@ Fable Deane</p>
													<p>Ad ultrices torquent odio fames auctor. Mattis pede eleifend convallis luctus tempor arcu sagittis. Non, non arcu molestie eu integer.</p>
												</div>
											</a>
											<a href="#" class="media">
												...
												<div class="media-body msg-detail">
													<small class="text-info pull-right">Yesterday</small>
													<p class="margin-bottom-5 text-info">@ Veblen
													</p>
													<p>Quis bibendum facilisi a potenti aptent pulvinar nulla iaculis class.Dapibus sodales, hac faucibus molestie nibh nibh in dictumst luctus.</p>
												</div>
											</a>
										</div>
										<a class="btn btn-info widgett-readmore waves-effect waves-light" href="javascript:void(0)">View More</a>
		...
		<script src="../assets/js/timeline/plyr.js"></script>
		...
		<script src="../assets/js/timeline/plyr.min.js"></script>
	</body>
</html>
