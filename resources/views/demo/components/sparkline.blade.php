...
<html lang="en">
	<head>
		...
		<title>Sparkline Chart| Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="sparkline-page site-navbar-small">
		...
		<div class="main-content">
			<div class="page-header">
				<div class="header-left-panel">
					<!-- Title Page -->
					<h1 class="page-title">Sparkline chart</h1>
					<!-- Breadcrumb Section -->
					<ol class="breadcrumb">
			...
			<div class="page-content container-fluid">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-sm-6 col-lg-3">
								<div class="page-wrap margin-lg-0">
									<div class="text-center">
										<!-- Pie Sparkline Chart -->
										<h4 class="list-title">Pie Chart</h4>
										<div class="basic-pie-chart"></div>
									</div>
								</div>
							</div>
							<div class="col-sm-6 col-lg-3">
								<div class="page-wrap margin-lg-0">
									<div class="text-center">
										...
										<h4 class="list-title">Line Chart</h4>
										<div class="basic-line-chart"></div>
									</div>
								</div>
							</div>
							<div class="col-sm-6 col-lg-3">
								<div class="page-wrap margin-lg-0 margin-sm-0 margin-md-0">
									<div class="text-center">
										<!-- Bar Sparkline Chart -->
										<h4 class="list-title">Bar Chart</h4>
							...
							<div class="col-sm-6 col-lg-3">
								<div class="page-wrap">
									<div class="text-center">
										<!-- Composite Sparkline Chart -->
										<h4 class="list-title">Compositie Chart</h4>
										<div class="basic-compositebar-chart">3,2,6,5,3,1,4,7,8,4</div>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="panel">
					<header class="panel-heading">
						<h3 class="panel-title">Chart Types</h3>
					</header>
					<div class="panel-body">
						<div class="row">
							<div class="sparkline">
								<div class="col-sm-4 col-lg-3">
									<div class="page-wrap">
										<div class="text-center">
											...
											<h4 class="list-title">Inline</h4>
											<span class="sparkline-line">10,9,8,2,6,7,4</span>
										</div>
									</div>
								</div>
								<div class="col-sm-4 col-lg-3">
									<div class="page-wrap">
										<div class="text-center">
											<!-- Line graphs Sparkline Chart -->
											<h4 class="list-title">Line graphs</h4>
											<span class="sparkline-line">8,7,3,0,0,0,1,1,3,4,10,10,10,10,10,0,0,0,4,6,5</span>
										</div>
									</div>
								</div>
								<div class="col-sm-4 col-lg-3">
									<div class="page-wrap">
										<div class="text-center">
											<!-- Bar Chart -->
											<h4 class="list-title">Bar charts</h4>
											<span class="sparkline-bar">8,5,3,2,4,7,6</span>
										</div>
									</div>
								</div>
								<div class="col-sm-4 col-lg-3">
									<div class="page-wrap">
										<div class="text-center">
											<!-- Nagative Chart -->
											<h4 class="list-title">Nagative values</h4>
											<span class="sparkline-bar">-3,4,3,0,-3,1</span>
										</div>
									</div>
								</div>
								<div class="col-sm-4 col-lg-3">
									<div class="page-wrap">
										<div class="text-center">
											...
											<span class="sparkline-bar">0:3,3:2,4:2,2:1</span>
										</div>
									</div>
								</div>
								<div class="col-sm-4 col-lg-3">
									<div class="page-wrap">
										<div class="text-center">
											<!-- Composite Chart -->
											<h4 class="list-title">Composite inline</h4>
											<span class="sparkline-compositeline">7,2,0,2,0,2,3,5,5,9,5,9,0,0,3,7,3,7,8</span>
										</div>
									</div>
								</div>
								<div class="col-sm-4 col-lg-3">
									<div class="page-wrap">
										<div class="text-center">
											<!-- Inline With Range Chart -->
											<h4 class="list-title">Inline with range</h4>
											<span class="sparkline-inlinerange">8,3,2,0,9,4,6,10,5,9,4,10,9,0,6,0,4</span>
										</div>
									</div>
								</div>
								<div class="col-sm-4 col-lg-3">
									<div class="page-wrap">
										<div class="text-center">
											<!-- Composite Sparkline Chart -->
											<h4 class="list-title">Composite bar</h4>
											<span class="sparkline-compositebar">5,4,8,7,2,4,3,1,5</span>
										</div>
									</div>
								</div>
								<div class="col-sm-4 col-lg-3">
									<div class="page-wrap">
										<div class="text-center">
											<!-- Discrete Sparkline Chart -->
											<h4 class="list-title">Discrete</h4>
											<span class="sparkline-discrete1">4,5,6,7,6,6,2,4,5,4,6,7,7,4,3,2,1,4,6,2,4,5,4,6,7,7,4,3,2,1,4,4,5,4,6,7,7,4,3,2,1</span>
										</div>
									</div>
								</div>
								<div class="col-sm-4 col-lg-3">
									<div class="page-wrap">
										<div class="text-center">
											<!-- Discrete With Threshold Sparkline Chart -->
											<h4 class="list-title">Discrete with threshold</h4>
											<span class="sparkline-discrete2">4,5,6,7,6,6,2,4,5,4,6,7,7,4,3,2,1,4,6,2,4,5,4,6,7,7,4,3,2,1,4,4,5,4,6,7,7,4,3,2,1</span>
										</div>
									</div>
								</div>
								<div class="col-sm-4 col-lg-3">
									<div class="page-wrap">
										<div class="text-center">
											<!-- Bullet Sparkline Chart -->
											<h4 class="list-title">Bullet charts</h4>
											<span class="sparkline-bullet">10,12,12,9,7</span>
											<br/>
											<span class="sparkline-bullet">10,12,14,9,7</span>
										</div>
									</div>
								</div>
								<div class="col-sm-4 col-lg-3">
									<div class="page-wrap">
										<div class="text-center">
											<!-- Customize Sparkline Chart -->
											<h4 class="list-title">Customize</h4>
											<span class="sparkline-linecustom">10,7,6,9,4,7,5,3</span>
										</div>
									</div>
								</div>
								...
								<div class="col-sm-4 col-lg-3">
									<div class="page-wrap">
										<div class="text-center">
											<!-- Trisitate Sparkline Chart -->
											<h4 class="list-title">Tristate charts</h4>
								...
								<div class="col-sm-4 col-lg-3">
									<div class="page-wrap">
										<div class="text-center">
											<!-- Tristate with colour map Sparkline Chart -->
											<h4 class="list-title">Tristate with colour map</h4>
								...
								<div class="col-sm-4 col-lg-3">
									<div class="page-wrap">
										<div class="text-center">
											<!-- Box Plot Sparkline Chart -->
											<h4 class="list-title">Box Plot</h4>
								...
								<div class="col-sm-4 col-lg-3">
									<div class="page-wrap margin-small-0">
										<div class="text-center">
											<!-- Pre computed Box  SparklineChart -->
											<h4 class="list-title">Pre-computed box</h4>
											<span class="sparkline-boxplotraw">Loading..</span>
										</div>
									</div>
								</div>
								...
								<div class="col-sm-4 col-lg-3">
									<div class="page-wrap margin-md-0 margin-sm-0">
										<div class="text-center">
											<!-- Pie Chart Gray Sparkline Chart -->
											<h4 class="list-title">Pie chart gray</h4>
											<span class="sparkline-pie-1">5,3</span>
										</div>
									</div>
								</div>
								<div class="col-sm-4 col-lg-3">
		...
		<script src="../assets/js/sparkline/custom-sparkline.js" type="text/javascript"></script>
	</body>
</html>
