...
<html lang="en">
	<head>
		...
		<title>Ribbon | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="dashboard site-navbar-small">
		...
		<div class="main-content">
			...
			<div class="page-content container-fluid">
				<div class="panel">
					<div class="panel-body contain-ribbon page-wrap">
						<!-- Pure Ribbon -->
						<h4 class="list-title">Pure ribbon</h4>
						<p class="margin-bottom-20">Pure ribbons have shared markup, starting with the default <code>.pure-ribbons</code> class, as well as shared states. swap modifier classes <code>.pure-ribbon-left</code> and right to switch ribbon direction. add any of the below mentioned modifier classes (example, <code>.pure-ribbon-gray</code> and <code>.pure-ribbon-success</code> and ...) to change the appearance of a ribbon color.
						</p>
						<div class="row">
							<div class="page-wrap">
								<div class="col-lg-2 col-sm-4 col-xs-12">
									<div class="ribbon-box ribbon-box-top ">
										<span class="pure-ribbon pure-ribbon-left pure-ribbon-gray"></span>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
									</div>
								</div>
								<div class="col-lg-2 col-sm-4 col-xs-12">
									<div class="ribbon-box ribbon-box-top ">
										<span class="pure-ribbon pure-ribbon-left pure-ribbon-success"></span>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
									</div>
								</div>
								<div class="col-lg-2 col-sm-4 col-xs-12">
									<div class="ribbon-box ribbon-box-top ">
										<span class="pure-ribbon pure-ribbon-left pure-ribbon-primary"></span>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
									</div>
								</div>
								<div class="col-lg-2 col-sm-4 col-xs-12">
									<div class="ribbon-box ribbon-box-top ">
										<span class="pure-ribbon pure-ribbon-warning"></span>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
									</div>
								</div>
								<div class="col-lg-2 col-sm-4 col-xs-12">
									<div class="ribbon-box ribbon-box-top">
										<span class="pure-ribbon pure-ribbon-info"></span>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
									</div>
								</div>
								<div class="col-lg-2 col-sm-4 col-xs-12">
									<div class="ribbon-box ribbon-box-top margin-bottom-0">
										<span class="pure-ribbon pure-ribbon-danger"></span>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
									</div>
								</div>
							</div>
					...
					<div class="panel-body contain-ribbon page-wrap">
						<!-- Flat Ribbon -->
						<h4 class="list-title">Flat ribbon</h4>
						<p>You can use flat ribbons to the top by using <code>.flat-ribbon</code> utility classes. add any of the below mentioned modifier classes (example, <code>.flat-ribbon-gray</code> and <code>.flat-ribbon-success</code> and ...) to change the appearance of a ribbon color.</p>
						<div class="row">
							<div class="page-wrap flat-border">
								<div class="col-lg-4 col-sm-6 col-xs-12">
									<div class="ribbon-box ribbon-box-top flat-ribbon-margin">
										<div class="flat-ribbon flat-ribbon-gray">Ribbon gray</div>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Cum sociis natoque penatibus et magnis dis parturient.
										<p>
									</div>
								</div>
								<div class="col-lg-4 col-sm-6 col-xs-12">
									<div class="ribbon-box ribbon-box-top flat-ribbon-margin">
										<div class="flat-ribbon flat-ribbon-success">Ribbon success</div>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Cum sociis natoque penatibus et magnis dis parturient.
										<p>
									</div>
								</div>
								<div class="col-lg-4 col-sm-6 col-xs-12">
									<div class="ribbon-box ribbon-box-top flat-ribbon-margin">
										<div class="flat-ribbon flat-ribbon-primary">Ribbon primary</div>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Cum sociis natoque penatibus et magnis dis parturient.
										<p>
									</div>
								</div>
								<div class="col-lg-4 col-sm-6 col-xs-12">
									<div class="ribbon-box ribbon-box-top flat-ribbon-margin">
										<div class="flat-ribbon flat-ribbon-warning">Ribbon warning</div>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Cum sociis natoque penatibus et magnis dis parturient.
										<p>
									</div>
								</div>
								<div class="col-lg-4 col-sm-6 col-xs-12">
									<div class="ribbon-box ribbon-box-top flat-ribbon-margin">
										<div class="flat-ribbon flat-ribbon-info">Ribbon info</div>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Cum sociis natoque penatibus et magnis dis parturient.
										<p>
									</div>
								</div>
								<div class="col-lg-4 col-sm-6 col-xs-12">
									<div class="ribbon-box ribbon-box-top flat-ribbon-margin margin-bottom-0">
										<div class="flat-ribbon flat-ribbon-danger">Ribbon danger</div>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Cum sociis natoque penatibus et magnis dis parturient.
										<p>
									</div>
								</div>
					...
					<div class="panel-body contain-ribbon page-wrap">
						<!-- Animation Ribbon -->
						<h4 class="list-title">Animation ribbon</h4>
						<p>You can use animation ribbons by using <code>.global-math</code> utility classes. the below mentioned modifier classes (example, <code>.plane-info</code> and <code>.plane-success</code> and ...) to change the appearance of a ribbons color.</p>
						<div class="row">
							<div class="page-wrap flat-border">
								<div class="col-lg-4 col-sm-4 col-xs-12">
									<div class="ribbon-box animation-box">
										<div class="global-math">
											<div class="mask top-math">
												<div class="plane plane-info"></div>
											</div>
											<div class="mask middle-top-math">
												<div class="plane plane-info"></div>
											</div>
											<div class="mask middle-down-math">
												<div class="plane plane-info"></div>
											</div>
											<div class="mask bottom-math">
												<div class="plane plane-info"></div>
											</div>
										</div>
									</div>
								...
								<div class="col-lg-4 col-sm-4 col-xs-12">
									<div class="ribbon-box animation-box">
										<div class="global-math">
											<div class="mask top-math">
												<div class="plane plane-success"></div>
											</div>
											<div class="mask middle-top-math">
												<div class="plane plane-success"></div>
											</div>
								...
								<div class="col-lg-4 col-sm-4 col-xs-12">
									<div class="ribbon-box animation-box margin-bottom-0">
										<div class="global-math">
											<div class="mask top-math">
												<div class="plane plane-danger"></div>
											</div>
											<div class="mask middle-top-math">
												<div class="plane plane-danger"></div>
											</div>
					...
					<div class="panel-body contain-ribbon page-wrap">
						<!-- Side Ribbon -->
						<h4 class="list-title">Side ribbon</h4>
						<p>A neatly CSS crafted ribbon for side edge containers of products or services that are on sale. it is subtly designed as a short ribbon so as to not cover the content of the product/service’s card. Use <code>.left-side-ribbon</code> class to quickly switch a left and right side styled ribbons.</p>
						<div class="row">
							<div class="page-wrap side-border">
								<div class="col-lg-3 col-sm-6 col-xs-12">
									<div class="ribbon-box ribbon-big-box ">
										<div class="left-side-ribbon ribbon-box-bottom">Ribbon gray</div>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
									</div>
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12">
									<div class="ribbon-box ribbon-big-box ">
										<div class="right-ribbon ribbon-box-bottom right-ribbon-info">Ribbon info</div>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
									</div>
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12">
									<div class="ribbon-box ribbon-box-top ">
										<div class="left-side-ribbon ribbon-top side-ribbon-danger">Ribbon danger</div>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
									</div>
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12">
									<div class="ribbon-box ribbon-box-top margin-bottom-0">
										<div class="right-ribbon ribbon-top side-ribbon-warning">Ribbon warning</div>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
									</div>
								</div>
							</div>
					...
					<div class="panel-body contain-ribbon last-box-ribbon">
						<!-- Clip Ribbon -->
						<h4 class="list-title">Clip ribbon</h4>
						<p>A clever design of a menu featured by nice right sided pure CSS ribbon elements featuring icon fonts to represent each of the items.use <code>.ribbon-clip</code> class to quickly switch a clip styled ribbons, add <code>.ribbon-top</code> to switch the ribbon direction.</p>
						<div class="row">
							<div class="page-wrap">
								<div class="col-lg-3 col-sm-6 col-xs-12">
									<div class="ribbon-box ribbon-big-box">
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
										<div class="ribbon ribbon-clip btn-warning">
											<div class="ribbon-button">Ribbon warning</div>
										</div>
									</div>
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12">
									<div class="ribbon-box ribbon-big-box">
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
										<div class="ribbon btn-success ribbon-reverse ribbon-clip">
											<div class="ribbon-button">Ribbon success</div>
										</div>
									</div>
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12">
									<div class="ribbon-box ribbon-bottom-box">
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
										<div class="ribbon ribbon-clip ribbon-top btn-primary">
											<div class="ribbon-button">Ribbon primary</div>
										</div>
									</div>
								</div>
								<div class="col-lg-3 col-sm-6 col-xs-12">
									<div class="ribbon-box ribbon-bottom-box margin-bottom-0">
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
										<div class="ribbon btn-blue ribbon-top ribbon-reverse ribbon-clip">
											<div class="ribbon-button">Ribbon info</div>
										</div>
									</div>
								</div>
							</div>
