...
<html lang="en">
	<head>
		...
		<title>Images | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="dashboard site-navbar-small image">
				...
				<div class="panel">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-6">
								<!--  Image Shape -->
								<h4 class="list-title">Image Shape</h4>
								<p>In <code>&lt;img&gt;</code>,use different class like <code>.img-rounded</code> , <code>.img-circle</code> , <code>.img-default</code> to style image.</p>
								<div class="row">
									<div class="col-sm-4">
										<div class="page-wrap">
											<p><code>&lt;img class="img-rounded"&gt;</code></p>
											<img class="img-rounded" width="150" height="150" src="../assets/images/image/img_240x240.jpg" alt="Images8">
										</div>
									</div>
									<div class="col-sm-4">
										<div class="page-wrap">
											<p><code>&lt;img class="img-circle"&gt;</code></p>
											<img class="img-circle" width="150" height="150" src="../assets/images/image/img_240x240.jpg" alt="Images6">
										</div>
									</div>
									<div class="col-sm-4">
										<div class="page-wrap">
											<p><code>&lt;img class="img-default"&gt;</code></p>
											<img class="img-default" width="150" height="150" src="../assets/images/image/img_240x240.jpg" alt="Images7">
										</div>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-xs-12">
								...
								<p>Anytime you need to display a piece of content—like an image—with an optional caption. Use <code>.caption</code> class.</p>
								<div class="row">
									<div class="col-sm-4">
										<div class="page-wrap">
											<div class="img-rounded">
												<img src="../assets/images/image/img_320x213.jpg" alt="Images1">
												<div class="caption">
													<h4>Nature</h4>
													<p>Aliquet augue, sed ipsum non hendrerit urna a etiam class donec. Ultrices tempor sapien nunc fames ante feugiat non morbi. Ornare enim ipsum mus natoque sociis vivamus, dapibus, nisi ridiculus.</p>
													<p><a class="btn btn-info margin-right-5 waves-effect waves-light" href="javascript:void(0)">Image</a>
														<a class="btn btn-default waves-effect waves-light" href="javascript:void(0)">Read</a>
													</p>
												</div>
											</div>
										</div>
									...
									<div class="col-sm-4">
										<div class="page-wrap">
											<div class="img-rounded">
												<img src="../assets/images/image/img_320x213.jpg" alt="Images2">
												<div class="caption">
													<h4>Nature</h4>
													<p>Gravida dui eros netus arcu metus sociis integer. Quisque orci mi mauris condimentum imperdiet habitasse libero penatibus magnis class Habitant pulvinar pellentesque dapibus porta.</p>
													<p><a class="btn btn-info margin-right-5 waves-effect waves-light" href="javascript:void(0)">Image</a>
														<a class="btn btn-default waves-effect waves-light" href="javascript:void(0)">Read</a>
													</p>
												</div>
									...
									<div class="col-sm-4">
										<div class="page-wrap">
											<div class="img-rounded">
												<img src="../assets/images/image/img_320x213.jpg" alt="Images3">
												<div class="caption">
													<h4>Nature</h4>
													<p>Conubia curae;. Habitant amet dignissim duis commodo convallis sem. Class laoreet Luctus ligula mi neque tincidunt quam, eleifend nisl. Lacinia lacus proin nec aenean.</p>
													<p><a class="btn btn-info margin-right-5 waves-effect waves-light" href="javascript:void(0)">Image</a>
														<a class="btn btn-default waves-effect waves-light" href="javascript:void(0)">Read</a>
													</p>
												</div>
							...
							<div class="col-lg-6">
								<div class="page-wrap">
									<!--  Thumbnails Default -->
									<h4 class="list-title">Thumbnails-default</h4>
									<p>The <code>.thumbnail</code> class shapes the image to a thumbnail:</p>
									<div class="row">
										<div class="col-xs-6 col-sm-6">
											<div class="thumbnail margin-bottom-30">
												<img src="../assets/images/image/img_320x213.jpg" class="imgWid" alt="Images1">
											</div>
										</div>
										<div class="col-xs-6 col-sm-6">
											<div class="thumbnail margin-bottom-30">
												<img src="../assets/images/image/img_320x213.jpg" class="imgWid" alt="Images2">
											</div>
										</div>
										<div class="col-xs-6 col-sm-6">
											<div class="thumbnail">
												<img src="../assets/images/image/img_320x213.jpg" class="imgWid" alt="Images3">
											</div>
										</div>
										<div class="col-xs-6 col-sm-6">
											<div class="thumbnail">
												<img src="../assets/images/image/img_320x213.jpg" class="imgWid" alt="Images4">
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-lg-6 col-xs-12 col-sm-12">
								<div class="page-wrap">
									<!--  Aligning Images -->
									<h4 class="list-title">Aligning images</h4>
									<p>Align images with the <code>.pull-left</code>, <code>.center-block</code> or <codE>.pull-right</code>.</p>
									<div class="row">
										<div class="col-sm-12 col-xs-12">
											<img class="pull-left margin-bottom-20" width="150" src="../assets/images/image/img_240x240.jpg" alt="Images7">
										</div>
										<div class="col-sm-12 col-xs-12">
											<img class="center-block margin-bottom-20" width="150" src="../assets/images/image/img_240x240.jpg" alt="Images8">
										</div>
										<div class="col-sm-12 col-xs-12">
											<img class="pull-right" width="150" src="../assets/images/image/img_240x240.jpg" alt="Images6">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!--  Images Responsive -->
									<h4 class="list-title">Images - Responsive</h4>
									<p>Create responsive images by adding an <code>.img-responsive</code> class to the <code>img</code> tag. It  applies <code>display: block;</code> and <code>max-width: 100%;</code> and <code>height: auto;</code> to the image:</p>
									<div>
										<img class="img-responsive" src="../assets/images/image/img_900x600.jpg" alt="Images5">
									</div>
								</div>
							</div>
						</div>
