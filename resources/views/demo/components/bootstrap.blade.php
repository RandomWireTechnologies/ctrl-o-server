...
<html lang="en">
	<head>
		...
		<title>Bootstrap Tables | Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<link rel="stylesheet" href="../assets/css/bootstrap-table/bootstrap-table.min.css">
	</head>
	<body class="basic-table site-navbar-small">
		...
		<div class="main-content">
			...
			<div class="page-content container-fluid">
				<div class="panel">
						...
						<div class="row">
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap margin-md-0">
									...
									<table data-toggle="table" data-url="../assets/data/table_base.json" data-height="250"
										data-mobile-responsive="true">
										<thead>
											<tr>
												<th data-field="id">ID</th>
												<th data-field="First">Item Name</th>
												<th data-field="Last">Number Of Item</th>
												<th data-field="Score">Item Price</th>
											</tr>
										</thead>
									</table>
								</div>
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap margin-bottom-0">
									<h4>Table From Data</h4>
									<p>Transform table from an existing data.</p>
									<table id="pageTableFromData" data-mobile-responsive="true">
										<thead>
											<tr>
												<th data-field="id">ID</th>
												<th data-field="First">Item Name</th>
					...
					<!-- End Basic Bootstrap Section -->
				</div>
				<div class="panel">
					<!-- Start Style Bootstrap Section -->
					<div class="panel-heading">
					...
					<div class="panel-body container-fluid">
						<div class="row">
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<h4>Classes</h4>
									<p>Use <code>height, classes, striped </code> options and <code>class, width</code> column
										options to set the styles of bootstrap table. 
									</p>
									<table data-toggle="table" data-classes="table table-hover table-condensed" data-url="../assets/data/table_base.json"
										data-striped="true" data-height="250" data-mobile-responsive="true">
										<thead>
											<tr>
												<th data-field="id">ID</th>
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<h4>Align</h4>
									<p>Use <code>align</code>, <code>halign</code> and <code>valign</code>options to set the alignment of the columns and their header.</p>
									<table data-toggle="table" data-url="../assets/data/bootstrap_table_test2.json"
										data-mobile-responsive="true">
										<thead>
											<tr>
												<th data-field="name" data-halign="right" data-align="right">Name</th>
												<th data-field="star" data-halign="center" data-align="left">Star</th>
												<th data-field="description" data-halign="left" data-align="right">Description</th>
											</tr>
										</thead>
									</table>
								</div>
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<h4>Rowstyle</h4>
									<p>Use<code>rowStyle</code>option to set the row style of bootstrap
										table.
									</p>
									<table data-toggle="table" data-url="../assets/data/table_base.json" data-mobile-responsive="true"
										data-row-style="rowStyle" data-height="250">
										<thead>
											<tr>
												<th data-field="id">ID</th>
												<th data-field="First">First Name</th>
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap margin-md-0">
									<h4>Cellstyle</h4>
									<p>Use<code>cellStyle</code>column option to set the cell style of
										bootstrap table. 
									</p>
									<table data-toggle="table" data-url="../assets/data/bootstrap_table_test2.json"
										data-mobile-responsive="true">
					...
					<!-- End Style Bootstrap Section -->
				</div>
				<div class="panel">
					<!-- Start Sort & Hideheader Bootstrap Section -->
					<div class="panel-heading">
						<h3 class="panel-title">Sort & Hideheader</h3>
					</div>
					<div class="panel-body container-fluid">
						<div class="row">
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									...
									<table data-toggle="table" data-url="../assets/data/table_base.json" data-height="250"
										data-sort-name="First" data-sort-order="desc" data-mobile-responsive="true">
										<thead>
											<tr>
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<h4>Format Sort</h4>
									<p>Use <code>formatter</code> column option to format the display
							...
							<div class="clearfix"></div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap margin-md-0 margin-lg-0">
									<h4>Custom Sort</h4>
									<p>Use <code>sorter</code> column option to define the custom sort
										of bootstrap table.
									</p>
									<table data-toggle="table" data-url="../assets/data/table_base.json" data-height="250"
										data-sort-name="Score" data-sort-order="desc" data-mobile-responsive="true">
										<thead>
											<tr>
												<th data-field="id" data-align="center" data-sortable="true">ID</th>
												<th data-field="First" data-align="left" data-sortable="true">First Name</th>
												<th data-field="Score" data-sortable="true" data-sorter="scoreSorter">Score</th>
											</tr>
										</thead>
									</table>
								</div>
					...
					<!-- End Sort & Hideheader Bootstrap Section -->
				</div>
				<div class="panel">
					<!-- Start Columns & Select Bootstrap Section -->
					<div class="panel-heading">
						<h3 class="panel-title">Columns & Select</h3>
					</div>
					<div class="panel-body container-fluid">
						<div class="row">
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									...
									<table id="pageTableColumns" data-mobile-responsive="true">
										<thead>
											<tr>
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									...
									<table id="pageTableLargeColumns" data-show-columns="true" data-height="400"
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap margin-md-0">
									<h4>Radio Select</h4>
									<p>Use <code>clickToSelect</code>, <code>selectItemName</code> options
										and <code>radio</code> column option to show a radio select table.
									</p>
									<table data-toggle="table" data-url="../assets/data/bootstrap_table_test.json"
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap margin-bottom-0">
									...
									<p>Use <code>clickToSelect</code> option and <code>checkbox</code> column option to show a checkbox select table.</p>
									<table data-toggle="table" data-url="../assets/data/bootstrap_table_test.json"
					...
					<div class="panel-body container-fluid">
						<div class="row">
							<div class="col-md-12">
								<div class="page-wrap">
									<h4>Card View</h4>
									<p>Use <code>cardView: true</code> option to show Card View.</p>
							...
							<div class="col-md-12">
								<div class="page-wrap">
									...
									<div class="btn-group hidden-xs" id="pageToolbar" role="group">
									...
									<table id="pageTableToolbar" data-mobile-responsive="true">
										<thead>
											<tr>
												<th data-field="name">Name</th>
												<th data-field="star">Star</th>
							...
							<div class="col-md-12">
								<div class="page-wrap">
									<h4>Pagination: Client Side</h4>
									<p>The default side pagination of table is <code>client</code>.</p>
									<table id="pageTablePagination" data-toggle="table" data-url="../assets/data/bootstrap_table_test.json"
										data-query-params="queryParams" data-mobile-responsive="true"
										data-height="400" data-pagination="true" data-search="true" data-icon-size="info">
										<thead>
											<tr>
												<th data-field="state" data-checkbox="true"></th>
							...
							<div class="col-md-12">
								<div class="page-wrap margin-bottom-0">
									<h4>Events</h4>
									<div class="alert alert-success" id="pagebtTableEventsResult" role="alert">
										Here is the result of event.
									</div>
									<div class="btn-group hidden-xs" id="pageTableEventsToolbar" role="group">
										<button type="button" class="btn btn-info btn-icon">
										<i class="icon md-plus" aria-hidden="true"></i>
										</button>
										<button type="button" class="btn btn-info btn-icon">
									...
									<table id="pageTableEvents" data-height="400" data-mobile-responsive="true">
										<thead>
											<tr>
												<th data-field="state" data-checkbox="true"></th>
												<th data-field="id">Item ID</th>
		...
		<script src="../assets/js/bootstrep-table/bootstrap-table.min.js"></script>
		<script src="../assets/js/bootstrep-table/bootstrap-table-mobile.min.js"></script>
		<script src="../assets/js/bootstrep-table/bootstrap.min.js"></script>
		...
		<!-- Page JavaScript -->
		<script src="../assets/js/bootstrep-table/custom.min.js"></script>
	</body>
</html>
