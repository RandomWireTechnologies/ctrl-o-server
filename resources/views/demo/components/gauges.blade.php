...
<html lang="en">
	<head>
		...
		<title>Gauges | Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<!-- Page CSS -->
		<link rel="stylesheet" href="../assets/css/gauge/gauge.min.css" />
	</head>
	<body class="dashboard site-navbar-small">
		...
		<div class="main-content">
			...
			<div class="page-content container-fluid">
				<div class="panel page-contain-chart">
					...
					<div class="panel-body">
						<div class="row">
							...
							<div class="col-lg-6 col-sm-6">
								<div class="page-wrap">
									<!-- Dynamic Gauge -->
									<h4 class="list-title">Dynamic</h4>
									<div class="gauge" id="GaugeDynamic" data-plugin="gauge" data-value="870" data-max-value="1000" data-stroke-color="#e91e63">
										<div style="" class="gauge-label">841</div>
										<canvas id="gauge-2" width="280" height="160"></canvas>
									</div>
								</div>
							</div>
							...
							<div class="col-md-12">
								...
								<div class="col-lg-4 col-sm-5">
									<div class="page-wrap">
										<div class="gauge gauge-lg margin-md-0 margin-sm-0">
											<canvas id="gauge-3" width="350" height="200"></canvas>
										</div>
									</div>
								</div>
								<div class="col-lg-4 col-sm-4">
									<div class="page-wrap">
										<div class="gauge margin-md-0 margin-sm-0">
											<canvas id="gauge-4" width="280" height="160"></canvas>
										</div>
									</div>
								</div>
								<div class="col-lg-4 col-sm-3">
									<div class="page-wrap">
										<div class="gauge gauge-sm margin-bottom-0">
											<canvas id="gauge-5" width="240" height="130"></canvas>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-lg-6 col-sm-6">
								<div class="page-wrap">
									<!-- Dynamic Donut -->
									<h4 class="list-title">Dynamic</h4>
									<div class="donut" id="DonutDynamic" data-plugin="donut" data-value="870" data-max-value="1000" data-stroke-color="#e91e63">
										<div style="" class="donut-label">841</div>
										<canvas id="donut-2" width="300" height="150"></canvas>
									</div>
								</div>
							</div>
							<div class="clearfix"></div>
							<div class="col-md-12">
								...
								<div class="col-lg-4 col-sm-5">
									<div class="page-wrap">
										<div class="spring-gauge margin-md-0 margin-sm-0">
											<canvas id="donut-3" width="280" height="200"></canvas>
										</div>
									</div>
								</div>
								<div class="col-lg-4 col-sm-4">
									<div class="page-wrap">
										<div class="spring-gauge margin-md-0 margin-sm-0">
											<canvas id="donut-4" width="210" height="160"></canvas>
										</div>
									</div>
								</div>
								<div class="col-lg-4 col-sm-3">
									<div class="page-wrap">
										<div class="spring-gauge margin-bottom-0">
											<canvas id="donut-5" width="170" height="130"></canvas>
										</div>
									</div>
								</div>
							</div>
		...
		<script src="../assets/js/gauge/gauge-prettify.js"></script>
		<script src="../assets/js/gauge/gauge-js.min.js"></script>
		<script src="../assets/js/gauge/gauges.min.js"></script>
	</body>
</html>
