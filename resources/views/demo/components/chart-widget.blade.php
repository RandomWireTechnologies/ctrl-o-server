...
<html lang="en">
	<head>
		...
		<title>Chart Widgets| Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="basic-table site-navbar-small chatWidget">
		...
		<div class="main-content">
			<div class="page-header">
				<div class="header-left-panel">
					<!-- Title Page -->
					<h1 class="page-title">Chart widgets</h1>
					<!-- Breadcrumb Section -->
					<ol class="breadcrumb">
						<li><a href="../dashboard_v1.html">Home</a></li>
						<li class="text-info">Widgets</li>
						<li class="active">Chart widgets</li>
					</ol>
				</div>
			</div>
			<div class="page-content">
				<div class="row">
					<!-- Start Sparkline Chart -->
					<div class="col-md-3 col-sm-6 col-xs-12">
						<div class="widget widgett-shadow">
							<div class="card-chart-box bg-info-widget">
								<p class="card-chart-title"><i class="icon icon_group"></i> New Clients</p>
								<h4>459</h4>
								<p><i class="icon arrow_carrot-up"></i> 15% <span class="green-text text-lighten-5"> from yesterday</span></p>
							</div>
							<div class="card-action bg-info-dark">
								<div class="basic-bar-chart"></div>
								<span class="sparkline-bar">5,3,9,6,5,9,7,3,5,2,5,4,7</span>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12">
						<div class="widget widgett-shadow">
							<div class="card-chart-box bg-success">
								<p class="card-chart-title"><i class="icon icon_cloud-upload"></i> Total Sales</p>
								<h4>$7890.43</h4>
								<p><i class="icon arrow_carrot-up"></i> 75% <span class="green-text text-lighten-5">last month</span></p>
							</div>
							<div class="card-action bg-success-dark">
								<span class="sparkline-line">5,3,9,6,5,9,7,3,5,2,5,4</span>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12">
						<div class="widget widgett-shadow">
							<div class="card-chart-box bg-warning">
								<p class="card-chart-title"><i class="icon icon_pushpin"></i> Today Profit</p>
								<h4>$786.68</h4>
								<p><i class="icon arrow_carrot-up"></i> 79% <span class="green-text text-lighten-5"> from yesterday</span></p>
							</div>
							<div class="card-action bg-warning-dark">
								<span class="sparkline-bar">5,-3,7,6,-5,9,1,-3,5,2,-5,1,7</span>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12">
						<div class="widget widgett-shadow">
							<div class="card-chart-box bg-danger">
								<p class="card-chart-title"><i class="icon icon_clipboard"></i> New Invoice</p>
								<h4>1504</h4>
								<p><i class="icon arrow_carrot-down"></i> 3% <span class="green-text text-lighten-5">from last month</span></p>
							</div>
							<div class="card-action bg-danger-dark">
								<span class="sparkline-line">0,-3,-9,-6,-5,-9,-7,-3,-5,-2,-5,-4</span>
							</div>
						</div>
					</div>
					<!-- End Sparkline Chart -->
				...
				<div class="row">
					<div class="col-md-6 col-sm-12">
						<div class="bg-white widget widgett-shadow">
							<!-- Echart -->
							<div class="widgets-top-padding echart-bottom">
								<h3 class="list-title text-info">Energy Predictions</h3>
								<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem. Maecenas nec odio et ante tincidunt tempus. </p>
							</div>
							<div class="">
								<div id="basic-area" class="echart-size"></div>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12">
						<div class="bg-white widget widgett-shadow">
							<div class="bg-red-600 white padding-20">
								<!-- Sparkline With Donut Chart widgets -->
								<div class="widget-font-20 clearfix">
									Stock
									<span class="pull-right">
									<i class="icon md-caret-up" aria-hidden="true"></i> 260
									</span>
								</div>
								<div class="font-size-14 red-200 clearfix">
									2016.8.20
									<span class="pull-right">+15.3 (4.3%)</span>
								</div>
								<div class="card-action">
									<span class="sparkline-line2">5,3,9,6,5,9,7,3,5,2,5,4</span>
								</div>
							</div>
							<div class="widgets-top-padding">
								<div class="row no-space">
									<div class="col-xs-7">
										<p><span class="icon md-circle circle-blue"></span>35% Dietary intake</p>
										<p class="margin-bottom-20">
											<span class="icon md-circle circle-red"></span>65% Midcap capture
										</p>
									</div>
									<div class="col-xs-5">
										<p class="text-right">Energy Stock</p>
										<p class="font-size-20 margin-bottom-0 text-right" style="line-height:1;">4200</p>
									</div>
									<div class="card-action">
										<span class="donut-info">1/5</span>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-md-3 col-sm-6 col-xs-12">
						<div class="bg-white widget widgett-shadow">
							<!-- Sparkline With Circle Chart widgets -->
							<div class="bg-info-widget white padding-20">
								<div class="widget-font-20 clearfix">
									Stock
									<span class="pull-right">
									<i class="icon md-caret-up" aria-hidden="true"></i> 767
									</span>
								</div>
								<div class="font-size-14 red-200 clearfix">
									2016.8.20
									<span class="pull-right">+10.3 (5.3%)</span>
								</div>
								<div class="card-action">
									<span class="sparkline-bar2">5,3,9,6,5,9,7,3,5,2,5</span>
								</div>
							</div>
							<div class="widgets-top-padding">
								<div class="row no-space">
									<div class="col-xs-7">
										<p><span class="icon md-circle circle-success"></span>75% Dietary intake</p>
										<p class="margin-bottom-20">
											<span class="icon md-circle circle-blue"></span>25% Midcap capture
										</p>
									</div>
									<div class="col-xs-5">
										<p class="text-right">Energy Stock</p>
										<p class="font-size-20 margin-bottom-0 text-right" style="line-height:1;">5300</p>
									</div>
									<div class="card-action">
										<span class="donut-info2">300/400</span>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="row">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="bg-white widget widgett-shadow">
									...
									<div class="widgets-top-padding">
										<h3 class="list-title text-info">3650</h3>
										<div class="font-size-14 clearfix">
											VIEWS OF YOUR PROJECT
										</div>
									</div>
									<div class="card-action2">
										<span class="sparkline-bar3">5,2,9,6,5,9,7,4</span>
									</div>
								</div>
							</div>
							<div class="col-md-12">
								<div class="bg-white widget widgett-shadow">
									...
									<div class="card-action2">
										<span class="sparkline-line3">5,3,9,6,5,9,7,3,5,2,7,9,4</span>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-md-3 col-sm-6 col-xs-12">
						<div class="bg-white widget widgett-shadow">
							<!-- Ribbon Chord Chart widgets -->
							<div class="widgets-top-padding">
								<div class="row">
									<div class="col-xs-12">
										<h3 class="list-title text-info">Team Summary of Last year </h3>
									</div>
								</div>
							</div>
							<div class="">
					...
					<div class="col-md-6 col-sm-12 widget-clear">
						<div class="bg-white widget widgett-shadow">
							<!-- Years WIth Chart widgets -->
							<div class="widgets-top-padding">
								<div class="row">
									<div class="col-xs-12">
										<h3 class="list-title text-info">Overview of Last year </h3>
										<p>Accusantium doloremque laudantium, totam rem aperiam. Maecenas nec odio et ante tincidunt tempus. </p>
									</div>
								</div>
							</div>
							<div class="padding-bottom-30">
								<div id="pageStackedbar"></div>
							</div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-3 col-sm-12 col-xs-12">
						<div class="bg-white widget widgett-shadow">
							<!-- Product Detail Sparkline Chart widgets -->
							<div class="bg-red-600 white padding-20">
								<div class="widget-font-20 clearfix">
									Last 30 days
								</div>
								...
								<div class="card-action">
									<span class="sparkline-bar4">2,5,3,2,-1,-3,-2,2,3,5,2</span>
								</div>
							</div>
							<div class="bg-white padding-viewers font-size-14 widget-viewers">
								<div class="text-left margin-bottom-20">
									<div>VIEWERS</div>
									<h2 class="text-info">11,231,451</h2>
								</div>
								<div class="text-left">
									<div>SALES</div>
									<h2 class="text-info">$ 12,132,677</h2>
								</div>
							</div>
						</div>
					</div>
					<div class="col-md-9 col-sm-12">
						<div class="bg-white widget widgett-shadow widget-clear">
							<!-- Realtime Flot Chart widgets -->
							...
							<div class="row">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="padding-20">
										<div class="font-size-20 text-uppercase grey-700">SYSTEM STATUS</div>
				...
				<div class="row">
					<div class="col-md-8 col-sm-12">
						<div class="bg-white widget widgett-shadow">
							<!-- waterfall Chart widgets -->
							<div class="widgets-top-padding">
								<div class="row">
									<div class="col-xs-12">
										<h3 class="list-title text-info">Summary of Last days </h3>
										<div class="row">
											<div class="col-md-6">
												<div class="col-xs-4">
													<div class="row">
														<div>TOTAL</div>
														<div class="text-red">22,126</div>
													</div>
												</div>
												<div class="col-xs-4">
													<div class="row">
														<div>TODAY</div>
														<div class="text-red">43</div>
													</div>
												</div>
												<div class="col-xs-4">
													<div class="row">
														<div>WEEK</div>
														<div class="text-red">56</div>
													</div>
												</div>
											</div>
										</div>
							...
							<div class="">
								<div id="change-waterfall" class="echart-size"></div>
							</div>
						</div>
					</div>
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="bg-white widget widgett-shadow">
							<!-- Nested Pie Chart widgets -->
							<div class="widgets-top-padding">
								<div class="row">
									<div class="col-xs-12">
										<h3 class="list-title text-info">Team Summary of Last year </h3>
										<div class="row">
											<div class="col-xs-4">
												<div>APPLE</div>
												<div class="text-success">+75.36%</div>
											</div>
											<div class="col-xs-4">
												<div>FACEBOOK</div>
												<div class="text-red">-10.25%</div>
											</div>
											<div class="col-xs-4">
												<div>GOOGLE</div>
												<div class="text-success">+43.12%</div>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="">
								<div id="nested-pie" class="echart-size"></div>
							</div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6 col-sm-12">
						<div class="bg-white widget widgett-shadow">
							<div class="widgets-top-padding">
								<div class="row">
									<!-- Pagesimpleline Chart widgets -->
									<div class="col-xs-12 col-sm-6 col-md-8">
										<h3 class="list-title text-info">Your Traffic Views</h3>
									</div>
									<div class="col-xs-12 col-sm-6 col-md-4">
										<div class="col-xs-6">
											<div class="row">
												<span class="widget-font-title">70 %</span>
												<div class="text-success">PC Browser</div>
											</div>
										</div>
										<div class="col-xs-6">
											<div class="row">
												<span class="widget-font-title">30 %</span>
												<div class="text-success">Mobile Phone</div>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="padding-bottom-30">
								<div id="pageSimpleline"></div>
							</div>
						</div>
					</div>
					<div class="col-md-6 col-sm-12">
						<div class="bg-white widget widgett-shadow">
							<!-- Pageareachart Chart widgets -->
							<div class="widgets-top-padding margin-bottom-20">
								<div class="row">
									<div class="col-md-4 col-sm-4 col-xs-4">
										<div>Earned</div>
										<span class="widget-font-20 text-red">43,124 USD</span>
									</div>
									<div class="col-md-4 col-sm-4 col-xs-4">
										<div>Currently</div>
										<span class="widget-font-20 text-red">354.41 KB</span>
									</div>
									<div class="col-md-4 col-sm-4 col-xs-4">
										<div>Average</div>
										<span class="widget-font-20 text-red">146.89 MB</span>
									</div>
								</div>
							</div>
							<div class="padding-bottom-30">
								<div id="pageareachart"></div>
							</div>
						</div>
					</div>
				</div>
		...
		<script src="../assets/js/peity-charts/jquery.peity2.min.js" type="text/javascript"></script>
		<script src="../assets/js/echarts/echarts-all.js" type="text/javascript"></script>
		<script src="../assets/js/c3-chart/d3.min.js" type="text/javascript"></script>
		<script src="../assets/js/c3-chart/c3.min.js" type="text/javascript"></script>
		<script src="../assets/js/float-chart/flot.jquery.js"></script>
		<script src="../assets/js/float-chart/jquery.flot.resize.min.js" type="text/javascript"></script>
		<script src="../assets/js/sparkline/jquery.sparkline.min.js" type="text/javascript"></script>
		...
		<!-- Page JavaScript -->
		<script src="../assets/js/chart-widgets/custom-chart-widgets.js" type="text/javascript"></script>
	</body>
</html>
