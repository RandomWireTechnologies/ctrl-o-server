...
<html lang="en">
	<head>
		...
		<title>Masonry | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="dashboard site-navbar-small">
		...
		<div class="main-content">
			...
			<div class="page-content container-fluid">
				<div class="panel">
					<div class="panel-body page-masonry">
						<div id="myContent">
							<!--  Start Masonry Box Section -->
							<div class="masonry-box">
								<div class="image-masonry"><img src="../assets/images/media/img_720x480.jpg" alt="Keep it short and sweet"/></div>
								<div class="bottom-masonry">
									<h2 class="title-masonry text-info">Keep it short and sweet</h2>
									<span class="right-masonry"><a href="javascript:void(0)"><span class="icon_heart icon-fav" aria-hidden="true"></span>50</a></span>
									<p class="des-text-masonry">
										Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent consequat gravida malesuada. Vestibulum metus felis, vulputate ac condimentum et, imperdiet quis ligula. Sed et magna non ex finibus vehicula quis sit
									</p>
									<div class="commnet-text-masonry">
										<span class="left-masonry">By<a href="javascript:void(0)" class="name-masonry">Lisa chih</a> <a href="javascript:void(0)" class="name-masonry">15, 2016</a> <a href="javascript:void(0)" class="name-masonry">3 Comments</a></span>
									</div>
									<button type="button" class="btn btn-info waves-effect waves-light">Read More</button>
								</div>
							</div>
							<div class="masonry-box">
								<div class="image-masonry"><img src="../assets/images/media/img_720x480.jpg" alt="The Stalker’s Guide to Highly" /></div>
								<div class="bottom-masonry">
									<h2 class="title-masonry text-info">The stalker’s guide to highly</h2>
									<span class="right-masonry"><a href="javascript:void(0)"><span class="icon_heart icon-fav" aria-hidden="true"></span>34</a></span>
									<p class="des-text-masonry">
										Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent consequat gravida malesuada. Vestibulum metus felis, vulputate ac condimentum et, imperdiet quis ligula. Sed et magna non ex finibus vehicula quis sit
									</p>
									<div class="commnet-text-masonry">
										<span class="left-masonry">By<a href="javascript:void(0)" class="name-masonry">Suhail davis</a> <a href="javascript:void(0)" class="name-masonry">14, 2016</a> <a href="javascript:void(0)" class="name-masonry">3 Comments</a></span>
									</div>
									<button type="button" class="btn btn-info  waves-effect waves-light">Read More</button>
								</div>
							</div>
							<div class="masonry-box">
								<div class="image-masonry"><img src="../assets/images/media/img_720x480.jpg" alt="Keyword but don’t go crazy" /></div>
								<div class="bottom-masonry">
									<h2 class="title-masonry text-info">Keyword but don’t go crazy</h2>
									<span class="right-masonry"><a href="javascript:void(0)"><span class="icon_heart icon-fav" aria-hidden="true"></span>22</a></span>
									<div class="commnet-text-masonry">
										<span class="left-masonry">By<a href="javascript:void(0)" class="name-masonry">Stian abuAli</a> <a href="javascript:void(0)" class="name-masonry">08, 2016</a> <a href="javascript:void(0)" class="name-masonry">3 Comments</a></span>
									</div>
								</div>
							</div>
							<div class="masonry-box">
								<div class="image-masonry"><img src="../assets/images/media/img_720x480.jpg" alt="Learn from others" /></div>
								<div class="bottom-masonry">
									<h2 class="title-masonry text-info">Learn from others</h2>
									<span class="right-masonry"><a href="javascript:void(0)"><span class="icon_heart icon-fav" aria-hidden="true"></span>57</a></span>
									<p class="des-text-masonry">
										Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent consequat gravida malesuada. Vestibulum metus felis, vulputate ac condimentum et, imperdiet quis ligula. Sed et magna non ex finibus vehicula quis sit
									</p>
									<div class="commnet-text-masonry">
										<span class="left-masonry">By<a href="javascript:void(0)" class="name-masonry">Nikola louise</a> <a href="javascript:void(0)" class="name-masonry">08, 2016</a> <a href="javascript:void(0)" class="name-masonry">3 Comments</a></span>
									</div>
									<button type="button" class="btn btn-info waves-effect waves-light">Read More</button>
								</div>
							</div>
							<div class="masonry-box">
								<div class="image-masonry"><img src="../assets/images/media/img_720x480.jpg" alt="Classic advice of learning" /></div>
								<div class="bottom-masonry">
									<h2 class="title-masonry text-info">Classic advice of learning</h2>
									<span class="right-masonry"><a href="javascript:void(0)"><span class="icon_heart icon-fav" aria-hidden="true"></span>78</a></span>
									<p class="des-text-masonry">
										Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent consequat gravida malesuada. Vestibulum metus felis, vulputate ac condimentum et, imperdiet quis ligula. Sed et magna non ex finibus vehicula quis sit
									</p>
									<div class="commnet-text-masonry">
										<span class="left-masonry">By<a href="javascript:void(0)" class="name-masonry">Areej kala</a> <a href="javascript:void(0)" class="name-masonry">08, 2016</a> <a href="javascript:void(0)" class="name-masonry">3 Comments</a></span>
									</div>
									<button type="button" class="btn btn-info waves-effect waves-light">Read More</button>
								</div>
							</div>
							<div class="masonry-box">
								<div class="image-masonry"><img src="../assets/images/media/img_720x480.jpg" alt="Past a colleague to get a sense" /></div>
								<div class="bottom-masonry">
									<h2 class="title-masonry text-info">Past a colleague to get a sense</h2>
									<span class="right-masonry"><a href="javascript:void(0)"><span class="icon_heart icon-fav" aria-hidden="true"></span>19</a></span>
									<p class="des-text-masonry">
										Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent consequat gravida malesuada. Vestibulum metus felis, vulputate ac condimentum et, imperdiet quis ligula. Sed et magna non ex finibus vehicula quis sit
									</p>
									<div class="commnet-text-masonry">
										<span class="left-masonry">By<a href="javascript:void(0)" class="name-masonry">James reo</a> <a href="javascript:void(0)" class="name-masonry">06, 2016</a> <a href="javascript:void(0)" class="name-masonry">3 Comments</a></span>
									</div>
									<button type="button" class="btn btn-info waves-effect waves-light">Read More</button>
								</div>
							</div>
							<div class="masonry-box">
								<div class="image-masonry"><img src="../assets/images/media/img_720x480.jpg" alt="Relevant search terms with a reasonable" /></div>
								<div class="bottom-masonry">
									<h2 class="title-masonry text-info">Relevant search terms with a reasonable</h2>
									<span class="right-masonry"><a href="javascript:void(0)"><span class="icon_heart icon-fav" aria-hidden="true"></span>56</a></span>
									<p class="des-text-masonry">
										Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent consequat gravida malesuada. 
									</p>
									<div class="commnet-text-masonry">
										<span class="left-masonry">By<a href="javascript:void(0)" class="name-masonry">Nikola shena</a> <a href="javascript:void(0)" class="name-masonry">04, 2016</a> <a href="javascript:void(0)" class="name-masonry">3 Comments</a></span>
									</div>
									<button type="button" class="btn btn-info waves-effect waves-light">Read More</button>
								</div>
							</div>
							<div class="masonry-box">
								<div class="image-masonry"><img src="../assets/images/media/img_720x480.jpg" alt="A blog title needs to be more descriptive" /></div>
								<div class="bottom-masonry">
									<h2 class="title-masonry text-info">A blog title needs to be more descriptive</h2>
									<span class="right-masonry"><a href="javascript:void(0)"><span class="icon_heart icon-fav" aria-hidden="true"></span>88</a></span>
									<p class="des-text-masonry">
										Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent consequat gravida malesuada. Vestibulum metus felis, vulputate ac condimentum et, imperdiet quis ligula. Sed et magna non ex finibus vehicula quis sit
									</p>
									<div class="commnet-text-masonry">
										<span class="left-masonry">By<a href="javascript:void(0)" class="name-masonry">Mike raj</a> <a href="javascript:void(0)" class="name-masonry">01, 2016</a> <a href="javascript:void(0)" class="name-masonry">3 Comments</a></span>
									</div>
									<button type="button" class="btn btn-info  waves-effect waves-light">Read More</button>
								</div>
							</div>
							<!--  End Masonry Box Section -->
						</div>
					</div>
				</div>
			</div>
