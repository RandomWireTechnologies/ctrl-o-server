...
<html lang="en">
	<head>
		...
		<title>Comments | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="comments-page site-navbar-small list">
			...
			<div class="page-content container-fluid">
							...
							<div class="row">
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="comment-page">
										<!-- Simple Comment -->
										<h4 class=list-title>Simple</h4>
										<p>Comment can contain simple image or name.</p>
										<div class="simple-comment">
											<div class="row">
												<div class="col-lg-2 col-sm-3 col-xs-3 mobile-comment">
													<a href="#" class="avatar-lg comment-photo">
													<img src="../assets/images/global/img_240x265.png" alt="post-image">
													</a>
												</div>
												<div class="col-lg-10 col-sm-9 col-xs-9 mobile-comment">
													<div class="name-section">
														<div class="left-name-comment"><a class="text-info">Sevral Deno</a></div>
														<div class="right-time-comment text-info">Last Sunday at 4:20 PM</div>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="col-sm-6 col-sm-6 col-xs-12">
									<div class="comment-page">
										<!-- Time Comment -->
										<h4 class=list-title>Comment time</h4>
										<p>Comment can contain witch time comment Post with comment.</p>
										<div class="simple-comment">
											<div class="row">
												<div class="col-lg-2 col-sm-3 col-xs-3 mobile-comment">
													<a href="#" class="avatar-lg comment-photo">
												...
												<div class="col-lg-10 col-sm-9 col-xs-9 mobile-comment">
													<div class="name-section">
														<div class="left-name-comment"><a class="text-info">Melissa Dock</a></div>
														<div class="right-time-comment text-info">Last Monday at 2:00 PM</div>
													</div>
													<div class="form-group btn-reply">
														<button class="btn btn-sm btn-info waves-effect waves-light" type="submit">Reply</button>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="col-sm-6 col-sm-6 col-xs-12">
									<div class="comment-page">
										<!-- Attach File Comment -->
										<h4 class=list-title>Comment attach a file</h4>
										<p>Comment can contain with attach a file post with comment.</p>
										<div class="simple-comment">
											<div class="row">
												<div class="col-lg-2 col-sm-3 col-xs-3 mobile-comment">
													<a href="#" class="avatar-lg comment-photo">
												...
												<div class="col-lg-10 col-sm-9 col-xs-9 mobile-comment">
													<div class="name-section">
														<div class="left-name-comment"><a class="text-info">WinCo Foot</a></div>
														<div class="right-time-comment text-info">Last Thursday at 6:30 PM</div>
													</div>
													<div class="comment-content">
														...
														<div class="attachment-info">
															<div>01-sample.jpg</div>
															<span><a href="#"><i class="icon icon_download"></i> Download</a></span>
															<span><a href="#"><i class="icon icon_trash_alt"></i> Delete</a></span>
														</div>
													</div>
												</div>
											</div>
								...
								<div class="col-sm-6 col-sm-6 col-xs-12">
									<div class="comment-page">
										<!-- Reply Form Comment -->
										<h4 class=list-title>Reply form</h4>
										<p>Comment can contain with form to reply to a comment.</p>
										<div class="simple-comment">
											<div class="row">
												<div class="col-lg-2 col-sm-3 col-xs-3 mobile-comment">
													<a href="#" class="avatar-lg comment-photo">
												...
												<div class="col-lg-10 col-sm-9 col-xs-9 mobile-comment">
													<div class="name-section">
														<div class="left-name-comment"><a class="text-info">Food Giant</a></div>
														<div class="right-time-comment text-info">Last Sunday at 11:15 AM</div>
													</div>
													<div class="form-group">
														<button class="btn btn-sm btn-info waves-effect waves-light" type="submit">Reply</button>
													</div>
													<div class="form-group form-material white-back">
														<textarea data-fv-field="standard_content" class="form-control" placeholder="Comment here" name="standard_content" rows="5"></textarea>
													</div>
													<div class="form-group">
														<button type="submit" class="btn btn-sm btn-info waves-effect waves-light">Reply</button>
														<button type="button" class="btn btn-sm btn-link grey-600 waves-effect waves-light">Close</button>
													</div>
												</div>
											</div>
										</div>
				...
				<div class="panel">
					<div class="panel-body comment-section">
						<!-- Start Comment Box-->
						<h4 class="list-title">Comments</h4>
						<div class="comment comment-box">
							<div class="media-body">
								<div class="comment-des comment-right">
									<div class="name-section">
										<div class="left-name-comment"><a class="text-info">John Carry</a></div>
										<div class="right-time-comment text-info">Last Sunday at 4:20 PM</div>
									</div>
									<p>
							...
							<div class="media-left left-photo">
								<img class="comment-photo" alt="post-image" src="../assets/images/global/img_240x265.png">
							</div>
						</div>
						<div class="comment comment-box">
							<div class="media-body">
								<div class="comment-des comment-right">
									<div class="name-section">
										<div class="left-name-comment"><a class="text-info">John Carry</a></div>
										<div class="right-time-comment text-info">Last Monday at 1:30 AM</div>
									</div>
									<p>
										I am alone, and feel the charm of existence in this spot, which was created for the bliss of souls like mine. I am so happy, my dear friend, so absorbed in the exquisite sense of mere tranquil existence, that I neglect my talents and but a few stray gleams steal into the inner sanctuary.
									</p>
									<button class="btn btn-sm btn-info waves-effect waves-light" type="submit">Reply</button>
								</div>
								<div class="comment">
									<div class="media-body">
										<div class="comment-des comment-right">
											<div class="name-section">
												<div class="left-name-comment"><a class="text-info">Sevral Deno</a></div>
												<div class="right-time-comment text-info">Last Monday at 4:00 PM</div>
											</div>
											<p>
						...
						<div class="comment comment-box">
							<div class="media-body">
								<div class="comment-des comment-right">
									<div class="name-section">
										<div class="left-name-comment"><a class="text-info">John Carry</a></div>
										<div class="right-time-comment text-info">Last Thursday at 4:20 PM</div>
									</div>
									<p>
									...
									<div class="comment">
										<div class="media-body">
											<div class="comment-des comment-right">
												<div class="name-section">
													<div class="left-name-comment"><a class="text-info">Sevral Deno</a></div>
													<div class="right-time-comment text-info">Last Thursday at 5:30 PM</div>
												</div>
												<p>
									...
									<div class="comment">
										<div class="media-body">
											<div class="comment-des comment-right">
												<div class="name-section">
													<div class="left-name-comment"><a class="text-info">John Carry</a></div>
													<div class="right-time-comment text-info">Last Thursday at 6:00 PM</div>
												</div>
												<div class="form-group form-material white-back">
													<textarea rows="5" name="standard_content" placeholder="Comment here" class="form-control" data-fv-field="standard_content"></textarea>
												</div>
												<div class="form-group">
													<button class="btn btn-info btn-sm waves-effect waves-light" type="submit">Reply</button>
													<button class="btn btn-link btn-sm grey-600 waves-effect waves-light" type="button">Close</button>
												</div>
											</div>
										</div>
										<div class="media-left left-photo">
						...
						<div class="row">
							<form action="#" method="post" class="form-comment">
								<h3 class="list-title">Leave A Reply</h3>
								<div class="col-lg-4 col-sm-4 col-xs-12">
									<div class="form-group form-material">
										<input class="form-control" type="text" autocomplete="off" placeholder="Full Name" name="name">
									</div>
								</div>
								<div class="col-lg-4 col-sm-4 col-xs-12">
									<div class="form-group form-material">
										<input class="form-control" type="text" autocomplete="off" placeholder="Email" name="name">
									</div>
								</div>
								<div class="col-lg-4 col-sm-4 col-xs-12">
									<div class="form-group form-material">
										<input class="form-control" type="text" autocomplete="off" placeholder="Subject" name="name">
									</div>
								</div>
								...
								<div class="col-lg-12 col-xs-12 col-sm-12">
									<div class="form-group">
										<button class="btn btn-info waves-effect waves-light" type="submit">Reply</button>
									</div>
								</div>
							</form>
						</div>
