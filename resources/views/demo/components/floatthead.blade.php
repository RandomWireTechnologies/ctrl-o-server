...
<html>
	<head>
		...
		<title>Tables With Floatthead | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="basic-table site-navbar-small">
		...
		<div class="main-content">
			<div class="page-header">
				<div class="header-left-panel">
					<!-- Title Page -->
					<h1 class="page-title">Tables with floatThead</h1>
					<!-- Breadcrumb Section -->
					<ol class="breadcrumb">
						<li><a href="../dashboard_v1.html">Home</a></li>
						<li class="text-info">Tables</li>
						<li class="active">Tables with floatThead</li>
					</ol>
				</div>
			</div>
			<div class="page-content container-fluid">
				<div class="panel">
					<!-- Start Example 1 FloatThead Section -->
						...
						<div class="page-wrap">
							<div class="table-responsive">
								<div class="floatThead-wrapper">
									<table id="floattheadtable1" class="table table-bordered table-striped margin-bottom-0">
										<thead>
											<tr>
										...
										<tbody>
											<tr>
												...
												<td>string</td>
												<td>'auto'</td>
												<td>Valid values: <code>'auto'</code>, <code>'fixed'</code>, <code>'absolute'</code>.<br/>Position the floated header using absolute or fixed positioning mode (auto picks best for your table scrolling type). Try switching modes if you encounter layout problems. </td>
											</tr>
											<tr>
												<td>scrollContainer</td>
												<td>function or <code>true</code></td>
												<td>null</td>
												<td>Defines a container element inside of which the table scrolls vertically and/or horizontally. If boolean <code>true</code> is used, then we use the table's offsetParent.</td>
											</tr>
											<tr>
												<td>responsiveContainer</td>
												<td>function</td>
												<td>null</td>
												<td>Defines a responsive container element inside of which the table scrolls horizontally (at some resolutions), everything else behaves like window scrolling. This option cannot be used together with <code>scrollContainer</code> option.</td>
											</tr>
											<tr>
												<td>headerCellSelector</td>
												<td>string</td>
												<td>tr:first>th:visible</td>
												<td>Specifies the selector used to find header cells (in the table's <code>thead</code> element)</td>
											</tr>
											<tr>
												<td>floatTableClass</td>
												<td>string</td>
												<td>floatThead-table</td>
												<td>This class is added to the table element after you run floatThead on it</td>
											</tr>
											<tr>
												<td>floatContainerClass</td>
												<td>string</td>
												<td>floatThead-container</td>
												<td>This class is added to the container div inside of which your <code>thead</code> will spend time floating</td>
											</tr>
											<tr>
												<td>top</td>
												<td>number or function</td>
												<td>0</td>
												<td>Offset from the top of the <code>window</code> where the floating header will 'stick' when scrolling down</td>
											</tr>
											<tr>
												<td>bottom</td>
												<td>number or function</td>
												<td>0</td>
												<td>Offset from the bottom of the <code>window</code> where the floating header will 'stick' when scrolling down</td>
											</tr>
											<tr>
												<td>zIndex</td>
												<td>number</td>
												<td>1001</td>
												<td>z-dashboard_v1 of the floating header</td>
											</tr>
											<tr>
												<td>debug</td>
												<td>boolean</td>
												<td>false</td>
												<td>Point out various possible issues via <code>console.log</code> if it is available</td>
											</tr>
											<tr>
												<td>getSizingRow</td>
												<td>function</td>
												<td>undefined</td>
												<td>
													<p class="text-error">Used by IE Only</p>
													If your table's first visible row (<code>tbody tr:visible:first&gt;*</code>) contains <code>td</code> or <code>th</code> elements with <code>colspan</code>s, then you need to return another set of cells  which have no colspans. In other words the selector should return the same number of cells as columns in your table. <a href="/floatThead/examples/row-groups/">In depth docs</a>
												</td>
											</tr>
											<tr>
												<td>copyTableClass</td>
												<td>boolean</td>
												<td>true</td>
												<td>Should the table's class attribute be copied to the floated table? This make the styles written for the table's class selector apply also to the floated header. However, if you are later selecting this table by class you may be surprised to find 2 tables.</td>
											</tr>
											<tr>
												<td>enableAria</td>
												<td>boolean</td>
												<td>false</td>
												<td>Copy the floated header's text back into original table for screen readers. This may cause css layout issues because that text might be styled in unforeseen ways. (aria-* attributes are always used even when set to false). </td>
											</tr>
											<tr>
												<td>autoReflow</td>
												<td>boolean</td>
												<td>false</td>
												<td>
													<p class="text-warning">Experimental</p>
													use MutationObserver (on good browsers) to reflow automatically when internal table DOM changes, or DOM within <code>scrollContainer</code>
												</td>
											</tr>
										</tbody>
									</table>
					...
					<!-- End Example 1 FloatThead Section -->
				</div>
				<div class="panel">
					<!-- Start Example 2 FloatThead Section -->
					<div class="panel-heading">
					...
					<div class="panel-body container-fluid">
						<div class="page-wrap">
							<div class="table-responsive">
								<div class="floatThead-wrapper2">
									<table id="floattheadtable2" class="table table-striped margin-bottom-0">
										<thead>
											<tr>
												<th>Name</th>
												<th>Email</th>
										...
										<tbody>
											<tr>
												<td >isaiah morgan</td>
												<td>isaiah.morgan50@example.com</td>
												<td>(892)-322-1767</td>
												<td>(177)-767-9275</td>
											</tr>
											<tr>
												<td >evelyn cooper</td>
												<td>evelyn.cooper69@example.com</td>
												<td>(425)-779-2136</td>
												<td>(424)-467-5545</td>
											</tr>
											<tr>
												<td >mason martin</td>
												<td>mason.martin65@example.com</td>
												<td>(149)-890-9325</td>
												<td>(906)-475-4308</td>
											</tr>
											<tr>
												<td >alexander hamilton</td>
												<td>alexander.hamilton19@example.com</td>
												<td>(306)-140-4527</td>
												<td>(792)-168-5014</td>
											</tr>
											<tr>
												<td >dennis nelson</td>
												<td>dennis.nelson55@example.com</td>
												<td>(815)-876-6449</td>
												<td>(795)-652-4660</td>
											</tr>
											<tr>
												<td >thomas hayes</td>
												<td>thomas.hayes24@example.com</td>
												<td>(358)-195-5812</td>
												<td>(604)-195-8025</td>
											</tr>
											<tr>
												<td >zoey parker</td>
												<td>zoey.parker17@example.com</td>
												<td>(544)-275-6534</td>
												<td>(788)-994-6843</td>
											</tr>
											<tr>
												<td >meghan cooper</td>
												<td>meghan.cooper47@example.com</td>
												<td>(981)-986-8806</td>
												<td>(872)-260-8143</td>
											</tr>
											<tr>
												<td >richard mitchelle</td>
												<td>richard.mitchelle41@example.com</td>
												<td>(372)-385-4079</td>
												<td>(649)-916-5614</td>
											</tr>
											<tr>
												<td >mason green</td>
												<td>mason.green14@example.com</td>
												<td>(540)-641-3985</td>
												<td>(748)-678-9603</td>
											</tr>
											<tr>
					...
					<!-- End Example 2 FloatThead Section -->
				</div>
			</div>
		</div>
		<!-- End Contain Section -->
		...
		<script src="../assets/js/floatThead/jquery.floatThead.min.js"></script>
		...
		<!-- Page JavaScript -->
		<script src="../assets/js/floatThead/custom_floatthead.min.js"></script>
	</body>
</html>
