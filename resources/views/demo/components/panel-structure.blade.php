...
<html lang="en">
	<head>
		...
		<title>Panel Structure | Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<!-- Page CSS -->
		<link rel="stylesheet" href="../assets/css/global/panel-transition.min.css" />
	</head>
	<body class="panel-structure site-navbar-small">
		...
		<div class="main-content">
			<div class="page-header">
				<div class="header-left-panel">
					...
					<ol class="breadcrumb">
						...
						<li class="active">Panel structure</li>
					</ol>
				</div>
			</div>
			<div class="page-content container-fluid">
				<div class="row">
					<div class="col-lg-4 col-xs-12 col-sm-6">
						<div class="panel panel-bordered">
							...
							<div class="panel-heading">
								<h4 class="panel-title">Panel Heading</h4>
							</div>
							<div class="panel-body">
								<h4>Body Heading</h4>
								<p>Accusamus expetendis cu mel, an eos facilis dissentias. An tempor nostrum erroribus eos, te cum tempor minimum accusam.</p>
								<p>At omnium iuvaret adipiscing usu, bonorum nominavi eum et, id viris dolore nostrud sed.</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-xs-12 col-sm-6">
					...
					<div class="clearfix visible-md-block  hidden-xlg"></div>
					<div class="col-lg-4 col-xs-12 col-sm-6">
						<div class="panel panel-bordered">
							<div class="panel-body">
								<!-- Body With Heading Panel -->
								<h4>Body Heading</h4>
					...
					<div class="col-lg-4 col-xs-12 col-sm-6">
						<div class="panel panel-bordered">
							<!-- Heading With Label Panel -->
							<div class="panel-heading">
								<h3 class="panel-title">Heading Label <span class="label btn-info">New</span></h3>
							</div>
							<div class="panel-body">
								<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
							</div>
					...
					<div class="col-lg-4 col-xs-12 col-sm-6">
						<div class="panel panel-bordered">
							<!-- Heading With Bottom Description Panel -->
							<div class="panel-heading">
								<h3 class="panel-title">Heading Desc Bottom <small class="panel-desc-buttom">Panel Description Here..</small></h3>
							</div>
							<div class="panel-body">
								<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
							</div>
					...
					<div class="col-lg-4 col-xs-12 col-sm-6">
						<div class="panel panel-bordered">
							<!-- Heading With Description Panel -->
							<div class="panel-heading">
								<h3 class="panel-title">Heading Desc <small>Panel Description Here..</small></h3>
							</div>
							<div class="panel-body">
					...
					<div class="col-lg-4 col-xs-12 col-sm-6">
						<div class="panel panel-bordered">
							<!-- Heading Icon Panel -->
							<div class="panel-heading">
								<h3 class="panel-title"><i class="icon_toolbox_alt" aria-hidden="true"></i>Heading Icon</h3>
							</div>
							<div class="panel-body">
								<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
							</div>
					...
					<div class="col-lg-4 col-xs-12 col-sm-6">
						<div class="panel panel-bordered">
							...
							<div class="panel-heading">
								<h3 class="panel-title">Heading Dropdown</h3>
								<div class="panel-actions dropdown-panel">
									<div class="dropdown">
										<a class="dropdown-toggle" id="PanelDropdown" data-toggle="dropdown" href="#" role="button">Dropdown <span class="caret"></span></a>
										<ul class="dropdown-menu bullet dropdown-menu-right" aria-labelledby="PanelDropdown" role="menu">
											<li><a href="javascript:void(0)"><i class="icon icon_mail_alt" aria-hidden="true"></i> Reply</a></li>
											<li><a href="javascript:void(0)"><i class="icon social_share" aria-hidden="true"></i> Share</a></li>
											<li><a href="javascript:void(0)"><i class="icon icon_trash_alt" aria-hidden="true"></i> Delete</a></li>
											<li class="divider"></li>
											<li><a href="javascript:void(0)"><i class="icon icon_adjust-vert" aria-hidden="true"></i> Settings</a></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-4 col-xs-12 col-sm-6">
						<div class="panel panel-bordered">
							<!-- Heading Link Panel -->
							<div class="panel-heading">
								<h3 class="panel-title">Heading Links</h3>
								<ul class="panel-actions link-panel">
					...
					<div class="col-lg-4 col-xs-12 col-sm-6">
						...
						<div class="panel panel-bordered">
							<div class="panel-heading">
								<h3 class="panel-title">Panel Alert</h3>
							</div>
					...
					<div class="col-lg-4 col-xs-12 col-sm-6">
						<div class="panel panel-bordered">
							...
							<div class="panel-heading">
								<h3 class="panel-title">Panel List Group</h3>
							</div>
							<div class="panel-body">
								<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
							</div>
							<ul class="list-group list-group-bordered">
								...
								<li class="list-group-item padding-bottom-30">Morbi leo risus</li>
							</ul>
						</div>
					</div>
					<div class="col-lg-4 col-xs-12 col-sm-6">
						<div class="panel panel-bordered">
							<!-- Tables Panel -->
							<div class="panel-heading">
								<h3 class="panel-title">Panel Tables</h3>
							</div>
							<div class="panel-body">
					...
					<div class="col-lg-4 col-xs-12 col-sm-6">
						<div class="panel panel-bordered">
							<!-- Inner List Group With Panel -->
							<div class="panel-heading">
								<h3 class="panel-title">Panel Inner List Group</h3>
							</div>
							<div class="panel-body">
								<p>Some default panel content here. Nulla vitae elit libero, a pharetra
									augue. Aenean lacinia bibendum nulla sed consectetur.
								</p>
								<ul class="list-group">
									<li class="list-group-item">
										<div class="media">
											<div class="media-left">
												...
												<img class="img-responsive" src="../assets/images/global/img_240x265.png" alt="panel image">
												</a>
											</div>
											<div class="media-right">
												<h4 class="media-heading">Alan Abe</h4>
									...
									<li class="list-group-item">
										<div class="media">
											...
											<div class="media-right">
												<h4 class="media-heading">Castor Elon</h4>
					...
					<div class="col-lg-4 col-xs-12 col-sm-6">
						<div class="panel panel-bordered">
							...
							<ul class="nav nav-tabs nav-tabs-line tab-padding hover-none" role="tablist" data-plugin="nav-tabs">
								<li class="active">
									<a href="#home" aria-controls="home" aria-expanded="true" role="tab" data-toggle="tab"><i class="icon icon_house" aria-hidden="true"></i>Home</a>
								</li>
								<li class="">
									<a href="#featured" aria-expanded="false" role="tab" data-toggle="tab"><i class="icon icon_profile" aria-hidden="true"></i>Featured</a>
								</li>
								<li class="">
									<a href="#css" aria-expanded="false" role="tab" data-toggle="tab"><i class="icon icon_tag" aria-hidden="true"></i>CSS</a>
								</li>
								<li class="">
									<a href="#sass" aria-expanded="false" role="tab" data-toggle="tab"><i class="icon icon_cloud" aria-hidden="true"></i>Sass</a>
								</li>
							</ul>
							<div class="panel-body">
								<div class="tab-content">
									...
									<div class="tab-pane" id="featured" role="tabpanel">
										Protervi dissensio consuetudine equos publicam ingenia. Voluptatibus legendus initia confirmare sententiam. Desistunt possint habeatur dediti dubio, triarium is offendimur reprehenderit exercitus laudabilis motus celeritas, utrum dissentio renovata, habet partus natus. Iustius disserunt, quantum ennii admodum divinum mortem elaborare primum autem.
									</div>
									...
									<div class="tab-pane" id="sass" role="tabpanel">
					...
					<div class="col-lg-4 col-xs-12 col-sm-6">
						<div class="panel panel-bordered">
							<!-- Panel Progressbar Panel -->
							<div class="panel-heading">
								<h3 class="panel-title">Panel Progress bar</h3>
								<div class="panel-actions">
									<button class="btn btn-info waves-effect" id="ButtonRandom" type="button">Random</button>
								</div>
							</div>
							<div class="panel-body">
								<div class="progress progress-sm active" data-goal="25" data-plugin="progress">
									<div class="progress-bar progress-bar-striped active" aria-valuemin="15" aria-valuemax="115" aria-valuenow="25"
										role="progressbar">15%</div>
								</div>
								<div class="progress progress-sm active" data-goal="-40" data-plugin="progress">
									<div class="progress-bar progress-bar-striped active" aria-valuemin="-100" aria-valuemax="0" aria-valuenow="-40"
										role="progressbar">65%</div>
								</div>
								<div class="progress progress-sm active" data-goal="80" data-plugin="progress">
									<div class="progress-bar progress-bar-striped active" aria-valuemin="0" aria-valuemax="100" aria-valuenow="80"
										role="progressbar">80%</div>
								</div>
								<div class="progress progress-sm active" data-goal="30" data-plugin="progress">
									<div class="progress-bar progress-bar-striped active" aria-valuemin="0" aria-valuemax="100" aria-valuenow="30"
										role="progressbar">30%</div>
								</div>
							</div>
						</div>
					</div>
					<div class="clearfix visible-xlg-block"></div>
					<div class="col-lg-4 col-xs-12 col-sm-6">
						<div class="panel panel-transparent panel-shadow">
							<!-- Transparent Shadow Panel -->
							<div class="panel-heading">
								<h3 class="panel-title">Transparent Shadow</h3>
								<div class="panel-actions structure-panel-right">
									<a class="panel-action icon icon_minus-06" aria-expanded="true" data-toggle="panel-collapse" aria-hidden="true"></a>
									<a class="panel-action icon icon_close" data-toggle="panel-close" aria-hidden="true"></a>
								</div>
							</div>
							<div class="panel-body">
								<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
					...
					<div class="col-lg-4 col-xs-12 col-sm-6">
						<div class="panel panel-bordered">
							<!-- Badge Panel -->
							<div class="panel-heading">
								<h3 class="panel-title">Panel Badges</h3>
								<div class="panel-actions">
					...
					<div class="col-lg-4 col-xs-12 col-sm-6">
						<div class="panel panel-bordered">
							<!-- Toggle Panel -->
							<div class="panel-heading">
								<h3 class="panel-title">Panel Toggle</h3>
								<div class="panel-actions">
					...
					<div class="col-lg-4 col-xs-12 col-sm-6">
						<div class="panel panel-bordered">
							<div class="panel-heading">
								<!-- Input Group With Panel -->
								<h3 class="panel-title">Panel Input Group</h3>
								<div class="panel-actions structure-panel-input">
									<button type="submit" class="search-btn">
									<i class="icon icon_search input-search-icon " aria-hidden="true"></i>
									</button>
									<input type="text" class="form-control" name="a" placeholder="Search..." />
								</div>
							</div>
							<div class="panel-body">
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce velit
					...
					<div class="col-lg-4 col-xs-12 col-sm-6">
						<div class="panel panel-bordered">
							<!-- Horizontal Panel -->
							<div class="panel-heading">
								<h3 class="panel-title">Panel Horizontal Scroll</h3>
							</div>
							<div class="panel-body horizontal-scroll">
								<div class="horizontal-in-scroll">
					...
					<div class="col-lg-4 col-xs-12 col-sm-6">
						<div class="panel panel-bordered">
							<!-- Vertical Panel -->
							<div class="panel-heading">
								<h3 class="panel-title">Panel Vertical Scroll</h3>
							</div>
							<div class="panel-body vertical-scroll">
								<div class="vertical-in-scroll">
									Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
								</div>
							</div>
						</div>
					...
					<div class="col-lg-4 col-sm-6 col-xs-12">
						<div class="panel panel-primary panel-bordered">
							<!-- Primary Panel -->
							<div class="panel-heading border-animation">
								<h3 class="panel-title text-box">Primary Panel</h3>
							</div>
							<div class="panel-body panel-primary-box">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</div>
						</div>
					</div>
					<div class="clearfix visible-md-block  hidden-xlg"></div>
					<div class="col-lg-4 col-sm-6 col-xs-12">
						<div class="panel panel-dark panel-bordered">
							<!-- Dark Panel -->
							<div class="panel-heading border-animation">
								<h3 class="panel-title text-box">Dark Panel</h3>
							</div>
							<div class="panel-body panel-warning-box">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</div>
						</div>
					</div>
					<div class="col-lg-4 col-sm-6 col-xs-12">
						<div class="panel panel-warning panel-bordered">
							<!-- warning Panel -->
							<div class="panel-heading border-animation">
								<h3 class="panel-title text-box border-animation">Warning Panel</h3>
							</div>
							<div class="panel-body panel-success-box">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</div>
						</div>
					</div>
					<div class="clearfix"></div>
					<div class="col-lg-4 col-sm-6 col-xs-12">
						<div class="panel panel-info panel-bordered">
							<!-- Template Panel -->
							<div class="panel-heading border-animation">
								<h3 class="panel-title text-box">Template Panel</h3>
							</div>
							<div class="panel-body panel-dark-box">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</div>
						</div>
					</div>
					<div class="col-lg-4 col-sm-6 col-xs-12">
						<div class="panel panel-danger panel-bordered">
							<!-- Danger Panel -->
							<div class="panel-heading border-animation">
								<h3 class="panel-title text-box">Danger Panel</h3>
							</div>
							<div class="panel-body panel-info-box">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</div>
						</div>
					</div>
					<div class="clearfix visible-md-block  hidden-xlg"></div>
					<div class="col-lg-4 col-sm-6 col-xs-12">
						<div class="panel panel-success panel-bordered">
							<!-- Success Panel -->
							<div class="panel-heading border-animation">
								<h3 class="panel-title text-box">Success Panel</h3>
							</div>
							<div class="panel-body panel-green-box">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</div>
						</div>
					</div>
				</div>
			</div>
		...
		<script src="../assets/js/panel/animate-list.min.js"></script>
		<script src="../assets/js/panel/panel.min.js"></script>
		<script src="../assets/js/progress-bar/jquery-asProgress.min.js"></script>
		<script src="../assets/js/panel/asprogress.min.js"></script>
	</body>
</html>
