...
<html lang="en">
	<head>
		...
		<title>Lightbox | Porish Material Admin Template</title>
	...
	<body class="dashboard site-navbar-small list">
		...
		<div class="main-content">
			...
			<div class="page-content container-fluid">
				<div class="panel">
					...
					<div class="panel-body lightbox">
						<div class="row">
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!--  Single Image Lighbox -->
									<h4 class="list-title">Single image lightbox</h4>
									<p>Simple popups horizontally and vertically ,only horizontally ,zoom animation with different scaling settings. </p>
									<div class="row">
										<div class="col-md-4 col-sm-6 col-xs-12">
											<a class="lightbox-display image-popup-vertical-fit" href="../assets/images/lightbox/img_1920x1080.jpg">
											<img class="img-responsive" src="../assets/images/lightbox/img_1920x1080.jpg" alt="light-image" >
											</a>
										</div>
										<div class="col-md-4 col-sm-6 col-xs-12">
											<a class="lightbox-display image-popup-fit-width" href="../assets/images/lightbox/img_1920x1080.jpg" data-plugin="magnificPopup">
											<img class="img-responsive" src="../assets/images/lightbox/img_1920x1080.jpg" alt="light-image" >
											</a>
										</div>
										<div class="clearfix visible-sm-block visible-xs-block"></div>
										<div class="col-md-4 col-sm-6 col-xs-12">
											<a class="lightbox-display image-popup-no-margins" href="../assets/images/lightbox/img_1920x1080.jpg" data-plugin="magnificPopup" data-close-btn-inside="false" data-fixed-contentpos="true" data-main-class="mfp-margin-0s mfp-with-zoom" data-zoom="{&quot;enabled&quot;: &quot;true&quot;,&quot;duration&quot;:&quot;300&quot;}">
											<img class="img-responsive" src="../assets/images/lightbox/img_1920x1080.jpg" alt="light-image" >
											</a>
										</div>
										<div class="visible-md-block visible-sm-block visible-xs-block"></div>
										<div class="col-md-4 col-sm-6 col-xs-12">
											<a class="lightbox-display image-popup-vertical-fit" href="../assets/images/lightbox/img_1920x1080.jpg" data-plugin="magnificPopup" data-main-class="mfp-img-mobile">
											<img class="img-responsive" src="../assets/images/lightbox/img_1920x1080.jpg" alt="light-image" >
											</a>
										</div>
										<div class="clearfix visible-sm-block visible-xs-block"></div>
										<div class="col-md-4 col-sm-6 col-xs-12">
											<a class="lightbox-display image-popup-fit-width" href="../assets/images/lightbox/img_1920x1080.jpg" data-plugin="magnificPopup" data-close-btn-inside="false" data-fixed-contentpos="true" data-main-class="mfp-margin-0s mfp-with-zoom" data-zoom="{&quot;enabled&quot;: &quot;true&quot;,&quot;duration&quot;:&quot;300&quot;}">
											<img class="img-responsive" src="../assets/images/lightbox/img_1920x1080.jpg" alt="light-image" >
											</a>
										</div>
										<div class="col-md-4 col-sm-6 col-xs-12">
											<a class="lightbox-display image-popup-no-margins margin-bottom-20" href="../assets/images/lightbox/img_1920x1080.jpg" data-plugin="magnificPopup">
											<img class="img-responsive" src="../assets/images/lightbox/img_1920x1080.jpg" alt="light-image" >
											</a>
										</div>
									</div>
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!--  Gallery Lighbox -->
									<h4 class="list-title">Lightbox gallery</h4>
									<p>In this gallery show lazy-loading of images is enabled for the next image based on move direction.</p>
									<div id="pageGallery">
										<div class="row">
											<div class="col-md-4 col-sm-6 col-xs-12">
												<a class="lightbox-display" href="../assets/images/lightbox/img_1920x1080.jpg" title="view-4">
												<img class="img-responsive" src="../assets/images/lightbox/img_1920x1080.jpg" alt="light-image" >
												</a>
											</div>
											<div class="col-md-4 col-sm-6 col-xs-12">
												<a class="lightbox-display" href="../assets/images/lightbox/img_1920x1080.jpg" title="view-5">
												<img class="img-responsive" src="../assets/images/lightbox/img_1920x1080.jpg" alt="light-image" >
												</a>
											</div>
											<div class="clearfix visible-sm-block visible-xs-block"></div>
											<div class="col-md-4 col-sm-6 col-xs-12">
												<a class="lightbox-display" href="../assets/images/lightbox/img_1920x1080.jpg" title="view-6">
												<img class="img-responsive" src="../assets/images/lightbox/img_1920x1080.jpg" alt="light-image" >
												</a>
											</div>
											<div class="visible-md-block visible-sm-block visible-xs-block"></div>
											...
											<div class="col-md-4 col-sm-6 col-xs-12">
												<a class="lightbox-display margin-bottom-20" href="../assets/images/lightbox/img_1920x1080.jpg" title="view-6">
												<img class="img-responsive" src="../assets/images/lightbox/img_1920x1080.jpg" alt="light-image" >
												</a>
											</div>
										</div>
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!--  Zoom Lighbox -->
									<h4 class="list-title">Zoom gallery</h4>
									...
									<div class="" id="pageZoomGallery">
										<div class="row">
											<div class="col-md-4 col-sm-6 col-xs-12">
												<a class="lightbox-display" href="../assets/images/lightbox/img_1920x1080.jpg" title="view-7" data-source="../assets/images/lightbox/img_1920x1080.jpg">
												<img class="img-responsive" src="../assets/images/lightbox/img_1920x1080.jpg" alt="light-image" >
												</a>
											</div>
											<div class="col-md-4 col-sm-6 col-xs-12">
												<a class="lightbox-display" href="../assets/images/lightbox/img_1920x1080.jpg" title="view-8" data-source="../assets/images/lightbox/img_1920x1080.jpg">
												<img class="img-responsive" src="../assets/images/lightbox/img_1920x1080.jpg" alt="light-image" >
												</a>
											</div>
											<div class="col-md-4 col-sm-6 col-xs-12">
												<a class="lightbox-display margin-bottom-20" href="../assets/images/lightbox/img_1920x1080.jpg" title="view-9" data-source="../assets/images/lightbox/img_1920x1080.jpg">
												<img class="img-responsive" src="../assets/images/lightbox/img_1920x1080.jpg" alt="light-image" >
												</a>
											</div>
										</div>
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!--  Popup With Video Or Map Lighbox -->
									<h4 class="list-title">Popup with video or map</h4>
									<p>In this page lightboxes are automatically disabled on small screen size and default behavior of link is triggered.</p>
									<div class="button-wrap">
										<a class="popup-youtube btn btn-info waves-effect waves-light" href="https://www.youtube.com/watch?v=kXjF0-yCmpk">Open youtube video</a>
										<a class="popup-vimeo btn btn-info waves-effect waves-light" href="https://vimeo.com/27160284">Open vimeo video</a>
										<a class="popup-gmaps btn btn-info waves-effect waves-light" href="https://maps.google.com/maps?q=221B+Baker+Street,+London,+United+Kingdom&amp;hl=en&amp;t=v&amp;hnear=221B+Baker+St,+London+NW1+6XE,+United+Kingdom">Open Google Map</a>
									</div>
								</div>
							</div>
							<div class="clearfix"></div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap margin-md-0">
									<!--  Error handling Lighbox -->
									<h4 class="list-title">Error handling</h4>
									<p>This is just basic page of how error messages are displayed. surely, you can change text or style them.</p>
									<div class="button-wrap">
										<a class="mfp-image btn btn-info waves-effect waves-light" id="pageBrokenImage" href="#">Broken image</a>
										<a class="mfp-ajax btn btn-info waves-effect waves-light" id="pageBrokenAjax" href="http://page.com/fakeg">Broken ajax request</a>
									</div>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap margin-bottom-0">
									<!--  Ajax Popup -->
									<h4 class="list-title">Ajax popup</h4>
									<p>Animations are added with simple CSS transitions, you can make them look however you wish.</p>
									<div class="button-wrap">
										<a class="btn btn-info waves-effect waves-light" id="pagePopupAjaxAlignTop" href="../assets/images/lightbox/test-ajax.html">Load content via ajax</a>
										<a class="btn btn-info waves-effect waves-light" id="pagePopupAjax" href="../assets/images/lightbox/test-ajax-213.html">Load another content via ajax</a>
									</div>
								</div>
							</div>
						</div>
		...
		<script src="../assets/js/lightbox-page/lightbox.js" type="text/javascript"></script>
	</body>
</html>
