...
<html lang="en">
	<head>
		...
		<title>Chat | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="chat-page site-navbar-small list">
				...
				<div class="panel margin-bottom-0">
					<div class="panel-heading panel-title chat-title-box chat-title-box-padding">
						...
						<div class="btn-group dropdown chat-btn-right">
							<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light padding-top-10 bgnone" id="chat-dropdown" data-toggle="dropdown" aria-expanded="false">
									...
									<div class="chat_message_wrapper">
										...
										<ul class="chat_message_right">
											<li class="chat_margin">
												...
												<p>Maecenas nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus. Nullam quis ante. Etiam sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh.<span class="chat_message_time_right"><i class="icon icon_clock_alt"></i> 13:39</span>
												</p>
											</li>
										</ul>
									</div>
								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="chat_message_wrapper">
										...
										<ul class="chat_message_right">
											<li class="chat_margin">
												<h3 class="chat-name-right">Sevral Den</h3>
												<p>Integer ante arcu, accumsan a, consectetuer eget, posuere ut, mauris. Praesent adipiscing. Phasellus ullamcorper ipsum rutrum nunc. Nunc nonummy metus. Vestibulum volutpat pretium libero. Cras id dui. Aenean ut eros et nisl sagittis vestibulum. Nullam nulla eros, ultricies sit amet, nonummy id, imperdiet feugiat, pede. Sed lectus. Donec mollis hendrerit risus. Phasellus nec sem in justo pellentesque facilisis.<span class="chat_message_time_right"><i class="icon icon_clock_alt"></i>  2:43 AM</span>
												</p>
											</li>
										</ul>
									</div>
					...
					<div class="panel-footer border-none chat_footer">
						<form>
							<div class="input-group form-material">
								...
								<span class="input-group-btn">
								<button type="button" class="btn icon md-mail-send"></button>
								</span>
							</div>
						</form>
					</div>
