...
<html>
	<head>
		...
		<title>Ajax Datatable | Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<!-- Page CSS -->
		<link rel="stylesheet" href="../assets/css/datatable/ajax-datatable/custom.css">
	</head>
	<body class="ajax_datatable site-navbar-small list">
		...
		<div class="main-content">
			<div class="page-header">
				<div class="header-left-panel">
					<!-- Title Page -->
					<h1 class="page-title">Ajax datatable</h1>
					<!-- Breadcrumb Section -->
					<ol class="breadcrumb">
						<li><a href="../dashboard_v1.html">Home</a></li>
						<li class="text-info">Tables</li>
						<li class="active">Ajax datatable</li>
					</ol>
				</div>
			</div>
			<div class="page-content validation">
				<div class="panel">
					<!-- Start Basic Ajax Datatable Section -->
					...
					<div class="panel-body container-fluid">
						<div class="table-container">
							...
							<table class="table table-striped table-bordered table-hover table-checkable" id="ajaxdatatable">
								<thead>
									<tr class="heading">
										<th style="width: 2%;">
									...
									<tr class="filter">
										...
										<td>
											<div class="input-group date date-picker input-inline margin-bottom-5 btn-block" data-date-format="dd/mm/yyyy">
											...
											<div class="input-group date date-picker input-inline btn-block display-block" data-date-format="dd/mm/yyyy">
										...
										<td>
											...
											<button class="btn btn-sm btn-danger btn-outline filter-cancel">
					...
					<!-- End Basic Ajax Datatable Section -->
				</div>
			</div>
		</div>
		<!-- End Contain Section -->
		...
		<script src="../assets/js/datatable/jquery.blockui.min.js" type="text/javascript"></script>
		<script src="../assets/js/datatable/datatable.js" type="text/javascript"></script>
		<script src="../assets/js/datatable/datatables.min.js" type="text/javascript"></script>
		<script src="../assets/js/datatable/datatables.bootstrap.js" type="text/javascript"></script>
		<script src="../assets/plugin/bootstrap-datepicker/js/bootstrap-datepicker.min.js" type="text/javascript"></script>
		...
		<!-- Page JavaScript -->
		<script src="../assets/js/datatable/ajax-datatable/app.min.js" type="text/javascript"></script>
		<script src="../assets/js/datatable/ajax-datatable/table-datatables-ajax.min.js" type="text/javascript"></script>
	</body>
</html>
