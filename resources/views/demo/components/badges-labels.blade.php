...
<html lang="en">
	<head>
		...
		<title>Badges & Labels | Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<div class="main-content">
			<div class="page-header">
				<div class="header-left-panel">
					<!--  Title Page -->
					<h1 class="page-title">Badges & labels</h1>
					<!--  Breadcrumb Section -->
					<ol class="breadcrumb">
					...
					<div class="panel-body container-fluid">
						<div class="row">
							<div class="col-lg-4 col-sm-6">
								<div class="page-wrap">
									<!--  Default Badges -->
									<h4 class="list-title">Badges Default</h4>
									...
									<table class="table table-bordered">
										...
										<tbody>
											<tr>
												<td><code>.badge-default</code></td>
												<td><span class="badge badge-default">43</span></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><span class="badge badge-dark">66</span></td>
											</tr>
										</tbody>
									</table>
								</div>
							...
							<div class="col-lg-4 col-sm-6">
								<div class="page-wrap">
									<!--  Radius Badges -->
									<h4 class="list-title">Badges Radius</h4>
									<p>Badges are numerical indicators of items are associated with a link use <code>.badge-radius</code> on any radius style badges.</p>
									<table class="table table-bordered">
										<thead>
											<tr>
												<th style="width: 50%;">Classes</th>
												<th style="width: 50%;">Badge-Radius</th>
											</tr>
										</thead>
										<tbody>
											<tr>
												<td><code>.badge-default</code></td>
												<td><span class="badge badge-radius badge-default">1</span></td>
											</tr>
											<tr>
												<td><code>.badge-primary</code></td>
												<td> <span class="badge badge-radius badge-primary">2</span></td>
											</tr>
											<tr>
												<td><code>.badge-success</code></td>
												<td><span class="badge badge-radius badge-success">3</span></td>
											</tr>
											<tr>
												<td><code>.badge-info</code></td>
												<td> <span class="badge badge-radius badge-info">4</span></td>
											</tr>
											<tr>
												<td><code>.badge-warning</code></td>
												<td><span class="badge badge-radius badge-warning">5</span></td>
											</tr>
											<tr>
												<td><code>.badge-danger</code></td>
												<td><span class="badge badge-radius badge-danger">6</span></td>
											</tr>
											<tr>
												<td><code>.badge-dark</code></td>
												<td><span class="badge badge-radius badge-dark">7</span></td>
											</tr>
										</tbody>
									</table>
								</div>
							...
							<div class="col-lg-4 col-sm-6">
								<div class="page-wrap">
									<!--  Unread Item Badges -->
									<h4 class="list-title">Unread Items</h4>
									<p>Easily highlight new or unread items with the .badge class With icon and span.</p>
									<table class="table table-bordered">
										<thead>
											<tr>
												<th style="width: 50%;">Name</th>
												<th style="width: 50%;">Unread Items</th>
											</tr>
										</thead>
										<tbody>
											<tr>
												<td>Index</td>
												<td><span>
													<i class="icon icon_house_alt" aria-hidden="true"></i>
													<span class="badge up badge-danger">1</span>
													</span>
												</td>
											</tr>
											<tr>
												...
												<td><span>
													...
													<span class="badge up badge-warning">2</span>
													</span>
												</td>
											</tr>
											<tr>
												...
												<td><span>
													<i class="icon icon_like" aria-hidden="true"></i>
											...
											<tr>
												<td>Call</td>
												<td><span>
													<i class="icon icon_wallet" aria-hidden="true"></i>
													<span class="badge up badge-info">4</span>
													</span>
												</td>
											</tr>
											<tr>
												<td>Songs</td>
												<td><span>
													<i class="icon icon_headphones" aria-hidden="true"></i>
													<span class="badge up badge-warning">5</span>
													</span>
												</td>
											</tr>
											<tr>
											...
											<tr>
												<td>Bookmark</td>
												<td><span>
													<i class="icon icon_ribbon_alt" aria-hidden="true"></i>
													<span class="badge up badge-dark">5</span>
													</span>
												</td>
											</tr>
										</tbody>
							...
							<div class="col-lg-4 col-sm-6">
								<div class="page-wrap">
									<!--  Size With Radius Badges -->
									<h4 class="list-title">Badges Sizes With Radius</h4>
									<p>Badges sizes for common scenarios, you can use <code>.badge-radius</code> on any radius style badges.</p>
									<div class="badges">
										<span class="badge badge-radius badge-lg badge-info">Large</span>
										<span class="badge badge-radius badge-info">Default</span>
										<span class="badge badge-radius badge-sm badge-info">Small</span>
									</div>
								</div>
							</div>
							<div class="clearfix visible-md-block visible-sm-block"></div>
							<div class="col-lg-4 col-sm-6">
								<div class="page-wrap">
									<!--  Button Badges -->
									<h4 class="list-title">Badges In Button</h4>
									<p>Badges can also be used inside other elements, such as buttons adding a <code>&lt;span class="badge"&gt;</code> to button div.</p>
									<div class="badges-buttons">
										<button type="button" class="btn btn-success waves-effect waves-light">
										Update
										<span class="badge badge-radius">3</span>
										</button>
										<button type="button" class="btn btn-info waves-effect waves-light">
										Update
										<span class="badge badge-radius">6</span>
										</button>
										<button type="button" class="btn btn-danger waves-effect waves-light">
										Update
										<span class="badge badge-radius">4</span>
										</button>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6">
								<div class="page-wrap">
									<!--  Status Badges -->
									<h4 class="list-title">Status Badges</h4>
									<p>You can use this examples to create status online,offline,busy and away indicator badges with profile images or similar elements.</p>
									<div class="badge-avatars">
										<div class="avatar avatar-online">
											<img src="../assets/images/global/img_240x265.png" alt="image1.jpg" style="height: 38px;">
											<i></i>
										</div>
										<div class="avatar avatar-off">
											<img src="../assets/images/global/img_240x265.png" alt="image2.jpg" style="height: 38px;">
											<i></i>
										</div>
										<div class="avatar avatar-busy">
											<img src="../assets/images/global/img_240x265.png" alt="image3.jpg" style="height: 38px;">
											<i></i>
										</div>
										<div class="avatar avatar-away last-flag">
											<img src="../assets/images/global/img_240x265.png" alt="image4.jpg" style="height: 38px;">
											<i></i>
										</div>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-lg-12 col-sm-12">
								<div class="badge-wrap margin-bottom-0">
									<!--  Nav With Badges -->
									<h4 class="list-title">Badges In Nav</h4>
									<p>Budges in nav styles are included active states in pill navigations. Highlight unread items by adding a <code>.badge-nav</code> to tab in div.</p>
									<div class="badge-nav">
										<ul class="nav nav-tabs nav-tabs-line">
											<li class="active" role="presentation">
												<a href="javascript:void(0)">
												<span>Home</span>
												<span class="badge badge-radius badge-danger">4</span>
												</a>
											</li>
					...
					<div class="panel-body container-fluid">
						<div class="row">
							<div class="col-lg-4 col-sm-6">
								<div class="page-wrap">
									<!-- Default Labels -->
									<h4 class="list-title">Labels Default</h4>
									<p>You can modify the appearance of the labels using the modifier classes such as, label-default, label-primary, label-success, label-info, label-warning, label-danger as shown in the following example.</p>
									<table class="table table-bordered">
										<thead>
											<tr>
												<th style="width: 50%;">Classes</th>
										...
										<tbody>
											...
											<tr>
												<td><code>.label-dark</code></td>
												<td><span class="label label-dark">Danger</span></td>
											</tr>
										</tbody>
									</table>
								</div>
							...
							<div class="col-lg-4 col-sm-6">
								<div class="page-wrap">
									<!--  Round Badges Label -->
									<h4 class="list-title">Labels Round</h4>
									<p>The following example shows all contextual label classes with round. add <code>.label-round</code> to change its shape.</p>
									<table class="table table-bordered">
										<thead>
											<tr>
												<th style="width: 50%;">Classes</th>
										...
										<tbody>
											<tr>
												<td><code>.label-default</code></td>
												<td><span class="label label-round label-default">Default</span></td>
											</tr>
											<tr>
												<td><code>.label-primary</code></td>
												<td><span class="label label-round label-primary">Primary</span></td>
											</tr>
											<tr>
												<td><code>.label-success</code></td>
												<td><span class="label label-round label-success">Success</span></td>
											</tr>
											<tr>
												<td><code>.label-info</code></td>
												<td><span class="label label-round label-info">Info</span></td>
											</tr>
											<tr>
												<td><code>.label-warning</code></td>
												<td><span class="label label-round label-warning">Warning</span></td>
											</tr>
											<tr>
												<td><code>.label-danger</code></td>
												<td><span class="label label-round label-danger">Danger</span></td>
											</tr>
											<tr>
												<td><code>.label-dark</code></td>
												<td><span class="label label-round label-dark">Danger</span></td>
											</tr>
										</tbody>
									</table>
								</div>
							...
							<div class="col-lg-4 col-sm-6">
								<div class="page-wrap">
									<!--  Outline Lables -->
									<h4 class="list-title">Labels outline</h4>
									<p>Add <code>.label-outline</code> to change its border style. Label can outline style and different border color options.</p>
									<table class="table table-bordered">
										<thead>
											<tr>
												<th style="width: 50%;">Outline Class</th>
												<th style="width: 50%;">Labels</th>
											</tr>
										</thead>
										<tbody>
											<tr>
												<td><code>.label-default</code></td>
												<td><span class="label label-outline label-default">Default</span></td>
											</tr>
											<tr>
												<td><code>.label-primary</code></td>
												<td><span class="label label-outline label-primary">Primary</span></td>
											</tr>
											<tr>
												<td><code>.label-success</code></td>
												<td><span class="label label-outline label-success">Success</span></td>
											</tr>
											<tr>
												<td><code>.label-info</code></td>
												<td><span class="label label-outline label-info">Info</span></td>
											</tr>
											<tr>
												<td><code>.label-warning</code></td>
												<td><span class="label label-outline label-warning">Warning</span></td>
											</tr>
											<tr>
												<td><code>.label-danger</code></td>
												<td><span class="label label-outline label-danger">Danger</span></td>
											</tr>
											<tr>
												<td><code>.label-dark</code></td>
												<td><span class="label label-outline label-dark">Danger</span></td>
											</tr>
										</tbody>
									</table>
								</div>
							...
							<div class="col-lg-4 col-sm-6">
								<div class="page-wrap">
									<!-- Sizes With Round Labels -->
									<h4 class="list-title">Labels Sizes With Round</h4>
									<p>Label sizes for common scenarios, you can use <code>.label-round</code> on any radius style label from default size to large/small size, you can add additional class <code>.label-lg</code> or <code>.label-sm</code>.</p>
									<div class="lables">
										<span class="label label-round label-lg label-info">Large</span>
										<span class="label label-round label-info">Default</span>
										<span class="label label-round label-sm label-info">Small</span>
									</div>
								</div>
							</div>
							<div class="col-lg-8 col-sm-12">
								<div class="page-wrap margin-bottom-0">
									<!--  Header With Labels -->
									<h4 class="list-title">Labels In Header</h4>
									<p>Labels scale to match the size of the immediate parent element by using relative font sizing and <code>em</code> units</p>
									<div class="lables">
