...
<html lang="en">
	<head>
		...
		<title>Typography | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="typography site-navbar-small">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
								<div class="page-wrap">
									<!--  Headings Typography -->
									<h4 class="list-title">Headings</h4>
									<div class="typ-content panel-box-shadow">
										<h1>h1. Heading H1</h1>
										<h2>h2. Heading H2</h2>
										<h3>h3. Heading H3</h3>
										<h4>h4. Heading H4</h4>
							...
							<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
								<div class="page-wrap">
									<!--  Styled Typography -->
									<h4 class="list-title">Styled headings</h4>
									<div class=" typ-content panel-box-shadow">
										<h1><i class="icon icon_book" aria-hidden="true"></i> Heading H1
											<small>Secondary text</small>
										</h1>
										<h2><i class="icon icon_book" aria-hidden="true"></i> Heading H2
											<small>Secondary text</small>
										</h2>
										<h3><i class="icon icon_book" aria-hidden="true"></i> Heading H3
											<small>Secondary text</small>
										</h3>
										<h4><i class="icon icon_book" aria-hidden="true"></i> Heading H4
											<small>Secondary text</small>
										</h4>
										<h5><i class="icon icon_book" aria-hidden="true"></i> Heading H5
											<small>Secondary text</small>
										</h5>
										<h6><i class="icon icon_book" aria-hidden="true"></i> Heading H6
											<small>Secondary text</small>
										</h6>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
								<div class="page-wrap">
									<!--  Well Typography -->
									<h4 class="list-title">Well</h4>
									<div class=" typ-content panel-box-shadow">
										<div class="well well-sm">Small well example <code>&lt;well-sm&gt;</code></div>
										<div class="well">Regular well example <code>&lt;well&gt;</code></div>
										<div class="well well-lg margin-bottom-10">Large well example <code>&lt;well-lg&gt;</code></div>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
								<div class="page-wrap">
									...
									<h4 class="list-title">Blockquote</h4>
									<div class=" typ-content panel-box-shadow">
										<blockquote class="margin-bottom-0">
											...
											<footer class="blockquote-footer">Lorem is
												<cite title="Source Title">Dummy text</cite>
											</footer>
										</blockquote>
										<blockquote class="blockquote-reverse margin-bottom-0">
											<p>Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker .</p>
											<footer class="blockquote-footer">Lorem is
												<cite title="Source Title">Dummy text</cite>
											</footer>
						...
						<div class="row">
							<div class="col-lg-4 col-sm-6">
								<div class="page-wrap">
									<!--  Lists Ordered Typography -->
									<h4 class="list-title">Lists - unordered</h4>
									<div class=" typ-content panel-box-shadow">
										<ul>
							...
							<div class="col-lg-4 col-sm-6">
								<div class="page-wrap">
									<!--  Lists Ordered Typography -->
									<h4 class="list-title">Lists - ordered</h4>
									<div class=" typ-content panel-box-shadow">
										<ol>
											<li>Lorem ipsum dolor sit amet</li>
											<li>
							...
							<div class="col-lg-4 col-sm-6">
								<div class="page-wrap">
									<!--  Lists unstyled Typography -->
									<h4 class="list-title">Lists - unstyled</h4>
									<div class=" typ-content panel-box-shadow">
							...
							<div class="col-lg-4 col-sm-6">
								<div class="page-wrap">
									...
									<h4 class="list-title">Body copy</h4>
									<div class=" typ-content panel-box-shadow">
							...
							<div class="col-lg-4 col-sm-6">
								<div class="page-wrap">
									...
									<h4 class="list-title">Highlight</h4>
									<div class=" typ-content panel-box-shadow">
										<p>For highlighting a run of text due to its relevance in another
											context, use the <code>&lt;mark&gt;</code> tag. like this:
										</p>
							...
							<div class="col-lg-4 col-sm-6">
								<div class="page-wrap">
									...
									<h4 class="list-title">Transform & align</h4>
									<div class=" typ-content panel-box-shadow">
										<p class="alignment-left">Text-align <code>left</code>  example.</p>
										<p class="alignment-center">Text-align <code>center</code>  example.</p>
										<p class="alignment-right">Text-align <code>right</code>  example.</p>
									</div>
								</div>
							</div>
							<div class="clearfix visible-xlg-block"></div>
							...
							<div class="col-lg-4 col-sm-6">
								<div class="page-wrap">
									<!--  Lists Icon Typography -->
									<h4 class="list-title">Lists - icons</h4>
									<div class=" typ-content panel-box-shadow">
										<ul class="list-with-icons">
											<li><i class="icon_check" aria-hidden="true"></i>Lorem ipsum dolor
												sit amet
											</li>
											<li>
												<i class="icon_check" aria-hidden="true"></i>Nulla volutpat aliquam
												velit
												<ul>
													<li>Phasellus iaculis neque</li>
													<li>Purus sodales ultricies</li>
											...
											<li><i class="icon_check" aria-hidden="true"></i>Faucibus porta lacus
												fringilla vel
											</li>
										</ul>
									</div>
							...
							<div class="col-lg-4 col-sm-6">
								<div class="page-wrap">
									<!--  Collapsible Submenu Typography -->
									<h4 class="list-title">Collapsible submenu</h4>
									<div class=" typ-content panel-box-shadow">
										<ul class="list-with-icons">
											<li>
												<i class=" arrow_carrot-right" aria-hidden="true"></i>Lorem ipsum dolor sit amet
											</li>
											<li>
												<a data-toggle="collapse" href="#pageSubmenu" aria-expanded="true">
												<i class=" arrow_carrot-right" aria-hidden="true"></i>Nulla volutpat aliquam velit
												</a>
												<ul class="collapse in" id="pageSubmenu">
													<li>Phasellus iaculis neque</li>
													<li>Purus sodales ultricies</li>
												</ul>
											</li>
											<li>
												<i class=" arrow_carrot-right" aria-hidden="true"></i>Faucibus porta lacus fringilla vel
											</li>
										</ul>
									</div>
								</div>
							...
							<div class="col-lg-4 col-sm-6">
								<div class="page-wrap">
									<!--  Lists Inline Typography -->
									<h4 class="list-title">Lists - inline</h4>
									<div class=" typ-content panel-box-shadow">
							...
							<div class="col-lg-4 col-sm-6">
								<div class="page-wrap">
									<!--  Address Typography -->
									<h4 class="list-title">Addresses</h4>
									<div class=" typ-content panel-box-shadow address-typo">
										<address>
											<strong>Cherry St.</strong>
											<br> 90 Magnolia Ave.
											<br> Point Beach, NJ 08742
											<br>
											<abbr title="Phone">Phone:</abbr> (125) 425-9807
										</address>
										<address>
											<strong>Email</strong>
											<br>
											<a href="javascript:void(0)">cherry.st@example.com</a>
										</address>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-8">
								<div class="page-wrap">
									<!--  Drop Cap Typography -->
									<h4 class="list-title">Drop cap</h4>
									<div class=" typ-content panel-box-shadow">
										<p>
											<span class="drop-cap margin-right-20">D</span>orem cursus ante dapibus diam. Sed nisi. Nulla quis sem
											...
											lacinia arcu eget nulla. Class <b>aptent</b> taciti sociosqu ad litora
										...
										<p>
											<span class="drop-cap drop-cap-reversed margin-right-20">D</span>orem cursus ante dapibus diam. Sed nisi. Nulla quis sem
											at nibh elementum imperdiet. Duis sagittis ipsum. Praesent mauris.
											Fusce nec tellus sed augue semper porta. <b>Mauris massa</b> Vestibulum
							...
							<div class="col-lg-4 col-sm-12 col-md-4 col-xs-12">
								<div class="page-wrap margin-md-0">
									...
									<h4 class="list-title">Description</h4>
									<div class=" typ-content panel-box-shadow">
										<dl>
											<dt><b>Description lists</b></dt>
							...
							<div class="col-lg-8 col-sm-12 col-md-8 col-xs-12">
								<div class="page-wrap margin-md-0">
									<!--  Horizontal Description Typography -->
									<h4 class="list-title">Horizontal description</h4>
									<div class=" typ-content panel-box-shadow">
										<dl class="dl-horizontal">
											...
											<dt><b>Malesuada porta</b></dt>
											<dd>Etiam porta sem malesuada magna mollis euismod >Lorem ipsum In enim nostrud ut in mollit sint cillum laborum
												ea quis qui porta sem malesuada magna mollis euismod >Lorem ipsum.
											</dd>
											<dt><b>Qui eiusmod magna.</b></dt>
											<dd>Lorem ipsum In enim nostrud ut in mollit sint cillum laborum
												ea quis qui >Lorem ipsum In enim nostrud ut in mollit sint cillum laborum
												ea quis qui >Lorem ipsum In enim nostrud ut in mollit sint cillum laborum
												ea quis qui. 
											</dd>
										</dl>
