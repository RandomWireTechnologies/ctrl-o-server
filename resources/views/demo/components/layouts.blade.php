...
<html lang="en">
	<head>
		...
		<title>Form Layouts | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="layout site-navbar-small layout">
		...
		<div class="main-content">
			...
			<div class="page-content">
						...
						<div class="row">
							<div class="col-sm-12 col-md-6">
								<div class="page-wrap">
									...
									<h4 class="list-title">Simple Forms With Icon</h4>
											...
											<div class="form-group form-material">
												...
												<div class="col-sm-9">
													<div class="radio-custom radio-default radio-inline padding-top-0">
														...
														<label for="inputHorizontalMale2">Male</label>
													</div>
													<div class="radio-custom radio-default radio-inline padding-top-0">
														<input type="radio" id="inputHorizontalFemale2" name="inputRadiosMale2" checked="">
														<label for="inputHorizontalFemale2">Female</label>
													</div>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="input-group">
														<div class="input-group-addon"><i class="icon icon_lock"></i></div>
														<input type="password" class="form-control" id="Inputpwd1" placeholder="Enter Password">
													</div>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="input-group">
														<div class="input-group-addon"><i class="icon icon_lock"></i></div>
														<input type="password" class="form-control" id="Inputpwd2" placeholder="Enter confirm Password">
													</div>
												</div>
											</div>
											<div class="form-group form-material">
							...
							<div class="col-sm-12 col-md-6">
								<div class="page-wrap">
									...
									<h4 class="list-title ">Forms With Right Icon</h4>
									<div class="margin-vertical-20">
										<form class="form-horizontal">
											<div class="form-group">
												<label class="col-sm-3 control-label">Your Name: </label>
											...
											<div class="form-group form-material">
												...
												<div class="col-sm-9">
													<div class="radio-custom radio-default radio-inline padding-top-0">
														<input type="radio" id="inputHorizontalMale3" name="inputRadiosMale3">
														<label for="inputHorizontalMale3">Male</label>
													</div>
													<div class="radio-custom radio-default radio-inline padding-top-0">
														<input type="radio" id="inputHorizontalFemale3" name="inputRadiosMale3" checked="">
														<label for="inputHorizontalFemale3">Female</label>
													</div>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="input-group">
														<input type="password" class="form-control" id="Inputpwd3" placeholder="Enter Password">
														<div class="input-group-addon"><i class="icon icon_lock"></i></div>
													</div>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-9">
													<div class="input-group">
														<input type="password" class="form-control" id="Inputpwd4" placeholder="Enter confirm Password">
														<div class="input-group-addon"><i class="icon icon_lock"></i></div>
													</div>
												</div>
											</div>
						...
						<div class="row">
							<div class="col-sm-12 col-md-6">
								<div class="page-wrap margin-md-0">
									<!-- Start Basic Form -->
									<h4 class="list-title ">Basic Form</h4>
									<div class="margin-top-20">
										<form autocomplete="off">
											...
											<div class="form-group form-material">
												...
												<input type="email" class="form-control" id="inputBasicEmail" name="inputEmail" placeholder="Email Address" autocomplete="off">
											</div>
											<div class="form-group form-material">
												<label class="control-label" for="inputBasicPassword">Password</label>
												<input type="password" class="form-control" id="inputBasicPassword" name="inputPassword" placeholder="Password" autocomplete="off">
											</div>
											<div class="form-group form-material">
												<div class="checkbox-custom checkbox-default">
													<input type="checkbox" id="inputBasicRemember" name="inputCheckbox" checked="">
													<label for="inputBasicRemember">Remember Me</label>
												</div>
											</div>
											<div class="form-group form-material margin-bottom-0">
												<button type="button" class="btn btn-info waves-effect waves-light">Sign Up</button>
											</div>
										</form>
									</div>
									<!-- End Basic Form -->
							...
							<div class="col-sm-12 col-md-6">
								<div class="page-wrap">
									<!-- Start Without Label Basic Form -->
									<h4 class="list-title ">Basic Form Without Label</h4>
									<div class="margin-top-20">
										<form class="">
											<div class="form-group form-material row">
												<div class="col-sm-6">
				...
				<div class="panel">
					<div class="panel-body">
						<!-- Start Basic Inline Form -->
						<h4 class="list-title">Basic Inline Form</h4>
						<p> Use <code>.form-inline</code> to display fields in inline.</p>
						<div class="page-wrap">
							<div class="margin-top-20">
								<form class="form-inline">
									...
									<div class="form-group form-material">
										<div class="checkbox-custom checkbox-default">
											<input type="checkbox" id="inputRemember" name="inputCheckboxRemember" checked="">
					...
					<div class="panel-body">
						<div class="row row-lg">
							<div class="col-sm-6 col-md-6">
								<div class="page-wrap">
									<!-- Input Sizing -->
									<h4 class="list-title">Input Sizing</h4>
									<div class="margin-vertical-20">
							...
							<div class="col-sm-6 col-md-6">
								<div class="page-wrap">
									<!-- Select Sizing -->
									<h4 class="list-title">Select Sizing</h4>
									<div class="margin-vertical-20">
							...
							<div class="col-sm-12">
								<div class="page-wrap">
									<h4 class="list-title">Column Sizing</h4>
									<!-- Column Sizing -->
									<div class="row row-lg">
										<div class="form-group form-material col-sm-2">
				...
				<div class="panel margin-bottom-0">
					<div class="panel-body">
						<!-- Input Grid -->
						<h4 class="list-title">Input Grid</h4>
						<div class="row">
							...
							<div class="col-md-3 form-group form-material">
							...
							<div class="col-md-2 form-group form-material">
							...
							<div class="col-md-1 form-group form-material">
