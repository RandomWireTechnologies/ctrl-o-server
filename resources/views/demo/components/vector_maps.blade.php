...
<html>
	<head>
		...
		<title>Vector Map | Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<!-- Page CSS -->
		<link rel="stylesheet" href="../assets/css/vector-map/custom.css" />
		<link href="../assets/css/vector-map/jquery-jvectormap-2.0.1.css" rel="stylesheet" type="text/css" media="screen" />
	</head>
	<body class="dashboard site-navbar-small list">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!-- World Vector Map -->
									<h4 class="list-title">WORLD MAP</h4>
									<figure>
										<div id="world-map-markers" class="map-size height-500"></div>
									</figure>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!-- USA Vector Map -->
									<h4 class="list-title">USA</h4>
									<figure>
										<div id="us_aea_en-map" class="map-size"></div>
									</figure>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!-- Germany Vector Map -->
									<h4 class="list-title">GERMANY</h4>
									<figure>
										<div id="de_mill_en-map" class="map-size"></div>
									</figure>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									...
									<h4>EUROPE</h4>
									<figure>
										<div id="europe_mill_en-map" class="map-size"></div>
									</figure>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!-- France Vector Map -->
									<h4 class="list-title">FRANCE</h4>
									<figure>
										<div id="fr_regions_mill_en-map" class="map-size"></div>
									</figure>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap margin-md-0">
									<!-- Canada Vector Map -->
									<h4 class="list-title">CANADA</h4>
									<figure>
										<div id="ca_lcc_en-map" class="map-size"></div>
									</figure>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap margin-md-0">
									<!-- India Vector Map -->
									<h4 class="list-title">INDIA</h4>
									<figure>
										<div id="in_mill_en-map" class="map-size"></div>
									</figure>
								</div>
							</div>
						</div>
		...
		<!-- Page JavaScript -->
		<script src="../assets/js/vector-map/jquery-jvectormap-2.0.1.min.js" type="text/javascript"></script>
		<script src="../assets/js/vector-map/jquery-jvectormap-world-mill-en.js" type="text/javascript"></script>
		<script src="../assets/js/vector-map/jquery-jvectormap-us-aea-en.js" type="text/javascript"></script>
		<script src="../assets/js/vector-map/jquery-jvectormap-de_mill_en.js" type="text/javascript"></script>
		<script src="../assets/js/vector-map/jquery-jvectormap-europe-mill-en.js" type="text/javascript"></script>
		<script src="../assets/js/vector-map/jquery-jvectormap-fr_regions-mill-en.js" type="text/javascript"></script>
		<script src="../assets/js/vector-map/jquery-jvectormap-ca-lcc-en.js" type="text/javascript"></script>
		<script src="../assets/js/vector-map/jquery-jvectormap-in-mill-en.js" type="text/javascript"></script>
		<script src="../assets/js/vector-map/scripts.js" type="text/javascript"></script>
	</body>
</html>
