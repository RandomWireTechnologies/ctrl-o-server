...
<html lang="en">
	<head>
		...
		<title>Google Map | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="dashboard site-navbar-small list">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!-- Basic Style Map -->
									<h4 class="list-title">Basic Style</h4>
									<div id="basic-map" class="map-size"></div>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!-- Click Style Map -->
									<h4 class="list-title">Click Style</h4>
									<div id="click-map" class="map-size"></div>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!-- Sky Blue Style Map -->
									<h4 class="list-title">Sky Blue Style</h4>
									<div id="sky-blue-map" class="map-size"></div>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!-- Traffic Map -->
									<h4 class="list-title">Traffic Style</h4>
									<div id="traffic-map" class="map-size"></div>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!-- Polyline Map -->
									<h4 class="list-title">Polyline Style</h4>
									<div id="polyline-map" class="map-size"></div>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!-- Lightness Map -->
									<h4 class="list-title">Lightness Style</h4>
									<div id="lightness-map" class="map-size"></div>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap margin-md-0">
									<!-- Imagery Map -->
									<h4 class="list-title">45° Imagery</h4>
									<div id="45-map" class="map-size"></div>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap margin-bottom-0">
									<!--  Light Style Map -->
									<h4 class="list-title">Light Style</h4>
									<div id="light-map" class="map-size"></div>
								</div>
							</div>
						</div>
					</div>
		...
		<script src="../assets/js/google-map/ui-google-map.js" type="text/javascript"></script>
	</body>
</html>
