...
<html>
	<head>
		...
		<title>Ace Editor | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="dashboard site-navbar-small editor-ace">
				...
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<div class="page-wrap margin-bottom-0">
									<!-- Auto Resizing Ace Editor -->
									<h4>Auto Resizing Editor</h4>
...
&lt;/html>
		...
		<script src="../assets/js/editor-ace/show_own_source.js"></script>
		<script src="../assets/js/editor-ace/custom.js"></script>
	</body>
</html>
