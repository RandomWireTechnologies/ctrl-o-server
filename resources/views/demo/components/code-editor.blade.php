...
<html lang="en">
	<head>
		...
		<title>Code Editor | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="basic-table site-navbar-small">
		...
		<div class="main-content">
			...
			<div class="page-content code-editor">
				<div class="panel">
					<div class="panel-body padding-left-0 editor-padding">
...
&lt;/html></pre>
		...
		<script src="../assets/js/editor-ace/ace.js"></script>
		<script src="../assets/js/code-editor/custom-code.js" type="text/javascript"></script>
		<script src="../assets/js/code-editor/custom-treeview.js" type="text/javascript"></script>
		<!-- Page JavaScript -->
