...
<html lang="en">
	<head>
		...
		<title>Overlay | Porish Material Admin Template</title>
	...
	<body class="dashboard site-navbar-small">
		...
		<div class="main-content">
			...
			<div class="page-content container-fluid">
				<div class="panel page-contain-aletify">
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-4 col-sm-6 col-xs-12">
								...
								<p>
									To display an basic overlay you can add the <code>.overlay-box</code> class. Add the <code>.overlay-description</code> class to a child element to create the overlay description panel.
								</p>
								<figure class="overlay-box">
									<img src="../assets/images/profile/img_400x266.png" alt="overlay img" />
									<div class="overlay-description">
										<h3>Contrary to popular belief</h3>
										<p>
											Lorem Ipsum is simply dummy text of the <a href="#">printing and typesetting industry</a>. Lorem Ipsum has been the industry's standard dummy
										</p>
									</div>
								</figure>
							</div>
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<!-- Toggle On Hover Overlay -->
								<h4 class="list-title">Toggle overlay on hover</h4>
								<p>To apply an toggle as an overlay, add the <code>.overlay-hover</code> class to an overlay container.</p>
								<figure class="overlay-box overlay-hover">
									<img src="../assets/images/profile/img_400x266.png" alt="overlay img" />
									<div class="overlay-description overlay-fade">
										<h3>Contrary to popular belief</h3>
										<p>
											Lorem Ipsum is simply dummy text of the <a href="#">printing and typesetting industry</a>. Lorem Ipsum has been the industry's standard dummy
										</p>
							...
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<!-- Image Overlay -->
								<h4 class="list-title">Overlay image</h4>
								...
								<figure class="overlay overlay-hover">
									<img src="../assets/images/profile/img_400x266.png" alt="overlay img">
									<img class="overlay-panel overlay-image overlay-fade" src="../assets/images/profile/img_400x266.png" alt="overlay img">
								</figure>
							</div>
						</div>
					</div>
				...
				<div class="panel page-contain-aletify">
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<!-- Inner Effect on Hover Icon Overlay -->
								<h4 class="list-title">Overlay inner effect on hover with icon</h4>
								<p>
									To display an icon you can add the <code>.effect-inner-effect</code> class and animate to add class <code>.overlay</code>
									to the overlay panel.
								</p>
								<figure class="effect-inner-effect effects-overlay">
									<div class="overlay">
										<img src="../assets/images/profile/img_400x266.png" alt="overlay img">
										<div class="overlay-hover-des">
											<a href="javascript:void(0)" class="icon-overlay"><span class="icon_search" aria-hidden="true"></span></a>
										</div>
									</div>
								</figure>
							</div>
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<!-- Icon Effect On Hover Overlay -->
								<h4 class="list-title">Overlay icon-effect on hover with icon</h4>
								<p>
									To display an icon you can add the <code>.icon-effect</code> class and animate to add class <code>.overlay</code>
									to the overlay panel.
								</p>
								<figure class="icon-effect effects-overlay">
									<div class="overlay">
										<img src="../assets/images/profile/img_400x266.png" alt="overlay img">
										<div class="overlay-hover-des">
											<a href="javascript:void(0)" class="icon-overlay"><span class="icon_search" aria-hidden="true"></span></a>
							...
							<div class="clearfix visible-md-block hidden-xlg"></div>
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<!-- Slider Top With Icon Overlay -->
								<h4 class="list-title">Overlay slide top on hover with icon</h4>
								<p>
									To display an icon you can add the <code>.effect-top-bottom</code> class and animate to add class <code>.overlay</code>
									to the overlay panel.
								</p>
								<figure class="effect-top-bottom effects-overlay">
									<div class="overlay">
										<img src="../assets/images/profile/img_400x266.png" alt="overlay img">
										<div class="overlay-hover-des">
											<a href="javascript:void(0)" class="icon-overlay"><span class="icon_search" aria-hidden="true"></span></a>
							...
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap margin-md-0">
									<!-- Slider Bottom With Icon Overlay -->
									<h4 class="list-title">Overlay bottom slide with icon</h4>
									<p>
										To display an icon you can add the <code>.effect-bottom-top</code> class and animate to add class <code>.overlay</code>
										to the overlay panel.
									</p>
									<figure class="effect-bottom-top effects-overlay clearfix margin-bottom-0">
										<div class="overlay">
											<img src="../assets/images/profile/img_400x266.png" alt="overlay img">
											<div class="overlay-hover-des">
												<a href="javascript:void(0)" class="icon-overlay"><span class="icon_search" aria-hidden="true"></span></a>
							...
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap margin-md-0 margin-sm-0">
									<!-- Slider Left With Icon Overlay -->
									<h4 class="list-title">Overlay left slide with icon</h4>
									<p>
										To display an icon you can add the <code>.effect-left-side</code> class and animate to add class <code>.overlay</code>
										to the overlay panel.
									</p>
									<figure class="effect-left-side effects-overlay clearfix margin-bottom-0">
										<div class="overlay">
											<img src="../assets/images/profile/img_400x266.png" alt="overlay img">
											<div class="overlay-hover-des">
												<a href="javascript:void(0)" class="icon-overlay"><span class="icon_search" aria-hidden="true"></span></a>
							...
							<div class="col-lg-4 col-sm-6 col-xs-12 margin-bottom-0">
								<!-- Slider RIght With Icon Overlay -->
								<h4 class="list-title">Overlay right slide with icon</h4>
								<p>
									To display an icon you can add the <code>.effect-right-side</code> class and animate to add class <code>.overlay</code>
									to the overlay panel.
								</p>
								<figure class="effect-right-side effects-overlay clearfix margin-bottom-0">
									<div class="overlay">
										<img src="../assets/images/profile/img_400x266.png" alt="overlay img">
										<div class="overlay-hover-des">
											<a href="javascript:void(0)" class="icon-overlay"><span class="icon_search" aria-hidden="true"></span></a>
				...
				<div class="panel page-contain-aletify">
					<div class="panel-heading">
						<h3 class="panel-title">Overlay position</h3>
					</div>
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<!-- Top Position Overlay -->
								<h4 class="list-title">Overlay top</h4>
								<figure class="page-wrap">
									<div class="overlay">
										<img src="../assets/images/profile/img_400x266.png" alt="overlay img">
										<div class="top-description top-overlay">
											Top Overlay
										</div>
									</div>
								</figure>
							...
							<div class="col-lg-4 col-sm-6 col-xs-12">
								...
								<h4 class="list-title">Overlay bottom</h4>
								<figure class="page-wrap">
									<div class="overlay">
										<img src="../assets/images/profile/img_400x266.png" alt="overlay img">
										<div class="top-description bottom-overlay">
											Bottom Overlay
										</div>
									</div>
								</figure>
							...
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<!-- Left Position Overlay -->
								<h4 class="list-title">Overlay left</h4>
								<figure class="page-wrap margin-md-0 margin-sm-0">
									<div class="overlay">
										<img src="../assets/images/profile/img_400x266.png" alt="overlay img">
										<div class="top-description left-overlay">
											Left Overlay
										</div>
									</div>
								</figure>
							...
							<div class="clearfix visible-lg-block"></div>
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<!-- Right Position Overlay -->
								<h4 class="list-title">Overlay right</h4>
								<figure class="overlay-top-section margin-bottom-0">
									<div class="overlay">
										<img src="../assets/images/profile/img_400x266.png" alt="overlay img">
										<div class="top-description right-overlay">
											Right Overlay
										</div>
									</div>
								</figure>
		...
		<script src="../assets/js/overlay/overlay-custom.js"></script>
	</body>
</html>
