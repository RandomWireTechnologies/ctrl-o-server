...
<html lang="en">
	<head>
		...
		<title>Form Masks | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="dashboard site-navbar-small list">
		...
		<div class="main-content">
			...
			<div class="page-content container-fluid validation">
				<div class="row">
					<div class="col-md-12">
						<div class="panel">
							<!-- Start Basic Masks -->
								...
								<form>
									<div class="form-group form-material">
										...
										<div class="col-sm-12">
											...
											<p class="help-block">e.g "2016-12-12"</p>
										</div>
									</div>
									<div class="form-group form-material">
										<label class="col-sm-12 control-label">Date</label>
										<div class="col-sm-12">
											...
											<p class="help-block">e.g "12/12/2016"</p>
										</div>
									</div>
									<div class="form-group form-material">
										...
										<div class="col-sm-12">
											...
											<p class="help-block">e.g "10: 10"</p>
										</div>
									</div>
									<div class="form-group form-material">
										<label class="col-sm-12 control-label">Time-Date</label>
										<div class="col-sm-12">
											<input type="text" class="form-control" id="time-date"/>
											<p class="help-block">e.g "10: 10 12/12/2016"</p>
										</div>
									</div>
									<div class="form-group form-material">
										<label class="col-sm-12 control-label">Characters (only)</label>
										<div class="col-sm-12">
											<input type="text" class="form-control" id="characters" />
											<p class="help-block">e.g "abcdefghk" (max 9)</p>
										</div>
									</div>
									<div class="form-group form-material">
										<div class="col-sm-12">
											<button type="button" class="btn-info btn waves-effect waves-light margin-right-5">Submit</button>
								...
								<form>
									<div class="form-group form-material">
										...
										<div class="col-sm-12">
											...
											<p class="help-block">e.g "(999) 999-9999"</p>
										</div>
									</div>
									<div class="form-group form-material">
										<label class="col-sm-12 control-label">Phone2</label>
										<div class="col-sm-12">
											<input type="text" class="form-control" id="phone2"/>
											<p class="help-block">e.g "+186 999-999-9999"</p>
										</div>
									</div>
									<div class="form-group form-material">
										<label class="col-sm-12 control-label">Phone Ext</label>
										<div class="col-sm-12">
											<input type="text" class="form-control" id="phoneEx"/>
											<p class="help-block">e.g "(999) 999-9999 x99999"</p>
										</div>
									</div>
									<div class="form-group form-material">
										<label class="col-sm-12 control-label">Credit Card</label>
										<div class="col-sm-12">
											<input type="text" class="form-control" id="Creditcard"/>
											<p class="help-block">e.g "9999-9999-9999-9999"</p>
										</div>
									</div>
									<div class="form-group form-material">
										...
										<div class="col-sm-12">
											...
											<p class="help-block">e.g "a*-9999-C999"</p>
										</div>
									</div>
									<div class="form-group form-material">
										...
										<div class="col-sm-12">
											...
											<p class="help-block">e.g "99.99%"</p>
										</div>
									</div>
									<div class="form-group form-material">
										...
										<div class="col-sm-12">
											...
											<p class="help-block">e.g "$999,999,999.99"</p>
										</div>
									</div>
									<div class="form-group form-material">
										<label class="col-sm-12 control-label">Currency</label>
										<div class="col-sm-12">
											<input type="text" class="form-control text-right" id="Currency2"/>
											<p class="help-block">e.g "$999,999,999.99"</p>
										</div>
									</div>
									<div class="form-group">
		...
		<script src="../assets/js/form-mask/jquery.formatter.min.js"></script>
		<script src="../assets/js/form-mask/custom-masks.js" type="text/javascript"></script>
	</body>
</html>
