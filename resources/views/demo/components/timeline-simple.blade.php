...
<html lang="en">
	<head>
		...
		<title>Simple Timeline | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="dashboard site-navbar-small simple-timeline">
		...
		<div class="main-content">
			<div class="page-header">
				<div class="header-left-panel">
					<!-- Title Page -->
					<h1 class="page-title">Simple timeline</h1>
					<!-- Breadcrumb Section -->
					<ol class="breadcrumb">
						<li><a href="../dashboard_v1.html">Home</a></li>
						<li class="text-info">Elements</li>
						<li class="active">Simple timeline</li>
					</ol>
				</div>
			</div>
			<div class="page-content container simple-timeline">
				<div class="static-box dash-content-shadow margin-bottom-0">
					<div class="timeline-main">
						<ul class="timeline-list-ul">
							<!-- Start Simple Timeline Section -->
							<li class="active">
								...
								<div class="timeline-content-new">
									<p class="push-bit"><a href="javascript:void(0)"><strong> Bart Deshong </strong></a></p>
									<p class="push-bit">The trip was an amazing and a life changing experience!!</p>
									<p class="push-bit"><a class="btn btn-info  mobile-btn-login btn-sign waves-effect waves-light"> <b>View More</b></a></p>
									<div class="row timeline-img-row">
										<div class="col-sm-6 col-md-4">
											<div class="overlap-media">
												<a class="media_zoom_image" href="../assets/images/media/img_720x480.jpg">
												<img class="overlap-figure overlap-scale" src="../assets/images/media/img_720x480.jpg" alt="" />
												</a>
											</div>
										</div>
										<div class="col-sm-6 col-md-4">
											<div class="overlap-media">
												<a class="media_zoom_image" href="../assets/images/media/img_720x480.jpg">
												<img class="overlap-figure overlap-scale margin-bottom-0" src="../assets/images/media/img_720x480.jpg"  alt="" />
												</a>
											</div>
										</div>
									</div>
							...
							<li class="active">
								...
								<div class="timeline-content-new">
									<p class="push-bit"><a href="javascript:void(0)"><strong>Admin</strong></a></p>
									<strong>"Lorem ipsum dolor sit amet.."</strong> comes from a line in section  9:00 <strong>am</strong> tomorrow!
								</div>
							</li>
							<li class="active">
								...
								<div class="timeline-content-new">
									<p class="push-bit"><a href="javascript:void(0)"><strong> Quinn Cortright </strong></a></p>
							...
							<li class="active">
								...
								<div class="timeline-content-new">
									<p class="push-bit"><a href="javascript:void(0)"><strong>Templiter Woods</strong></a></p>
									<p class="push-bit">Today I had the lunch of my life! It was Awesome!</p>
									<div class="row">
										<div class="col-sm-6 col-md-4">
											<div class="overlap-media">
												<a class="media_zoom_image" href="../assets/images/media/img_720x480.jpg">
												<img class="overlap-figure overlap-scale imgWid" src="../assets/images/media/img_720x480.jpg" alt="" />
												</a>
											</div>
										</div>
									</div>
							...
							<li class="active padding-bottom-0">
								<div class="timeline-icon"><i class="fa fa-pencil"></i></div>
								<div class="timeline-time"><small>1 week ago</small></div>
								<div class="timeline-content-new">
									<p class="push-bit"><a href="javascript:void(0)"><strong> Henry Kostelnik </strong></a></p>
									...
									<p>Maecenas ultrices, justo vel imperdiet gravida, urna ligula hendrerit nibh, ac cursus nibh sapien in purus. Mauris tincidunt tincidunt turpis in porta Ut egestas tempor est, in cursus enim venenatis eget! Nulla quis ligula ipsum justo vel imperdiet gravida.</p>
									<p class="push-bit"><a class="btn btn-info  mobile-btn-login btn-sign waves-effect waves-dark"><b> Read More </b></a></p>
								</div>
							</li>
							<!-- End Simple Timeline Section -->
						</ul>
					</div>
				</div>
			</div>
