...
<html lang="en">
	<head>
		...
		<title>Pricing Tables | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="dashboard site-navbar-small pricing-table">
			...
			<div class="page-content">
				<div class="panel">
					<div class="panel-body container-fluid">
						<div class="page-wrap">
							<!-- Start Pricing Table With Background Title -->
							<h4 class="list-title">Pricing-Table with background in Title</h4>
							<div class="bg-in-title">
								<div class="row">
									<div class="col-lg-3 col-sm-6 col-xs-12">
										<div class="price-list">
											<div class="price-header">
												<div class="price-title bg-grey-600">
													<div>Standard</div>
												</div>
												<div class="price-price grey-600">
											...
											<div class="price-footer">
												<a class="btn btn-info waves-effect waves-light" role="button">
												<i class="icon arrow_right font-16 margin-right-10" aria-hidden="true"></i>Start your free trial
												</a>
											</div>
										</div>
									</div>
									<div class="col-lg-3 col-sm-6 col-xs-12">
										<div class="price-list">
											<div class="price-header">
												<div class="price-title bg-blue-a300">Premium</div>
												<div class="price-price blue-a300">
													<span class="price-currency">$</span>
									...
									<div class="col-lg-3 col-sm-6 col-xs-12">
										<div class="price-list margin-sm-0">
											<div class="price-header">
												<div class="price-title bg-teal-a400">Professional</div>
									...
									<div class="col-lg-3 col-sm-6 col-xs-12">
										<div class="price-list">
											<div class="price-header">
												<div class="price-title bg-purple-300">Flagship</div>
												<div class="price-price purple-300">
													<span class="price-currency">$</span>
							...
							<!-- End Pricing Table With Background Title -->
						</div>
						<div class="page-wrap">
							<!-- Start Pricing Table -->
							<h4 class="list-title">Pricing-Table</h4>
							<div class="price-table">
								<div class="row">
									<div class="col-lg-3 col-sm-6 col-xs-12">
										<div class="price-column-four">
											<a class="pricing-right-title" href="">
												<div class="pricing-title-text">
													<p class="original-text">Basic plan</p>
													<p class="hover-text">View plan</p>
												</div>
											</a>
											<div class="pricing-contain-section">
												<div class="price-header">
										...
										<div class="price-column-four">
											...
											<div class="pricing-contain-section">
												<div class="price-header">
													...
													<div class="price-title">Flagship</div>
												</div>
												<ul class="price-features">
													<li>Full Access</li>
													<li>Documentation</li>
						...
						<div class="page-wrap">
							<!-- Start Pricing Table With Background -->
							<h4 class="list-title">Pricing-Table with background</h4>
							<div class="bg-in-head">
								<div class="row">
									<div class="col-lg-3 col-sm-6 col-xs-12">
										<div class="price-list price-ribbon-list text-center">
											<div class="price-header">
												<div class="ribbon-last-box ribbon-badge">
													<span class="ribbon-inner inner-warning">New</span>
												</div>
												<div class="price-title">
													<div class="price-round">
														<span class="price-in-round"> $25 </span>
													</div>
													<div class="price-title-round">Standard</div>
												</div>
											</div>
											<ul class="price-features white-bg">
												<li>Full Access</li>
												<li>Documentation</li>
												<li>Customer Support</li>
												<li>Free Update</li>
											</ul>
											<div class="price-footer text-center bg-grey-300">
												<a class="btn btn-info waves-effect waves-light" role="button">
												<i class="icon arrow_right font-16 margin-right-10" aria-hidden="true"></i>Start your free trial
												</a>
											</div>
									...
									<div class="col-lg-3 col-sm-6 col-xs-12">
										<div class="price-list price-ribbon-list text-center">
											<div class="price-header">
												<div class="ribbon-last-box ribbon-badge">
													<span class="ribbon-inner inner-primary">Pro</span>
												</div>
												<div class="price-title">
													<div class="price-round">
														<span class="price-in-round"> $50 </span>
													</div>
													<div class="price-title-round">Premium</div>
												</div>
											</div>
											<ul class="price-features white-bg">
												<li>Full Access</li>
									...
									<div class="col-lg-3 col-sm-6 col-xs-12">
										<div class="price-list price-ribbon-list text-center">
											<div class="price-header">
												<div class="ribbon-last-box ribbon-badge">
													<span class="ribbon-inner inner-danger">Hot</span>
												</div>
												<div class="price-title">
													<div class="price-round">
														<span class="price-in-round"> $75 </span>
													</div>
													<div class="price-title-round">Professional</div>
												</div>
											</div>
											<ul class="price-features white-bg">
												<li>Full Access</li>
									...
									<div class="col-lg-3 col-sm-6 col-xs-12">
										<div class="price-list price-ribbon-list text-center">
											<div class="price-header">
												<div class="ribbon-last-box ribbon-badge">
													<span class="ribbon-inner inner-success">Save</span>
												</div>
												<div class="price-title">
													<div class="price-round">
														<span class="price-in-round"> $95 </span>
													</div>
													<div class="price-title-round">Flagship</div>
												</div>
											</div>
											<ul class="price-features white-bg">
												<li>Full Access</li>
							...
							<!-- End Pricing Table With Background -->
						</div>
					</div>
				</div>
			</div>
