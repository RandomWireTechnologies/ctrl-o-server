...
<html lang="en">
	<head>
		...
		<title>Cover | Porish Material Admin Template</title>
		<!-- Favicons -->
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="page-wrap">
									...
									<h4 class="list-title">Background Image</h4>
									<p>Add your own background image with <code>.background-cover</code> to make it your own background image.</p>
									<div class="cover cover-image">
										<div class="background-cover" style="background-image: url('../assets/images/timeline/img_960x640.jpg')"></div>
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="page-wrap">
									...
									<h4 class="list-title">Responsive Image</h4>
									<p>If the width property is set to 100%, the image will be responsive use class <code>.image-cover</code>.</p>
									<div class="cover">
										<img class="image-cover" src="../assets/images/timeline/img_960x640.jpg" alt="Responsive img">
									</div>
								</div>
							</div>
								...
								<div class="page-wrap">
									<div class="margin-bottom-40">
										...
										<div class="cover plyr">
											<video poster="../assets/images/timeline/1274x716.jpg" controls crossorigin>
												...
												<track kind="captions" label="English" srclang="en" src="//cdn.selz.com/plyr/1.0/en.vtt" accesskey="" default>
												<a href="https://cdn.selz.com/plyr/1.0/movie.mp4">Download</a>
											</video>
										</div>
									</div>
									<h4 class="list-title">Audio</h4>
									<!-- Audio Cover -->
									<p>Audio using js</p>
									<div class="cover plyr">
										<audio controls>
							...
							<div class="col-sm-6">
								<div class="page-wrap">
									<!-- Iframe Cover -->
									<h4 class="list-title">Iframe</h4>
									<p>use an explicit descendant class <code>.iframe-cover</code> when you want to match the styling for other attributes.</p>
									<div class="cover">
										<iframe class="iframe-cover height-405 height-xs-300" src="http://www.youtube.com/embed/YE7VzlLtp-4?autoplay=0&amp;controls=0&amp;showinfo=0&amp;rel=0&amp;loop=1&amp;modestbranding=1&amp;wmode=transparent&amp;enablejsapi=1&amp;api=1"></iframe>
									</div>
								</div>
							</div>
							<div class="clearfix"></div>
							<div class="col-sm-6">
								<div class="page-wrap margin-md-0 margin-sm-0">
									<!-- Gallery Cover -->
									<h4 class="list-title">Gallery</h4>
									<p>It's extremly easy to use the <code>.gallery-cover</code> class to a gallery.</p>
									<div class="cover">
										<div class="gallery-cover carousel slide" id="cover-gallery" data-ride="carousel">
											<ol class="carousel-indicators">
												<li class="" data-target="#cover-gallery" data-slide-to="0"></li>
												<li data-target="#cover-gallery" data-slide-to="1" class="active"></li>
												<li data-target="#cover-gallery" data-slide-to="2" class=""></li>
											</ol>
											<div class="carousel-inner" role="listbox">
												<div class="item active">
													<img alt="First slide" src="../assets/images/timeline/img_960x640.jpg">
												</div>
												<div class="item">
													<img alt="Second  slide" src="../assets/images/timeline/img_960x640.jpg">
												</div>
												<div class="item">
													<img alt="Third  slide" src="../assets/images/timeline/img_960x640.jpg">
												</div>
											</div>
											<a class="left carousel-control" href="#cover-gallery" data-slide="prev" role="button">
											<span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
											<span class="sr-only">Previous</span>
											</a>
											<a class="right carousel-control" href="#cover-gallery" data-slide="next" role="button">
							...
							<div class="col-sm-6">
								<div class="page-wrap">
									<!-- Quote -->
									<h4 class="list-title">Quote</h4>
									<p>The blockquote displays use the <code>.quote-cover</code> class to a quote.</p>
									<div class="cover margin-bottom-25">
										<blockquote class="quote-cover padding-left-35" aria-hidden="true">Eleifend quis Bibendum malesuada cursus ullamcorper habitasse magnis aliquet sit.</blockquote>
									</div>
									<!-- Quote With Background -->
									<p>Quote with background</p>
									<div class="cover">
										<div class="background-cover padding-vertical-30" style="background-image: url('../assets/images/timeline/img_960x640.jpg')">
											<blockquote class="quote-cover padding-left-35 padding-horizontal-10 white gray_template-gray" aria-hidden="true">Lobortis nibh etiam mus auctor sodales sed aptent et a.</blockquote>
										</div>
									</div>
								</div>
							</div>
