...
<html lang="en">
	<head>
		...
		<title>ECharts | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="basic-table site-navbar-small">
		...
		<div class="main-content">
			...
			<div class="page-content container-fluid">
				<div class="panel">
					<div class="panel-body modal-wrap">
						<div class="row">
							<div class="">
								<div class="col-md-6">
									<div class="page-wrap margin-md-0">
										<!-- Basic Area Echarts -->
										<h4 class="list-title">Basic area line</h4>
										<div id="basic-area" class="echart-size"></div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="page-wrap margin-bottom-0">
										<!-- Waterfall Bar Echarts -->
										<h4 class="list-title">Change waterfall bar</h4>
				...
				<div class="panel">
					<div class="panel-body modal-wrap">
						<div class="row row-lg">
							<div class="col-md-12">
								<!-- Large Scale Scatter Echarts -->
								<h4 class="list-title">Large-scale scatter</h4>
								<div id="large-scale-scatter" class="echart-size"></div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="panel-body modal-wrap">
						<div class="row row-lg">
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="page-wrap margin-bottom-0">
									<!-- Nested Pie Echarts -->
									<h4 class="list-title">Nested pie</h4>
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="page-wrap margin-bottom-0">
									<!-- Basic Radar Echarts -->
									<h4 class="list-title">Basic radar</h4>
									<div id="basic-radar" class="echart-size"></div>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row row-lg">
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="page-wrap margin-md-0 margin-sm-0">
									<!-- Non Ribbon Chord Echarts -->
									<h4 class="list-title">Non-ribbon chord</h4>
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="page-wrap margin-bottom-0">
									<!-- Basic Chord Echarts -->
									<h4 class="list-title">Basic chord</h4>
									<div id="basic-chord" class="echart-size"></div>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="panel">
					<div class="panel-body modal-wrap">
						<div class="row row-lg">
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="page-wrap margin-bottom-0">
									<!-- Multiple Angular Gauges Echarts -->
									<h4 class="list-title">Multiple angular gauges</h4>
									<div id="multiple-angular-gauges" class="echart-size"></div>
								</div>
							</div>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="page-wrap margin-bottom-0">
									<!-- Basic Funnel Echarts -->
									<h4 class="list-title">Basic funnel</h4>
									<div id="basic-funnel" class="echart-size"></div>
								</div>
							</div>
						</div>
					</div>
		...
		<script src="../assets/js/echarts/echart.js" type="text/javascript"></script>
	</body>
</html>
