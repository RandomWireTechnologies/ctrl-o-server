...
<html lang="en">
	<head>
		...
		<title>Animation | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="dashboard site-navbar-small">
			...
			<div class="page-content container-fluid">
				<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">General Buttons Heading</h3>
					</div>
					<div class="panel-body container-fluid">
						<div class="row">
							<div class="col-lg-6">
								<div class="page-wrap">
									<div class="container-fluid contain-animation">
										<div class="animation-wrap">
											<!--  Basic Animation -->
											<h4>Basic Animation</h4>
											<p>Use a classes <code>.animation-{name}</code> to the element you want to animate.</p>
											<div class="animation-btn">
												<div class="animation-div animation-hover">
													<button class="btn btn-default animation-fade" type="button">Fade</button>
												</div>
												<div class="animation-div animation-hover">
													<button class="btn btn-primary animation-scale-up" type="button">Scale Up</button>
												</div>
												<div class="animation-div animation-hover">
													<button class="btn btn-success animation-scale-down" type="button">Scale Down</button>
												</div>
												<div class="animation-div animation-hover">
													<button class="btn btn-info animation-slide-top" type="button">Slide Top</button>
												</div>
												<div class="animation-div animation-hover">
													<button class="btn btn-warning animation-slide-bottom" type="button">Slide Bottom</button>
												</div>
												<div class="animation-div animation-hover">
													<button class="btn btn-danger animation-slide-left" type="button">Slide Left</button>
												</div>
												<div class="animation-div animation-hover">
													<button class="btn btn-dark animation-slide-right" type="button">Slide Right</button>
												</div>
												<div class="animation-div animation-hover">
													<button class="btn btn-success animation-shake" type="button">Shake</button>
												</div>
												<div class="animation-div animation-hover">
													<button class="btn btn-primary animation-scale" type="button">Scale</button>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="page-wrap">
									<div class="container-fluid contain-animation">
										<div class="animation-wrap">
											...
											<p>Use a classes <code>.animation-reverse</code> to the element you want to reverse any animation.</p>
											<div class="animation-btn">
												<div class="animation-div animation-hover">
													<button class="btn btn-default animation-reverse animation-fade" type="button">Fade</button>
												</div>
												<div class="animation-div animation-hover">
													<button class="btn btn-primary animation-reverse animation-scale-up" type="button">Scale Up</button>
												</div>
												<div class="animation-div animation-hover">
													<button class="btn btn-success animation-reverse animation-scale-down" type="button">Scale Down</button>
												</div>
												<div class="animation-div animation-hover">
													<button class="btn btn-info animation-reverse animation-slide-top" type="button">Slide Top</button>
												</div>
												<div class="animation-div animation-hover">
													<button class="btn btn-warning animation-reverse animation-slide-bottom" type="button">Slide Bottom</button>
												</div>
												<div class="animation-div animation-hover">
													<button class="btn btn-danger animation-reverse animation-slide-left" type="button">Slide Left</button>
												</div>
												<div class="animation-div animation-hover">
													<button class="btn btn-dark animation-reverse animation-slide-right" type="button">Slide Right</button>
												</div>
												<div class="animation-div animation-hover">
													<button class="btn btn-success animation-reverse animation-shake" type="button">Shake</button>
												</div>
												<div class="animation-div animation-hover">
													<button class="btn btn-primary animation-reverse animation-scale" type="button">Scale</button>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="col-lg-6">
								<div class="page-wrap">
									<div class="container-fluid contain-animation">
										<div class="animation-wrap">
											<!--  Curls Animation -->
											<h4>Curls Animation</h4>
											<p>Use a classes <code>.animation-{name}</code> to the element you want to curls animation.</p>
											<div class="animation-btn animation-div">
												<button class="btn btn-curl btn-info left-curl-btn">Curl Top Left</button>
												<button class="btn btn-curl btn-info right-curl-btn">Curl Top Right</button>
												<button class="btn btn-curl btn-info right-bottom-curl-btn">Curl Bottom Right</button>
												<button class="btn btn-curl btn-info left-bottom-curl-btn">Curl Bottom Left</button>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-lg-6">
								<div class="page-wrap">
									<div class="container-fluid contain-animation">
										<div class="animation-wrap">
											<!--  Shadow And Glow Animation -->
											<h4>Shadow and Glow</h4>
											<p>
												To Shadow and Glow animation, add the
												<code>.animation-{name}</code>
												to add a animation.
											</p>
											<div class="animation-btn">
												<button class="btn-curl btn-info hvr-shadow">Shadow</button>
												<button class="btn-curl btn-info hvr-grow-shadow">Grow Shadow</button>
												<button class="btn-curl btn-info hvr-float-shadow">Float Shadow</button>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="page-wrap margin-lg-0">
									<div class="container-fluid contain-animation">
										<div class="animation-wrap">
											...
											<p>The animation-duration property defines how many seconds or milliseconds an animation takes to complete one cycle, add the <code>.animation-duration-{time(second)}</code> class.
											</p>
											<div class="animation-btn">
												<div class="animation-div animation-hover">
													<button class="btn-curl btn-info animation-duration-3 animation-scale-up" type="button">Duration 3s</button>
												</div>
												<div class="animation-div animation-hover">
													<button class="btn-curl btn-info animation-duration-10 animation-slide-right" type="button">Duration 10s</button>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="page-wrap margin-0">
									<div class="container-fluid contain-animation">
										<div class="animation-wrap">
											...
											<p>The animation-delay property specifies a delay for the start of an animation, add the <code>.animation-delay-{time(milesecond)}</code> class.
											</p>
											<div class="animation-btn">
												<div class="animation-div animation-hover">
													<button class="btn btn-curl btn-info animation-scale-up animation-delay-100 waves-effect waves-light" type="button">Delay 100ms</button>
												</div>
												<div class="animation-div animation-hover">
													<button class="btn btn-curl btn-info animation-scale-up animation-delay-200 waves-effect waves-light" type="button">Delay 200ms</button>
												</div>
												<div class="animation-div animation-hover">
													<button class="btn btn-curl btn-info animation-scale-up animation-delay-300 waves-effect waves-light" type="button">Delay 300ms</button>
												</div>
												<div class="animation-div animation-hover">
													<button class="btn btn-curl btn-info animation-scale-up animation-delay-400 waves-effect waves-light" type="button">Delay 400ms</button>
												</div>
												<div class="animation-div animation-hover">
													<button class="btn btn-curl btn-info animation-scale-up animation-delay-500 waves-effect waves-light" type="button">Delay 500ms</button>
												</div>
											</div>
										</div>
									</div>
					...
					<div class="panel-body container-fluid">
						<div class="row">
							<div class="col-lg-6 col-md-12">
								<div class="page-wrap pull-left">
									<!--  Style Spinner -->
									<h4>Style</h4>
									<div class="lodding">
										<div class="loader two-color"></div>
										<div class="loader three-color"></div>
										<div class="loader four-color"></div>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-6 col-md-12">
								<div class="page-wrap pull-left">
									<!--  Flashing Spinner -->
									<h4>Flashing Style</h4>
									<div class="dotted-spinner lodding">
										<div class="dotted-round">
							...
							<div class="col-lg-6 col-md-12">
								<div class="page-wrap pull-left margin-0">
									<!--  Animation Spinner -->
									<h4>Animation Style</h4>
									<div class="lodding">
										<div class="cssload-container-right">
					...
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div data-animate="fade" data-plugin="appear" class="panel panel-primary panel-bordered animation-fade">
									<div class="panel-heading border-animation">
										<h3 class="panel-title text-box margin-bottom-0">Animate Fade</h3>
									</div>
									<div class="panel-body panel-primary-box">To use CSS3 animation <code>data-plugin="appear"</code> and <code>data-animate="fade"</code> to display animate.</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div data-animate="slide-top" data-plugin="appear" class="panel panel-success panel-bordered animation-slide-top">
									<div class="panel-heading border-animation">
										<h3 class="panel-title text-box margin-bottom-0">Animate Slide Top</h3>
									</div>
									<div class="panel-body panel-green-box">To use CSS3 animation <code>data-plugin="appear"</code> and <code>data-animate="slide-top"</code> to display animate.</div>
								</div>
							</div>
							<div class="clearfix visible-md-block hidden-xlg"></div>
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div data-animate="slide-bottom" data-plugin="appear" class="panel panel-info panel-bordered animation-slide-bottom">
									<div class="panel-heading border-animation">
										<h3 class="panel-title text-box margin-bottom-0">Animate Slide Bottom</h3>
									</div>
									<div class="panel-body panel-dark-box">To use CSS3 animation <code>data-plugin="appear"</code> and <code>data-animate="slide-bottom"</code> to display animate.</div>
								</div>
							</div>
							<div class="clearfix visible-lg-block"></div>
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div data-animate="scale-up" data-plugin="appear" class="panel panel-warning panel-bordered animation-scale-up">
									<div class="panel-heading border-animation">
										<h3 class="panel-title text-box margin-bottom-0">Animate Scale Up</h3>
									</div>
									<div class="panel-body panel-success-box">To use CSS3 animation <code>data-plugin="appear"</code> and <code>data-animate="scale-up"</code> to display animate.</div>
								</div>
							</div>
							<div class="clearfix visible-md-block hidden-xlg"></div>
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div data-animate="scale-down" data-plugin="appear" class="panel panel-danger panel-bordered animation-scale-down">
									<div class="panel-heading border-animation">
										<h3 class="panel-title text-box margin-bottom-0">Animate Scale Down</h3>
									</div>
									<div class="panel-body panel-info-box">To use CSS3 animation <code>data-plugin="appear"</code> and <code>data-animate="scale-down"</code> to display animate.</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div data-animate="slide-right" data-plugin="appear" class="panel panel-dark panel-bordered animation-slide-right">
									<div class="panel-heading border-animation">
										<h3 class="panel-title text-box margin-bottom-0">Animate Slide Right</h3>
									</div>
									<div class="panel-body panel-warning-box">To use CSS3 animation <code>data-plugin="appear"</code> and <code>data-animate="slide-right"</code> to display animate.</div>
								</div>
							</div>
							<!--  End Animation Box -->
						</div>
		...
		<script src="../assets/js/alertify/all-alertify.js"></script>
	</body>
</html>
