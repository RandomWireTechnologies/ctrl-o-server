...
<html lang="en">
	<head>
		...
		<title>Form General | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="general site-navbar-small">
		...
		<div class="main-content">
			...
			<div class="page-content container-fluid">
					...
					<div class="panel-body container-fluid">
						<div class="row">
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Simple Input -->
									<h4 class="list-title">Simple Input</h4>
							...
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Placeholder Input -->
									<h4 class="list-title">Placeholder</h4>
							...
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Input Focus -->
									<h4 class="list-title">Input Focus</h4>
									<input type="text" class="form-control input-focus" placeholder="This is focused...">
								</div>
							</div>
							<div class="clearfix visible-lg-block"></div>
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap general-form">
									<!-- Search Input -->
									<h4 class="list-title">Search</h4>
									<div class="form-group">
									...
									<div class="form-group">
										<div class="input-search">
											...
											<input type="text" class="form-control input-round" placeholder="Search ...">
										</div>
									</div>
									<div class="form-group">
										<div class="input-search input-search-dark">
											<span class="input-search-icon icon_search" aria-hidden="true"></span>
											<input type="text" class="form-control" name="search" placeholder="Search...">
											<button type="button" class="input-search-close" data-icon="M"></button>
										</div>
									</div>
									<div class="form-group">
										<div class="input-search">
							...
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap">
									...
									<h4 class="list-title">Different Color Input</h4>
									<div class="form-group">
							...
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- File Upload -->
									<h4 class="list-title">File Upload</h4>
									<div class="form-group">
									...
									<div class="form-group">
										<div class="input-group input-group-file">
											<span class="fileUpload btn btn-dark">
											<span>Upload</span>
											<input type="file" class="upload" />
											</span>
											<input type="text" class="form-control" readonly="">
							...
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Disable Input -->
									<h4 class="list-title">Disable</h4>
							...
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Textarea -->
									<h4 class="list-title">Textarea</h4>
					...
					<div class="panel-body container-fluid">
						<div class="row">
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Text Addon -->
									<h4 class="list-title">Text Addon</h4>
									<p>Place one add-on or button on either side of an input. You may
										also place one on both sides of an input.
									</p>
									<div class="form-group">
										<div class="input-group">
											<input type="email" class="form-control" placeholder="email">
											<span class="input-group-addon text-info">@domain.com</span>
										</div>
									</div>
									<div class="form-group">
										<div class="input-group">
							...
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Icon Addon -->
									<h4 class="list-title">Icon Addon</h4>
									...
									<div class="form-group">
										<div class="input-group input-group-icon">
											...
											<span class="icon_profile text-info" aria-hidden="true"></span>
											</span>
									...
									<div class="form-group">
										<div class="input-group input-group-icon">
											<span class="input-group-addon">
											<span class="icon_mail text-info" aria-hidden="true"></span>
											</span>
							...
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Button Addon -->
									<h4 class="list-title">Button Addon</h4>
									...
									<div class="form-group">
										<div class="input-group">
											<span class="input-group-btn">
											<button type="button" class="btn btn-info waves-effect waves-light">Go!</button>
											</span>
							...
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap margin-lg-0">
									<!-- Button With Dropdowns Input -->
									<h4 class="list-title">Buttons With Dropdowns</h4>
									...
									<div class="form-group">
										<div class="input-group">
											<div class="input-group-btn">
												<button type="button" class="btn btn-info dropdown-toggle waves-effect waves-light" data-toggle="dropdown">Action
									...
									<div class="form-group margin-bottom-0">
										<div class="input-group">
											<input type="text" class="form-control">
											<div class="input-group-btn">
												<button type="button" class="btn btn-info waves-effect waves-light">Action</button>
							...
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap margin-md-0 margin-sm-0">
									<!-- Size Input -->
									<h4 class="list-title">Size</h4>
									<p>Add the relative form sizing classes to the <code>.input-group</code>  
										itself and contents within will automatically resize—no need
				...
				<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">Checkbox And Radio Button</h3>
					</div>
					<div class="panel-body container-fluid">
						<div class="row">
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap margin-lg-0">
									<!-- Checkbox -->
									<h4 class="list-title">Checkboxes</h4>
									...
									<label class="control control-checkbox margin-bottom-0">Disabled & checked
							...
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap margin-lg-0">
									...
									<label class="control control-radio margin-bottom-0">Disabled & checked
							...
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap margin-bottom-0">
									<!-- Different Color Radio And Checkbox -->
									<h4 class="list-title">Different color radio and checkbox</h4>
									<p>Add class <code>.radio</code> and <code>.checkbox</code> to make it.</p>
									<div class="radio radio-danger">
										<input type="radio" checked="" value="option2" id="radio4" name="radio3">
										<label for="radio4">
										One
										</label>
									</div>
									<div class="radio radio-warning">
										<input type="radio" value="option1" id="radio3" name="radio3">
										<label for="radio3">
										Next
										</label>
									</div>
									<div class="checkbox checkbox-danger">
										<input type="checkbox" checked="" class="styled" id="checkbox6">
										<label for="checkbox6">
										Check me out
										</label>
									</div>
									<div class="checkbox checkbox-warning margin-bottom-0">
										<input type="checkbox" checked="" class="styled" id="checkbox5">
										<label for="checkbox5">
										Check me out
										</label>
									</div>
