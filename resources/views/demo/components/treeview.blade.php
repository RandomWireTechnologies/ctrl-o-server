...
<html>
	<head>
		...
		<title>Treeview | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="dashboard site-navbar-small list">
						...
						<div class="row">
							<div class="col-md-4 col-sm-4">
								<div class="page-wrap">
									...
									<div>
										<div data-plugin="treeview" data-source="getPageTreeview" id="basicTreeview"></div>
									</div>
								</div>
							</div>
							<div class="col-md-4 col-sm-4">
								<div class="page-wrap">
									<!--  Collapsed Treeview -->
									<h4 class="list-title">Collapsed</h4>
									<div>
										<div data-plugin="treeview" data-source="getPageTreeview" data-levels="1" id="treeviewCollapsed"></div>
									</div>
								</div>
							</div>
							<div class="col-md-4 col-sm-4">
								<div class="page-wrap">
									<!--  Expanded Treeview -->
									<h4 class="list-title">Expanded</h4>
									<div>
										<div data-plugin="treeview" data-source="getPageTreeview" data-levels="99" id="expandedTreeview"></div>
									</div>
								</div>
							</div>
							...
							<div class="col-md-4 col-sm-4">
								<div class="page-wrap">
									<!--  Custom Icons Treeview -->
									<h4 class="list-title">Custom icons</h4>
									<div>
										<div data-plugin="treeview" data-source="getPageTreeview" data-expand-icon="icon arrow_carrot-right"
											data-collapse-icon="icon arrow_carrot-down" data-node-icon="icon icon_ribbon"
											id="customIconstreeview"></div>
									</div>
								</div>
							</div>
							<div class="col-md-4 col-sm-4">
								<div class="page-wrap">
									...
									<h4 class="list-title">Tags as badges</h4>
									<div>
										<div class="treebadges" data-plugin="treeview" data-source="getPageTreeview" data-expand-icon="icon icon_check"
											data-collapse-icon="icon icon_check_alt" data-node-icon="icon icon_profile"
											data-show-tags="true" id="treeviewTagsAsBadges"></div>
									</div>
								</div>
							</div>
							<div class="col-md-4 col-sm-4">
								<div class="page-wrap">
									<h4 class="list-title">Json data</h4>
									<div>
										<div id="pageJsonData"></div>
									</div>
								</div>
							</div>
							<div class="clearfix"></div>
							<div class="col-md-4 col-sm-4">
								<div class="page-wrap margin-md-0 margin-sm-0">
									<!--  Searchable Treeview -->
									<h4 class="list-title">Searchable tree</h4>
									<form class="form-group" id="pageSearchForm" role="search">
										<div class="input-search">
							...
							<div class="col-md-4 col-sm-4">
								<div class="page-wrap margin-md-0 margin-sm-0">
									<!--  Expandible Treeview -->
									<h4 class="list-title">Expandible tree</h4>
									<button type="button" class="btn btn-info waves-effect waves-light margin-bottom-15" id="pageExpandAll">Expand All</button>
									<button type="button" class="btn btn-info waves-effect waves-light margin-bottom-15" id="pageCollapseAll">Collapse All</button>
									<div>
										<div id="treeviewexpandible"></div>
									</div>
								</div>
							</div>
							<div class="col-md-4 col-sm-4">
		...
		<script src="../assets/js/treeview/treeview.min.js"></script>
