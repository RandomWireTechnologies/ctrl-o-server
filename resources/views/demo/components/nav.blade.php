...
<html lang="en">
	<head>
		...
		<title>Nav | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="dashboard site-navbar-small">
		...
		<div class="main-content navs">
			<div class="page-header">
				<div class="header-left-panel">
					<!-- Title Page -->
					<h1 class="page-title">Nav</h1>
					<!-- Breadcrumb Section -->
					<ol class="breadcrumb">
			...
			<div class="page-content container-fluid nav-tab">
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Pills Nav -->
									<h4 class="list-title">Pills</h4>
									<p>Pills are created with <code>.nav-pills</code> class.</p>
									<div class="nav-box-content panel-box-shadow">
										<ul class="nav nav-pills">
											<li class="active" role="presentation"><a href="javascript:void(0)">Home</a></li>
											<li role="presentation"><a href="javascript:void(0)">Menu1</a></li>
											<li class="disabled" role="presentation"><a href="javascript:void(0)">Menu2</a></li>
										</ul>
									</div>
								</div>
							</div>
							<div class="col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Pills With Icon Nav -->
									<h4 class="list-title">Pills with icon</h4>
									<p><code>.nav-pills</code> with different icon.</p>
									<div class="nav-box-content panel-box-shadow">
										<ul class="nav nav-pills">
											<li class="active" role="presentation"><a href="javascript:void(0)"><i class="  icon_pencil" aria-hidden="true"></i> Home</a></li>
											<li role="presentation"><a href="javascript:void(0)"><i class="icon_profile" aria-hidden="true"></i> Menu</a></li>
											<li class="disabled" role="presentation"><a href="javascript:void(0)"><i class="icon_tool " aria-hidden="true"></i> Menu2</a></li>
										</ul>
									</div>
								</div>
							</div>
							<div class="col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Justified Pills Nav -->
									<h4 class="list-title">Justified pills</h4>
									<p>Easily make tabs or pills equal widths of their parent at screens wider than 768px with <code>.nav-justified</code>.</p>
									<div class="nav-box-content panel-box-shadow">
										<ul class="nav nav-pills nav-justified">
											<li class="active" role="presentation"><a href="javascript:void(0)"><i class="  icon_pencil" aria-hidden="true"></i> Home</a></li>
											<li role="presentation"><a href="javascript:void(0)"><i class="icon_profile" aria-hidden="true"></i> Menu1</a></li>
											<li role="presentation"><a href="javascript:void(0)"><i class="icon_tool " aria-hidden="true"></i> Menu2</a></li>
										</ul>
									</div>
								</div>
							</div>
							<div class="col-sm-6 col-xs-12">
								<div class="page-wrap">
									...
									<h4 class="list-title">Pills with dropdowns</h4>
									<p>Add dropdown menu with pills.</p>
									<div class="nav-box-content panel-box-shadow">
										<ul class="nav nav-pills">
											<li class="active" role="presentation"><a href="javascript:void(0)"><i class="icon_pencil" aria-hidden="true"></i> Menu1</a></li>
											<li class="dropdown" role="presentation">
												<a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0)" aria-expanded="false" role="button">
												<i class=" icon_menu" aria-hidden="true"></i> Dropdown
							...
							<div class="col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Tabs With Dropdown Nav -->
									<h4 class="list-title">Tabs with dropdown menu</h4>
									<p>Tabs can also be display with droupdown menu.</p>
									<div class="nav-box-content panel-box-shadow">
										<ul class="nav nav-tabs">
											<li class="active"><a href="javascript:void(0)">Home</a></li>
											<li class="dropdown">
												<a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0)">Menu 1 <span class="caret"></span></a>
												<ul class="dropdown-menu">
													<li><a href="javascript:void(0)">Submenu 1-1</a></li>
							...
							<div class="col-sm-6 col-xs-12 col-md-6">
								<div class="page-wrap">
									<!-- Stacked Pills Nav -->
									<h4 class="list-title">Stacked pills</h4>
									<p>Pills can also be display in vertically. for this use <code>.nav-stacked</code> class.</p>
									<div class="nav-box-content panel-box-shadow">
							...
							<div class="col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Tabs Nav -->
									<h4 class="list-title">Nav tabs</h4>
									<p>Tabs are created with <code>.nav-tabs</code> class which require <code>.nav</code> base class.</p>
									<div class="nav-box-content panel-box-shadow">
										<ul class="nav nav-tabs">
											<li class="active"><a data-toggle="tab" href="javascript:void(0)" aria-expanded="true">Home</a></li>
											<li class=""><a data-toggle="tab" href="javascript:void(0)" aria-expanded="false">Menu1</a></li>
											<li class=""><a data-toggle="tab" href="javascript:void(0)" aria-expanded="false">Menu2</a></li>
										</ul>
									</div>
								</div>
							</div>
							<div class="col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Nav Tabs Line Nav -->
									<h4 class="list-title">Nav tabs line</h4>
									<p>If user want to tabs in line, use <code>.nav-tabs-line</code> class.</p>
									<div class="nav-box-content panel-box-shadow nav-tabs-horyzontal">
										<ul class="nav nav-tabs nav-tabs-line hover-none">
											<li  class="active"><a data-toggle="tab" href="javascript:void(0)">Home</a></li>
											<li><a data-toggle="tab" href="javascript:void(0)">Menu1</a></li>
											<li><a data-toggle="tab" href="javascript:void(0)">Menu2</a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Tabs Justified Nav -->
									<h4 class="list-title">Nav tabs justified</h4>
									<p>Tabs justified with use of <code>.nav-justified</code> class.</p>
									<div class="nav-box-content panel-box-shadow">
										<ul class="nav nav-tabs">
										...
										<div class="tab-content">
											<div id="home" class="tab-pane fade in active">
												<h4>Home</h4>
												<p class="margin-bottom-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua psum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore  psum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
											</div>
											<div id="menu1" class="tab-pane fade">
												<h4>Menu 1</h4>
												<p class="margin-bottom-0">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.  </p>
											</div>
											<div id="menu2" class="tab-pane fade">
												<h4>Menu 2</h4>
												<p class="margin-bottom-0">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur.</p>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Tabs vertial Nav -->
									<h4 class="list-title">Nav tabs vertical</h4>
									<p>Tabs can also display in vertial.</p>
									<div class="nav-box-content panel-box-shadow">
										<div class="nav-tabs-vertical nav-overflow">
											<ul class="nav nav-tabs">
												<li class="active"><a data-toggle="tab" href="javascript:void(0)">Home</a></li>
												<li><a data-toggle="tab" href="javascript:void(0)">Menu1</a></li>
												<li><a data-toggle="tab" href="javascript:void(0)">Menu2</a></li>
												<li><a data-toggle="tab" href="javascript:void(0)">Menu3</a></li>
											</ul>
										</div>
									</div>
								</div>
							...
							<div class="col-md-12">
								<div class="page-wrap margin-bottom-0">
									<!-- Start Quick Menu Box -->
									<h4 class="list-title">Quick menu</h4>
									<p>Quick menu with different style.</p>
									<div class="row ">
										<div class="col-md-2 col-sm-6">
											<div class="menu-item-nav blue first-nav-menu">
												<i class="icon icon_mail _alt" aria-hidden="true"></i> 
												<h3>4</h3>
												<hr class="primary" />
												<p>Mail</p>
											</div>
										...
										<div class="col-md-2  col-sm-6">
											<div class="menu-item-nav light-red">
												<i class="icon  icon_upload" aria-hidden="true"></i>
												<h3>7</h3>
												<hr class="primary" />
												<p>Upload</p>
											</div>
										...
										<div class="col-md-2  col-sm-6">
											<div class="menu-item-nav color">
												<i class="icon  icon_info_alt" aria-hidden="true"></i>
												<h3>12</h3>
												<hr class="primary" />
												<p>Notification</p>
											</div>
										...
										<div class="clearfix visible-sm-block"></div>
										<div class="col-md-2  col-sm-6">
											<div class="menu-item-nav yellow">
												<i class="icon  icon_upload" aria-hidden="true"></i>
												<h3>7</h3>
												<hr class="primary" />
												<p>Upload</p>
										...
										<div class="col-md-2  col-sm-6">
											<div class="menu-item-nav light-orange">
										...
										<div class="col-md-2  col-sm-6">
											<div class="menu-item-nav purple">
												<i class="icon icon_profile" aria-hidden="true"></i>
												<h3>8</h3>
												<hr class="primary" />
												<p>Viewer</p>
									...
									<div class="row">
										<div class="col-md-3  col-sm-6">
											<div class="menu-item-nav light-yellow">
												<i class="icon icon_profile" aria-hidden="true"></i>
												<h3>8</h3>
												<hr class="primary" />
												<p>Viewer</p>
