...
<html lang="en">
	<head>
		...
		<title>Panel Transition | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="site-navbar-small">
		...
		<div class="main-content panel-trasition">
			<div class="page-header">
				<div class="header-left-panel">
					<!--  Title Page -->
					<h1 class="page-title">Panel transition</h1>
					<!--  Breadcrumb Section -->
					<ol class="breadcrumb">
						<li><a href="../dashboard_v1.html">Home</a></li>
						<li class="text-info">Basic UI</li>
						<li class="active">Panel transition</li>
					</ol>
				</div>
				<div class="header-right-panel">
					<!--  Button Effect Section -->
					<button type="button" data-type="fade" class="btn btn-info waves-effect waves-light">Fade</button>
					<button type="button" data-type="scale-up" class="btn btn-info waves-effect waves-light">Scale Up</button>
					<button type="button" data-type="slide-left" class="btn btn-info waves-effect waves-light">Slide Left</button>
					<button type="button" data-type="slide-right" class="btn btn-info waves-effect waves-light">Slide Right</button>
					<button type="button" data-type="slide-top" class="btn btn-info waves-effect waves-light">Slide Top</button>
					<button type="button" data-type="slide-bottom" class="btn btn-info waves-effect waves-light">Slide Bottom</button>
				</div>
			</div>
			<div id="pageTransition" class="page-content container-fluid" data-plugin="animateList">
				<div class="row">
					<!--  Start Panel Box Section -->
					<div class="col-lg-4 col-sm-6 col-xs-12">
						<div class="panel panel-bordered">
							<div class="panel-heading">
								<h3 class="panel-title">Panel Title</h3>
								<div class="panel-actions">
									<a class="btn-panel btn-info icon icon_refresh waves-effect waves-light" data-toggle="panel-refresh" data-load-type="blue-only"
										data-load-callback="customRefreshCallback" aria-hidden="true"></a>
									<a class="btn-panel btn-info icon icon_minus-06 waves-effect waves-light" aria-expanded="true" data-toggle="panel-collapse"
										aria-hidden="true"></a>
									<a class="btn-panel btn-info icon arrow_expand waves-effect waves-light" data-toggle="panel-fullscreen" aria-hidden="true"></a>
									<a class="btn-panel btn-info icon icon_close waves-effect waves-light" data-toggle="panel-close" aria-hidden="true"></a>
								</div>
							</div>
