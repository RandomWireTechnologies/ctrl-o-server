...
<html lang="en">
	<head>
		...
		<title>Social Widgets| Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="socialWidget site-navbar-small social-widget">
		...
		<div class="main-content">
			<div class="page-header">
				<div class="header-left-panel">
					<!-- Title Page -->
					<h1 class="page-title">Social widgets</h1>
					<!-- Breadcrumb Section -->
					<ol class="breadcrumb">
						<li><a href="../dashboard_v1.html">Home</a></li>
						<li class="text-info">Widgets</li>
						<li class="active">Social widgets</li>
					</ol>
				</div>
			</div>
			<div class="page-content social-widget">
				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="static-box padding-0 pull-left">
							<div class="my-profile-widget">
								<!-- Profile Image And Social Icon Widget -->
								<div class="profile-widget-head">
									<h3 class="white font-24 font-xs-18 margin-bottom-0">Herry Soviet</h3>
									<p class="white">Designer in Google</p>
									<span class="avatar avatar-lg80 height-80"><img alt="social-user" class="padding-0" src="../assets/images/global/img_240x265.png"></span>
								</div>
								<p>Porttitor ac ipsum vestibulum cursus magna hendrerit accumsan nostra. Dolor ligula orci.</p>
								<div class="social-follow">
									<ul class="padding-10 border-top">
										<li><a href="javascript:void(0)"><span><i class="fa fa-heart purple"></i></span> <span class="text-muted">1,147</span></a></li>
										<li><a href="javascript:void(0)"><span><i class="fa fa-share-alt background-info"></i> </span><span class="text-muted">3,584</span></a></li>
										<li><a href="javascript:void(0)"><span><i class="fa fa-comment green"></i></span> <span class="text-muted">2,145</span></a></li>
									</ul>
								</div>
							</div>
						</div>
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="static-box padding-0 pull-left">
							<div class="my-profile-widget">
								<!-- name And Social Icon Widget -->
								<div class="profile-widget-head">
									<h3 class="white">Labrin Scholar</h3>
									<span class="avatar avatar-lg80 height-80"><img alt="" class="padding-0" src="../assets/images/global/img_240x265.png"></span>
								</div>
								<h4 class="text-center">@labrin_scholar</h4>
								<p>Habitasse penatibus venenatis eget nec rhoncus dignissim. Non velit lorem.</p>
								<div class="social-follow">
									<ul class="padding-10 border-top">
										<li><a href="javascript:void(0)"><span><i class="fa fa-heart purple"></i></span> <span class="text-muted">1,147</span></a></li>
										<li><a href="javascript:void(0)"><span><i class="fa fa-share-alt background-info"></i> </span><span class="text-muted">3,584</span></a></li>
					...
					<div class="col-md-12 col-sm-12 col-xs-12 col-lg-6">
						<div class="row">
							<div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
								<div class="static-box bg-cyan-500">
									<!-- Email With Social Widget -->
									<div class="display-table vertical-align-middle">
										<div class="type-3 padding-right-15 avatar avatar-lg80">
											<img src="../assets/images/global/img_240x265.png" class="follow-img pull-left" alt="social-user">
										</div>
										<div class="type-3 text-left white">
											<h3 class="margin-vertical-0 white">Jeny</h3>
											<p class="margin-bottom-0 font-13"><a href="#">jeny@gmail.com</a></p>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
								<div class="static-box bg-purple-400">
									<!-- Email With Social Widget -->
									<div class="display-table vertical-align-middle">
										<div class="type-3 padding-right-15 avatar avatar-lg80">
											<img src="../assets/images/global/img_240x265.png" class="follow-img pull-left" alt="social-user">
										...
										<div class="type-3 text-left white">
											<h3 class="margin-vertical-0 white">Alex</h3>
											<p class="margin-bottom-0 font-13"><a href="#">alex@gmail.com</a></p>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
								<div class="widgett widgett-article widgett-shadow">
									<div class="widgett-header cover padding-0 bg-blue-500">
										<!-- blockquote With Social Widget -->
										<div class="background-cover padding-15">
											<blockquote class="quote-cover padding-left-35 padding-horizontal-10 white gray_template-gray">Malesuada vulputate nunc. Facilisi maecenas ridiculus varius hymenaeos euismod. Vestibulum ligula suspendisse conubia at libero Sollicitudin ipsum facilisis potenti parturient.</blockquote>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12 col-lg-12">
								<div class="widgett widgett-article widgett-shadow">
									<div class="row">
										<div class="col-sm-12">
											<!-- Button With Social Widget -->
											<div class="back-img-user padding-top-35 margin-bottom-0">
												<div class="avatar avatar-lg avatar-xs-lg">
													<img src="../assets/images/global/img_240x265.png" alt="">
												</div>
												<h3>Brian Kellvin</h3>
												<span>@briankellvin</span><br>
												<a href="#0" class="btn btn-info  mobile-btn-login btn-sign waves-effect waves-dark">Follow us</a>
												<div class="social-follow">
													<ul>
														<li><a href="javascript:void(0)"><span><i class="fa fa-heart purple"></i></span> <span>1,147</span></a></li>
														<li><a href="javascript:void(0)"><span><i class="fa fa-share-alt background-info"></i> </span><span>3,584</span></a></li>
														<li><a href="javascript:void(0)"><span><i class="fa fa-comment green"></i></span> <span>2,145</span></a></li>
													</ul>
												</div>
											</div>
										</div>
							...
							<div class="col-md-6 col-sm-12 col-xs-12 col-lg-12">
								<div class="widgett widgett-article widgett-shadow">
									<!-- blockquote With Social Widget -->
									<div class="widgett-header cover padding-0">
										<div class="background-cover padding-15" style="background-image: url('../assets/images/social/img_2048x1152.jpg');">
											<blockquote class="quote-cover padding-left-35 padding-horizontal-10 white gray_template-gray">Malesuada vulputate nunc. Facilisi maecenas ridiculus varius hymenaeos euismod. Vestibulum ligula suspendisse conubia at libero Sollicitudin ipsum facilisis potenti parturient.</blockquote>
										</div>
									</div>
									<div class="widgett-footer text-center ">
										<div class="social-follow1">
											<ul class="">
												<li><a href="javascript:void(0)" class="text-muted"><span><i class="fa fa-heart"></i></span> <span>1,821</span></a></li>
												<li><a href="javascript:void(0)" class="text-muted"><span><i class="fa fa-share-alt"></i> </span><span>2,415</span></a></li>
												<li><a href="javascript:void(0)" class="text-muted"><span><i class="fa fa-comment"></i></span> <span>1,254</span></a></li>
											</ul>
										</div>
									</div>
								</div>
							...
							<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
								<div class="widgett widgett-shadow avatar-group"  style=" background-image: url('../assets/images/social/img_2048x1152.jpg');background-size: cover;">
									<!-- Multiple Profile With Social Widget -->
									<div class="widgett-header text-center padding-30">
										<ul class="list-unstyled list-inline">
											<li>
												<a class="avatar avatar-md margin-5" href="javascript:void(0)">
												<img src="../assets/images/global/img_240x265.png" alt="social-user">
												</a>
											</li>
											<li>
												<a class="avatar avatar-md margin-5" href="javascript:void(0)">
										...
										<div class="font-size-18 white">Amazing Surge</div>
										<div class="font-size-14 white">Design</div>
									</div>
									<div class="widgett-footer white text-center overlap-background">
										<div class="social-follow1">
											<ul class="">
												<li><a href="javascript:void(0)" class="white"><span><i class="fa fa-heart"></i></span> <span>1,821</span></a></li>
												<li><a href="javascript:void(0)" class="white"><span><i class="fa fa-share-alt"></i> </span><span>2,415</span></a></li>
												<li><a href="javascript:void(0)" class="white"><span><i class="fa fa-comment"></i></span> <span>1,254</span></a></li>
											</ul>
										</div>
									</div>
								</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-12 col-lg-12">
								<div class="widgett widgett-shadow">
									<!-- Background With Social Widget -->
									<div class="widgett-header overlap">
										<div class="cover-background height-150" style="background-image: url('../assets/images/social/img_1920x1280.jpg'); background-size: cover;"></div>
									</div>
									<div class="widgett-body padding-horizontal-30 padding-vertical-20" style="height:calc(100% - 250px);">
										<div class="display-table">
											<a class="type-3 avatar avatar-lg80 avatar-xs-lg" href="javascript:void(0)">
											<img src="../assets/images/global/img_240x265.png" alt="social-user">
											</a>
											<div class="type-3 padding-left-15">
												<h4 class="margin-vertical-0">Herry Jack</h4>
												<span class="text-muted"><a href="#">herry@yahoo.com</a></span>
											</div>
										</div>
									</div>
									<div class="widgett-footer bg-grey-500 text-center">
										<div class="social-follow1">
											<ul class="">
												<li><a href="javascript:void(0)" class="white"><span><i class="fa fa-heart"></i></span> <span>1,821</span></a></li>
												<li><a href="javascript:void(0)" class="white"><span><i class="fa fa-share-alt"></i> </span><span>2,415</span></a></li>
							...
							<div class="col-md-6 col-sm-6 col-xs-12 col-lg-12">
								<div class="widgett widgett-article widgett-shadow">
									<!-- Backoground And Profile Image With Social Widget -->
									<div class="widgett-header cover padding-0 overlap">
										<img class="image-cover" src="../assets/images/social/img_1920x1280.jpg" alt="social-img">
										<div class="widgett-info v-align">
											<div class="align-middle padding-15">
												<div class="inner-middle">
													...
													<h3 class="margin-bottom-0 margin-top-20 margin-top-xs-5">Abel Kellvin</h3>
													<span class="pull-left width-100">@abelkellvin</span><br>
												</div>
											</div>
										</div>
									</div>
					...
					<div class="col-md-12 col-sm-12 col-xs-12 col-lg-6">
						<div class="row">
							<div class="col-md-6 col-sm-6 col-xs-12 col-lg-12">
								<div class="widgett widgett-article widgett-shadow">
									<!-- Profile Name With Social Widget -->
									<div class="widgett-header cover padding-0 overlap">
										<img class="image-cover" src="../assets/images/blog/blog3.jpeg" alt="blog-image">
										<div class="widgett-info v-align">
											<div class="align-middle padding-15">
												<div class="inner-middle">
													<div class="avatar avatar-lg80 avatar-xs-lg">
														<img src="../assets/images/global/img_240x265.png" alt="social-user">
													</div>
													<h4 class="white font-24 font-xs-18 margin-bottom-0">Mark Keller</h4>
													<span class="pull-left text-center width-100">mark123@gmail.com</span>
												</div>
											</div>
										</div>
									</div>
									<div class="">
										<div class="widgett-footer">
											<div class="social-follow1">
												<ul class="">
													<li><a href="javascript:void(0)"><span><i class="fa fa-heart"></i></span> <span>1,147</span></a></li>
													<li><a href="javascript:void(0)"><span><i class="fa fa-share-alt"></i> </span><span>3,584</span></a></li>
													<li><a href="javascript:void(0)"><span><i class="fa fa-comment"></i></span> <span>2,145</span></a></li>
												</ul>
											</div>
										</div>
									</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-12 col-lg-12">
								<div class="widgett widgett-article widgett-shadow">
									<!-- Profile Name And Email With Social Widget -->
									<div class="widgett-header cover padding-0 overlap">
										<img class="image-cover" src="../assets/images/social/img_1920x1280.jpg" alt="blog-image">
										<div class="widgett-info v-align">
											<div class="align-middle">
												<div class="inner-middle">
													<div class="inline-block">
														<div class="type-3 avatar avatar-lg80 avatar-xs-lg">
															<img src="../assets/images/global/img_240x265.png" class="follow-img pull-left" alt="social-user">
														</div>
														<div class="type-3 text-center padding-left-15">
															<h4 class="white margin-vertical-0 font-24 font-xs-18">Aline Rachel</h4>
															<span class="pull-left text-center width-100"><a href="#">aline@gmail.com</a></span>
														</div>
													</div>
												</div>
											</div>
									...
									<div class="">
										<div class="widgett-footer text-center">
											<div class="social-follow1">
												<ul class="">
													<li><a href="javascript:void(0)"><span><i class="fa fa-heart"></i></span> <span>2,458</span></a></li>
													<li><a href="javascript:void(0)"><span><i class="fa fa-share-alt"></i> </span><span>3,541</span></a></li>
													<li><a href="javascript:void(0)"><span><i class="fa fa-comment"></i></span> <span>1,254</span></a></li>
												</ul>
											</div>
										</div>
									</div>
							...
							<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
								<div class="panel top-profile">
									<!-- Social Icon And Profile Image With Social Widget -->
									<div class="profile-bottom">
										<div class="name-profile">Munaro Jacob</div>
										<div class="post-profile">Project Manager</div>
									</div>
									<div class="profile-image"><img src="../assets/images/blog/img_890x593.jpeg" alt="profile-image"></div>
									<div class="col-md-12">
							...
							<div class="col-md-6 col-sm-6 col-xs-12 col-lg-12">
								<div class="widgett widgett-shadow">
									<!-- Background Image Overlay With Social Widget -->
									<div class="widgett-header overlap">
										<div class="cover-background height-150" style="background-image: url('../assets/images/social/img_1920x1280.jpg'); background-size: cover;"></div>
									</div>
									<div class="widgett-body padding-horizontal-30 padding-vertical-20" style="height:calc(100% - 250px);">
										<div class="dspl">
											...
											<div class="type-3 padding-left-15">
												<h3 class="margin-vertical-0">Caleb Richards</h3>
												<span class="text-muted">@caleb_richards</span>
											</div>
										</div>
										<p class="padding-top-15 margin-bottom-0">Reiciendis iactant eligendi. Vestrae referenda mundus asperum physico miserum viderer.</p>
									</div>
									<div class="widgett-footer white text-center">
										<div class="social-follow1">
											<ul class="border-top">
												<li><a href="javascript:void(0)"><span><i class="fa fa-heart"></i></span> <span>1,821</span></a></li>
												<li><a href="javascript:void(0)"><span><i class="fa fa-share-alt"></i> </span><span>2,415</span></a></li>
												<li><a href="javascript:void(0)"><span><i class="fa fa-comment"></i></span> <span>1,254</span></a></li>
											</ul>
										</div>
									</div>
							...
							<div class="col-md-6 col-sm-6 col-xs-12 col-lg-12">
								<div class="widgett widgett-article widgett-shadow">
									<!-- Location With Social Widget -->
									<div class="widgett-header height-150 cover padding-0 text-center overlap">
										<img class="img-cover" src="../assets/images/social/img_1920x1280.jpg" alt="social-user">
										<div class="widgett-info v-align">
											<div class="widgett-head-label">
												<button type="button" class="btn btn-danger waves-effect waves-light">USA</button>
											</div>
											<div class="align-middle">
												<div class="inner-middle">
													<div class="inline-block">
														<div class="type-3 avatar avatar-lg80 avatar-xs-lg padding-right-15">
															<img class="" src="../assets/images/global/img_240x265.png" alt="social-user"> 
														</div>
														<div class="type-3 text-center">
															<h4 class="white margin-vertical-0 font-24 font-xs-18">Vale Lewis</h4>
															<span class="pull-left text-center width-100">@donald_lewis</span>
														</div>
													</div>
												</div>
											</div>
									...
									<div class="widgett-body padding-20">
										<h4 class="text-center margin-top-0"> Carol Taylor</h4>
										<p class="text-center margin-bottom-0">Facilisis pretium consequat etiam conubia. Montes eu viverra nonummy urna. </p>
									</div>
									<div class="widgett-footer text-center">
										<div class="social-follow1">
											<ul class="border-top">
