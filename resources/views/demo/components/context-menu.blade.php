...
<html lang="en">
	<head lang="en">
		...
		<title>Context Menu | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="dashboard site-navbar-small">
			...
			<div class="page-content">
				<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">Context menu
							<span class="panel-desc-buttom">Right click inside the box to trigger the menu.</span>
						</h3>
					</div>
						...
						<div class="row row-lg">
							<div class="col-md-6">
								<div class="page-wrap">
									...
									<div id="defaultcontext" class="context-well height-200" data-toggle="context" data-target="#contextMenu1"></div>
									<div id="contextMenu1">
										<ul class="dropdown-menu" role="menu">
											<li><a><i class="icon icon_documents_alt" aria-hidden="true"></i> Copy</a></li>
											<li><a><i class="icon icon_id" aria-hidden="true"></i> Cut</a></li>
											<li><a><i class="icon icon_document_alt" aria-hidden="true"></i> Paste</a></li>
											<li class="divider"></li>
											<li><a><i class="icon social_share" aria-hidden="true"></i> Share</a></li>
										</ul>
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="page-wrap">
									<!--  Active Context Menu -->
									<h4 class="list-title">Active</h4>
									<div id="context2" data-toggle="context" data-target="#contextmenu2">This is an area where the context menu is active
										<span class="comtext-grey">However, we wont allow it here.</span> But anywhere else in this text should be perfectly fine. This one is started with only javascript.
									</div>
									<div id="contextmenu2">
										<ul class="dropdown-menu" role="menu">
											<li><a><i class="icon icon_documents_alt" aria-hidden="true"></i> Copy</a></li>
							...
							<div class="col-md-6">
								<div class="page-wrap">
									<!--  Action With Context Menu -->
									<h4 class="list-title">Context With Action</h4>
									<p>Show the menu name of the item that was selected.</p>
									<div id="contextaction" class="context-well height-200 margin-bottom-0" data-toggle="context" data-target="#contextmenu3"></div>
									<div id="contextmenu3">
										<ul class="dropdown-menu" role="menu">
											<li><a><i class="icon icon_documents_alt" aria-hidden="true"></i> Copy</a></li>
											<li><a><i class="icon icon_id" aria-hidden="true"></i> Cut</a></li>
		...
		<!-- Page JavaScript -->
		<script src="../assets/plugin/bootstrap-contextmenu/js/bootstrap-contextmenu.js"></script>
	</body>
</html>
