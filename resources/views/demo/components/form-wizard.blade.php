...
<html lang="en">
	<head>
		...
		<title>Form Wizard | Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<!-- Page CSS -->
		<link rel="stylesheet" href="../assets/plugin/jQuery-Form-Validator/css/theme-default.css" />
		<link rel="stylesheet" href="../assets/css/form-advanced/demo_style.css" />
		<link rel="stylesheet" href="../assets/css/form-advanced/smart_wizard.css" />
		<!--  Global Template CSS -->
	...
	<body class="basic-table site-navbar-small">
		...
		<div class="main-content">
			...
			<div class="page-content validation">
				<div class="row">
					<div class="col-lg-6">
						<div class="panel">
							<!-- Start Form Wizard Vertical Section -->
							<div class="panel-heading">
								<h3 class="panel-title">Form Wizard Vertical</h3>
							</div>
							<div class="panel-body">
								<div data-toggle="wizard" class="form-wizard wizard-vertical">
									<ol>
										<li>
									...
									<div>
										<p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. beatae vitae dicta sunt explicabo. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? sint occaecati cupiditate.</p>
									</div>
									<div>
										<p>Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur? At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium. voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio.</p>
									</div>
									<div>
										<p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. beatae vitae dicta sunt explicabo. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur?</p>
									</div>
									<div>
										<div class="jumbotron margin-0">
											<h3 class="text-info">Done!</h3>
											<h5>Sed ut perspiciatis unde omnis iste.</h5>
											<p>
												<button type="button" class="btn w-icon btn-info waves-effect waves-light">Proceed Now</button>
											</p>
										</div>
									</div>
								</div>
							</div>
							<!-- End Form Wizard Vertical Section -->
						</div>
					</div>
					<div class="col-lg-6">
						<div class="panel">
							<!-- Start Form Wizard Vertical Style Section -->
							<div class="panel-heading">
								<h3 class="panel-title">Vertical Style</h3>
							</div>
							<div class="panel-body">
								<div id="wizard_verticle" class="form_wizard wizard_verticle">
									<ul class="list-unstyled wizard_steps margin-bottom-0">
										<li>
											<a href="#step-11">
									...
									<div id="step-11">
										<h4 class="StepTitle margin-bottom-15">Step 1 Content</h4>
									...
									<div id="step-22">
										<h4 class="StepTitle margin-bottom-15">Step 2 Content</h4>
										<p>Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur? At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium.
									...
									<div id="step-33">
										<h4 class="StepTitle margin-bottom-15">Step 3 Content</h4>
										<p>beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.
											Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur.
										</p>
									</div>
									<div id="step-44">
										<h4 class="StepTitle margin-bottom-15">Step 4 Content</h4>
										<p>Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur? At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium.
											voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio.
										</p>
									</div>
							...
							<!-- End Form Wizard Vertical Style Section -->
						</div>
					</div>
				</div>
				<div class="panel">
					<!-- Start Horizontal With Validation Section -->
					<div class="panel-heading">
						<h3 class="panel-title">Form Wizard Horizontal with validation</h3>
					</div>
					<div class="panel-body">
						<table>
							<tr>
										...
										<div id="wizard" class="swMain">
											<ul>
												<li><a href="#step-1">
													...
													<span class="stepDesc">
													Account Details<br />
													<small>Duis volutpat nunc at ligula.</small>
													</span>
													</a>
												</li>
												<li><a href="#step-2">
													...
													<span class="stepDesc">
													Profile Details<br />
													<small>Nulla pharetra imperdiet.</small>
													</span>
													</a>
												</li>
												<li><a href="#step-3">
													...
													<span class="stepDesc">
													Contact Details<br />
													<small>Sed elementum lorem dolor.</small>
													</span>
													</a>
												</li>
												<li><a href="#step-4">
													...
													<span class="stepDesc">
													Other Details<br />
													<small>Nullam sit amet magna.</small>
													</span>
													</a>
												</li>
											</ul>
												...
												<div id="step-1">
													...
													<div class="row">
														<div class="col-md-4 col-sm-4" style="text-align: left">
															<input type="text" id="username" placeholder="Username" name="username" value="" class="txtBox form-control">
															<div style="text-align: left"><span id="msg_username"></span>&nbsp;</div>
														</div>
														<div class="col-md-4 col-sm-4" style="text-align: left">
															<input type="password" placeholder="Password" id="password" name="password" value="" class="txtBox form-control">
															<div style="text-align: left"><span id="msg_password"></span>&nbsp;</div>
														</div>
														<div class="col-md-4 col-sm-4" style="text-align: left">
															<input type="password" placeholder="Confirm Password" id="cpassword" name="cpassword" value="" class="txtBox form-control">
															<div style="text-align: left"><span id="msg_cpassword"></span>&nbsp;</div>
														</div>
													</div>
												</div>
												<div id="step-2">
													...
													<div class="row">
														<div class="col-md-4 col-sm-4" style="text-align: left">
															<input type="text" id="firstname" placeholder="First Name" name="firstname" value="" class="txtBox form-control">
															<div style="text-align: left"><span id="msg_firstname"></span>&nbsp;</div>
														</div>
														<div class="col-md-4 col-sm-4" style="text-align: left">
															<input type="text" id="lastname" placeholder="Last Name" name="lastname" value="" class="txtBox form-control">
															<div style="text-align: left"><span id="msg_lastname"></span>&nbsp;</div>
														</div>
														<div class="col-md-4 col-sm-4" style="text-align: left">
															<select id="gender" name="gender" class="txtBox form-control">
																<option value="Male">Male</option>
																<option value="Female">Female</option>
															</select>
															<div style="text-align: left"><span id="msg_gender"></span>&nbsp;</div>
														</div>
													</div>
												</div>
												<div id="step-3">
													...
													<div class="row">
														<div class="col-md-4 col-sm-4" style="text-align: left">
															<input type="text" id="email" placeholder="Email" name="email" value="" class="txtBox form-control">
															<div style="text-align: left"><span id="msg_email"></span>&nbsp;</div>
														</div>
														<div class="col-md-4 col-sm-4" style="text-align: left">
															<input type="text" id="phone" placeholder="Phone" name="phone" value="" class="txtBox form-control">
															<div style="text-align: left"><span id="msg_phone"></span>&nbsp;</div>
														</div>
														<div class="col-md-4 col-sm-4" style="text-align: left">
															<input type="text" name="address" id="address" placeholder="Address" value="" class="txtBox form-control">
															<div style="text-align: left"><span id="msg_address"></span>&nbsp;</div>
														</div>
													</div>
												</div>
												<div id="step-4">
													...
													<div class="row">
														<div class="col-md-6 col-sm-6" style="text-align: left">
															<input type="text" id="hobbies" placeholder="Hobbies" name="phone" value="" class="txtBox form-control">
															<div style="text-align: left"><span id="hobbies_detail"></span>&nbsp;</div>
														</div>
														<div class="col-md-6 col-sm-6" style="text-align: left">
															<textarea name="address" id="address2" placeholder="About You" class="txtBox form-control" rows="2"></textarea>
															<div style="text-align: left"><span id="msg_address2"></span>&nbsp;</div>
														</div>
													</div>
												</div>
											</div>
					...
					<!-- End Horizontal With Validation Section -->
				</div>
				<div class="panel">
					<!-- Start Form Wizard Horizontal Section -->
					<div class="panel-heading">
						<h3 class="panel-title">Form Wizard Horizontal</h3>
					</div>
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div id="wizard-form" class="form_wizard wizard_horizontal">
									<ul class="wizard_steps">
										<li>
											<a href="#step-5" aria-expanded="true">
												<div class="col-md-6 col-sm-12 col-xs-12 wizard-center">
													<div class="step-box margin-md-1">
														<span class="sp-series gray-back">1</span>
														<div class="sp-circle step-col">
															<span class="wizard-title">Add Friend</span>
															<p>Li Europan lingues es membres</p>
														</div>
													</div>
												</div>
											</a>
										...
										<li>
											<a href="#step-6" aria-expanded="true">
												<div class="col-md-6 col-sm-12 col-xs-12 wizard-center">
													<div class="step-box margin-md-1">
														<span class="sp-series gray-back">2</span>
														<div class="sp-circle step-col">
															<span class="wizard-title">Profile info</span>
															<p>Li Europan lingues es membres</p>
														</div>
													</div>
												</div>
										...
										<li>
											<a href="#step-7" aria-expanded="true">
												<div class="col-md-6 col-sm-12 col-xs-12 wizard-center">
													<div class="step-box margin-md-1">
														<span class="sp-series gray-back">3</span>
														<div class="sp-circle step-col">
															<span class="wizard-title">Join Friend</span>
															<p>Li Europan lingues es membres</p>
														</div>
													</div>
												</div>
									...
									<div id="step-5">
										<!--<div class="col-md-12 wizard-content-padding">-->
					...
					<!-- End Form Wizard Horizontal Section -->
				</div>
			</div>
		</div>
		<!-- End Contain Section -->
		...
		<!-- Page JavaScript -->
		<script src="../assets/js/form-wizad/bwizard.min.js" type="text/javascript"></script>
		<script src="../assets/js/form-wizad/parsley.min.js" type="text/javascript"></script>
		<script src="../assets/js/form-wizad/wizard.js" type="text/javascript"></script>
		<script src="../assets/js/form-wizad/jquery.smartWizard.js" type="text/javascript"></script>
		<script src="../assets/js/form-wizad/custom.min.js" type="text/javascript"></script>
		<script src="../assets/js/form-wizad/jquery.smartWizard-2.0.min.js" type="text/javascript"></script>
	</body>
</html>
