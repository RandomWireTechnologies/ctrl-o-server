...
<html lang="en">
	<head>
		...
		<title>Material Element | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="input-elments site-navbar-small">
		...
		<div class="main-content">
			<div class="page-header">
				<div class="header-left-panel">
					<!-- Title Page -->
					<h1 class="page-title">Material element</h1>
					<!-- Breadcrumb Section -->
					<ol class="breadcrumb">
						<li><a href="../index.html">Home</a></li>
						<li class="text-info">Forms</li>
						<li class="active">Material element</li>
					</ol>
				</div>
			</div>
			<div class="page-content container-fluid">
				<div class="panel">
					<!-- Start Visible Labels Section -->
							...
							<div class="col-sm-6 col-md-6">
								<form>
									<div class="form-group form-material">
										<label class="control-label" for="inputText">Example</label>
										<input type="text" class="form-control" id="inputText" name="inputText" placeholder="Example">
									</div>
									<div class="form-group form-material">
									...
									<div class="form-group form-material material form-material-file">
										<label class="control-label" for="inputFile">File</label>
										<input type="text" class="form-control" placeholder="Browse.." readonly="">
										<input type="file" id="inputFile" name="inputFile" multiple="" class="">
									</div>
								</form>
							</div>
							<div class="col-sm-6 col-md-6">
								...
								<div class="form-group form-material">
									<label class="control-label" for="selectMultiple">Multi select</label>
									<select class="form-control" id="selectMultiple" multiple="">
										<option>1</option>
										<option>2</option>
										<option>3</option>
										<option>4</option>
					...
					<!-- End Visible Labels Section -->
				</div>
				<div class="panel">
					<!-- Start Validate Field Section -->
					<div class="panel-heading">
						<h3 class="panel-title">Validate field</h3>
					</div>
					<div class="panel-body">
						<div class="validate">
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group form-material">
										<label class="control-label" for="inputDisabled">Input with disabled</label>
										<input type="text" class="form-control" id="inputDisabled" placeholder="Input with Disabled" disabled="">
									</div>
									<div class="form-group form-material">
										<label class="control-label" for="inputFocus">Input with focus</label>
										<input type="text" class="form-control focus" id="inputFocus" placeholder="Input with Focus">
									</div>
									<div class="form-group form-material">
										<label class="control-label text-warning" for="inputWarning">Input with warning</label>
										<input type="text" class="form-control focus form-warning" id="inputWarning" placeholder="Input with Warning">
									</div>
									<div class="form-group form-material">
										<label class="control-label text-danger" for="inputError">Input error</label>
										<input type="text" class="form-control focus form-danger" id="inputError" placeholder="Input with Error">
									</div>
									<div class="form-group form-material">
										<label class="control-label text-success" for="inputSuccess">Input success</label>
										<input type="text" class="form-control focus form-success" id="inputSuccess" placeholder="Input with Success">
									</div>
									<div class="form-group form-material">
										<label class="control-label text-info">Input info</label>
										<input type="text" class="form-control" placeholder="Input with info">
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group form-material">
										<label class="control-label" for="inputSmall">Small input</label>
										<input type="text" class="form-control form-control-sm" id="inputSmall" name="inputSmall" placeholder="Small Input">
									</div>
									<div class="form-group form-material">
									...
									<div class="form-group form-material">
										...
										<input type="text" class="form-control form-control-lg" id="inputLarge" name="inputLarge" placeholder="Large Input">
									</div>
									<div class="form-group form-material">
									...
									<div class="input-group form-material">
										<span class="input-group-addon" id="basic-addon3">https://page.com/users/</span>
					...
					<!-- End Validate Field Section -->
				</div>
				<div class="panel">
					<!-- Start Floating Labels Section -->
					<div class="panel-heading">
						<h3 class="panel-title">Floating labels</h3>
					</div>
					<div class="panel-body">
						<div class="row">
							<div class="col-sm-6 col-md-6">
								<div class="page-wrap margin-md-0">
									<form autocomplete="off">
										<div class="validate">
											...
											<div class="form-group form-material material floatlabl form-material-file">
											...
											<div class="form-group form-material material floatlabl row">
												<div class="col-xs-6 col-sm-6 col-md-6 ">
													<input type="text" class="form-control empty" id="inputGrid1" name="inputGrid1" >
													<label class="control-label margin-left-15" for="inputGrid1">Input grid</label>
												</div>
												<div class="col-xs-6 col-sm-6 col-md-6">
													<input type="text" class="form-control empty" id="inputGrid2" name="inputGrid2" >
													<label class="control-label margin-left-15" for="inputGrid2">Input grid</label>
												</div>
											</div>
										</div>
									</form>
							...
							<div class="col-sm-6 col-md-6">
								<form autocomplete="off">
									<div class="validate">
										...
										<div class="form-group form-material material floatlabl">
											<label class="control-label control-label-option">Multi select</label>
											<select class="form-control empty" id="selectMulti" multiple="">
												<option>1</option>
												<option>2</option>
												<option>3</option>
												<option>4</option>
									...
									<div class="form-group form-material material floatlabl">
										<label class="control-label control-label-option">Custom form</label>
									</div>
									<div class="row">
										<div class="col-lg-6 col-sm-6">
											<div class="input-group form-material margin-bottom-10">
												<span class="input-group-btn cust-btn">
												<button class="btn btn-info" type="button">Go!</button>
												</span>
												<input type="text" class="form-control padding-left-5" placeholder="Search for...">
											</div>
										</div>
										<div class="col-lg-6 col-sm-6">
											<div class="input-group form-material">
		...
		<!-- Page JavaScript -->
		<script src="../assets/js/material/jquery.placeholder.min.js" type="text/javascript"></script>
