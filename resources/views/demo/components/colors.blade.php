...
<html lang="en">
	<head>
		...
		<title>Colors | Porish Material Admin Template</title>
		<!-- Favicons -->
			...
			<div class="page-content colors">
				<div class="panel">
					...
					<div class="panel-body container-fluid">
						<div class="page-wrap">
							<!--  Base Color -->
							<h4 class="list-title">Base Color Palette</h4>
							<p>This is base color palette. User can select any color for elements according to base color. 
							</p>
							<div class="color-primaries">
								<div class="bg-grey-200 grey-600"><span>#eeeeee</span></div>
								<div class="bg-grey-500"><span>#9e9e9e</span></div>
								<div class="bg-indigo-500"><span>#3f51b5</span></div>
								<div class="bg-cyan-500"><span>#00bcd4</span></div>
								<div class="bg-green-500"><span>#4caf50</span></div>
								<div class="bg-orange-500"><span>#ff9800</span></div>
								<div class="bg-red-500"><span>#f44336</span></div>
								<div class="bg-purple-500"><span>#9c27b0</span></div>
							</div>
						</div>
						<div class="page-wrap">
							<!--  Palette Color -->
							<h4 class="list-title">Color Palette</h4>
							<p>The color palette has primary and accent colors that can be used to develop brand colors.
							</p>
							<p class="margin-bottom-30">The color palette starts with primary colors and fills in the spectrum to create a complete and usable palette for web
								project. We suggests using the 500 colors as the primary colors in your project and the other colors as accents colors.
							</p>
							<div class="row row-lg color-palette margin-bottom-0">
								...
								<div class="col-sm-12 col-md-12 col-xs-12 ">
									<!--  Pink Color -->
									<h5 class="text-uppercase margin-top-10">pink</h5>
									<ul class="list-group">
								...
								<div class="col-sm-12 col-md-12 col-xs-12">
									<!--  Purple Color -->
									<h5 class="text-uppercase margin-top-10">purple</h5>
									<ul class="list-group">
								...
								<div class="col-sm-12 col-md-12 col-xs-12">
									<!--  Deep Purple Color -->
									<h5 class="text-uppercase margin-top-10">deep-purple</h5>
									<ul class="list-group">
								...
								<div class="col-sm-12 col-md-12 col-xs-12">
									<!--  Indigo Color -->
									<h5 class="text-uppercase margin-top-10">indigo</h5>
									<ul class="list-group">
								...
								<div class="col-sm-12 col-md-12 col-xs-12">
									<!--  Blue Color -->
									<h5 class="text-uppercase margin-top-10">blue</h5>
									<ul class="list-group">
								...
								<div class="col-sm-12 col-md-12 col-xs-12">
									<!--  Light Blue Color -->
									<h5 class="text-uppercase margin-top-10">light-blue</h5>
									<ul class="list-group">
								...
								<div class="col-sm-12 col-md-12 col-xs-12">
									<!--  Cyan Color -->
									<h5 class="text-uppercase margin-top-10">cyan</h5>
									<ul class="list-group">
								...
								<div class="col-sm-12 col-md-12 col-xs-12">
									<!--  Teal Color -->
									<h5 class="text-uppercase margin-top-10">teal</h5>
									<ul class="list-group">
								...
								<div class="col-sm-12 col-md-12 col-xs-12">
									<!--  Green Color -->
									<h5 class="text-uppercase margin-top-10">green</h5>
									<ul class="list-group">
								...
								<div class="col-sm-12 col-md-12 col-xs-12">
									<!--  Light Green Color -->
									<h5 class="text-uppercase margin-top-10">light-green</h5>
									<ul class="list-group">
								...
								<div class="col-sm-12 col-md-12 col-xs-12">
									<!--  Lime Color -->
									<h5 class="text-uppercase margin-top-10">Lime</h5>
									<ul class="list-group">
								...
								<div class="col-sm-12 col-md-12 col-xs-12">
									<!--  Yellow Color -->
									<h5 class="text-uppercase margin-top-10">yellow</h5>
									<ul class="list-group">
								...
								<div class="col-sm-12 col-md-12 col-xs-12">
									<!--  Amber Color -->
									<h5 class="text-uppercase margin-top-10">amber</h5>
									<ul class="list-group">
								...
								<div class="col-sm-12 col-md-12 col-xs-12">
									<!--  orange Color -->
									<h5 class="text-uppercase margin-top-10">orange</h5>
									<ul class="list-group">
								...
								<div class="col-sm-12 col-md-12 col-xs-12">
									<!--  Deep Orange Color -->
									<h5 class="text-uppercase margin-top-10">deep-orange</h5>
									<ul class="list-group">
								...
								<div class="col-sm-12 col-md-12 col-xs-12">
									<!--  Brown Color -->
									<h5 class="text-uppercase margin-top-10">brown</h5>
									<ul class="list-group">
								...
								<div class="col-sm-12 col-md-12 col-xs-12">
									<!--  Gray Color -->
									<h5 class="text-uppercase margin-top-10">Gray</h5>
									<ul class="list-group">
								...
								<div class="col-sm-12 col-md-12 col-xs-12 margin-bottom-0">
									<!--  Blue Gray Color -->
									<h5 class="text-uppercase margin-top-10">blue-gray</h5>
									<ul class="list-group">
