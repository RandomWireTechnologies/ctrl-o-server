...
<html lang="en">
	<head>
		...
		<title>Rickshaw | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="basic-table site-navbar-small">
		...
		<div class="main-content">
			<div class="page-header">
				<div class="header-left-panel">
					<!-- Title Page -->
					<h1 class="page-title">Rickshaw</h1>
					<!-- Breadcrumb Section -->
					<ol class="breadcrumb">
			...
			<div class="page-content container-fluid rickshaw-page">
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-6">
								<div class="page-wrap">
									<!-- Line & Toggling Rickshaw -->
									<h4 class="list-title">Lines & toggling</h4>
									<p>Basic lines with a legend and x-axis ticks and labels. toggle lines on and off by clicking checkmarks.</p>
									<div>
										<div id="linestoggling" class="mobile-rickshaw"></div>
										<div class="rickshaw-legend-wrap">
											<div id="linestogglingLegend"></div>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="page-wrap">
									<h4 class="list-title">Live update scatter</h4>
									<p>Basic scatter plot with two overlapping series.</p>
									<div>
										<div id="log_ajax"></div>
										<div class="rickshaw-legend-wrap">
											<div id="log_ajaxLegend"></div>
										</div>
									</div>
								</div>
							</div>
							<div class="clearfix"></div>
							<!-- Stacked Bars Rickshaw -->
							<div class="col-md-6">
								<div class="page-wrap">
									<h4 class="list-title">Stacked bars with deterministic colors</h4>
									<p>Requests per second by HTTP status as stacked bars that can carry across graphs.</p>
									<div>
										<div id="stackedbarsChart"></div>
										<div class="rickshaw-legend-wrap">
							...
							<div class="col-md-6">
								<div class="page-wrap">
									<!-- Interpolated Rickshaw -->
									<h4 class="list-title">Interpolated colors</h4>
									<p>Interpolate color schemes for graphs with area.</p>
									<div>
										<div id="interpolateChart"></div>
										<div class="rickshaw-legend-wrap">
											<div id="interpolateLegend"></div>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6">
								<div class="page-wrap">
									<h4 class="list-title">Y-Axis tick marks and grid lines</h4>
									<p>Draw y-axis tick marks and grid lines with abbreviated numbers.</p>
									<div>
										<div id="y_axis"></div>
										<div class="rickshaw-legend-wrap">
											<div id="y_axisLegend"></div>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="page-wrap">
									<!-- Scatter Plot Rickshaw -->
									<h4 class="list-title">Scatter plot with multiple series</h4>
									<p>Basic scatter plot with two overlapping series.</p>
									<div>
										<div id="scatterplotrChart" class="mobile-rickshaw"></div>
										<div class="rickshaw-legend-wrap">
											<div id="scatterplotrLegend"></div>
										</div>
									</div>
								</div>
							</div>
							<div class="clearfix"></div>
							<!-- Multiple Renderers Rickshaw -->
							<div class="col-md-12">
								<h4 class="list-title">Multiple renderers</h4>
								<p>Bars, lines, area, and scatterplot graphs all in one setting.</p>
								<div>
									<div id="pageMultipleChart"></div>
									<div id="pageMultipleSlider" class="margin-top-10"></div>
									<div class="rickshaw-legend-wrap">
										<div id="pageMultipleLegend"></div>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- Page JavaScript -->
		<script src="../assets/js/rickshaw/d3.min.js" type="text/javascript"></script>
		<script src="../assets/js/rickshaw/rickshaw.js" type="text/javascript"></script>
		<script src="../assets/js/rickshaw/custom-rickshaws.min.js" type="text/javascript"></script>
	</body>
</html>
