...
<html>
	<head>
		...
		<title>Flot | Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<!-- Page CSS -->
		<link rel="stylesheet" href="../assets/css/float-chart/custom.css" />
		<!-- Global Template CSS -->
	...
	<body class="dashboard site-navbar-small">
		...
		<div class="main-content flot-chart">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-6 col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Realtime Flot -->
									<h4 class="list-title">Realtime</h4>
									<div class="chart-float">
										<div id="realtime-flot" class="placeholder-float"></div>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Full Bg Line Flot -->
									<h4 class="list-title">Full-bg line</h4>
									<div class="chart-float">
										<div id="full-float" class="placeholder-float"></div>
									</div>
									<button style="display:none;" class="fetchSeries"></button>
									<a href="data-eu-gdp-growth.json"></a>
								</div>
							</div>
							<div class="col-lg-6 col-sm-6 col-xs-12">
								<div class="page-wrap margin-md-0 margin-sm-0">
									<!-- Curve Flot -->
									<h4 class="list-title">Curve</h4>
									<div class="chart-float">
										<div id="crave-flot" class="placeholder-float"></div>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-sm-6 col-xs-12">
								<div class="page-wrap margin-bottom-0">
									<!-- Symbols Line Flot -->
									<h4 class="list-title">Symbols line</h4>
									<div class="chart-float">
										<div id="symbol-flot" class="placeholder-float"></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-6 col-sm-6 col-xs-12">
								<div class="page-wrap margin-md-0 margin-sm-0">
									<!-- Stack Bar Flot -->
									<h4 class="list-title">Stack bar</h4>
									<div class="chart-float">
										<div id="stack-flot" class="placeholder-float"></div>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-sm-6 col-xs-12">
								<div class="page-wrap margin-bottom-0">
									<!-- Annotations Bar Flot -->
									<h4 class="list-title">Annotations bar</h4>
									<div class="chart-float">
										<div id="annotations-bar" class="placeholder-float"></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<div class="page-wrap">
									<!-- Pie Flot -->
									<h4 class="list-title">Pie</h4>
									<div class="main-pie-float">
										<div id="pie-float" class="placeholder-float"></div>
										<div id="menu-button" class="button-wrap">
											<button id="default-flot" class="btn btn-info waves-effect waves-light">Default</button>
											<button id="without-flot" class="btn btn-info waves-effect waves-light">Legend</button>
											<button id="label-flot" class="btn btn-info waves-effect waves-light">Label</button>
											<button id="hidden-style-flot" class="btn btn-info waves-effect waves-light">Styles #1</button>
											<button id="hidden-flot" class="btn btn-info waves-effect waves-light">Styles #2</button>
											<button id="donut-flot" class="btn btn-info waves-effect waves-light">Donut pie</button>
											<button id="donut-hole-flot" class="btn btn-info waves-effect waves-light">Donut hole</button>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<!-- Navigation Flot -->
								<h4 class="list-title">Navigation</h4>
								<div class="chart-float">
									<div id="navigation" class="placeholder-float"></div>
								</div>
							</div>
						</div>
					</div>
		...
		<script src="../assets/js/float-chart/jquery.flot.resize.min.js"></script>
		<script src="../assets/js/float-chart/flot.symbol.js"></script>
		<script src="../assets/js/float-chart/flot.pie.js"></script>
		<script src="../assets/js/float-chart/flot.time.js"></script>
		<script src="../assets/js/float-chart/flot.selection.js"></script>
		<script src="../assets/js/float-chart/jquery.flot.navigate.js"></script>
	</body>
</html>
