...
<html lang="en">
	<head>
		...
		<title>Markdown Editor | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="dashboard site-navbar-small editor-markdown">
		...
		<div class="main-content">
			...
			<div class="page-content">
				...
				<div class="panel">
					<div class="panel-body">
						<div class="page-wrap margin-bottom-0">
							...
							<h4>Inline Editor</h4>
							<p>Inline editing with Bootstrap-Markdown is done by adding <code>data-provide="markdown-editable"</code> attribute.All contents within this "markdown-editable" context is really editable. Just click anywhere!</p>
				...
				<div class="panel">
					<div class="panel-body">
						<div class="page-wrap margin-bottom-0">
							<!-- Events Markdown Editor -->
							<h4>Events/ Hook</h4>
							<p>There are six main events within Bootstrap-Markdown lifecycle : <code>onShow</code>, <code>onPreview</code>, <code>onChange</code>, <code>onSave</code> and <code>onBlur</code>. Heres an example to hook into those events via code:</p>
							<form>
								<textarea id="target-editor"></textarea>
								<br/>
								<button id="editor-triger-init" class="btn btn-info">Transform into Bootstrap-Markdown</button>
							</form>
						</div>
					</div>
				</div>
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
								<div class="page-wrap width-responsive">
									<form>
										<p>Custom width using <code>data-width="245"</code> attribute</p>
										<textarea data-provide="markdown" data-width="245"></textarea>
									</form>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
							...
							<div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
								<div class="page-wrap margin-md-0">
									<form>
										...
										<textarea data-provide="markdown" data-hidden-buttons="cmdBold"></textarea>
										<br/>
									</form>
								</div>
							</div>
				...
				<div class="panel">
					<div class="panel-body">
						<div class="page-wrap margin-bottom-0">
							<!-- Editor Panel Markdown Editor -->
							<h4>Editor Panel</h4>
							<p>Bootstrap-Markdown panel could be easily extended to suit your own specific needs. You can just set <code>additionalButtons</code> param, with your own buttons group. Heres an example to add button group into editor panel:</p>
		...
		<script src="../assets/js/editor-markdown/to-markdown.js"></script>
		<script src="../assets/js/editor-markdown/custom.js"></script>
	</body>
</html>
