...
<html>
	<head>
		...
		<title>Breadcrumbs | Porish Material Admin Template</title>
		<!-- Favicons -->
					...
					<div class="panel-body">
						<div class="row row-lg">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Default Breadcrumb -->
									<h4 class="list-title">Default Style</h4>
									<p>A breadcrumb is a navigation scheme that indicates current page's location to the user within a website or application added in CSS through <code>:before</code> and content.</p>
									<div class="margin-top-20">
										<div class="bread-content panel-box-shadow">
											<ol class="breadcrumb back-breadcrumb">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="page-wrap">
									...
									<h4 class="list-title">Arrow Style</h4>
									<p>Add styler class <code>.breadcrumb-arrow</code> to change slash or arrow style.</p>
									<div class="margin-top-20">
										<div class="bread-content panel-box-shadow">
											<ol class="breadcrumb breadcrumb-arrow back-breadcrumb">
												<li><a href="javascript:void(0)">Home</a></li>
											</ol>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Items With Icon And Slash Breadcrumb -->
									<h4 class="list-title">Items With Icon And Slash</h4>
									<p>Add <code>.icon_house</code> class to display home symbols with slash.</p>
									<div class="margin-top-20">
										<div class="bread-content panel-box-shadow">
											<ol class="breadcrumb back-breadcrumb">
												<li><a href="javascript:void(0)"><i class="icon_house"></i> Home</a></li>
											</ol>
											<ol class="breadcrumb ">
												<li><a href="javascript:void(0)"><i class="icon_house"></i> Home</a></li>
												<li class="active">Library</li>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Items With Icon And Arrow Breadcrumb -->
									<h4 class="list-title">Items With Icon And Arrow</h4>
									<p>Add <code>.icon_house</code> class to display home symbols with arrow.</p>
									<div class="margin-top-20">
										<div class="bread-content panel-box-shadow">
											<ol class="breadcrumb breadcrumb-arrow back-breadcrumb">
												<li><a href="javascript:void(0)"><i class="icon_house"></i> Home</a></li>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="page-wrap margin-md-0 margin-sm-0">
									...
									<h4 class="list-title">Responsive</h4>
									<p>Responsive breadcrumbs that jquery-asBreadcrumbs allows you to automatically resizes your breadcrumbs and hide the overflowing crumbs and transfer to a dropdown menu.</p>
									<div class="margin-top-20">
										<div class="bread-content panel-box-shadow">
											<ol class="breadcrumb breadcrumb-left " data-plugin="breadcrumb">
												<li class="breadcrumb-dropdown dropdown" style="">
													<div class="dropdown">
														<a href="javascript:void(0);" data-toggle="dropdown"><i class="caret"></i></a>
														<ul class="breadcrumb-menu dropdown-menu" role="menu">
															<li style="display: none;"><a href="javascript:void(0);">Data</a></li>
															<li style="display: none;"><a href="javascript:void(0);">Customize</a></li>
															<li style="display: none;"><a href="javascript:void(0);">JavaScript</a></li>
															<li style="display: none;"><a href="javascript:void(0);">Components</a></li>
												...
												<li class="breadcrumb-ellipsis" style="display: inline-block;">…</li>
												<li style="display: none;"><a href="javascript:void(0)">Home</a></li>
												<li style="display: none;"><a href="javascript:void(0)">Getting Started</a></li>
												<li style="display: none;"><a href="javascript:void(0)">Library</a></li>
												<li style="display: none;"><a href="javascript:void(0)">Document</a></li>
												<li style="display: inline-block;"><a href="javascript:void(0)">Components</a></li>
												<li style="display: inline-block;"><a href="javascript:void(0)">JavaScript</a></li>
												<li style="display: inline-block;"><a href="javascript:void(0)">Customize</a></li>
												<li class="active" style="display: inline-block;">Data</li>
											</ol>
										</div>
									</div>
								</div>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								...
								<div class="page-wrap margin-0">
									<h4 class="list-title">Accessibility</h4>
									<p>Adding the <code>aria-label</code> attribute gives context to a screen reader. </p>
									<div class="margin-top-20">
										<div class="bread-content panel-box-shadow">
											<ol class="breadcrumb" aria-label="breadcrumbs" role="menubar">
												<li><a href="javascript:void(0)">Home</a></li>
												<li><a href="javascript:void(0)">Getting Started</a></li>
												<li><a href="javascript:void(0)">Library</a></li>
												<li class="disable" aria-disabled="true"><a href="javascript:void(0)">Customize</a></li>
												<li class="active">Data</li>
											</ol>
										</div>
									</div>
