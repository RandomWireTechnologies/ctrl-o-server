...
<html lang="en">
	<head>
		...
		<title>Panel Action | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="panel-action site-navbar-small">
						...
						<div class="panel">
							<div class="panel-heading">
								...
								<div class="panel-actions">
									<a class="btn btn-panel btn-info icon_refresh waves-effect waves-dark" data-toggle="panel-refresh" data-load-type="round-circle" data-load-callback="customRefreshCallback" aria-hidden="true"></a>
								</div>
							</div>
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="panel">
							<div class="panel-heading">
								...
								<div class="panel-actions">
									<a class="btn btn-panel btn-info icon_minus-06 waves-effect waves-dark" data-toggle="panel-collapse" aria-hidden="true"></a>
								</div>
							</div>
							<div class="panel-body">
								Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
					...
					<div class="col-lg-6 col-sm-6 col-xs-12">
						<div class="panel">
							<div class="panel-heading">
								...
								<div class="panel-actions">
									<a class="btn btn-panel btn-info arrow_expand waves-effect waves-dark" data-toggle="panel-fullscreen" aria-hidden="true"></a>
								</div>
							</div>
							<div class="panel-body">
								Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="panel">
							<div class="panel-heading">
								...
								<div class="panel-actions">
									<a class="btn btn-panel btn-info icon_close waves-effect waves-dark" data-toggle="panel-close" aria-hidden="true"></a>
								</div>
							</div>
							<div class="panel-body">
								Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
