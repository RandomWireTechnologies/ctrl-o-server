...
<html>
	<head>
		...
		<title>jsGrid | Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<link rel="stylesheet" href="../assets/css/jsgrid/jsgrid.min.css"/>
		<link rel="stylesheet" href="../assets/plugin/bootstrap-datepicker/css/bootstrap-datepicker.min.css"/>
	</head>
	<body class="basic-table site-navbar-small jsGrid">
		...
		<div class="main-content">
			...
			<div class="page-content container-fluid">
				<div class="row">
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						<div class="panel">
							<header class="panel-heading">
								...
								<div class="panel-actions short-field margin-left-15">
									<select id="pagesortingField" class="form-control input-md">
										<option>Name</option>
										<option>Age</option>
							...
							<header class="panel-heading">
								...
								<div class="panel-actions">
									<div class="btn-group btn-group-sm" data-toggle="buttons" role="group">
										<label class="btn btn-info waves-effect waves-light active">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="panel">
							<!-- Custom Grid Field JsGrid -->
							<header class="panel-heading">
								<h3 class="panel-title">Custom Grid Field</h3>
							</header>
							<div class="panel-body">
								<div id="pageCustomGridField"></div>
							</div>
						</div>
					</div>
					<div id="jsGrid"></div>
		...
		<script src="../assets/plugin/jquery-ui/js/jquery-ui.min.js" type="text/javascript"></script>
		...
		<script src="../assets/js/jsgrid/jsgrid.min.js" type="text/javascript"></script>
		...
		<!-- Page JavaScript -->
		<script src="../assets/js/jsgrid/jsgrid-db.min.js" type="text/javascript"></script>
		<script src="../assets/js/jsgrid/jsgrid2.min.js" type="text/javascript"></script>
	</body>
</html>
