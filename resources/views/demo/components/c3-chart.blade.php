...
<html lang="en">
	<head>
		...
		<title>c3 Chart | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="basic-table site-navbar-small">
		...
		<div class="main-content">
			<div class="page-header">
				<div class="header-left-panel">
					<!-- Title Page -->
					<h1 class="page-title">C3 chart</h1>
					<!-- Breadcrumb Section -->
					<ol class="breadcrumb">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<div class="page-wrap">
									<!-- FLow Chart -->
									<h4 class="list-title">Flow chart</h4>
									<p>Load/unload data as flowing.</p>
									<div>
										<div id="pageFlow"></div>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="page-wrap margin-md-0">
									<!-- Simple Line Chart -->
									<h4 class="list-title">Simple XY line chart</h4>
									<p>Simple line chart with custom X.</p>
									<div>
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-6">
								<div class="page-wrap">
									<!-- Scatter Plot Chart -->
									<h4 class="list-title">Scatter plot</h4>
									<p>Display as scatter plot.</p>
									<div>
										<div id="pageScatterplot"></div>
									</div>
								</div>
							</div>
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<div class="page-wrap margin-md-0">
									<!-- Stacked Bar Chart -->
									<h4 class="list-title">Stacked bar chart</h4>
							...
							<div class="col-md-6">
								<div class="page-wrap margin-bottom-0">
									<!-- Combination Chart -->
									<h4 class="list-title">Combination chart</h4>
									<p>Display as combination chart.</p>
									<div>
										<div id="pageCombinationchart"></div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="page-wrap margin-md-0">
									...
									<p>Display as pie chart.</p>
									<div>
										<div id="pagePiechart"></div>
									</div>
								</div>
							</div>
							<div class="col-md-6">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-6">
								<div class="page-wrap margin-md-0">
									<!-- Sub Chart -->
									<h4 class="list-title">Sub chart</h4>
									<p>Show sub chart for zoom and selection range.</p>
									<div>
										<div id="pageSubchart"></div>
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="page-wrap margin-bottom-0">
									<!-- Zoom Chart -->
									<h4 class="list-title">Zoom chart</h4>
									<p>Zoom by mouse wheel event and slide by drag.</p>
									<div>
										<div id="pageZoomchart"></div>
									</div>
								</div>
							</div>
						</div>
		...
		<script src="../assets/js/c3-chart/custom-c3chart.min.js" type="text/javascript"></script>
	</body>
</html>
