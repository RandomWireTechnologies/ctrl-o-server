...
<html lang="en">
	<head>
		...
		<title>Morris Charts | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="basic-table site-navbar-small">
						...
						<div class="row">
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									...
									<div id="myfirstchart" class="myfirstchart morrisheight" style="width: 100%"></div>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!-- Area Chart -->
									<h4 class="list-title">Area chart</h4>
									<div id="areachart" class="areachart morrisheight"></div>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									...
									<div id="barcharts" class="morrisheight"></div>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!-- Stacked Bars Chart -->
									<h4 class="list-title">Stacked bars chart</h4>
									<div id="stackedbars" class="morrisheight"></div>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!-- Daylight savings Time Chart -->
									<h4 class="list-title">Daylight-savings time</h4>
									<div id="daylightsavings" class="morrisheight"></div>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!-- Custom Chart -->
									<h4 class="list-title">Custom data</h4>
									<div id="graph-area" class="morrisheight"></div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									...
									<div id="negativevalues" class="morrisheight"></div>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!-- Formatting Dates Chart -->
									<h4 class="list-title">Formatting dates YYYY</h4>
									<div id="formattingdates" class="morrisheight"></div>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!-- Time Events Chart -->
									<h4 class="list-title">Time events</h4>
									<div id="timeevents" class="morrisheight"></div>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!-- Non Continuous Chart -->
									<h4 class="list-title">Non-continuous data</h4>
									<div id="noncontinuousdata" class="morrisheight"></div>
								</div>
							</div>
							<div class="col-md-4 col-sm-4 col-xs-12">
								<div class="page-wrap margin-md-0 margin-sm-0">
									<!-- Donut Chart -->
									<h4 class="list-title">Donut chart</h4>
									<div id="donutchart" class="morrisheight"></div>
								</div>
							</div>
							<div class="col-md-4 col-sm-4 col-xs-12">
								<div class="page-wrap margin-md-0 margin-sm-0">
									<!-- Donut Colors Chart -->
									<h4 class="list-title">Donut colors</h4>
									<div id="donutcolors" class="morrisheight"></div>
								</div>
							</div>
							<div class="col-md-4 col-sm-4 col-xs-12">
								<div class="page-wrap margin-bottom-0">
									<!-- Donut Formatter Chart -->
									<h4 class="list-title">Donut formatter</h4>
									<div id="donutformatter" class="morrisheight"></div>
								</div>
							</div>
						</div>
					</div>
		...
		<!-- Page JavaScript -->
		<script src="../assets/js/morrischarts/raphael-min.js" type="text/javascript"></script>
		<script src="../assets/js/morrischarts/morris.min.js" type="text/javascript"></script>
		<script src="../assets/js/morrischarts/morriscustom.js" type="text/javascript"></script>
	</body>
</html>
