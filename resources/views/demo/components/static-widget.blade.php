...
<html lang="en">
	<head>
		...
		<title>Static Widgets| Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="dashboard site-navbar-small static-widget">
		...
		<div class="main-content">
			<div class="page-header">
				<div class="header-left-panel">
					<!-- Title Page -->
					<h1 class="page-title">Static widgets</h1>
					<!-- Breadcrumb Section -->
					<ol class="breadcrumb">
						<li><a href="../dashboard_v1.html">Home</a></li>
						<li class="text-info">Widgets</li>
						<li class="active">Static widgets</li>
					</ol>
				</div>
			</div>
			<div class="page-content">
				<div class="row">
					<div class="col-lg-6 col-md-12 col-sm-12">
						<div class="static-box pull-left">
							<div class="tasks-progress">
								<!-- Task In Progress Widget -->
								<h4 class="list-title">Tasks in Progress</h4>
								<p class="margin-bottom-20">Your tasks is here</p>
								<div class="row">
									<div class="col-md-6 col-sm-6">
										<span>Update JQuery</span>
										<div class="progress active">
											<div style="width:84%;" aria-valuemax="100" aria-valuemin="0" aria-valuenow="84" role="progressbar" class="progress-bar progress-bar-striped progress-bar-danger"></div>
										</div>
									</div>
									<div class="col-md-6 col-sm-6">
										<span>Updating 256</span>
										<div class="progress active">
											<div style="width:45%;" aria-valuemax="100" aria-valuemin="0" aria-valuenow="45" role="progressbar" class="progress-bar progress-bar-striped progress-bar-default"></div>
										</div>
									</div>
									<div class="col-md-6 col-sm-6">
										<span>Fontawesome</span>
										<div class="progress active">
											<div style="width:68%;" aria-valuemax="100" aria-valuemin="0" aria-valuenow="68" role="progressbar" class="progress-bar progress-bar-striped progress-bar-info"></div>
										</div>
									</div>
									<div class="col-md-6 col-sm-6">
										<span>Latest jQuery</span>
										<div class="progress active">
											<div style="width:75%;" aria-valuemax="100" aria-valuemin="0" aria-valuenow="75" role="progressbar" class="progress-bar progress-bar-striped progress-bar-success"></div>
										</div>
									</div>
									<div class="col-md-6 col-sm-6">
										<span>Google API</span>
										<div class="progress active">
											<div style="width:35%;" aria-valuemax="100" aria-valuemin="0" aria-valuenow="35" role="progressbar" class="progress-bar progress-bar-striped progress-bar-warning"></div>
										</div>
									</div>
									<div class="col-md-6 col-sm-6">
										<span>Montsiser</span>
										<div class="progress active">
											<div style="width:55%;" aria-valuemax="100" aria-valuemin="0" aria-valuenow="55" role="progressbar" class="progress-bar progress-bar-striped progress-bar-dark"></div>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-6 col-sm-6">
								<div class="static-box">
									<div class="row">
										<div class="col-md-5 col-sm-6 col-xs-6"> <span class="static-icon"><i class="widget-i icon_cart_alt"></i></span></div>
										<div class="col-md-7 col-sm-6 col-xs-6 text-right">
											<!-- Product Widget -->
											<h4 class="text-success font-17">Products</h4>
											<h2 class="margin-top-0">1560</h2>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="text-center">
										<div class="row">
											<div class="col-md-7 col-sm-6 col-xs-6">
												<!-- Projects Widget -->
												<h4 class="text-left text-info font-17">Projects</h4>
												<h2 class="text-left margin-top-0">254</h2>
											</div>
											<div class="col-md-5 col-sm-6 col-xs-6"><span class="static-icon pull-right"><i class="widget-i icon_toolbox_alt"></i></span></div>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6">
								<div class="static-box">
									...
									<h4>Open Projects</h4>
									<div class="list-inline row margin-bottom-0">
										<div class="col-md-6 col-sm-6 col-xs-6 font-50"><i class="icon_folder-alt"></i></div>
										<div class="col-md-6 col-sm-6 col-xs-6 text-right"><span class="counter">311</span></div>
									</div>
								</div>
							</div>
							<div class="col-md-6 col-sm-6">
								<div class="static-box">
									...
									<h4>Invoice</h4>
									<div class="list-inline row margin-bottom-0">
										<div class="col-md-5 col-sm-6 col-xs-6"><span class="counter">196</span></div>
										<div class="col-md-7 col-sm-6 col-xs-6 font-50 text-right"><i class="icon_documents"></i></div>
									</div>
								</div>
							</div>
							<div class="clearfix"></div>
					...
					<div class="col-md-12 col-sm-12">
						<div class="row">
							...
							<div class="col-lg-3 col-md-6 col-sm-6">
								<div class="static-box bg-cyan-500 static-with-bg">
									<div class="text-center">
										<h4>Ratio</h4>
										<h2 class="margin-top-0"><i class="icon_piechart margin-right-10"></i>46%</h2>
									</div>
								</div>
							</div>
							<div class="col-lg-3 col-md-6 col-sm-6">
								<div class="static-box bg-grey-500 static-with-bg">
									<div class="text-center">
										<!-- Downloads Widget -->
										<h4>Downloads</h4>
										<h2 class="margin-top-0"><i class="icon_download margin-right-10"></i>57</h2>
									</div>
								</div>
							</div>
							<div class="col-lg-3 col-md-6 col-sm-6">
								<div class="static-box text-right">
									<div class="row">
										<!-- Message Widget -->
										<div class="col-xs-6"><span class="static-icon margin-top-5"><i class="widget-i icon_mail_alt"></i></span></div>
										<div class="col-xs-6">
											<h4>Messages</h4>
											<h2 class="margin-top-0">34</h2>
										</div>
									</div>
								</div>
							</div>
							<div class="col-lg-3 col-md-6 col-sm-6">
								<div class="static-box text-center">
									<!-- Visitors Widget -->
									<h4>Visitors</h4>
									<h2 class="margin-top-0">50</h2>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-12 col-sm-12">
						<div class="row">
							<div class="col-md-6 col-sm-6">
								<div class="static-box">
									<div class="text-center">
										<!-- Email Received Widget -->
										<a href="#" class="circle-widget bg-indigo-a100">
										<span><i class="icon_mail_alt"></i></span>
										</a>
										<div class="padding-top-10 static-info">
											<span class="w-meta-value">20</span>
											<span class="w-meta-title">Email Received</span>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-6 col-sm-6">
								<div class="static-box">
									<div class="text-center">
										<!-- Downloads Widget -->
										<a href="#" class="circle-widget bg-orange-600">
										<span><i class="icon_download"></i></span>
										</a>
										<div class="padding-top-10 static-info">
											<span class="w-meta-value">50</span>
											<span class="w-meta-title">Downloads</span>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-6 col-sm-6">
								<div class="static-box">
									<div class="text-center">
										<!-- Email Widget -->
										<div class="avatar avatar-md"><img src="../assets/images/global/img_240x265.png" class="follow-img pull-left" alt="user"></div>
										<h4 class="margin-bottom-5">Chadengle</h4>
										<p class="margin-bottom-0"><a href="#">abc@gmail.com</a></p>
							...
							<div class="col-md-6 col-sm-6">
								<div class="static-box">
									<div class="text-center">
										<!-- Email Widget -->    
										<div class="avatar avatar-md"><img src="../assets/images/global/img_240x265.png" class="follow-img pull-left" alt="user"></div>
										<h4 class="margin-bottom-5">Jack</h4>
										<p class="margin-bottom-0"><a href="#">xyz@gmail.com</a></p>
						...
						<div class="row">
							<div class="col-md-6 col-sm-6">
								<div class="static-box text-center">
									<!-- Location Widget -->
									<i class="icon_pin"></i>
									<p class="text-muted">25th Aug</p>
									<h3 class="margin-top-5">Now Get 30% Off</h3>
									<button class="btn btn-success waves-effect waves-light margin-top-15">Default</button>
								</div>
							</div>
							<div class="col-md-6 col-sm-6">
								<div class="static-box text-center">
									<!-- Gathering Widget -->
									<h4 class="margin-bottom-20 margin-top-0">Gathering grass their lights. Darkness evening void for it.</h4>
									<div class="inline-block">
										<div class="display-table">
											<div class="type-3 avatar avatar-md">
							...
							<div class="clearfix"></div>
							<div class="col-md-6 col-sm-6">
								<div class="static-box bg-purple static-with-bg text-center">
									<!-- Location Widget -->
									<i class="icon_pin"></i>
									<p class="text-muted">21 July</p>
									<h3 class="margin-top-5">Now Get 50% Off</h3>
									<button class="btn btn-warning waves-effect waves-light margin-top-15">Default</button>
								</div>
							</div>
							<div class="col-md-6 col-sm-6">
								<div class="static-box text-center">
									<!-- Employee Widget -->
									<h4 class="margin-bottom-5 margin-top-0">We Have</h4>
									<h2 class="margin-top-5">410<i class="icon_plus"></i></h2>
									<h4 class="margin-top-10">Employee</h4>
									<button class="btn btn-info waves-effect waves-light margin-top-5">View</button>
								</div>
							</div>
							<div class="clearfix"></div>
						</div>
					...
					<div class="col-lg-6 col-md-12 col-sm-12 clearfix">
						<div class="row">
							<div class="col-md-12 col-sm-12">
								<div class="static-box bg-teal-a400 static-with-bg">
									<!-- File Widget -->
									<div class="side-icon"><i class="icon_document" aria-hidden="true"></i></div>
									<h4>Total File</h4>
									<h2>1,254</h2>
								</div>
							</div>
							<div class="col-md-12 col-sm-12">
								<div class="static-box">
									...
									<h4 class="margin-top-0 margin-bottom-15 list-title">Latest Projects</h4>
					...
					<div class="col-lg-6 col-md-12 col-sm-12">
						<div class="row">
							<div class="col-md-6 col-sm-6">
								<div class="static-box">
									<div class="row">
										<div class="col-md-6 col-sm-6 col-xs-6  padding-top-10">
											<!-- Clients Widget -->
											<i class="icon_contacts_alt font-25"></i>
											<h4>Clients</h4>
										</div>
										<div class="col-md-6 col-sm-6 col-xs-6">
											<h2 class="text-right text-success">225</h2>
										</div>
										<div class="col-md-12 col-sm-12 col-xs-12 padding-top-10">
											<div class="progress progres-sm">
												<div class="progress-bar progress-bar-success" aria-valuemax="100" aria-valuemin="0" aria-valuenow="54" role="progressbar" style="width:54%;">
												</div>
											</div>
										</div>
									</div>
							...
							<div class="col-md-6 col-sm-6">
								<div class="static-box">
									<div class="row">
										...
										<div class="col-md-6 col-sm-6 col-xs-6">
											<h2 class="text-right text-success">854</h2>
										</div>
										<div class="col-md-12 col-sm-12 col-xs-12 padding-top-10">
											<div class="progress progres-sm">
												<div class="progress-bar progress-bar-info" aria-valuemax="100" aria-valuemin="0" aria-valuenow="84" role="progressbar" style="width:84%;">
												</div>
											</div>
										</div>
									</div>
							...
							<div class="clearfix"></div>
							<div class="col-md-12 col-sm-12">
								<div class="static-box bg-red-300 static-with-bg">
									<!-- Total Songs Widget -->
									<div class="side-icon"><i class="icon_music" aria-hidden="true"></i></div>
									<h4>Total Songs</h4>
									<h2>908</h2>
								</div>
							</div>
