...
<html lang="en">
	<head>
		...
		<title>Progress-Bars | Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<link rel="stylesheet" href="../assets/css/global/progress.css" />
	...
	<body class="dashboard site-navbar-small list">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-6 col-sm-6">
								<div class="page-wrap">
									...
									<div>
										...
										<div class="progress">
											<div class="progress-bar progress-bar-info" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 70%" role="progressbar">
												<span>80/100 Complete (success)</span>
											</div>
										</div>
										<div class="progress">
											<div class="progress-bar progress-bar-success active" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="width: 75%" role="progressbar">
												<span>75% !!!Watch out!!!</span>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-lg-6 col-sm-6">
								<div class="page-wrap">
									<!--  Basic Progress -->
									<h4 class="list-title">Striped</h4>
									<p>Uses a gradient to create a striped effect.</p>
									<div>
										<div class="progress">
											<div class="progress-bar progress-bar-info progress-bar-striped" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 70%" role="progressbar">
												<span class="sr-only">80/100 Complete (success)</span>
											</div>
										</div>
										<div class="progress">
											<div class="progress-bar progress-bar-info progress-bar-striped" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 70%" role="progressbar">
							...
							<div class="col-lg-6 col-sm-6">
								<div class="page-wrap">
									...
									<p>Use <code>.progress-sm</code>, <code>.progress-md</code>, <code>.progress-lg</code> to create a different Size.</p>
									<div>
							...
							<div class="col-lg-6 col-sm-6">
								<div class="page-wrap">
									<!--  Animated Progress-->
									<h4 class="list-title">Animated</h4>
									<p>The striped gradient can also be animated. add <code>.animatebar-bar</code> to animate the stripes right to left via CSS3 animations.</p>
									<div class="animatebar clearfix" data-percent="65%">
										<div class="animatebar-title progress-bar-success"><span>Design</span></div>
										<div class="animatebar-bar progress-bar-success"></div>
										<div class="animatebar-bar-percent">65%</div>
									</div>
									<div class="animatebar clearfix" data-percent="85%">
										<div class="animatebar-title progress-bar-warning"><span>Develop</span></div>
										<div class="animatebar-bar progress-bar-warning"></div>
										<div class="animatebar-bar-percent">85%</div>
									</div>
									<div class="animatebar clearfix" data-percent="60%">
										<div class="animatebar-title progress-bar-danger"><span>Graphics</span></div>
										<div class="animatebar-bar progress-bar-danger"></div>
										<div class="animatebar-bar-percent">60%</div>
									</div>
								</div>
							</div>
							<div class="clearfix"></div>
							<div class="col-lg-6 col-sm-6">
								<div class="page-wrap">
									<!--  Stacked Progress-->
									<h4 class="list-title">Stacked</h4>
									<p>The stacked gradient can also be different size progress. in one <code>.progress</code> add different color and <code>.progress-bar</code> the Stacked right to left via part of color.</p>
									<div>
										<div class="progress">
											<div class="progress-bar progress-bar-success" style="width: 30%" role="progressbar">
												<span class="sr-only">30% Complete (success)</span>
											</div>
											<div class="progress-bar progress-bar-warning progress-bar-striped" style="width: 25%" role="progressbar">
												<span class="sr-only">25% Complete (warning)</span>
											</div>
											<div class="progress-bar progress-bar-danger" style="width: 15%" role="progressbar">
												<span class="sr-only">15% Complete (danger)</span>
											</div>
										</div>
										<div class="progress">
											<div class="progress-bar progress-bar-warning" style="width: 15%" role="progressbar">
												<span>15% Complete (warning)</span>
											</div>
											<div class="progress-bar progress-bar-success" style="width: 50%" role="progressbar">
										...
										<div class="progress">
											...
											<div class="progress-bar progress-bar-warning" style="width: 25%" role="progressbar">
												<span>25%</span>
											</div>
											<div class="progress-bar progress-bar-info" style="width: 30%" role="progressbar">
												<span>30%</span>
											</div>
											<div class="progress-bar progress-bar-danger" style="width: 15%" role="progressbar">
												<span>15%</span>
							...
							<div class="col-lg-3 col-sm-6">
								<div class="page-wrap">
									<!--  Vertical Bar Size Progress-->
									<h4 class="list-title">Vertical bar size</h4>
									<p>Use vertical bar with different size.</p>
									<div class="prog progress-vertical">
										<div class="progress progres-sm progres-vertical">
											<div class="progress-bar" style="height:20%;" role="progressbar">
												<span class="sr-only">20% Complete</span>
											</div>
										</div>
										<div class="progress progres-md progres-vertical">
											<div class="progress-bar" style="height:40%;" role="progressbar">
												<span class="sr-only">40% Complete</span>
											</div>
										</div>
										<div class="progress progres-xm progres-vertical">
											<div class="progress-bar" style="height:60%;" role="progressbar">
												<span class="sr-only">60% Complete</span>
											</div>
										</div>
										<div class="progress progres-lg progres-vertical">
											<div class="progress-bar" style="height:80%;" role="progressbar">
							...
							<div class="col-lg-3 col-sm-6">
								<div class="page-wrap">
									<!--  Vertical Complete Color Progress-->
									<h4 class="list-title">Vertical complex with color</h4>
									<p>Use vertical complex with different color.</p>
									<div class="prog progress-vertical">
										<div class="progress progress-xs progres-vertical">
											<div class="progress-bar" style="height:90%;" role="progressbar">
												<span class="sr-only">90% Complete (success)</span>
											</div>
											<div class="progress-bar progress-bar-warning progress-bar-striped" style="height:40%;" role="progressbar">
												<span class="sr-only">40% Complete (warning)</span>
											</div>
											<div class="progress-bar progress-bar-danger" style="height:30%;" role="progressbar">
												<span class="sr-only">30% Complete (danger)</span>
											</div>
										</div>
										<div class="progress progress-xs progres-vertical">
											<div class="progress-bar progress-bar-success progress-bar-indicating active" style="height:80%;" role="progressbar">
												<span class="sr-only">80% Complete</span>
											</div>
										</div>
										<div class="progress progres-md progres-vertical">
											<div class="progress-bar progress-bar-info" style="height:70%;" role="progressbar">
												<span class="sr-only">70% Complete</span>
											</div>
										</div>
										<div class="progress progres-xm progres-vertical">
											<div class="progress-bar progress-bar-warning progress-bar-striped active" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="height:60%;" role="progressbar">
												<span class="sr-only">60% Complete</span>
											</div>
										</div>
										<div class="progress progres-xm progres-vertical">
											<div class="progress-bar progress-bar-danger progress-bar-striped" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="height:50%;" role="progressbar">
												<span class="sr-only">50% Complete (success)</span>
											</div>
										</div>
										<div class="progress progres-lg progres-vertical">
											<div class="progress-bar progress-bar-dark" style="height:40%;" role="progressbar">40%</div>
										</div>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-sm-12">
								<div class="page-wrap">
									<div class="prog-btn">
										<!--  Pieprogress Circle Progress-->
										<h4 class="list-title">Pieprogress circle</h4>
										<p>Use pieprogress circle with different style.</p>
									</div>
									<div class="row">
										<div class="pie_progress col-md-2 col-sm-1" role="progressbar" data-goal="33">
											<div class="pie_progress__number">0%</div>
											<div class="pie_progress__label">New Clients</div>
										</div>
										<div class="pie_progress col-md-2 col-sm-1" role="progressbar" data-goal="-50" data-barcolor="#3daf2c" data-barsize="10" aria-valuemin="-100" aria-valuemax="100">
											<div class="pie_progress__content">Hello</div>
										</div>
										<div class="pie_progress--slow col-md-2 col-sm-1" role="progressbar">
											<span class="pie_progress__number">0%</span>
										</div>
										<div class="pie_progress--countdown col-md-2 col-sm-1" role="progressbar">
											<span class="pie_progress__number">2: 00</span>
										</div>
									</div>
									<div class="text-center prog prog-buttons">
										<button class="btn btn-info waves-effect waves-light" id="button_start2" type="button">start</button>
										<button class="btn btn-info waves-effect waves-light" id="button_stop2" type="button">stop</button>
										<button class="btn btn-info waves-effect waves-light" id="button_go2" type="button">go to value 50</button>
										<button class="btn btn-info waves-effect waves-light" id="button_go_percentage2" type="button">go to 50%</button>
										<button class="btn btn-info waves-effect waves-light" id="button_finish2" type="button">finish</button>
										<button class="btn btn-info waves-effect waves-light" id="button_reset2" type="button">reset</button>
									</div>
								</div>
							</div>
							<div class="col-md-12 col-sm-12">
								<h4 class="list-title">Circle progress bar</h4>
								<p>Use different style circle progress bar.</p>
								<div class="row">
									<div class="col-lg-3 col-sm-6 col-xs-12 text-center responsive-progress-bar">
										<input class="knob" data-width="210" data-height="200" data-displayPrevious=true data-fgColor="#36a9e1" data-skin="tron" data-cursor=true value="75" data-thickness=".2">
									</div>
									<div class="col-lg-3 col-sm-6 col-xs-12 text-center responsive-progress-bar">
										<input class="knob" data-width="200" data-height="200" data-cursor=true data-fgColor="#5cb85c" data-thickness=.3 value="29">
									</div>
									<div class="col-lg-3 col-sm-6 col-xs-12 text-center responsive-progress-bar">
										<input class="knob" data-width="200" data-thickness=".3" data-angleOffset=90 data-fgColor="#d9534f" value="75">
									</div>
									<div class="col-lg-3 col-sm-6 col-xs-12 text-center responsive-progress-bar">
										<input class="knob" data-width="200" data-thickness=".4" data-angleOffset=90 data-fgColor="#f0ad4e" data-linecap=round value="66">
									</div>
								</div>
							</div>
						</div>
		...
		<script type="text/javascript" src="../assets/js/progress-bar/jquery-asProgress.js"></script>
		<script type="text/javascript" src="../assets/js/progress-bar/jquery-asPieProgress.js"></script>
		<script type="text/javascript" src="../assets/js/progress-bar/progress.js"></script>
		<script src="../assets/js/easypiechart/angular.js"></script>
		<script src="../assets/js/easypiechart/easypiechart.js"></script>
		<script src="../assets/js/easypiechart/jquery.knob.min.js"></script>
		<script src="../assets/js/easypiechart/custom.js"></script>
		<script type="text/javascript">
			$(document).ready(function(){
			    jQuery('.animatebar').each(function(){
			        jQuery(this).find('.animatebar-bar').animate({
