...
<html lang="en">
	<head>
		...
		<title>Page Headers | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="dashboard site-navbar-small">
			...
			<div class="page-header">
				<div class="header-left-panel">
					...
					<ol class="breadcrumb">
						...
						<li class="active">Page headers</li>
					</ol>
				</div>
			</div>
			<div class="page-content container-fluid headers-page">
				<div class="panel">
					<div class="panel-body">
						<div class="page-wrap">
							<!--  Stat Basic Header Section -->
							...
							<!--  End Basic Header Section -->
						</div>
						<div class="page-wrap">
							<!--  Start Breadcrumb Bottom Header Section -->
							<h4 class="list-title">Breadcrumb Bottom</h4>
							<div class="header-bg">
								<div class="page-header">
									<div class="header-left-panel">
										<h1 class="page-title">Page Title</h1>
							...
							<!--  End Breadcrumb Bottom Header Section -->
						</div>
						<div class="page-wrap">
							<!--  Start Breadcrumb Top Header Section -->
							<h4 class="list-title">Breadcrumb Top</h4>
							<div class="header-bg">
								<div class="page-header">
									<div class="header-left-panel">
										<ol class="breadcrumb top-breadcrumb">
							...
							<!--  End Breadcrumb Top Header Section -->
						</div>
						<div class="page-wrap">
							<!--  Start Header With Search Box Section -->
							<h4 class="list-title">With Search</h4>
							<div class="header-bg">
								<div class="page-header">
									<div class="header-left-panel">
										...
										<div class="header-right-panel right-search-header darkInputIndex">
											<form>
							...
							<!--  End Header With Search Box Section -->
						</div>
						<div class="page-wrap">
							<!--  Start Header With Button Group Section -->
							<h4 class="list-title">With Button Group</h4>
							<div class="header-bg">
								<div class="page-header">
									<div class="header-left-panel">
										<div class="header-left-title text-left">
										...
										<div class="header-right-panel right-button-header">
											<div class="btn-group btn-group-sm" id="withBtnGroup" aria-label="Page Header Actions" role="group">
												<button type="button" class="btn btn-info header-button waves-effect" data-toggle="tooltip" data-original-title="Search" data-container="body">
												<i class="icon icon_search" aria-hidden="true"></i>
												</button>
												<button type="button" class="btn btn-info header-button waves-effect" data-toggle="tooltip" data-original-title="Print" data-container="body">
												<i class="icon icon_printer" aria-hidden="true"></i>
												</button>
												<button type="button" class="btn btn-info header-button waves-effect" data-toggle="tooltip" data-original-title="Reload" data-container="body">
												<i class="icon icon_refresh" aria-hidden="true"></i>
												</button>
												<button type="button" class="btn btn-info header-button waves-effect" data-toggle="tooltip" data-original-title="Setting">
												<i class="icon icon_tool" aria-hidden="true"></i>
												</button>
											</div>
										</div>
									</div>
							...
							<!--  End Header With Button Group Section -->
						</div>
						<div class="page-wrap">
							<!--  Start Header With Button Section -->
							<h4 class="list-title">With Button</h4>
							<div class="header-bg">
								<div class="page-header">
									<div class="header-left-panel">
										<div class="header-left-title text-left">
										...
										<div class="header-right-panel right-search-header">
											<button type="button" class="btn w-icon btn-info waves-effect waves-light"><i class="icon_pencil"></i>Edit</button>
											<button type="button" class="btn w-icon btn-info waves-effect waves-light"><i class="icon_refresh"></i>Refresh</button>
											<button type="button" class="btn w-icon btn-info waves-effect waves-light"><i class="icon_cog"></i>Setting</button>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="page-wrap">
							<!--  Start Header With Button Section -->
							<h4 class="list-title"> With Round Button</h4>
							<div class="header-bg">
								<div class="page-header">
									<div class="header-left-panel">
										<div class="header-left-title text-left">
										...
										<div class="header-right-panel right-search-header">
											<button type="button" class="btn w-icon btn-info btn-round waves-effect" data-toggle="tooltip" data-original-title="Edit">
											<i class="icon icon_pencil" aria-hidden="true"></i>Edit
											</button>
											<button type="button" class="btn w-icon btn-info btn-round waves-effect" data-toggle="tooltip" data-original-title="Refresh">
											<i class="icon icon_refresh" aria-hidden="true"></i>Refresh
											</button>
											<button type="button" class="btn w-icon btn-info btn-round waves-effect margin-right-0" data-toggle="tooltip" data-original-title="Setting">
											<i class="icon icon_tool" aria-hidden="true"></i>Setting
											</button>
										</div>
									</div>
								</div>
						...
						<div class="page-wrap">
							<!--  Start Header With Description Section -->
							<h4 class="list-title">With Description</h4>
							<div class="header-bg">
								<div class="page-header">
									<div class="header-left-panel">
										<div class="header-left-title mobile-des-header">
											<h1 class="page-title">Page Title</h1>
											<p class="margin-bottom-0">Page Description Here. </p>
										</div>
										<ol class="breadcrumb des-breadcrumb">
											<li><a href="../dashboard_v1.html">Home</a></li>
											<li class="active">You are Here</li>
										</ol>
									</div>
							...
							<!--  End Header With Description Section -->
						</div>
						<div class="page-wrap">
							<!--  Start Center Header Section -->
							<h4 class="list-title">Centered</h4>
							<div class="header-bg">
								<div class="page-header">
									<div class="header-left-panel text-center">
										<h1 class="page-title">Page Title</h1>
										<p class="margin-bottom-0">Page Description Here. </p>
									</div>
								</div>
							</div>
							<!--  End Center Header Section -->
						</div>
						<div class="page-wrap">
							<!--  Start Header With Chart Section -->
							<h4 class="list-title">With Charts</h4>
							<div class="header-bg">
								<div class="page-header">
									<div class="header-left-panel">
										<div class="header-left-title text-left">
										...
										<div class="header-right-panel right-chart-header">
											<div class="chart-header">
												<span data-plugin="peityLine" data-width="90" data-height="25" data-padding="0.25" data-skin="blue">5,3,9,6,5,9,7,3,5,2</span>
											</div>
											<div class="header-counter">
												<div class="counter">Visitors</div>
												<span class="header-counter-number">1,854,784</span>
											</div>
										</div>
									</div>
								</div>
							</div>
							<!--  End Header With Chart Section -->
						</div>
						<div class="page-wrap">
							<!--  Start Header With Stats Section -->
							<h4 class="list-title">With Stats</h4>
							<div class="header-bg margin-bottom-0">
								<div class="page-header">
									<div class="header-left-panel">
										<div class="header-left-title text-left">
											<h1 class="page-title">Page Title</h1>
										...
										<div class="header-right-panel right-stats-header">
											<div class="panel-right-width">
												<div class="col-sm-4">
													<div class="header-counter">
														<span class="header-counter-number font-weight-medium">9741</span>
														<div class="counter">Likes</div>
													</div>
												</div>
												<div class="col-sm-4">
													<div class="header-counter">
														<span class="header-counter-number font-weight-medium">875</span>
														<div class="counter">Members</div>
													</div>
												</div>
												<div class="col-sm-4">
													<div class="header-counter">
														<span class="header-counter-number font-weight-medium">$5,223</span>
														<div class="counter">Profit</div>
													</div>
												</div>
											</div>
										</div>
		...
		<script src="../assets/js/chart/peity.min.js"></script>
