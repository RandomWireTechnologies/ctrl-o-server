...
<html lang="en">
	<head>
		...
		<title>Carousel | Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<link rel="stylesheet" href="../assets/css/carousel/slick.min.css">
		...
		<link rel="stylesheet" href="../assets/css/carousel/custom.css">
	</head>
	<body class="dashboard site-navbar-small">
		...
		<div class="main-content">
			...
			<div class="page-content carousel">
						...
						<div class="row ">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class=" margin-bottom-0">
									<!--  Default Carousel -->
									<h4 class="list-title">Default</h4>
									...
									<div class="page-wrap margin-md-0 margin-sm-0">
										<div class="carousel slide" id="CarouselDefault" data-ride="carousel">
											<ol class="carousel-indicators carousel-indicators-fall">
												<li class="active" data-slide-to="0" data-target="#CarouselDefault"></li>
												<li class="" data-slide-to="1" data-target="#CarouselDefault"></li>
												<li class="" data-slide-to="2" data-target="#CarouselDefault"></li>
											</ol>
											<div class="carousel-inner" role="listbox">
												<div class="item active">
													<img class="width-full" src="../assets/images/timeline/img_960x640.jpg" alt="carousel">
												</div>
												<div class="item">
													<img class="width-full" src="../assets/images/timeline/img_960x640.jpg" alt="carousel">
												</div>
											...
											<a class="left carousel-control" href="#CarouselDefault" role="button" data-slide="prev">
											<span class="icon arrow_carrot-left" aria-hidden="true"></span>
											<span class="sr-only">Previous</span>
											</a>
											<a class="right carousel-control" href="#CarouselDefault" role="button" data-slide="next">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="page-wrap margin-bottom-0">
									<!--  Captions Carousel -->
									<h4 class="list-title">Captions</h4>
									...
									<div class="carousel slide" id="CarouselCaptions" data-ride="carousel">
										<ol class="carousel-indicators carousel-indicators-fillin">
											<li class="" data-slide-to="0" data-target="#CarouselCaptions"></li>
											<li class="" data-slide-to="1" data-target="#CarouselCaptions"></li>
											<li class="active" data-slide-to="2" data-target="#CarouselCaptions"></li>
										</ol>
										<div class="carousel-inner" role="listbox">
											<div class="item">
												<img class="width-full" src="../assets/images/timeline/img_960x640.jpg" alt="Carousel with Caption">
												<div class="carousel-caption">
													<h3>First Image</h3>
													<p>Habitant quis class in mollis magnis. Nunc turpis porta augue.</p>
												</div>
											</div>
											<div class="item">
												<img class="width-full" src="../assets/images/timeline/img_960x640.jpg" alt="Carousel with Caption">
												<div class="carousel-caption">
													<h3>Second Image</h3>
													<p>Placerat sed in parturient dictum interdum nunc ullamcorper.</p>
												</div>
											</div>
											<div class="item active">
												<img class="width-full" src="../assets/images/timeline/img_960x640.jpg" alt="Carousel with Caption">
												<div class="carousel-caption">
													<h3>Third Image</h3>
													<p>Aliquam amet sociosqu praesent potenti quam. Taciti pretium dictumst.</p>
												</div>
											</div>
										</div>
				...
				<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">Owlcarousel</h3>
					</div>
					<div class="panel-body container-fluid">
						<div class="row ">
							<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!--  No Marging Carousel -->
									<h4 class="list-title">No Margins</h4>
									<p>Owlcarousel of image without margin..Image carousels allow users to browse through a set of items and make a selection of one if they so choose. Typically, the images are hyperlinked.</p>
									<div class="padding-20">
										<div id="owl-demo13">
											<div class="item m-0">
												<img src="../assets/images/timeline/img_960x640.jpg" alt="" />
											</div>
											<div class="item m-0">
												<img src="../assets/images/timeline/img_960x640.jpg" alt="" />
											</div>
							...
							<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!--  Sample Portfolio Carousel -->
									<h4 class="list-title">Sample Portfolio</h4>
									<p>User can also add Label and some content about image below the gallery.</p>
									<div class="padding-25 padding-bottom-0 new-arrow">
										<div id="owl-demo16" class="owl-carousel owl-theme padding-horizontal-10">
											<div class="item">
												<div class="cover"><img src="../assets/images/timeline/img_960x640.jpg" alt="" />
												</div>
												<h4>Pede Facilisis</h4>
												<p>Mi Netus nostra mattis amet convallis ipsum. Amet vitae lacinia. </p>
											</div>
											<div class="item">
												<div class="cover"><img src="../assets/images/timeline/img_960x640.jpg" alt="" /></div>
												<h4>Keja Gtiyaju</h4>
												<p>Sapien. Euismod Senectus phasellus eleifend elementum dolor montes, sed potenti.</p>
											</div>
											<div class="item">
												<div class="cover"><img src="../assets/images/timeline/img_960x640.jpg" alt="" /></div>
												<h4>Ipsum Dolor</h4>
												<p>Porta risus sed eu per lacinia massa diam scelerisque dapibus dolor. </p>
											</div>
											<div class="item">
												<div class="cover"><img src="../assets/images/timeline/img_960x640.jpg" alt="" /></div>
												<h4>Pede Facilisis</h4>
												<p>Pretium, habitant consequat ante facilisis. Vulputate. Tempus a, varius montes. </p>
											</div>
											<div class="item">
												<div class="cover"><img src="../assets/images/timeline/img_960x640.jpg" alt="" /></div>
												<h4>Loigi Dictusin</h4>
												<p>Cubilia dictumst fusce turpis Euismod imperdiet sociis malesuada dis molestie. </p>
											</div>
											<div class="item">
												<div class="cover"><img src="../assets/images/timeline/img_960x640.jpg" alt="" /></div>
												<h4>Purus Elementum </h4>
												<p>Elit quisque cras mattis donec morbi purus elementum auctor facilisis. </p>
											</div>
										</div>
									</div>
								</div>
				...
				<div class="panel">
					<div class="panel-heading">
						<!--  Slick Carousel -->
						<h3 class="panel-title">Slick Carousel</h3>
					</div>
					<div class="panel-body container-fluid">
						<div class="row ">
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<h4 class="list-title">Single Item</h4>
									<div class="padding-horizontal-25">
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									...
									<h4 class="list-title">Multiple Items</h4>
									<div class="padding-horizontal-25">
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!--  Data Attribute Carousel -->
									<h4 class="list-title">Data Attribute Settings</h4>
									<div class="slider" id="defaultData" data-slick='{"slidesToShow": 3, "slidesToScroll": 3}'>
										<div>
											<h3>A</h3>
										</div>
										<div>
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									<!--  AUtoplay Carousel -->
									<h4 class="list-title">AutoPlay</h4>
									<div class="slider" id="defaultAutoplay">
										<div>
											<h3 class="margin-horizontal-5">A</h3>
										</div>
										<div>
											<h3 class="margin-horizontal-5">B</h3>
										</div>
										<div>
											<h3 class="margin-horizontal-5">C</h3>
										</div>
										<div>
											<h3 class="margin-horizontal-5">D</h3>
										</div>
										<div>
											<h3 class="margin-horizontal-5">E</h3>
										</div>
										<div>
											<h3 class="margin-horizontal-5">F</h3>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap margin-bottom-lg-0">
									<!--  Responisve Display Carousel -->
									<h4 class="list-title">Responsive Display</h4>
									<div class="slider" id="defaultResponsive">
										<div>
											<h3>A</h3>
										</div>
										<div>
							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap">
									...
									<h4 class="list-title">Adaptive Height</h4>
									<div class="padding-horizontal-25">
										<div id="owl-demo5" class="owl-carousel owl-theme">
											<div class="item">
												<h1 class="margin-0">A</h1>
											</div>
											<div class="item">
												<h1 class="margin-0">B</h1>
												<p>User!!</p>
											</div>
											<div class="item">
												<h1 class="margin-0">C</h1>
												<p>Hii<br>Check in!</p>
											</div>
											<div class="item">
												<h1 class="margin-0">D</h1>
												<p>Yeah...</p>
											</div>
										</div>
									</div>
		...
		<script src="../assets/js/carousel-page/owl.carousel.js"></script>
		<script src="../assets/js/carousel-page/slick.min.js"></script>
		<script src="../assets/js/carousel-page/custom.js"></script>
	</body>
</html>
