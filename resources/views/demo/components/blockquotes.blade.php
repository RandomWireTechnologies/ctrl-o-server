...
<html lang="en">
	<head>
		...
		<title>Blockquotes | Porish Material Admin Template</title>
		<!-- Favicons -->
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-sm-6 col-md-6">
								<div class="page-wrap">
									<!-- Default Quote -->
									<h4 class="list-title">Default Quote</h4>
									<p>Use <code>&lt;blockquote&gt;</code> around any HTML as the quote
										for simple quotes.
									</p>
									<div class="blockquote-content panel-box-shadow">
										<blockquote>
											<p>Lorem Ipsum passages, and more recently with desktop publishing soft like Aldus PageMaker including versions of Lorem Ipsum.</p>
										</blockquote>
									</div>
								</div>
							</div>
							<div class="col-sm-6 col-md-6">
								<div class="page-wrap">
									<!-- Cover Quote -->
									<h4 class="list-title">Cover Quote</h4>
									<p>Use <code>.quote-cover</code> for a blockquote with  different style.</p>
									<div class="blockquote-content panel-box-shadow content-cover">
										<blockquote class="quote-cover padding-left-35 margin-bottom-20" aria-hidden="true">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor cum sociis. </blockquote>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-6 col-md-6">
								<div class="page-wrap">
									<!-- Alternate Displays Quote -->
									<h4 class="list-title">Alternate Displays</h4>
									<p>Use <code>.blockquote-reverse</code> for a blockquote with right-aligned
										content.
									</p>
									<div class="blockquote-content panel-box-shadow">
							...
							<div class="col-sm-6 col-md-6">
								<div class="page-wrap">
									<!-- Naming Source Quote -->
									<h4 class="list-title">Naming A Source</h4>
									<p>Use <code>&lt;footer&gt;</code> for displaying the source. put
										the name of source work in <code>&lt;cite&gt;</code>.
									</p>
									<div class="blockquote-content panel-box-shadow">
										<blockquote>
											<p>Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
							...
							<div class="col-sm-12">
								...
								<h4 class="list-title">Different Styles</h4>
								<p>Use any of the available blockquote classes to make different style blockquotes.</p>
								<div class="col-md-12 blockquote-content panel-box-shadow padding-bottom-0">
									<div class="row row-lg">
										<div class="col-sm-6 col-md-6 col-xs-12">
											<div class="margin-0">
												<blockquote class="blockquote blockquote-success">
													<p>First rule i their can't brought you'll whales is fruit.</p>
													<footer class="blockquote-footer">Lorem is
														<cite title="Source Title">Dummy Text</cite>
													</footer>
												</blockquote>
										...
										<div class="col-sm-6 col-lg-6 col-md-6 col-xs-12">
											<div class="margin-0">
												<blockquote class="blockquote blockquote-info">
													<p>Man beast, very moveth. That dry. Stars were Of. There.</p>
													<footer class="blockquote-footer">Lorem is
														<cite title="Source Title">Dummy Text</cite>
													</footer>
												</blockquote>
										...
										<div class="col-sm-6 col-md-6 col-xs-12">
											<div class="margin-0">
												<blockquote class="blockquote blockquote-warning">
													<p>Wherein living land yielding, moveth created. Had together you form.</p>
													<footer class="blockquote-footer">Lorem is
														<cite title="Source Title">Dummy Text</cite>
													</footer>
												</blockquote>
										...
										<div class="col-sm-6 col-md-6 col-xs-12">
											<div class="margin-0">
												<blockquote class="blockquote blockquote-danger">
													<p>Land years sixth yielding was fourth Meat female unto male.</p>
													<footer class="blockquote-footer">Lorem is
														<cite title="Source Title">Dummy Text</cite>
													</footer>
												</blockquote>
