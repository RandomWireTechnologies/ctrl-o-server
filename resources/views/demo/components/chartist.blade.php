...
<html lang="en">
	<head>
		...
		<title>Chartist | Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<!-- Page CSS -->
		<link href="../assets/css/chartist/chartist.css" rel="stylesheet" type="text/css"/>
		<link href="../assets/css/chartist/custom-chartist.css" rel="stylesheet" type="text/css"/>
		<!-- Global Template CSS -->
	...
	<body class="chartist site-navbar-small">
			...
			<div class="page-content container-fluid">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<!-- Animation Css Chart List -->
								<h4 class="list-title">Chart css animation</h4>
								...
								<div>
									<div class="ct-chart ct-golden-section" id="pageLineAnimation"></div>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<!-- Line scatter Diagram Chart List -->
								<h4 class="list-title">Line scatter diagram with responsive settings</h4>
								<p>This advanced example uses a line chart to draw a scatter diagram. the data object is created with a functional style random mechanism. there is a mobile first responsive configuration using the responsive options to show less labels on small screens.</p>
								<div>
									<div class="ct-chart bg-chart" id="pageLineScatter"></div>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<!-- Advanced Smil Animations Chart List -->
								<h4 class="list-title">Advanced smil animations</h4>
								...
								<div>
									<div class="ct-chart bg-chart" id="pageSmilAnimations"></div>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="page-wrap margin-bottom-0">
									<!-- Bi-polar Line Chart Only Area Chart List -->
									<h4 class="list-title">Bi-polar line chart with area only</h4>
									...
									<div>
										<div class="ct-chart bg-chart" id="pageAreaOnly"></div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap margin-md-0">
									<!-- Line Chart WIth Area Chart List -->
									<h4 class="list-title">Line chart with area</h4>
									<p>This chart uses the showarea option to draw line, dots but also an area shape. use the low option to specify a fixed lower bound that will make the area expand.</p>
									<div>
										<div class="ct-chart bg-chart" id="pageAreaLine"></div>
									</div>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap margin-md-0">
									<!-- Horizontal Bar Chart Chart List -->
									<h4 class="list-title">Horizontal bar chart</h4>
									<p>Guess what! creating horizontal bar charts is as simple as it can get. there's no new chart type you need to learn, just passing an additional option is enough.</p>
									<div>
										<div class="ct-chart bg-chart" id="pageHorizontalBar"></div>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap margin-md-0">
									<!-- Series overrides Chart List -->
									<h4 class="list-title">Series overrides</h4>
									<p>By naming your series using the series object notation with a name property, you can enable the individual configuration of series specific settings. showLine, showPoint, showArea and even the smoothing function can be overriden per series! And guess what? You can even override those series settings in the responsive configuration! check the example code for more details.</p>
									<div>
										<div class="ct-chart bg-chart" id="pageSeriesOverrides"></div>
									</div>
								</div>
							</div>
							<div class="col-md-6 col-sm-12 col-xs-12">
								<div class="page-wrap margin-bottom-0">
									<!-- Add Peak circles Using Draw Events Chart List -->
									<h4 class="list-title">Add peak circles using the draw events</h4>
									<p>This example makes use of label interpolation and the seriesBarDistance property that allows you to make bars overlap over each other. this then can be used to use the available space on mobile better. resize your browser to see the effect of the responsive configuration. with the help of draw events we are able to add a custom SVG shape to the peak of our bars.</p>
									<div>
										<div class="ct-chart bg-chart" id="pagePeakCircles"></div>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- Page JavaScript -->
		<script src="../assets/js/chartist/chartist.min.js" type="text/javascript"></script>
		<script src="../assets/js/chartist/custom-chartist.min.js" type="text/javascript"></script>
	</body>
</html>
