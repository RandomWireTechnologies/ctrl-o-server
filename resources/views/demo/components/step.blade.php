...
<html lang="en">
	<head>
		...
		<title>Step  | Porish Material Admin Template</title>
		<!-- Favicons -->
						...
						<div class="step">
							<div class="row">
								<div class="col-md-12 ">
									<div class="page-wrap">
										...
										<div class="row traingle">
											...
											<div class="col-md-3 col-sm-6 col-xs-12">
												<div class="step-box">
													<span class="sp-series info-back"><span>2</span></span>
													<div class="sp-circle info-back">
														<span class="sp-title">Find friend</span>
														<p>Lorem ipsum dolor sit amet</p>
													</div>
												</div>
											</div>
											<div class="col-md-3 col-sm-6 col-xs-12">
												<div class="step-box">
													...
													<div class="sp-circle step-col">
														<span class="sp-title">Profile info</span>
														<p>Lorem ipsum dolor sit amet</p>
													</div>
												</div>
											</div>
											<div class="col-md-3 col-sm-6 col-xs-12">
												<div class="step-box">
													<span class="sp-series gray-back">4</span>
													<div class="sp-circle step-col">
														<span class="sp-title">Join</span>
														<p>Lorem ipsum dolor sit amet</p>
													</div>
												</div>
											</div>
								...
								<div class="col-md-12">
									<div class="page-wrap">
										<!-- Set Icon Step -->
										<h4 class="list-title">Set icon</h4>
										<p>Set default step with icon</p>
										<div class="step-row row stp-icons">
											<div class="col-sm-4 col-xs-12">
												<div class="step-box">
													<span class="sp-series gray-back"><span class="sp-icon icon icon_ribbon_alt" aria-hidden="true"></span></span>
													<div class="sp-circle step-col">
														<span class="sp-title">Panel</span>
													</div>
												</div>
											</div>
											<div class="col-sm-4 col-xs-12">
												<div class="step-box">
													<span class="sp-series info-back"><span class="sp-icon icon  icon_cone_alt" aria-hidden="true"></span></span>
													<div class="sp-circle info-back">
														<span class="sp-title">Modal</span>
													</div>
												</div>
											</div>
											<div class="col-sm-4 col-xs-12">
												<span class="sp-series gray-back"> <span class="sp-icon icon  icon_pushpin_alt" aria-hidden="true"></span></span>
												<div class="sp-circle step-col">
													<span class="sp-title">Default</span>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="col-md-12">
									<div class="row stp-icons">
										<div class="col-md-3 col-sm-6 col-xs-12">
											<div class="step-box">
												<!-- Success Step -->
												<h4 class="list-title">Step success </h4>
												<p>Set default step and class<code>.success-back</code></p>
												<div class="margin-vertical-20">
													<span class="sp-series success-back white">A</span>
													<div class="sp-circle success-back">
														<span class="sp-title white">Accrual</span>
														<p class="white">Lorem ipsum dolor sit amet</p>
													</div>
												</div>
											</div>
										</div>
										<div class="col-md-3 col-sm-6 col-xs-12">
											<div class="step-box">
												<!-- Error Step -->
												<h4 class="list-title">Step error</h4>
												<p>Set default step and class<code>.error-back</code></p>
												<div class="margin-vertical-20">
													<span class="sp-series error-back white">B</span>
													<div class="sp-circle error-back">
														<span class="sp-title white">Enlistment</span>
														<p class="white">Lorem ipsum dolor sit amet</p>
													</div>
												</div>
											</div>
										</div>
										<div class="clearfix visible-sm-block  hidden-xlg"></div>
										<div class="col-md-3 col-sm-6 col-xs-12">
											<div class="step-box">
												<!-- Info Step -->
												<h4 class="list-title">Step info</h4>
												<p>Set default step and class<code>.info-back</code></p>
												<div class="margin-vertical-20">
													<span class="sp-series info-back"><span>C</span></span>
													<div class="sp-circle info-back">
														<span class="sp-title">Getting</span>
														<p>Lorem ipsum dolor sit amet</p>
													</div>
												</div>
											</div>
										...
										<div class="col-md-3 col-sm-6 col-xs-12">
											<div class="step-box margin-bottom-0">
												<!-- Disabled Step -->
												<h4 class="list-title">Step disabled</h4>
												<p>Set default step and class<code>.gray-back</code></p>
												<div class="margin-vertical-20 margin-bottom-0">
													<span class="sp-series gray-back"><span>D</span></span>
													<div class="sp-circle gray-back">
														<span class="sp-title">Getting</span>
														<p>Lorem ipsum dolor sit amet</p>
													</div>
												</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="page-wrap margin-md-0">
										<!-- Square With Icon Step -->
										<h4 class="list-title margin-bottom-30">Square with icon</h4>
										<div class="margin-vertical-20">
											<div class="row prl-square">
												<div class="pr-pearl done col-xs-4 ">
													<div class="prl-icon"><i class="icon icon_pencil-edit" aria-hidden="true"></i></div>
													<span class="prl-title">Plan</span>
												</div>
												<div class="pr-pearl current col-xs-4">
													<div class="prl-icon"><i class="icon icon_image" aria-hidden="true"></i></div>
													<span class="prl-title">Design</span>
												</div>
												<div class="pr-pearl col-xs-4 ">
													<div class="prl-icon"><i class="icon icon_cogs" aria-hidden="true"></i></div>
													<span class="prl-title">Development</span>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="col-md-6">
									<div class="page-wrap">
										<!-- Round Step -->
										<h4 class="list-title margin-bottom-30">Round</h4>
										<div class="margin-vertical-20">
											<div class="row">
												<div class="pr-pearl done col-xs-4 ">
													<span class="prl-series">A</span>
													<span class="prl-title">Plan</span>
												</div>
												<div class="pr-pearl current col-xs-4 ">
													<span class="prl-series">B</span>
													<span class="prl-title">Design</span>
												</div>
												<div class="pr-pearl col-xs-4 ">
													<span class="prl-series">C</span>
													<span class="prl-title">Development</span>
												</div>
											</div>
										</div>
								...
								<div class="col-md-6">
									<div class="page-wrap margin-md-0">
										<!-- Square Step -->
										<h4 class="list-title margin-bottom-30">Step square</h4>
										<div class="margin-vertical-20">
											<div class="row prl-square">
												<div class="pr-pearl current col-xs-4">
													<div class="prl-icon"><i class="icon  icon_pencil-edit" aria-hidden="true"></i></div>
												...
												<div class="pr-pearl disabled col-xs-4">
													<div class="prl-icon"><i class="icon  icon_image" aria-hidden="true"></i></div>
													<span class="prl-title">Design</span>
												</div>
												<div class="pr-pearl disabled col-xs-4">
										...
										<div class="list-title margin-vertical-20">
											<div class="row prl-square">
												<div class="pr-pearl done col-xs-4">
													<div class="prl-icon"><i class="icon  icon_pencil-edit" aria-hidden="true"></i></div>
													<span class="prl-title">Plan</span>
										...
										<div class="list-title margin-vertical-20">
											<div class="row prl-square">
												...
												<div class="pr-pearl current error col-xs-4">
													<div class="prl-icon"><i class="icon icon_image" aria-hidden="true"></i></div>
													<span class="prl-title">Design</span>
												</div>
												<div class="pr-pearl disabled col-xs-4">
										...
										<div class="list-title margin-vertical-20 margin-bottom-0">
											<div class="row prl-square prl-lg">
												<div class="pr-pearl done col-xs-4">
													<div class="prl-icon"><i class="icon  icon_pencil-edit" aria-hidden="true"></i></div>
													<span class="prl-title">Plan</span>
												</div>
								...
								<div class="col-md-6">
									<div class="margin-bottom-0">
										<!-- Round Size Step -->
										<h4 class="list-title margin-bottom-30">Round size</h4>
										<div class="margin-vertical-20">
											<div class="prl-xs row">
												<div class="pr-pearl done col-xs-4">
													<span class="prl-series">A</span>
													<span class="prl-title">Plan</span>
												</div>
