...
<html lang="en">
	<head>
		...
		<title>Chart | Porish Material Admin Template</title>
		<!-- Favicons -->
	...
	<body class="dashboard site-navbar-small">
		...
		<div class="main-content">
			...
			<div class="page-content container-fluid chart-page">
				<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">Chart.js</h3>
					</div>
						...
						<div class="row">
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap">
									...
									<canvas id="myChart_pie" height="252"></canvas>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Doughnut Chart -->
									<h4 class="list-title">Doughnut</h4>
									...
									<canvas id="myChart_doughnut" height="250"></canvas>
								</div>
							</div>
							...
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Polar Area Chart -->
									<h4 class="list-title">Polar area</h4>
									<p>Polar area charts are similar to pie charts, but each segment has the same angle - the radius of the segment differs depending on the value.this type of chart is often useful when we want to show a comparison data similar to a pie chart, but also show a scale of values for context.</p>
									<canvas id="myChart5_polar" height="250"></canvas>
								</div>
							</div>
							...
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap margin-md-0">
									<!-- Bar Chart -->
									<h4 class="list-title">Bar</h4>
									<p>The bar chart has the a very similar data structure to the line chart, and has an array of datasets, each with colours and an array of data. again, colours are in CSS format. We have an array of labels too for display. in the example, we are showing the same data as the previous line chart example.</p>
									<canvas id="myChart_bar" height="250"></canvas>
								</div>
							</div>
							<div class="clearfix visible-sm-block visible-md-block"></div>
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap margin-md-0 margin-sm-0">
									<!-- Line Chart -->
									<h4 class="list-title">Line</h4>
									<p>The line chart requires an array of labels for each of the data points. this is shown on the X axis. the data for line charts is broken up into an array of datasets. each dataset has a colour for the fill, a colour for the line and colours for the points and strokes of the points. these colours are strings just like CSS. you can use RGBA, RGB, HEX or HSL notation.</p>
									<canvas id="myChart_line" height="250"></canvas>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 col-xs-12">
								<div class="page-wrap">
									<!-- Radar Chart -->
									<h4 class="list-title">Radar</h4>
									<p>For a radar chart, to provide context of what each point means, we include an array of strings that show around each point in the chart. for the radar chart data, we have an array of datasets. each of these is an object, with a fill colour, a stroke colour, a colour for the fill of each point, and a colour for the stroke of each point. we also have an array of data values.</p>
									<canvas id="myChart_radar" height="251"></canvas>
								</div>
							</div>
						</div>
					</div>
		...
		<script src="../assets/js/chart/chart-page.js"></script>
		<script src="../assets/js/chart/chart-merge.js"></script>
	</body>
</html>
