...
<html>
	<head>
		...
		<title>Markdown-Flavoured Editor | Porish Material Admin Template</title>
		<!-- Favicons -->
		...
		<!-- Page CSS -->
		<link rel="stylesheet" href="../assets/css/editor-markdown-flav/custom.css">
		<link rel="stylesheet" href="../assets/css/editor-markdown-flav/default.css">
		<link rel="stylesheet" href="../assets/css/editor-markdown-flav/base16-light.css">
		<link rel="stylesheet" href="../assets/css/editor-markdown-flav/codemirror.css">
	</head>
	<body class="dashboard site-navbar-small flav">
		...
		<div class="main-content">
			<div class="page-header">
				<div class="header-left-panel">
					<!-- Title Page -->
					<h1 class="page-title">Markdown flavoured editor</h1>
					<!-- Breadcrumb Section -->
					<ol class="breadcrumb">
						<li><a href="../dashboard_v1.html">Home</a></li>
						<li class="text-info">Forms</li>
						<li class="active">Markdown flavoured editor</li>
					</ol>
				</div>
			</div>
			<div class="page-content editor-markdown-flav">
				<div class="panel">
					<div class="panel-body">
						<div class="row">
							<div id="in" class="col-md-6 col-sm-12 col-lg-6 margin-bottom-md-20">
								<!-- Start Markdown Flavoured Editor -->
								<form>
									<textarea id="code">
									...
									* File contents are saved in the URL so you can share files
									Cum malesuada pulvinar etiam lectus taciti sagittis augue aliquet morbi.
									Look, Here is a list!
									* list1
									* list2
									* list3
								...
								<!-- ENd Markdown Flavoured Editor -->
							</div>
							<div id="out" class="col-md-6"></div>
							<div id="menu">
								<!-- Start Save As Markdown Flavoured Editor -->
								<span>Save As</span>
								...
								<!-- End Save As Markdown Flavoured Editor -->
							</div>
						</div>
					</div>
				</div>
		...
		<!-- Page JavaScript -->
		<script src="../assets/js/editor-markdown-flav/markdown-it.js"></script>
		<script src="../assets/js/editor-markdown-flav/markdown-it-footnote.js"></script>
		<script src="../assets/js/editor-markdown-flav/highlight.pack.js"></script>
		<script src="../assets/js/editor-markdown-flav/emojify.js"></script>
		<script src="../assets/js/editor-markdown-flav/codemirror.js"></script>
		<script src="../assets/js/editor-markdown-flav/overlay.js"></script>
		<script src="../assets/js/editor-markdown-flav/xml.js"></script>
		<script src="../assets/js/editor-markdown-flav/markdown.js"></script>
		<script src="../assets/js/editor-markdown-flav/gfm.js"></script>
		<script src="../assets/js/editor-markdown-flav/javascript.js"></script>
		<script src="../assets/js/editor-markdown-flav/css.js"></script>
		<script src="../assets/js/editor-markdown-flav/htmlmixed.js"></script>
		<script src="../assets/js/editor-markdown-flav/continuelist.js"></script>
		<script src="../assets/js/editor-markdown-flav/rawdeflate.js"></script>
		<script src="../assets/js/editor-markdown-flav/rawinflate.js"></script>
		<script src="../assets/js/editor-markdown-flav/custom.js"></script>   
	</body>
</html>
